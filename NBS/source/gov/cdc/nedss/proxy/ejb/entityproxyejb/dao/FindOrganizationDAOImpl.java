...

{
 ...
 //For logging
  ...
  public static final String BASENAMEQUERYSQL =
      ...
      " FROM organization o, organization_name onm  "+
      " where " +
  ...
  public static final String BASEADDRESSQUERYSQL =
      ...
      "	from organization o, entity_locator_participation elp1, " +
      "	postal_locator pl "+
  ...
  public static final String BASETELEQUERYSQL =
      ...
      "	from " +
      "	organization o, entity_locator_participation elp2, " +
      "	tele_locator tl "+
      "  where  "+
...
/* Queries for Oracle */
  ...
  public static final String BASEADDRESSQUERYORACL =
      ...
      " pl.street_addr1 \"streetAddr1\", "+
      " pl.street_addr2 \"streetAddr2\", "+
      "	pl.city_desc_txt \"city\", pl.zip_cd \"zip\",  pl.state_cd \"state\", pl.cnty_cd \"cntyCd\" "+
      "	from organization o, entity_locator_participation elp1, " +
      "	postal_locator pl "+
      "	where o.organization_uid = elp1.entity_uid  "+
      "	and elp1.class_cd = 'PST' "+
     ...
     //// Added for Electronic indicator flag  reading from NEDSS.Preperties file-Sathya
		 ...
		 if (propUtil.getDatabaseServerType() != null && propUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			 query = "SELECT o.organization_uid \"organizationUid\" "+
		             "from organization o  "+
					 "WHERE "+
		             "(o.edx_ind is null or o.edx_ind != 'Y')  and "+
