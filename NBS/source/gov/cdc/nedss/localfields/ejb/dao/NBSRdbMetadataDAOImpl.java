...
public class NBSRdbMetadataDAOImpl extends DAOBase {
	...
	private final String INSERT_RDB_METADATA_HISTORY = "INSERT INTO NBS_rdb_metadata_hist(nbs_rdb_metadata_uid, nbs_page_uid, nbs_ui_metadata_uid, record_status_cd, record_status_time, last_chg_user_id, last_chg_time, local_id, rpt_admin_column_nm, rdb_table_nm, user_defined_column_nm, rdb_column_nm version_ctrl_nbr)"
	                                                 + " SELECT nbs_rdb_metadata_uid, nbs_page_uid, nbs_ui_metadata_uid, record_status_cd, record_status_time, last_chg_user_id, last_chg_time, local_id, rpt_admin_column_nm, rdb_table_nm, user_defined_column_nm, rdb_column_nm, ? from NBS_rdb_metadata"
