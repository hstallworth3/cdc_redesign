...
public class LocallyDefinedResultAndSnomedDAOImpl extends DAOBase{
	...
	private static final String FIND_RESULT_SNOMED_LINK_ORA="SELECT lab_result_cd \"labResultCd\" "
		+", laboratory_id \"laboratoryID\" "
		+", snomed_cd \"snomedCd\" "
		+"FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +".Lab_result_Snomed ";
	...
	private static final String CREATE_LINK_ORA="INSERT INTO "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE 
	+".Lab_result_Snomed  (lab_result_cd, laboratory_id, snomed_cd, status_cd,status_time,effective_from_time)"
	+"values(?,?,?,?,?,?)";
	...
	private static final String FIND_LABRESULT_ORA = " SELECT DISTINCT lab_result_cd \"labResultCd\", laboratory_id \"laboratoryId\" ,lab_result_desc_txt \"labResultDescTxt\" FROM "
		+ NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Lab_result ";
	...
	private static final String FIND_SNOMED_ORA = " SELECT snomed_cd \"snomedCd\", snomed_desc_txt \"snomedDescTx\" FROM "
		+ NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Snomed_code ";
...
public Collection<Object> getLabResultSnomedDTCollection(String whereClause) throws NEDSSDAOSysException, NEDSSSystemException {
        ...
        if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID))
			codeSql = FIND_RESULT_SNOMED_LINK_ORA;
