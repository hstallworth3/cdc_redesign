...
public class DeDuplicationProcessorEJB implements SessionBean, DeDuplicationBusinessInterface
{
     ...
     * @throws Exception
     */
    private void switchSupercededMPRRevisionPUIDsToSurvivirMPRPUIDs(PersonVO inPersonVO, Collection<Object> inCollection, PrepareVOUtils inPrepareVOUtils,
        NedssUtils inNedssUtils, NBSSecurityObj inNBSSecurityObj, DeDuplicationHelper deDuplicationHelper) throws Exception
    {
        ...
        Long personParentUID = inPersonVO.getThePersonDT().getPersonParentUid();
        String localId = inPersonVO.getThePersonDT().getLocalId();
        ...
        try
        {
            ...
            while(supercededMPRCollection.hasNext())
            {
                ...
                mergeDtColl.add(deDuplicationHelper.buildPersonMergeDt(supercededPersonVO, supercededPersonVO, inNBSSecurityObj, ts));
                Collection<Object> collection = null;
                try {
			...
			try
			{
			    while(samePivotCollectionIterator.hasNext())
			    {
			        try
			        {
			            ...
			            samePatientMatchCollectionFromRaceAndEthnic = deDuplicationDAO.getSamePatientsFromRaceAndEthnic(currentPivot);
			            ...
			            if(deDuplicationDAO.hasEntityIds(currentPivot)){
			                ...
			                samePatientMatchCollectionFromEntity = deDuplicationDAO.getEntitysFromEntity(currentPivot);
