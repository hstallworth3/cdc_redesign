    ...
    extends AbstractVO
{
  ...
  public Collection<Object> theRealizedRoleCollection;
  public User theUser;
  ...
  {
    return theRealizedRoleCollection;
  }
  ...
  {
    theRealizedRoleCollection  = aTheRealizedRoleCollection;
  }
  ...
  {
    if (this.theRealizedRoleCollection  == null)
    {
      this.theRealizedRoleCollection  = new ArrayList<Object> ();
    }
    int currentSize = this.theRealizedRoleCollection.size();
    // check if we have this many realized roles
    if (index < currentSize)
    {
      try
      {
	Object[] tempArray = this.theRealizedRoleCollection.toArray();
    ...
    for (int i = currentSize; i < index + 1; i++)
    {
      ...
      this.theRealizedRoleCollection.add(tempRole);
    }
