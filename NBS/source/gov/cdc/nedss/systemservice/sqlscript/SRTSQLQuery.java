...
public class SRTSQLQuery {
   ...
   public static final String TREATMENTPREDEFINEDQUERYORACLE =
       "Select  code_system_cd \"codeSystemCd\", code_system_desc_txt \"cdSystemDescTxt\",  dose_qty \"doseQty\"," + " dose_qty_unit_cd \"doseQtyUnitCd\"," +
       " route_cd \"routeCd\"," + " interval_cd \"intervalCd\"," +
       " duration_amt \"durationAmt\"," +
       " duration_unit_cd \"durationUnitCd\" from " +
   ...
   public static final String CODEQUERYORACLE_FOR_DESCRIPTION_TXT = "Select code \"key\", " +
       " code_desc_txt \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       ".code_Value_General where upper(code_set_nm) = ? ";
   ...
   public static final String CODEQUERYORACLE = "Select code \"key\", " +
       " code_short_desc_txt \"value\", concept_code \"altValue\" , status_cd \"statusCd\",  effective_to_time \"effectiveToTime\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       ".code_Value_General where upper(code_set_nm) = ? order by concept_order_nbr, lower(code_short_desc_txt) ";
   public static final String CITYSQL = "select code \"key\", " +
                                        " code_desc_txt \"value\"  from " +
                                        NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                        "..city_code order by code_desc_txt";
   public static final String CITYORACLESQL = "select code \"key\", " +
                                              " code_desc_txt \"value\"  from " +
                                              NEDSSConstants.
                                              SYSTEM_REFERENCE_TABLE +
                                              ".city_code ";
   ...
   public static final String STATEORACLESQL = "select state_cd \"key\", " +
                                               " code_desc_txt \"value\", status_cd \"statusCd\",  effective_to_time \"effectiveToTime\" from  " +
                                               NEDSSConstants.
                                               SYSTEM_REFERENCE_TABLE +
                                               ".state_code order by code_desc_txt ";
   public static final String STATEABSQL = "select state_cd \"key\", " +
                                           ...
                                           NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                           "..state_code ";
   public static final String STATEABORACLESQL = "select state_cd \"key\", " +
                                                 " state_nm \"value\", status_cd \"statusCd\",  effective_to_time \"effectiveToTime\" from  " +
                                                 NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                 ".state_code ";
   ...
   public static final String COUNTYORACLESQL = "select  code \"key\", " +
       " code_desc_txt \"value\" from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                ".State_county_code_value  where INDENT_LEVEL_NBR='2'";
   public static final String COUNTY_DESC_SQL = "SELECT code \"key\", " +
													   " code_desc_txt \"value\" FROM " +
													   NEDSSConstants.SYSTEM_REFERENCE_TABLE +
													   "..State_county_code_value where code= ";
   public static final String COUNTY_DESC_ORACLE = "SELECT code \"key\", " +
									   " code_desc_txt \"value\" FROM " +
									   NEDSSConstants.SYSTEM_REFERENCE_TABLE +
									   ".State_county_code_value where code= ";
    ...
    public static final String COUNTYSHORTDESCSQL = "SELECT code \"key\", " +
                                           ...
                                           NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                           "..State_county_code_value where INDENT_LEVEL_NBR='2'";
    public static final String COUNTYSHORTDESCORACLESQL = "select  code \"key\", " +
        " code_short_desc_txt \"value\" from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                 ".State_county_code_value  where INDENT_LEVEL_NBR='2'";
   ...
   public static final String COUNTRYORACLESQL = "select code  \"key\", " +
       " code_desc_txt \"value\" from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                 ".country_code order by code_desc_txt ";
  ...
  public static final String COUNTRYSHORTDESCSQL = "select code \"key\", " +
                                                   ...
                                                   NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                   "..country_code ";
 public static final String COUNTRYSHORTDESCORACLESQL = "select code  \"key\", " +
                                                        " code_short_desc_txt \"value\" from " +
                                                        NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                                        ".country_code ";
   ...
   public static final String RACESQL = "select  code \"key\", " +
                                        ...
                                        NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                        "..race_code ";
   public static final String RACEORACLESQL = "select code  \"key\", " +
       " code_short_desc_txt \"value\" from " +
                                              NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                              ".race_code ";
   ...
   public static final String GETADDRTYPEORACLESQL = "select  code \"key\", " +
       " code_short_desc_txt \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general where (code_set_nm = 'EL_TYPE') and (code not in ('BDL', 'BR')) ";
   ...
   public static final String GETADDRUSEORACLESQL = "select  code \"key\", " +
       " code_short_desc_txt \"value\"  from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general " +
       " where (code_set_nm = 'EL_USE') and (code NOT IN ('BDL', 'BIR', 'DTH')) ";
   ...
   public static final String PROGRAMAREASQL =
       ...
       " WHERE condition_cd = ?";   
   public static final String PROGRAMAREAORACLESQL =
       "select condition_cd \"key\", " +
       " prog_area_cd \"value\"  FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".condition_code " +
       " WHERE condition_cd = ?";
   ...
   public static final String PROGRAM_AREA_LIST_ORACLE_SQL =
       "select DISTINCT  prog_area_cd \"key\", " +
       " prog_area_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code";
   public static final String CONDTION_CODE_SQL =
       ...
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Condition_Code ";
   public static final String CONDTION_CODE_ORACLE =
       "SELECT condition_cd \"key\", " + " condition_short_nm \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_Code ";
    ...
    public static final String CONDTIONANDPROGRAMAREA_CODE_SQL =
        ...
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Condition_Code ";
    public static final String CONDTIONANDPROGRAMAREA_CODE_ORACLE =
        "SELECT condition_cd \"key\", " + " prog_area_cd \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_Code ";
    ...
    public static final String CONDTIONANDINVFORM_CODE_SQL =
        ...
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Condition_Code ";
    public static final String CONDTIONANDINVFORM_CODE_ORACLE =
        "SELECT condition_cd \"key\", " + " investigation_form_cd \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_Code ";
    ...
    public static final String CONDTIONFAMILY_CODE_SQL =
        ...
        " order by value";
    public static final String CONDTIONFAMILY_CODE_ORACLE =
        "SELECT condition_cd \"key\", " + " condition_short_nm \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_Code " +
        "where family_cd in (select family_cd from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + 
        ".Condition_Code " + "where condition_cd='?') " +
    ...
    public static final String BM_OTHER_BAC_SP_AND_BM_SPEC_ISOL_ORACLE =
        "SELECT code_short_desc_txt \"key\", " + " code_Set_nm \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general where code_Set_nm in('BM_OTHER_BAC_SP','BM_SPEC_ISOL')";
    ...
    public static final String BM_OTHER_BAC_SP_AND_BM_SPEC_ISOL_ISOL_CODE_DESC_TEXT_KEY_ORACLE =
        "SELECT code_desc_txt \"key\", " + " code \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general where code_Set_nm in('BM_OTHER_BAC_SP','BM_SPEC_ISOL')";
    ...
    public static final String VAC_NM_CODE_ORACLE =
        "SELECT code_short_desc_txt \"key\", " + " code \"value\" FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general where code_Set_nm = 'VAC_NM' order by lower(code_short_desc_txt)";
    ...
    public static final String STATE_DEFINED_SRT_CODESET_ORACLE =
            "SELECT code_set_nm \"key\", " + " code_set_short_desc_txt \"value\" , status_cd \"statusCd\",  effective_to_time \"effectiveToTime\" from  " +
            NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Codeset_Group_Metadata where ldf_picklist_ind_cd='Y' order by code_set_short_desc_txt";

    public static final String SAIC_DEFINED_SRT_CODESET_ORACLE =
    ...
    public static final String SAIC_DEFINED_SRT_CODES_ORACLE =
   ...
   public static final String RESULTDTESTDESCORACLE =
  ...
  public static final String RESULTDTESTDESCSQL =
   ...
   public static final String RESULTDTESTDESCLABORACLE =
...
//     ", 1 \"value\"  FROM "
   ...
   public static final String CODE_DESC_TXT_ORACLE_SQL =
       "SELECT DISTINCT code_desc_txt \"key\" " +
//     ", 1 \"value\" FROM "
       " FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       ".Code_value_general WHERE code = ?";
   public static final String LANGUAGESQL = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\"  FROM " +
                                            NEDSSConstants.SYSTEM_REFERENCE_TABLE +
                                            "..language_code";
   public static final String LANGUAGEORACLESQL = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\"  FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".language_code";
   public static final String INDUSTRYCODEESQL = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Industry_code";
   public static final String INDUSTRYCODEORACLESQL = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Industry_code";
   ...
   public static final String NAICSINDUSTRYCODEORACLESQL =
       "SELECT code \"key\", " + " code_short_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       ".NAICS_Industry_code where indent_level_nbr=1";
   ...
   public static final String CASEWORKERSORACLE =
		   "SELECT distinct root_extension_txt \"key\", " + " first_nm||' '||last_nm \"value\" FROM " +
	    		   "person_name pn , entity_id ei, auth_user au, auth_user_role aur " +
	    		   "where pn.person_uid = ei.entity_uid " +
	    		   "and ei.type_cd = 'QEC' "+
   ...
   public static final String PROGRAMAREACONDITIONSORACLESQL =
       "SELECT c.condition_cd \"conditionCd\", " + " c.condition_short_nm \"conditionShortNm\", c.prog_area_cd \"stateProgAreaCode\", " + " p.prog_area_desc_txt \"stateProgAreaCdDesc\",  c.investigation_form_cd  \"investigationFormCd\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_code c, " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code p " + " where c.prog_area_cd = p.prog_area_cd and c.indent_level_nbr = ? and c.prog_area_cd IN ";
   public static final String PROGRAMAREACONDITIONSORACLESQLWOINDENT =
       "SELECT c.condition_cd \"conditionCd\", " + " c.condition_short_nm \"conditionShortNm\", c.prog_area_cd \"stateProgAreaCode\", " + " p.prog_area_desc_txt \"stateProgAreaCdDesc\",  c.investigation_form_cd  \"investigationFormCd\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_code c, " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code p " + " where c.prog_area_cd = p.prog_area_cd and c.condition_cd=? ";
   public static final String ACTIVE_PROGRAMAREA_CONDITIONS_ORACLE_SQL =
       "SELECT c.condition_cd \"conditionCd\", " + " c.condition_short_nm \"conditionShortNm\", c.prog_area_cd \"stateProgAreaCode\", " + " p.prog_area_desc_txt \"stateProgAreaCdDesc\",  c.investigation_form_cd  \"investigationFormCd\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_code c, " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code p " + " where c.prog_area_cd = p.prog_area_cd and c.status_cd = 'A' and c.investigation_form_cd is not NULL and c.indent_level_nbr = ? and c.prog_area_cd IN ";
   ...
   public static final String COUNTRY_CODE_ORACLE = "SELECT code \"key\", " +
       "code_short_desc_txt \"value\" " + "FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Country_code order by CODE_SHORT_DESC_TXT";
   ...
   public static final String PROGRAM_AREA_CODED_VALUES_ORACLE =
       "SELECT prog_area_cd \"key\" , " + " prog_area_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code";
  ...
  public static final String CODED_RESULT_VALUES_ORACLE =
    "SELECT lab_result_cd \"key\" , " + "lab_result_desc_txt \"value\" FROM " +
    NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".lab_result where ORGANISM_NAME_IND = 'N' AND LABORATORY_ID = 'DEFAULT'";
   ...
   public static final String PROGRAM_AREA_IDS_SQL =
       ...
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Program_area_code";
   public static final String PROGRAM_AREA_IDS_ORACLE =
       "SELECT prog_area_cd \"key\" , " + " nbs_uid \"intValue\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Program_area_code";
   ...
   public static final String JURISDICTION_CODED_VALUES_ORACLE =
       "SELECT code \"key\" , " + "code_desc_txt  \"value\", export_ind \"altValue\"  FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Jurisdiction_code order by code_desc_txt";
   ...
   public static final String JURISDICTION_CODED_VALUES_FOR_DOC_ORACLE =
   ...
   //"where state_domain_cd = \'47\'";
   public static final String JURISDICTION_NUMERIC_IDS_ORACLE =
       "SELECT code \"key\" , " + " nbs_uid \"intValue\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Jurisdiction_code ";
   //"where state_domain_cd = \'47\'";
   //
   //-----------for build d security - oracle
   ...
   public static final String LAB_TEST_ORACLE_SQL =
       "SELECT nbs_test_code \"key\" " + " , nbs_test_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "." +
       NEDSSConstants.LAB_TEST_TABLE;
   ...
   public static final String SUSP_TEST_ORACLE_SQL =
       "SELECT nbs_susp_test_cd \"key\" , " +
       " nbs_susp_test_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "." +
       NEDSSConstants.SUSP_TEST_TABLE;
   public static final String JURISDICTION_SQL = "SELECT code  \"key\" ," +
       " code_short_desc_txt \"value\"  FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Jurisdiction_code ";
   public static final String JURISDICTION_ORACLE = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Jurisdiction_code ";
   public static final String BMDCODEQUERYSQL = "Select code \"key\"," +
       ...
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       "..code_Value_General where upper(code_set_nm) = ? ";
   public static final String BMDCODEQUERYORACLE = "Select code \"key\"," +
       " code_short_desc_txt \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
          ".code_Value_General where upper(code_set_nm) = ? ";
   ...
   public static final String REPORTSUMMARYQUERYORACLE = "Select code \"key\"," +
       "code_desc_txt \"value\"  from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
       ".code_Value_General where code_set_nm = 'SUMMARY_RPT_SRC' " +
       " AND super_code_set_nm = 'COUNTY_CCD' AND super_code  = ? ";
   ...
   public static final String RSUMMARYCONDITIONQUERYORACLE =
       "Select condition_cd \"key\"," + "  prog_area_cd \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".condition_code "; //where upper(reportable_summary_ind) = 'Y' ";
   ...
   public static final String RSUMMARYDATACODEQUERYSQL =
       "Select condition_cd \"key\"," + " condition_short_nm \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..condition_code "; //where upper(reportable_summary_ind) = 'Y' ";
   public static final String RSUMMARYDATACODEQUERYORACLE =
       "Select condition_cd \"key\"," + "  condition_short_nm \"value\" from " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".condition_code "; //where upper(reportable_summary_ind) = 'Y' ";
   ...
   /* Add for LDFs */
   public static final String GETLDFDROPDOWN_ORCL = "SELECT CODE \"key\"," +
   ...
   public static final String GETLDFSRTDROPDOWN_ORA = "SELECT code_set_nm \"key\"," +
   		"code_set_short_desc_txt \"value\" from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +".Codeset_Group_Metadata  where ldf_picklist_ind_cd='Y' order by code_set_short_desc_txt" ;
   ...
   public static final String GETLDFPAGEIDS_ORACLE = "SELECT ldf_page_id \"ldfPageId\"," +
  ...
  public static final String GETLDFPAGEIDSHOME_ORACLE = "SELECT ldf_page_id \"ldfPageId\"," +
  " business_object_nm \"businessObjNm\", condition_cd \"conditionCd\", " +
  " ui_display \"uiDisplay\", indent_level_nbr \"indentLevelNbr\"," +
  " parent_is_cd \"parentIsCd\", nbs_uid \"nbsUid\", status_cd \"statusCd\","+
  " code_short_desc_txt  \"codeShortDescTxt\", display_row \"displayRow\"," +
  ...
  public static final String GETLDFPAGEIDSHOME_SQL =
   ...
   public static final String OCCUPATIONCODEORACLESQL = "SELECT code \"key\", " +
       " code_short_desc_txt \"value\" FROM " +
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
               ".OCCUPATION_CODE where indent_level_nbr=1";

/* Race code and category. Done for dat migration */
   public static final String RACECODEANDCATEGORYORACLE = "select code \"key\",  "+
       " parent_is_cd \"value\""+
       " from "+
       NEDSSConstants.SYSTEM_REFERENCE_TABLE +
...
/* Ethnicity code and group. Done for dat migration */
   public static final String ETHNICITYCODEANDGROUOPORCL = "select code \"value\" , " +
   ...
   public static final String ETHNICITYCODEANDGROUOPSQL = "select code \"value\" , " +
    ...
    public static final String REPORTSOURCESINCOUNTYORCL = "select code \"key\" , " +
    ...
    public static final String LAB_TEST_DESC_ORA =
        "SELECT lab_test_desc_txt FROM " +
        NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".LAB_TEST ";
    ...
    public static final String CODEQUERY_ORA_ORDERED = "Select code \"key\", code_short_desc_txt \"value\" from " +
	NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_Value_General where upper(code_set_nm) = ? order by NBS_UID ";    
    
    public static final String SELECT_SNOMED_PROGRAM_AREA_EXCLUSION_ORA = "SELECT snomed_cd \"snomedCd\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Snomed_code WHERE ";
    public static final String SELECT_LOINC_PROGRAM_AREA_EXCLUSION_ORA = "SELECT loinc_cd \"loincCd\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".LOINC_code WHERE ";
    public static final String SELECT_LAB_TEST_PROGRAM_AREA_EXCLUSION_ORA = "SELECT lab_test_cd \"labTestCd\", laboratory_id \"laboratoryId\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Lab_test WHERE ";
    public static final String SELECT_LAB_RESULT_PROGRAM_AREA_EXCLUSION_ORA = "SELECT lab_result_cd \"labResultCd\", laboratory_id \"laboratoryId\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Lab_result WHERE ";
    public static final String SELECT_SNOMED_PROGRAM_AREA_EXCLUSION_SQL = "SELECT snomed_cd \"snomedCd\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Snomed_code WHERE ";
    public static final String SELECT_LOINC_PROGRAM_AREA_EXCLUSION_SQL = "SELECT loinc_cd \"loincCd\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..LOINC_code WHERE ";
    public static final String SELECT_LAB_TEST_PROGRAM_AREA_EXCLUSION_SQL = "SELECT lab_test_cd \"labTestCd\", laboratory_id \"laboratoryId\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Lab_test WHERE ";
    public static final String SELECT_LAB_RESULT_PROGRAM_AREA_EXCLUSION_SQL = "SELECT lab_result_cd \"labResultCd\", laboratory_id \"laboratoryId\", pa_derivation_exclude_cd \"paDerivationExcludeCd\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Lab_result WHERE ";
	...
	public static final String CODE_DESC_SHORT_TXT_ORACLE ="SELECT DISTINCT code_short_desc_txt \"key\" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Code_value_general WHERE code = ? and upper(code_set_nm) = ? ";
	...
	public static final String CONTACTTRACINGENABLEINDORACLESQL = "select condition_cd  \"key\", " +
			 " contact_tracing_enable_ind \"value\" from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
           ".condition_code order by condition_cd ";
	...
	public static final String PARTICIPATIONTYPESSQL =
			"SELECT act_class_cd \"actClassCd\", " + "subject_class_cd \"subjectClassCd\", " + " type_cd \"typeCd\", type_desc_txt \"typeDescTxt\", " + "question_identifier \"questionIdentifier\" FROM " +
					NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Participation_type " +
					" where question_identifier is not null and record_status_cd = 'ACTIVE' order by type_cd ";
	
	public static final String PARTICIPATIONTYPESORACLESQL =
			"SELECT act_class_cd \"actClassCd\", " + "subject_class_cd \"subjectClassCd\", " + " type_cd \"typeCd\", type_desc_txt \"typeDescTxt\", " + "question_identifier \"questionIdentifier\" FROM " +
					NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Participation_type " +
					" where question_identifier is not null and record_status_cd = 'ACTIVE' order by type_cd ";
	...
	public static final String COINFECTION_CONDITION_ORA = "SELECT condition_cd , coinfection_grp_cd from nbs_srte.condition_code where coinfection_grp_cd is not null" ;
	...
	public static final String PHIN_TO_NBS_CODE_SQL = "select distinct cvg.code_set_nm +'^'+ cvg.concept_code PHINConcepts, cvg.code  from wa_ui_metadata wum " 
					+ " inner join " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..codeset cs on wum.code_set_group_id = cs.code_set_group_id and upper(cs.class_cd)='CODE_VALUE_GENERAL' "
					+ " inner join " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..Code_value_general cvg on "
					+" cs.code_set_nm = cvg.code_set_nm" ;
	
	public static final String PHIN_TO_NBS_CODE_ORA = "select distinct cvg.code_set_nm ||'^'|| cvg.concept_code PHINConcepts, cvg.code  from wa_ui_metadata wum " 
			+ " inner join " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".codeset cs on wum.code_set_group_id = cs.code_set_group_id and upper(cs.class_cd)='CODE_VALUE_GENERAL' "
			+ " inner join " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Code_value_general cvg on "
			+ " cs.code_set_nm = cvg.code_set_nm" ;
}
