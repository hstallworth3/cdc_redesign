		          ...
		          dt.getRecordStatusCd().equals(NEDSSConstants.RECORD_STATUS_ACTIVE))
		      {
		        ...
		        if (postalDt != null)
		        {
		          ...
		          try
		          {
		            ...
		            {
		              sqlQuery = ELRConstants.JURISDICTION_SELECT_ORACLE;
		              sqlCityQuery = ELRConstants.
		                  JURISDICTION_CITY_SELECT_ORACLE_DM;
		            }
		            else
		            {
		          ...
		          dt.getRecordStatusCd().equals(NEDSSConstants.RECORD_STATUS_ACTIVE))
		      {
		        ...
		        if (postalDt != null)
		        {
		          ...
		          try
		          {
		            ...
		            {
		              sqlQuery = ELRConstants.JURISDICTION_SELECT_ORACLE;
		              sqlCityQuery = ELRConstants.JURISDICTION_CITY_SELECT_ORACLE;
