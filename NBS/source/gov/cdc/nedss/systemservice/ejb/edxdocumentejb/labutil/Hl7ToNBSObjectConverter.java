...
public class Hl7ToNBSObjectConverter {
	...
	public static Timestamp processHL7TSType(HL7TSType time, String itemDescription) throws NEDSSAppException {
		String timeStr = "";
		try {
	...
	public static Timestamp processHL7TSTypeWithMillis(HL7TSType time, String itemDescription) throws NEDSSAppException {
		String dateStr = "";
		try {
			Timestamp toTimestamp = null;
	...
	public static Timestamp processHL7TSTypeForDOBWithoutTime(HL7TSType time) throws NEDSSAppException {
		Timestamp toTimestamp = null;
		String toTime = "";
		...
		try {
			...
			if (time != null) {
				...
				if (year >= 0 && month >= 0 && date >= 0) {
					...
					toTimestamp = StringUtils.stringToStrutsTimestamp(toTime); //if can't process returns null
				}
			}
		} catch (Exception e) {
	...
	public static Timestamp processHL7DTType(HL7DTType time, String itemDescription) throws NEDSSAppException {
		Timestamp toTimestamp = null;
		...
		if (time != null) {
			try {
				...
				if (year >= 0 && month >= 0 && date >= 0) {
					...
					toTimestamp = StringUtils.stringToStrutsTimestamp(toTime);
				}
			} catch (Exception e) {
	...
	public static PersonVO getProviderVO(HL7XCNType collector,
	...
	public static EntityIdDT processEntityData(HL7CXType hl7CXType,
	...
	public static PersonVO MapPersonNameType(HL7XPNType hl7XPNType,
		...
		String toCode = dao.findToCode("ELR_LCA_NM_USE", personNameDT.getNmUseCd(), "P_NM_USE");
		if(toCode!=null){
	...
	public static PostalLocatorDT nbsStreetAddressType(HL7SADType hl7SADType,
			PostalLocatorDT pl) {
	...
	public static EntityLocatorParticipationDT personAddressType(
	...
	public static EntityLocatorParticipationDT organizationAddressType(
	...
	public static EntityLocatorParticipationDT addressType(
	...
	public static EntityLocatorParticipationDT orgTelePhoneType(
	...
	public static EntityLocatorParticipationDT telePhoneType(
		...
		if (hl7LocalNumber != null) {
			number = (int) hl7LocalNumber.getHL7Numeric() + "";
	...
	public static Timestamp convertCalToTimeStamp(Calendar calenderObject) {
	...
	public static ParticipationDT defaultParticipationDT(
	...
	public static String formatSSN(String ssn) {
		...
		if (ssn != null && !ssn.equals("") && !ssn.equals(" ")) {
			ssn=ssn.trim();
			if (ssn.length() > 3) {
				newSSN = ssn.substring(0, 3);
				newSSN = newSSN + "-";
				if (ssn.length() > 5) {
					newSSN = newSSN + ssn.substring(3, 5) + "-";
					newSSN = newSSN + ssn.substring(5, (ssn.length()));
					ssn = newSSN;
				} else {
					newSSN = newSSN + ssn.substring(3, ssn.length()) + "- ";
					ssn = newSSN;
				}
			} else {
				ssn = ssn + "- - ";
	...
	private static String translateStateCd(String msgInStateCd)
		...
		if(msgInStateCd!=null && msgInStateCd.trim().length()>0)
		{
			...
			String SRT_SELECT_STATE_CD_SQL = "select state_cd \"key\" "+
		      ...
		      String codeSql = null;
		      if (PropertyUtil.getInstance().getDatabaseServerType() != null
		                  && PropertyUtil.getInstance().getDatabaseServerType().equalsIgnoreCase(
		                              NEDSSConstants.ORACLE_ID)) {
		            codeSql = SRT_SELECT_STATE_CD_ORACLE;
		      } else {
