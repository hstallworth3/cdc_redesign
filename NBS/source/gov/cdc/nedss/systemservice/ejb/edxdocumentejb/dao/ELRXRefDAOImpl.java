...
public class ELRXRefDAOImpl extends BMPBase{
  ...
  private static final String ELR_CODE_X_REF_ORACLE = "SELECT to_code FROM "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE +".elr_xref WHERE from_code_set_nm = ? "+
