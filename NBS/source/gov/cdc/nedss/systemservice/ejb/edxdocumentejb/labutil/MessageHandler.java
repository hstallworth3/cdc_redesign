...
public class MessageHandler {
	...
	public static LabResultProxyVO getMessage(HL7MSHType messageHandlerType, EdxLabInformationDT edxLabInformationDT){
	...
	public static EdxELRLabMapDT processSendingFacility(HL7HDType SendingFacility, EdxLabInformationDT edxLabInformationDT){
	...
	public static EdxELRLabMapDT processReceivingFacility(HL7HDType receivingFacility, EdxLabInformationDT edxLabInformationDT){
		EdxELRLabMapDT edxLabMapDT  = new EdxELRLabMapDT();
	...
	public static LabResultProxyVO createOrganizationVO(LabResultProxyVO labResultProxyVO, EdxELRLabMapDT edxLabMapDT, EdxLabInformationDT edxLabInformationDT){
