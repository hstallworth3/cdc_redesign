      ...
      EJBException, RemoteException
  {
    ...
    try {
    	...
    	dsmAlgorithmDT = algorithmDao.updateDSMAlgorithmDT(dsmAlgorithmDT);
  		...
  		logger.fatal("DSMAlgorithmEJB.updateDSMAlgorithm: NEDSSSystemException:  "+ se2.getMessage(), se2);
  		throw new NEDSSSystemException(se2.getMessage(), se2);
	}
  	catch(Exception e) {
  		logger.fatal("DSMAlgorithmEJB.updateDSMAlgorithm: Exception: :  "+ e.getMessage(), e);
  		throw new EJBException(e.getMessage(), e);
	}
