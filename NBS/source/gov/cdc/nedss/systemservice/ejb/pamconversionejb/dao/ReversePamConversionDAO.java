...
public class ReversePamConversionDAO  extends DAOBase{
	...
	private static final String SELECT_FROM_PHC_TABLE_ORACLE = "Select MAX(public_health_case_uid) \"publicHealthCaseUid\" from public_health_case t1 LEFT JOIN NBS_conversion_master t2 ON t1.public_health_case_uid=t2.ACT_UID AND t2.process_type_ind='Production' AND t2.status_cd = 'UpdatePass' where t2.ACT_UID IS NULL AND t1.cd=?  AND t1.case_type_cd = 'I'  ";
