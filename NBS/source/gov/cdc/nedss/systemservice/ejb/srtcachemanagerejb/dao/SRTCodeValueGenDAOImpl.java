...
public class SRTCodeValueGenDAOImpl extends DAOBase{
  ...
  public static String anatomicORCL = "select  ana.code \"code\", ana.anatomic_site_desc_txt \"codeShortDescTxt\"," +
                  ...
                  " order by upper(anatomic_site_desc_txt)";
  public static String anatomicLoincORCL ="select  ana.code \"code\", ana.anatomic_site_desc_txt \"codeShortDescTxt\"," +
                  "lc.loinc_cd \"loincCd\"" +
 ...
 public static String anatomicLoincSQL ="select  ana.code \"code\", ana.anatomic_site_desc_txt \"codeShortDescTxt\"," +
  ...
  public static String anatomicSQL = "select  ana.code \"code\", ana.anatomic_site_desc_txt \"codeShortDescTxt\"," +
    ...
    public static String anatomicAllORCL = "select  ana.code \"code\", ana.anatomic_site_desc_txt \"codeShortDescTxt\"" +
                  " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".anatomic_site_code ana  " +
   ...
   public static String specimenSourceORCL = "select  ssc.code \"code\", ssc.specimen_source_desc_txt \"codeShortDescTxt\"," +
                   "lt.test_type_cd \"testTypeCd\",lt.lab_test_desc_txt \"labTestDescTxt\", lt.lab_test_cd \"labTestCd\",lt.laboratory_id \"laboratoryId\""+
                    ...
                    " order by upper(specimen_source_desc_txt)";
public static String specimenSourceLoincORCL ="select  ssc.code \"code\", ssc.specimen_source_desc_txt \"codeShortDescTxt\"," +
                    "lc.loinc_cd \"loincCd\"" +
                    " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
...
public static String specimenSourceLoincSQL = "select  ssc.code \"code\", ssc.specimen_source_desc_txt \"codeShortDescTxt\"," +
   ...
   public static String specimenSourceSQL = "select  ssc.code \"code\", ssc.specimen_source_desc_txt \"codeShortDescTxt\"," +
    ...
    public static String specimenSourceAllORCL = "select  ssc.code \"code\", ssc.specimen_source_desc_txt \"codeShortDescTxt\"" +
                   " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".specimen_source_code ssc  " +
   ...
   public static String unitORCL = "select  uc.code \"code\", uc.UNIT_DESC_TXT \"codeShortDescTxt\"," +
                    "lt.test_type_cd \"testTypeCd\",lt.lab_test_desc_txt \"labTestDescTxt\", lt.lab_test_cd \"labTestCd\",lt.laboratory_id \"laboratoryId\""+
                    ...
                    " order by upper(code),upper(UNIT_DESC_TXT)";
public static String unitLoincORCL = "select  uc.code \"code\", uc.UNIT_DESC_TXT \"codeShortDescTxt\"," +
                   "lc.loinc_cd \"loincCd\""+
                   " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".UNIT_CODE uc,  " +
                   NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".loinc_code lc,  " +
...
public static String unitLoincSQL ="select  uc.code \"code\", uc.UNIT_DESC_TXT \"codeShortDescTxt\"," +
   ...
   public static String unitAllORCL = "select  uc.code \"code\", uc.UNIT_DESC_TXT \"codeShortDescTxt\"" +
                 " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".UNIT_CODE uc  " +
   ...
   public static String reportingSourceORCL = "select  rsc.code \"code\", rsc.reporting_source_desc_txt \"codeShortDescTxt\"," +
                     ...
                     " order by upper(reporting_source_desc_txt)";
   ...
   public static String reportingSourceAllORCL ="select  rsc.code \"code\", rsc.reporting_source_desc_txt \"codeShortDescTxt\"" +
                  " from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".reporting_source_code rsc  " +
...
public Collection<Object>  getLoincAnatomicSiteData() throws NEDSSSystemException {
       ...
       try{
	       if (propertyUtil.getDatabaseServerType() != null &&
	           propertyUtil.
	           getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	          query = anatomicLoincORCL;
	       }
	       else {
	          query = anatomicLoincSQL;
