...
public String getConditionSelected() {
	...
	public String getProgramArea(){
		if(getProgramAreaLabSelected()!=null && !getProgramAreaLabSelected().equals("")  && getProgramAreaLabSelected()!= null)
			return getProgramAreaLabSelected();
		if(getProgramAreaMorbSelected()!=null && !getProgramAreaMorbSelected().equals("")  && getProgramAreaMorbSelected()!= null)
			return getProgramAreaMorbSelected();
		if(getProgramAreaCaseSelected()!=null && !getProgramAreaCaseSelected().equals("") && getProgramAreaCaseSelected()!= null)
			return getProgramAreaCaseSelected();
		if(getProgramAreaInvestigationSelected()!=null && !getProgramAreaInvestigationSelected().equals("")  && getProgramAreaInvestigationSelected()!= null)
