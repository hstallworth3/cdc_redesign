...
public class EntityIdDAOImpl extends BMPBase
{
        ...
        private static final String SELECT_ENTITY_IDS =
                ...
                + "FROM " + DataTables.ENTITY_ID_TABLE + " WHERE entity_uid = ?";
        ...
        private static final String SELECT_ENTITYUID_ENTITY_ID =
                " SELECT Entity.entity_uid FROM " + DataTables.ENTITY_ID_TABLE+" , "
...
logger.debug("personID = " + personUID);
        ...
        /**
          ...
          * @throws NEDSSSystemException
          **/
        private void insertEntityIDs(long personUID, Collection<Object> entityIDs)
                                throws NEDSSSystemException
        {
                ...
                try
                {
                        ...
                        logger.debug("Number of elements: " + entityList.size());
                                ...
                                if (entityID != null)
                                insertEntityID(personUID, entityID);
                                //else
                                //throw new NEDSSPersonDAOAppException("Empty person name collection");
                ...
                catch(Exception ex)
                {
                        logger.fatal("personUID: "+personUID+" Exception while inserting " +
                                        "entity ids into ENTITY_ID_TABLE: personUID: "+personUID+"\n", ex);
        ...
        /**
          ...
          * @throws NEDSSSystemException
          **/
        private void insertEntityID(long personUID, EntityIdDT entityID)
                        throws NEDSSSystemException
        {
                Connection dbConnection = null;
                PreparedStatement preparedStmt = null;
			...
			if (entityID.getAssigningAuthorityCd() != null
					&& entityID.getAssigningAuthorityCd().length() > 199) {
				assigningAuthouritycd = entityID.getAssigningAuthorityCd()
						.substring(0, 198);
				logger.debug("Assigning Authourity Code '"
						+ entityID.getAssigningAuthorityCd()
                ...
                if(entityIDs != null)
                {
                        try
                        {
                                for(anIterator = entityIDs.iterator(); anIterator.hasNext(); )
                                {
                                        ...
                                        if(entityID.isItNew())
                                          insertEntityID((entityID.getEntityUid()).longValue(), entityID);

                                        if(entityID.isItDirty())
...

  {
        ...
        try
        {
               ...
               /** System.out.println(" \n\n The querry  ...... " + SELECT_COUNT_ENTITY_ID.toString() );**/
                ...
                if(resultSet.next())
                {
                           entityUid = new Long(resultSet.getInt(1));
