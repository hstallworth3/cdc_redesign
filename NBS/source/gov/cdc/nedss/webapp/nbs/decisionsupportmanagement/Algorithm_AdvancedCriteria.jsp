            ...
            <nedss:container id="IdAdvancedSubSection" classType="subSect" name="Advanced Criteria" >
									 ...
									 <tbody id="questionbodyIdAdvancedSubSection">
										 <tr id="patternIdAdvancedSubSection" class="odd" style="display:none">
											 <td style="width:3%;text-align:center;">
											 	<input id="viewIdAdvancedSubSection" type="image" src="page_white_text.gif" onclick="viewAdvCriteriaClicked(this.id,'IdAdvancedSubSection','patternIdAdvancedSubSection','questionbodyIdAdvancedSubSection');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td>
											 <td style="width:3%;text-align:center;" >
											 	<input id="editIdAdvancedSubSection" type="image" src="page_white_edit.gif" onclick="editAdvCriteriaClicked(this.id,'IdAdvancedSubSection');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td>
											 <td style="width:3%;text-align:center;">
											 	<input id="deleteIdAdvancedSubSection" type="image" src="cross.gif" onclick="deleteAdvCriteriaClicked(this.id,'IdAdvancedSubSection','patternIdAdvancedSubSection','questionbodyIdAdvancedSubSection');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">
											 </td>
		        ...
		        <tr>
		         	<td class="fieldName"> 
		           	...
		           	<td>
				 		<div id="advDate">  
						 	<html:text name="decisionSupportForm" property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.CRITERIA_VALUE+")"%>' maxlength="10" size="10" styleId="advVal_date" onkeyup="DateMask(this,null,event)" onchange="changeDarkBGColor('IdAdvancedSubSection');changeLightBGColorOfAdvancedBatch('','',this);"/>
							<html:img src="calendar.gif" onclick="getCalDate('advVal_date','advVal_dateIcon'); return false;" styleId="advVal_dateIcon"></html:img>
						</div>
						<div id="advText"> 
