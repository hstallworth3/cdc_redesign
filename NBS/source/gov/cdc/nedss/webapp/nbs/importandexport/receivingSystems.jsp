					...
					<fieldset style="border-width: 0px;" id="expAlg">
						<nedss:container id="subsec1" classType="subSect"
							...
							<tr>
								...
								<td><logic:equal name="receivingFacilityForm"
										...
										<html:text property="selection.receivingSystemShortName"
											size="20" maxlength="10" styleId="sysShrtNm"
							...
							<tr>
								...
								<td><logic:equal name="receivingFacilityForm"
										property="actionMode" value="Create">
										<html:text property="selection.receivingSystemOwner" size="20"
											maxlength="10" styleId="sysOwner" title="Enter the entity (e.g., city, state, territory, facility, etc.) that owns the system. This value, sent in the MSH4 position of an ELR, is required in order to process a Decision Support algorithm for a Lab Report message. The sending facility NamespaceID in the NBS XML schema is compared against this Facility Name field." />
									</logic:equal> <logic:equal name="receivingFacilityForm"
										property="actionMode" value="Edit">
										<html:text property="selection.receivingSystemOwner" size="20"
											maxlength="10" styleId="sysOwner" title="Enter the entity (e.g., city, state, territory, facility, etc.) that owns the system. This value, sent in the MSH4 position of an ELR, is required in order to process a Decision Support algorithm for a Lab Report message. The sending facility NamespaceID in the NBS XML schema is compared against this Facility Name field." />
