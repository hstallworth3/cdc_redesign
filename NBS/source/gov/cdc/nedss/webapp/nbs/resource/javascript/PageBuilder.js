...
function PageBuilder(canvasElt)
{
                            ...
                            case 'subsection':
                                if (previousElt != null) {
                                    ...
                                    if(batchUid != null){
                                    	...
                                    	$j($j($j("#" + jsonObj[i].pageElementUid).parent()).find("div.subSection div.header").get(0)).find("div.content span.ieVerticalAlignHelper").append('<a class="repeatingBlockLink" href="javascript:void(0)"><img alt="Repeating SubSection" src="RepeatingBlock.gif"/>&nbsp;</a>&nbsp;');
                                        ...
                                        $j($j($j(currentElt).find("a.groupFieldsLink").get(0)).find("img").get(0)).attr("src", "link_break.gif").attr("alt", "Un-Group all Fields Rows in SubSection");
                                   }else
                                   {
                                       ...
                                       $j($j($j(currentElt).find("a.groupFieldsLink").get(0)).find("img").get(0)).attr("src", "link.gif").attr("alt", "Group all Fields Rows in SubSection");;
                                   }
                                }
        		...
        		}else
        		{
        			 ...
        			 if (choice) {
        				 ...
        				 if(childEltsCount == 2){
        					 ...
        					 $j($j($j($j($j(parentElt).get(0)).find("div.header div.controls a.groupFieldsLink")).get(0)).find("img").get(0)).attr("src", "link.gif").attr("alt", "Group all Fields Rows in SubSection");;
    ...
    this.toggleAllChildren = function(thisElt) {
        ...
        if (
            ...
            if (currState.indexOf("Collapse All") >= 0) {
                $j($j(thisElt).find("img")).attr("src", "ExpandAll.gif").attr("alt", "Expand All Sections");
                ...
                $j($j(thisElt).find("img")).attr("src", "CollapseAll.gif").attr("alt", "Collapse All Sections");
            ...
            if (currState.indexOf("Collapse All") >= 0) {
                $j($j(thisElt).find("img")).attr("src", "ExpandAll.gif").attr("alt", "Expand All Subsections");
                ...
                $j($j(thisElt).find("img")).attr("src", "CollapseAll.gif").attr("alt", "Collapse All Subsections");
    ...
    * */
	...
	($j("#"+subSectionEltId+"").find(".repeatingBlockLink").length==0)) {
	            ...
	            $j($j($j(elt).parent()).find("div.subSection div.header").get(0)).find("div.content span.ieVerticalAlignHelper").append('<a class="repeatingBlockLink" href="javascript:void(0)"><img alt="Repeating SubSection" src="RepeatingBlock.gif"/>&nbsp;</a>&nbsp;');
	            ...
	            $j($j($j(elt).find("a.groupFieldsLink").get(0)).find("img").get(0)).attr("src", "link_break.gif").attr("alt", "Un-Group all Fields Rows in SubSection");
	        }
	        else {
	            ...
	            "return to Edit Page.";
	        	 ...
	        	 if (choice) {
		            ...
		            $j($j($j(elt).find("a.groupFieldsLink").get(0)).find("img").get(0)).attr("src", "link.gif").attr("alt", "Group all Fields Rows in SubSection");;
		            if (childEltsCount> 0) {
		                for (var i = 0; i < childEltsCount; i++) {
		                	var fieldRowElt = $j(elt).find(".fieldRow").get(i);
		                	var fieldRowEltId = $j(fieldRowElt).attr("id");
    	...
    	else if(hasRollingNote == 'T' && childEltsCount > 1)
	{
    	...
    	{
    		var eltLabel = getElementLabel(subSectionEltId, eltType);
    		var msg = eltLabel + " cannot be made into a repeating block, as this subsection includes generic investigation questions. Please see the Generic Investigation Template in the Template Library or reference Page Builder training materials for a list of generic investigation questions."
    		alert(msg);
    	}
    ...
    getFieldRow = function(pageElt) {
        ...
        switch (pageElt.elementType.toLowerCase()) {
            case 'question':
	            ...
	            }else if(pageElt.isStandardized == 'T' && dataLoc.indexOf(".ANSWER_TXT")>= 0)
	            {
	                ...
	                qIconImg = "<img src=\"PublishedIcon.gif\" />";
	                controlPart = "<div class=\"controls\"> <span style=\"visibility:hidden\" class=\"hiddenNotCaseAnswerFieldRowIdSpan\">\"NoGroup\"</span> <a title=\"View Question\" class=\"viewFieldRowLink\" href=\"javascript:void(0)\">  <img src=\"page_white_text.gif\" alt=\"View Question\"/> </a> &nbsp; <a title=\"Edit Question\" class=\"editFieldRowLink\" href=\"javascript:void(0)\"> <img src=\"page_white_edit.gif\" alt=\"Edit Question\"/> </a> &nbsp; <a class=\"relocateLink\" href=\"javascript:void(0)\" title=\"\Relocate\"> <img src=\"doc_page.jpg\" alt=\"Relocate\"/> </a> </div>";
	            }
	            else if(pageElt.isPublished == 'T' && dataLoc.indexOf(".ANSWER_TXT") >= 0){
	            	qIconImg = "<img src=\"PublishedIcon.gif\" />";
        ...
        */
        if(coinfInd == 'T' && publishInd != 'T') {
			...
			controlPart = "<div class=\"controls\"> <a title=\"View Question\" class=\"viewFieldRowLink\" href=\"javascript:void(0)\"> <img src=\"page_white_text.gif\" alt=\"View Question\"/> </a> &nbsp; <a title=\"Edit Question\" style=\"visibility:hidden\"class=\"editFieldRowLink\" href=\"javascript:void(0);return false;\"> <img src=\"page_white_edit_disabled.gif\" alt=\"Edit Question\"/> </a> &nbsp; <a class=\"relocateLink\" href=\"javascript:void(0)\" title=\"\Relocate\"> <img src=\"doc_page.jpg\" alt=\"Relocate\"/> </a> &nbsp; <a title=\"Delete Question\"  style=\"visibility:hidden\" class=\"deleteLink\" href=\"javascript:void(0)\"> <img src=\"cross.gif\" alt=\"Delete Question\"/> </a> </div>";
	}
        var html = "<li> <div class=\"" + cssClass + "\" id=\"" + pageElt.pageElementUid + "\"> <div class=\"header\"> <div class=\"content\">"+ qIconImg1 + qIconImg + " <span class=\"ieVerticalAlignHelper\"></span> <span class=\"title\">" + defaultVal + "</span></div> " + controlPart + "</div> </li>";
        var elt = jQuery(html);
    ...
    getSection = function(pageElt) {
        ...
        var html = "<li> <div class=\"" + cssClass + "\" id=\"" + pageElt.pageElementUid + "\"> <div class=\"header\" > <div class=\"content\"> <span class=\"ieVerticalAlignHelper\"></span><a class=\"toggleLink\" href=\"javascript:void(0)\"><img src=\"minus_sign.gif\" alt=\"Collapse\"/></a> &nbsp; <a class=\"toggleAllChildrenLink\" title=\"Collapse All Subsections\" href=\"javascript:void(0)\"> <img src=\"CollapseAll.gif\" alt=\"Collapse All Subsections\"/> </a> &nbsp;Section: <span class=\"title\">" + pageElt.elementLabel + "</span></div><div class=\"controls\"><span class=\"ieVerticalAlignHelper\"></span> <a class=\"addSubSection\" title=\"Add New Subsection to this Section\" href=\"javascript:void(0)\"> <img src=\"add.gif\" alt=\"Add New Subsection\"/> </a> &nbsp; <a title=\"View Section\" class=\"viewSectionLink\" href=\"javascript:void(0)\"> <img src=\"page_white_text.gif\" alt=\"View Section\"/> </a> &nbsp; <a title=\"Edit Section\" class=\"editSectionLink\" href=\"javascript:void(0)\"> <img src=\"page_white_edit.gif\" alt=\"Edit Section\"/> </a> &nbsp; <a class=\"relocateSectionLink\" href=\"javascript:void(0)\" title=\"Relocate\"> <img src=\"doc_page.jpg\" alt=\"Relocate\"/> </a>&nbsp;<a title=\"Delete Section\" class=\"deleteLink\" href=\"javascript:void(0)\"> <img src=\"cross.gif\" alt=\"Delete Section\"/> </a></div></div><div class=\"body\"><ul class=\"sortableSubSections\">" 
        + "</ul></div></div> </li>";
        var elt = jQuery(html);
    ...
    getTabBody = function(pageElt, isActive) {
        ...
        var html = "<div id=\"" + pageElt.pageElementUid + "\" class=\"" + tabBodyClass + "\"><div style=\"width:200px; text-align:left; margin-top:10px; float:left;\"><a class=\"toggleAllChildrenLink\" title=\"Collapse All Sections \" href=\"javascript:void(0)\"> &nbsp;&nbsp; <img src=\"CollapseAll.gif\" alt=\"Collapse All Sections\"/> <span class=\"text\">Collapse All Sections </span></a> &nbsp;</div><div style=\"width:200px; float:right;\" class=\"utilButton\"> <a title=\"Add Section\" class=\"addSection\" href=\"javascript:void(0)\"> <img src=\"add.gif\" alt=\"Add Section\" /> </a> &nbsp; <a title=\"View Tab\" class=\"viewTabLink\" href=\"javascript:void(0)\"> <img src=\"page_white_text.gif\" alt=\"View Tab\"/> </a> &nbsp; <a title=\"Edit Tab\" class=\"editTabLink\" href=\"javascript:void(0)\"> <img src=\"page_white_edit.gif\" alt=\"Edit Tab\"/> </a> &nbsp; <a title=\"Delete Tab\" class=\"deleteLink\" href=\"javascript:void(0)\"> <img src=\"cross.gif\" alt=\"Delete Tab\"/> </a></div> <div class=\"ffClear\"> </div> <ul class=\"sortableSections\"></ul></div>";
        var elt = jQuery(html);
    ...
    relocateElement = function(targetEltLinkInPopUp,publishIndOfSource, dataLoc, containerElt) {
        ...
        if(publishIndOfSource == 'T' && targetEltType == 'subSection' && containment == 'parent')
        {
        	...
        	var eltLabel = getElementLabel(sourceEltId, "fieldRow");
        	var msg = eltLabel + 
            " cannot be moved into this repeating block, as this question is a generic investigation question. Please see the Generic Investigation Template in the Template Library or reference Page Builder training materials for a list of generic investigation questions."; 
        	alert(msg);
        }
	            ...
	            switch (targetEltType) {
	                case 'subSection':
	                    ...
	                    if(sourceChildEltsCount == 0){
        					...
        					$j($j($j($j("#" + sourceSubsectionEltId).find("div.header div.controls a.groupFieldsLink")).get(0)).find("img").get(0)).attr("src", "link.gif").attr("alt", "Group all Fields Rows in SubSection");;
	                        ...
	                        switch (action) {
	                            case 'add':
	                                if (containerElt != null) {
	                                    ...
	                                    var batchUid = pageElt.questionGroupSeqNbr;
	                                	var cssClass = "subSection" + " " + fbRef.nbsPageElementCssClass;
	                                    var html = "<li> <div class=\"" + cssClass + "\" id=\"" + pageElt.pageElementUid + "\"> <div class=\"header\"> <div class=\"content\"> <span class=\"ieVerticalAlignHelper\"></span> <a class=\"toggleLink\" href=\"javascript:void(0)\"><img src=\"minus_sign.gif\" alt=\"Collapse\"/></a> &nbsp; Subsection: <span class=\"title\">" + pageElt.elementLabel + "</span></div> <div class=\"controls\">  &nbsp; <a class=\"importQuestionLink\" title=\"Add/Import Element(s)\" href=\"javascript:void(0)\"> <img src=\"add.gif\" alt=\"Add/Import Element(s)\"/> </a> &nbsp; <a title=\"View Subsection\" class=\"viewSubsectionLink\" href=\"javascript:void(0)\"> <img src=\"page_white_text.gif\" alt=\"View Subsection\"/> </a> &nbsp; <a title=\"Edit Subsection\" class=\"editSubsectionLink\" href=\"javascript:void(0)\"> <img src=\"page_white_edit.gif\" alt=\"Edit Subsection\"/> </a> &nbsp; <a class=\"relocateSubSectionLink\" href=\"javascript:void(0)\" title=\"Relocate\"> <img src=\"doc_page.jpg\" alt=\"Relocate\"/> </a> &nbsp; <a class=\"groupFieldsLink\" title=\"Group All Questions in Subsection as Batch\" href=\"javascript:void(0)\">  </a> <a title=\"Delete Subsection\" class=\"deleteLink\" href=\"javascript:void(0)\"> <img src=\"cross.gif\" alt=\"Delete Subsection\"/> </a> </div> </div> <div class=\"body\"> <ul class=\"sortableFieldRows\">" + "</ul></div> </div> </li>";
	                                    var currentElt = jQuery(html);
	                                    var subSectionElt = $j(currentElt).find(".subSection").get(0);
	                                    handleEvents(subSectionElt, 'subSection', publishInd, batchUid);
	                            ...
	                            case 'edit':
	                            	...
	                            	$j($j($j("#" + jsonObj[i].pageElementUid).find("div.header div.controls a.groupFieldsLink").get(0)).find("img").get(0)).attr("src", "link.gif").attr("alt", "Un-Group all Fields Rows in SubSection");
