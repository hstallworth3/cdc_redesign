...
function stdConditionToDiagnosis() {
  ...
  if (theConditionCd == null)
    return ("");
  if (theConditionCd != null && (theConditionCd.indexOf("10311") != -1)) //is Syph
    return ("710");
  if (theConditionCd != null && (theConditionCd.indexOf("10312") != -1)) //is Syph
    return ("720");
  if (theConditionCd != null && (theConditionCd.indexOf("10313") != -1)) //is Syph
    return ("730");
  if (theConditionCd != null && (theConditionCd.indexOf("10315") != -1)) //is Syph
    return ("740");
  if (theConditionCd != null && (theConditionCd.indexOf("10314") != -1)) //is Syph
    return ("745");
  if (theConditionCd != null && (theConditionCd.indexOf("10318") != -1)) //is Syph
    return ("750");
  if (theConditionCd != null && (theConditionCd.indexOf("10316") != -1)) //is Syph
    return ("790");
...
function stdRuleCheckCaseStatusOnSubmit() {
        ...
        if (theDisposition != null && theDisposition != "") {
    		...
    		var a1Str = buildErrorAnchorLink(getElementByIdOrByName('NBS173L'), "Disposition");      		
                ...
                i++;
             } else if (theCaseStatus == 'P' && (theDisposition == 'A' || theDisposition == 'B' || theDisposition == 'C' || theDisposition == 'D' || theDisposition == 'F' || theDisposition == '3' || theDisposition == '6'))  {
                 var a2Str = buildErrorAnchorLink(getElementByIdOrByName('INV163L'), "Case Status");   
    		 var a1Str = buildErrorAnchorLink(getElementByIdOrByName('NBS173L'), "Disposition");   
                 var theCaseStatusText = $j('#INV163 :selected').text();
                 var theDispositionText = $j('#NBS173 :selected').text();
...
function stdSetReadonlyDate(fieldId) 
{
  ...
  $j('#' + fieldId + 'L').css("color","grey");//Fatima
...
function stdHideFieldsOnLoad() {
  ...
  //investigationStatusLabel.style.color="grey";
...
function stdHideParticipation(identifierId) 
{
  ...
  $j("#" + identifierId + "S").css("color", "#BBB");
}
...
function crStdSetupReferralBasisOptions(sourcePatientDispo, sourcePatientInterview)
{
