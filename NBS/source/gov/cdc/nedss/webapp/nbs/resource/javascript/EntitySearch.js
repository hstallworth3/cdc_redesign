...
function openEntitySearchWindow(type, table,VO){
	...
	if(type=="organizationReportMorb"){
		...
		targetResultedTest ="labResults_s[i].observationVO_s[1].theObservationDT.cdDescTxt\" header=\"Resulted Test Name\" parent=\"Lab Report\" isNested=\"yes\" validate=\"required\" fieldLabel=\"Resulted Test Name\" onchange=\"getOrganismIndicatorMorb();";
