	...
	$.extend($.fn, {
		...
		if( o.actionMode == undefined)  o.actionMode  = 'InitLoad';
	        ...
	        $(this).each( function() {
					...
					var html = '<img class="multiSelect" src="combo_select.gif" id="queueIcon" align="top" border="0"/>';
					html += '<div class="multiTextOptions" style="position: absolute;z-index: 99999; display: none;">';
					html +='<label style="text-align:center;background: #CFCFCF;white-space:nowrap;">';
					html +='&nbsp;&nbsp;&nbsp;&nbsp;<input id="b1'+appendText+'" type="button" onclick="selectfilterCriteria()" value=" OK " '+flag+' style="width:40%;" />';
					html +='&nbsp;<input id="b2Text" type="button" value="Cancel" style="width:40%;" />&nbsp;&nbsp;&nbsp;&nbsp;</label>';
					html += '<br>';
					html += '<br>';					
					html += '<label><b>Contains:</b></label>';
					html += '<label class="pText"><input type="text" size="25" name="' + str +'" value="'+valueOfFilter+'" id="'+appendText+'" onKeyUp="onKeyUpValidate()"/></label>' ;
					html += '<br>';
					html += '<br>';
					html +='<label style="text-align:center;background: #CFCFCF;white-space:nowrap;">';
					html +='&nbsp;&nbsp;&nbsp;&nbsp;<input id="b2'+appendText+'"  type="button" onclick="selectfilterCriteria()" value=" OK " '+flag+' style="width:40%;"/>';
					...
					$(select).find('OPTION').each( function() {
						if( $(this).val() != '' ) {
							html += '<label class="pText"><input type="checkbox" name="' + $(select).attr('name') + '" value="' + $(this).val() + '"';							
		...
		multiSelect: function(o, callback) {
			...
			$(this).each( function() {
				...
				html +='<label style="text-align:center;background: #CFCFCF;white-space:nowrap;"><input id="b1" class="button" type="button" onclick="selectfilterCriteria()" value=" OK " style="width:40%;" title="Apply Filter"/><input id="b2" class="button" type="button" value="Cancel" style="width:40%;" title="Cancel Filter"/></label>';
