...
<%
	...
	<html:form>
		...
		<%
		           ArrayList data = (ArrayList) request.getAttribute("CR2");
					...
					<table width="98%">
		             ...
		             <td align="center">
						  	<display:table name="named" class="dtTable" style="margin-top:0em;"  id="parent">
								...
								<display:column property="contactInvestigationCase" title="Case No." style="width:10%;"/>
								<!--<display:column property="namedBack" title="NB" style="width:10%;"/>-->
							 <display:setProperty name="basic.empty.showtable" value="true"/>
					       </display:table>
				      </td>
				     </tr>
					...
					<table width="98%">
		             ...
		             <td align="center">
						  	<display:table name="signAndSymptoms" class="dtTable" style="margin-top:0em;"  id="parent">
								...
								<display:column property="anatomicalSite" title="Anatomic Site" style="width:10%;"/>
								<display:column property="obsOnsetDate" title="Observation Date" format="{0,date,MM/dd/yyyy}" style="width:8%;"/>
