			...
			<tr>
				<td>
					<table width="98%">
		             <tr>
		             <td align="center">
						  	<display:table name="internetOcByContType" class="dtTable" style="margin-top:0em;"  id="parent">
								<display:column property="label" title="Outcomes" style="width:16%;"/>
								<display:column property="count1" title="I1" style="width:12%;"/>
								<display:column property="count2" title="I2" style="width:12%;"/>
								<display:column property="count3" title="I3" style="width:12%;"/>
								<display:column property="count4" title="I4" style="width:12%;"/>
								<display:column property="count5" title="I5" style="width:12%;"/>
								<display:column property="count6" title="I6" style="width:12%;"/>
								<display:column property="count7" title="I7" style="width:12%;"/>
							 <display:setProperty name="basic.empty.showtable" value="true"/>
					       </display:table>
				      </td>
				     </tr>
