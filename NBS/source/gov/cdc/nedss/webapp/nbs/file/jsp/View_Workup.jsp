...
%>     
     ...
     <script language="JavaScript"> 
		  ...
		  var plusIcon1 = "<img src=\"section_expand.gif\" alt=\"Expand\" \/>";
		  /** 
		...
		/** Popup a child window and load the page that is currently being 
	       ...
	       */
	       function printPreview() {
	           ...
	           var o = new Object();
	           o.opener = self;
	           var URL = '/nbs/LoadViewFile1.do?method=ViewFile&ContextAction=print&uid=<%=request.getAttribute("uid")%>';
...
%> 
   ...
   <logic:equal name="viewEventsOnly" value="true">
        	<body onload="startCountdown1();handlePatExtendedBE();focusTab();autocompTxtValuesForJSP();tableCollapseEvent();fieldFocus();">
</logic:equal>
<logic:notEqual name="viewEventsOnly" value="true">
    <logic:equal name="DSPersonForm" property="actionMode" value="Edit">  
    <body onload="enableOrDisable('INV2002','ReasonUnknown','UNK');enableOrDisable('CurrSex','UnknownSpecify','U');startCountdown1();handlePatExtendedBE();autocompTxtValuesForJSP();handlebatchEntry();showHideSpanishOrigin();loadCounties();clearBatchEntryFields('nameTable');clearBatchEntryFields('addrTable');clearBatchEntryFields('phoneTable');clearBatchEntryFields('idenTable');clearBatchEntryFields('raceTable');document.location.href='#pageview';">
    </logic:equal>
      <logic:notEqual name="DSPersonForm" property="actionMode" value="Edit">
      	<body onload="startCountdown1();handlePatExtendedBE();focusTab();autocompTxtValuesForJSP();tableCollapseSummary();tableCollapseEvent();handlebatchEntry();fieldFocus();">
         </logic:notEqual>
 </logic:notEqual>     
				     ...
				     <table class="style">
					   <tr class="cellColor">
							...
							<a name=pageTop> </a>
					            ...
					            <span style="font:16px Arial; margin-left:0.2em;"> <%=request.getAttribute("personLocalID")%> </span>
					            <span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>
					        </td>
					    </tr>
					    </table>
