...
<html>
    <head>
        ...
        {
            var confirmMsg = '<%=request.getAttribute("confirm_Concept_Msg")%>';
            var newVads = '<%=request.getAttribute("newVads")%>';
            var isMore = true;
            if(confirmMsg == null || confirmMsg == 'null')
            {
            	 return false;
            }else
            {
        ...
        {
            var confirmMsg = '<%=request.getAttribute("confirm_Msg")%>';
            if(confirmMsg == null || confirmMsg == 'null')
            {
                return false;
            }
		...
		function makeMSelects() {
			...
			$j("#type").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#stats").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#code").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#name").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#description").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});			
		}	
        </script> 
        <style type="text/css">
