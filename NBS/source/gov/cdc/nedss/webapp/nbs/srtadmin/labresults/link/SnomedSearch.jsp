        ...
        <script type="text/javascript">
            function findComponent()
            {
                ...
                {	
                    ...
                    getElementByIdOrByName("snomedCode").style.color="red";							
                    getElementByIdOrByName("descS").style.color="red";
                    isError = true;
                }
                else {
		              ...
		              <fieldset style="border-width:0px;" >
		                  <nedss:container id="subSect3" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:text styleId="srchSnomed" property="searchCriteria(SNOMED_CD)" maxlength="20"/>
                                    </td>
                                </tr>      		    
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <html:text styleId="snomedCd" property="searchCriteria(SNOMED)" size="25" maxlength="100"/>
                                    </td>
                                </tr>
                                <tr>
