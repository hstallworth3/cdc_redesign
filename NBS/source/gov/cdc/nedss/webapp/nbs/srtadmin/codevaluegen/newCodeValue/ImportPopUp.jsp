		...
		<script language="JavaScript">
		 function importVads(){
             ...
             if(criteria != null && criteria.value.length == 0)
             {
                 ...
                 getElementByIdOrByName("Vads").style.color="red";
                 return false;		
             }
				...
				<table cellspacing="15" cellpadding="20" style="font-family : Geneva, Arial, Helvetica, sans-serif; font-size : 10pt;">
				    ...
				    <tr>
				          <td class="InputFieldLabel" id="Vads">
				          	<span style="color:#FF0000">*</span><span style="" >Value Set Code:</span>
				          </td>
				          <td class="InputField">
				           	<html:text styleId="vadsSearch" name="SRTAdminManageForm"  property="searchCriteria(VADValueSetCd)"  size="50" maxlength="100"/>
				          </td>
				    </tr>
				    <tr>
