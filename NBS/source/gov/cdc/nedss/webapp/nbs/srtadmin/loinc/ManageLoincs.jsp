        ...
        <script type="text/javascript">
            ...
            function findComponent()
            {
                ...
                if(cd.length == 0 && desc.length == 0) {
                    ...
                    getElementByIdOrByName("loincCode").style.color="red";
                    getElementByIdOrByName("desLoinc").style.color="red";
                    isError = true;					
                }
                else {
                        ...
                        <fieldset style="border-width:0px;" id="search">
                            <nedss:container id="subsec1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:text styleId="srchLoinc" property="searchCriteria(LOINC_CD)" maxlength="20"/>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <html:text styleId="loincCd" property="searchCriteria(LOINC)" size="50" maxlength="200"/>
                                    </td>
                                </tr>
                                <tr>
