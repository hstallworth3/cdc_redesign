                        ...
                        <fieldset style="border-width:0px;" id="search">
                            <nedss:container id="subsec1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:text styleId="srchLabResult" property="searchCriteria(LABTEST)" size="20" maxlength="20" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <html:text styleId="srchLabResultDesc" property="searchCriteria(RESULT_DESC)" size="50" maxlength="50"/>
                                    </td>
                                </tr>
                                <tr>
