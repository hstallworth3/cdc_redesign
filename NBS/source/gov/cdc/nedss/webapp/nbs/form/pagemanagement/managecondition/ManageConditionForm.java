...
public class ManageConditionForm extends BaseForm{
	...
	private Collection<Object>  conditionDTColl;
...
//	private ArrayList<Object> coInfGroupList = new ArrayList<Object> ();
	...
	public Collection<Object> getConditionDTColl() {
		return conditionDTColl;
	}
	public void setConditionDTColl(Collection<Object> conditionDTColl) {
		this.conditionDTColl = conditionDTColl;
	}
