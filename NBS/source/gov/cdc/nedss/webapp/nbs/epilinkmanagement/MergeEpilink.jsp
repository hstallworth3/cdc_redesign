					...
					<div class="sectBody">
						<table class="subSect">
							...
							<tr>
								...
								<td><html:text styleId="epilinkId1" name="epiLinkIdForm"
										property="currentEpiLinkId" maxlength="100" size="40" /></td>
							</tr>

							<tr>
								<td class="fieldName" nowrap id="newepl"><font
									class="boldTenRed"> * </font>New Epi-Link ID:</td>
								<td><html:text styleId="epilinkId2" name="epiLinkIdForm"
										property="newEpiLinkId" maxlength="100" size="40" /></td>
							</tr>
