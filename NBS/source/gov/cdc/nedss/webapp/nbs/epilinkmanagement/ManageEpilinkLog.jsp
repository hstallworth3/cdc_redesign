...
function makeMSelects() {
    $j("#lprocessedDate").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	$j("#loldEpiLink").multiSelect({actionMode: '<%=request.getAttribute("ActionMode")%>'});
	$j("#lnewEpiLink").multiSelect({actionMode: '<%=request.getAttribute("ActionMode")%>'});

	$j("#luserName").text({actionMode: '<%=request.getAttribute("ActionMode")%>'});
