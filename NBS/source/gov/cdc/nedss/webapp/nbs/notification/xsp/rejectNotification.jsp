    ...
    */
	...
	function verify() {
		...
		if( rejComments != null && rejComments.value.length == 0) {
			...
			getElementByIdOrByName("rej").style.color="red";
			isError = true;		
		}
		else {
...
<body onunload="closePopup()">
	<form>
		<table style="width:100%;font-family : Geneva, Arial, Helvetica, sans-serif; font-size : 10pt; margin-top:20px;">
			...
			<tr>
				...
				<td class="InputField-popup">
					<textarea rows="5" cols="40"  onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)" id="rejectComments"></textarea>
				</td>
			</tr>
	        <tr>
