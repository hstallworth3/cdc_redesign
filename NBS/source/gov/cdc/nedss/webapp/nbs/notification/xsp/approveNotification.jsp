...
<head>
   ...
   function getElementByIdOrByNameNode(name, node){
	...
	function changeContent() {
		var notificationCd='<%=request.getParameter("notificationCd")%>';
		var nndAssociated='<%=request.getParameter("nndAssociated")%>';
		var jurisdiction='<%=request.getParameter("jurisdiction")%>';
		var shareAssociated='<%=request.getParameter("shareAssocaited")%>';
...
<body  onload="changeContent()" onunload="closePopup()">
	...
	<div id="allAssocTrue" style="display:none;" >
		<table style="font-family :Arial; font-size : 10pt;" > <tr><td>&nbsp;&nbsp;</td></tr>
		...
		<table cellspacing="15" cellpadding="20" style="font-family : Geneva, Arial, Helvetica, sans-serif; font-size : 10pt;">
			<tr>
				...
				<td class="InputField-popup">
					<textarea rows="5" cols="40"  onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)" id="approveCommts" style="text-align:left">
					</textarea>
				</td>
			</tr>
		  <tr>
	...
	<div id="nndAssocFalse" style="display:none;" >
		<table  cellpadding="20" style="font-family :Arial; font-size : 10pt;">
			<tr>
				<td> By approving this transfer, this case will no longer be counted in your reporting jurisdiction; the <br/>ownership of this case will be transfered to: <b><%=decodedFilename%></b> <br/><br/>Once transferred, the investigation will be closed, the investigation jurisdiction will be set to <br/>
				<b><%=request.getParameter("jurisdiction")%></b> and the case status will be set to 'Not A Case'. If there is an existing NND notification for this case, a rescind notification will be sent to the CDC.
				<br/>
				</td>
			</tr>
		</table>
		<table cellspacing="15" cellpadding="20" style="font-family :Arial; font-size : 10pt;">
			<tr>
				<td class="InputFieldLabel-popup" nowrap>
					<span style="" >Approval Comments:</span>
				</td>
				<td class="InputField-popup">
					<textarea rows="5" cols="40"  onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)" id="approveCommts1">
					</textarea>
				</td>
		  </tr>
		  <tr>
