...
<html>
	...
	function checkExternalFacility()
	{
		...
		if( newJur != null && newJur.length == 0) {
			...
			getElementByIdOrByName("assignAuCD").style.color="red";
			isError = true;		
		}
		else {
		   getElementByIdOrByName("assignAuCD").style.color="black";
				...
				if(trim(mySplitResult[i]).length>0){
					if(newJur==mySplitResult[i]  && trim(getElementByIdOrByName("transOwn").value).length>0){
						...
						if( externalFacility != null && externalFacility == 0) {
							...
							getElementByIdOrByName("transferTo").style.color="red";
							isError = true;		
						}
						else {
						...
						if( commentfield != null && commentfield == 0) {
							...
							getElementByIdOrByName("TransferComments").style.color="red";
							isError = true;		
						}
						else {
			 ...
			 <table cellspacing="15" cellpadding="20" style="font-family : Geneva, Arial, Helvetica, sans-serif; font-size : 10pt;">
				...
				<tr style="background:#FFF;">
	              <td colspan="2">
				  	...
				  	<tr>
			  	  		<td colspan="2">
	  	  					Transfer <b><%=(String)request.getAttribute("DSInvestigationLocalID") %></b> from <b><%=(String)request.getAttribute("oldJurisdiction") %></b> Jurisdiction to:
			  	  		</td>
				  	</tr>
		          	<tr>
		               ...
		               <td class="InputField" id="transfer">
			               	<html:select  property="proxy.publicHealthCaseVO_s.thePublicHealthCaseDT.jurisdictionCd"  onchange="enableCommentAndRecipientFields()" styleId ="transOwn">
		           ...
		           <tr id="exportList" class="none">
		               ...
		               <td class="InputField">
			               	<html:select  property="proxy.notificationVO_s.theNotificationDT.exportReceivingFacilityUid"  styleId ="exportFacility">
