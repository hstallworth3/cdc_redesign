...
<nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Treatments" classType="subSect">     
    <tr>
	    <td colspan="2">
            ...
            <display:table name="treatmentList" class="dtTable" id="treatlist" style="margin-top:0.15em;">
	            <display:column style="width:5%;">
	            	<div align="center" style="margin-top: 3px">
	            		<input type="checkbox" value="${treatlist.isAssociated}" name="${treatlist.localId}" ${treatlist.checkBoxId}/>
	            	</div>
	            </display:column>
