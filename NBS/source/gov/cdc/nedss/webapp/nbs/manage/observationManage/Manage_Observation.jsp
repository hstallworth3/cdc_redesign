...
<%if(((String)request.getAttribute("AssoLabPermission")).equals("true")){%>
    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Lab Reports" classType="subSect">                           
        <tr>
            <td colspan="2">
               <display:table name="observationSummaryLabList" class="dtTable" id="lablist" style="margin-top:0.15em;">
                    <display:column style="width:5%;">
                        <div align="center" valign="middle">
                            <input type="checkbox" value="${lablist.isAssociated}" name="${lablist.observationUid}" ${lablist.checkBoxId}  ${lablist.disabled}/>
                        </div>
                    </display:column>
    ...
    <img style="background-color: #5F8DBF;width: 100%;" alt="" border="0" height="1" width="50" src="transparent.gif">
<%}%>

<%if(((String)request.getAttribute("AssoMorbPermission")).equals("true")){%>    
    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Morbidity Reports" classType="subSect">
        <tr>
            <td colspan="2">
                ...
                <display:table name="observationSummaryMorbList" class="dtTable" id="morbList" style="margin-top:0.15em;">
                    <display:column style="width:5%;">
                        <div align="center" >
                            <input type="checkbox" value="${morbList.isAssociated}" name="${morbList.localId}" ${morbList.checkBoxId}  ${morbList.disabled}/>
                        </div>
                    </display:column>
