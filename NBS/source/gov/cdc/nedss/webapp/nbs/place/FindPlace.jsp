...
<body class="container">
    ...
    <html:form  action="Place" method="post">
        ...
        <table class="subSect" id="placeSearch">
            <thead>
                <tr>
                    <th colspan="2"></th>
                </tr>
            ...
            <tr>
                 ...
                 <td class="operCol" style="min-width:200px">
                    <html:select name="placeForm" property="placeSearch.nmOperator" styleId="nmoperator">
                         <html:optionsCollection property="codedValueNoBlnk(SEARCH_SNDX)" value="key" label="value" />
                    </html:select> 
                 </td>
                 <td width="1%"></td>
                 <td style="min-width:200px">
                     <html:text name="placeForm"  property="placeSearch.nm"/>
                 </td>
            </tr>
            <tr>
                 ...
                 <td width="1%"></td>
                 <td>
                     <html:select styleId="typeCd" name="placeForm"  property="placeSearch.typeCd">
            ...
            <tr>
                 ...
                 <td class="operCol">
                    <html:select name="placeForm" property="placeSearch.streetAddr1Operator" styleId="saoperator">
                         <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value" />
                    </html:select> 
                 </td>
                 <td width="1%"></td>
                 <td>
                     <html:text name="placeForm" property="placeSearch.streetAddr1"/>
                 </td>
            </tr>
            <tr>
                 <td class="fieldName" valign="middle">City:</td>
                 <td class="operCol">
                    <html:select name="placeForm" property="placeSearch.cityOperator" styleId="cdoperator">
                         <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value" />
                    </html:select> 
                 </td>
                 <td width="1%"></td>
                 <td>
                     <html:text styleId="city" name="placeForm"  property="placeSearch.city"/>
                 </td>
            </tr>
            <tr>
                ...
                <td width="1%"></td>
                <td>
                    <html:select name="placeForm" property="placeSearch.state"  styleId="state">
            ...
            <tr>
                ...
                <td width="1%"></td>
                <td>
                    <html:text name="placeForm" property="placeSearch.zip" onkeyup="ZipMask(this, event)"/>
                </td> 
            </tr>
            <tr>
                ...
                <td class="operCol">&nbsp;</td>
                <td width="1%"></td>
                <td><html:text name="placeForm" property="placeSearch.phoneNbrTxt" onkeyup="TeleMask(this, event)" /></td>
            </tr>
        </table>
        <br/>
        <div class="grayButtonBar">
