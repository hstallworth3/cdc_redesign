	...
	public static ActionForward paginate(BaseForm form, HttpServletRequest request, String name, ActionMapping mapping) {
		 ...
		 if(pageParam != null && request.getParameter(pageParam) != null) {
			...
			form.getAttributeMap().put("PageNumber", pageNo);		
			 ...
			 if((form.getAttributeMap().get("queueSize")!=null || form.getAttributeMap().get("maxRowCount")!=null || request.getAttribute("maxRowCount")!=null) && (request.getAttribute("queueCount")!=null || form.getAttributeMap().get("investigationList")!=null)){
				 ...
				 if(request.getAttribute("queueCount")!=null)
					 ...
					 numNotif=((ArrayList<Object>)form.getAttributeMap().get("investigationList")).size();
