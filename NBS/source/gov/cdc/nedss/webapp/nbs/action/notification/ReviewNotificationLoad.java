    ...
    extends DispatchAction
{
        ...
        try
        {
                ...
                if(forceEJBcall) {
                 ...
                 //   populateNndAssociated(notificationsForApproval);
                    ...
                    invForm.getAttributeMap().put("DSNotificationList",notificationsForApproval);
    				//Set InvSummaryVOColl as property of Form first time since this list is used for distinct dropdown values in the form
                   invForm.setNotifiSummaryVOColl(notificationsForApproval);
                    invForm.initializeDropDowns();
                	...
                	notificationsForApproval = (ArrayList<Object> ) invForm.getAttributeMap().get("DSNotificationList");
                }
    			...
    			invForm.getAttributeMap().put("notificationList",notificationsForApproval);
    ...
    public ActionForward filterNotificationSubmit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		//When all filters are applied (equivalent to no filter applied), Collection<Object>  is set to null in which case retrieve it from Form.
			...
			notificationSummaryVOs = (ArrayList<Object> ) invForm.getNotifiSummaryVOColl();
		}
		HttpSession session = request.getSession();
	    ...
	    NBSContext.lookInsideTreeMap(tm);
	    String sCurrTask = NBSContext.getCurrentTask(session);
		invForm.getAttributeMap().put("DSNotificationList",notificationSummaryVOs);
    ...
    private Collection<Object>  filterNotification(InvestigationForm investigationForm, HttpServletRequest request) {
		...
		try {
			...
			ArrayList<Object> invSummaryVOs = (ArrayList<Object> ) investigationForm.getNotifiSummaryVOColl();
