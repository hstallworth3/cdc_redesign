...
public class ELRActivityLogSubmit
  ...
  static final LogUtils logger = new LogUtils(ELRActivityLogSubmit.class.
                                              getName());
  private boolean successSelected = false;
  private boolean bothFailPassSelected = false;
  /**
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm aForm,
    ...
    setELRCounts((ArrayList<?> )reportList.get(1), request);
 ...
 * @param HttpServletRequest
 * */
  private void setELRCounts(ArrayList<?>  countList, HttpServletRequest request){
