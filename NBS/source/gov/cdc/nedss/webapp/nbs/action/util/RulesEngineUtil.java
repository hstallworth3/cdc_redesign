...
public class RulesEngineUtil extends RuleConstants{
	 ...
	 * @return
	 */
	public Map<Object,Object> initiateForm(Map<Object,Object> questionMap, PamForm form) {
	 ...
	 * @return
	 */
	public Collection<Object>  fireRules(String sourceInd, PamForm form, Map<Object,Object> formFieldMap) {
    ...
    */
	...
	public Collection<Object>  cascadingEnableOnFilterTarget(Collection<Object> fieldColl, RulesDT rulesDT,  String sourceInd, Map<Object,Object> formFieldMap,  Map<Object,Object> answerArrayMap,String formCode, PamForm form){
		// get the SourceField properties from the Map
		FormField formField = (FormField) formFieldMap.get(sourceInd);
