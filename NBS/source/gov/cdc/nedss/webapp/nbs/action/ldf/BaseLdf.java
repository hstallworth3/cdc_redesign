	 ...
	 */
  	public void createLDFsForHomePage(HttpServletRequest request, Collection<Object>  list, String type) {
  		...
  		if (list.size() > 0) {
			...
			sb.append("<br/>");
			sb.append("<br/>");
			sb.append("<img class=\"DarkGray\" border=\"0\" height=\"3\" width=\"100%\" src=\"tb_topstrip.jpg\"/>");
			...
			while (it.hasNext()) {
				...
				if(dataType != null && dataType.equalsIgnoreCase("LNK")) {
					...
					sb.append("<br/>");
					sb.append("<img class=\"DarkGray\" border=\"0\" height=\"2\" width=\"100%\" src=\"transparent.gif\"/>");
