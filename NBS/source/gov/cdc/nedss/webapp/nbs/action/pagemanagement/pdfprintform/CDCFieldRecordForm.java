...
public class CDCFieldRecordForm extends CommonPDFPrintForm{
	...
	private	static String NBS263_CD = "NBS263_CD";//Field Follow Up form constant
	protected static String NBS263_CD__ResultNBS263 = NBS263_CD + delimiter1+ "ResultNBS263";
	...
	private static void initializeFieldFollowUpValues() throws NEDSSAppException{
		...
		if(fieldFollowUpFieldsMap.size()==0){
			...
			fieldFollowUpFieldsMap.put(NBS263_CD__ResultNBS263, NBS263_CD);
	...
	private static void fillPDForm(PDAcroForm acroForm, HttpServletRequest req) throws NEDSSAppException {
			...
			try {
				...
				getMappedValues(fieldFollowUpFieldsMap, req);
