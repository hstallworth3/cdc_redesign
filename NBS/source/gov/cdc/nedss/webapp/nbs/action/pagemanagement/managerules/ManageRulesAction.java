...
public class ManageRulesAction extends DispatchAction
{
    	...
    	try{
    		...
    		/////////////////////ENABLE/DISABLE//////////////////////
    			...
    			if(flagCheck){
    				...
    				mrForm.getErrorList().add("The Target Field, "+ convertArrayToString(selectedTarget, hashMapTarget, hashMap) +" can only be associated with one enable/disable Source Field. ");
    		...
    		////////////////////////////REQUIRE/////////////////////////////
       			...
       			if(flagCheck){
       				...
       				mrForm.getErrorList().add("The Target Field, "+ convertArrayToString(selectedTarget, hashMapTarget, hashMap) +" can only be associated with one Require IF Source Field. ");
       				request.setAttribute("errors", mrForm.getErrorList());  
       				request.setAttribute("reload", "true");
       				return (mapping.findForward(ManageRulesAction.ADD_BUSINESS_RULE));
       			}
    		...
    		/////////////////////HIDE/UNHIDE//////////////////////
    			...
    			if(flagCheck){
    				...
    				mrForm.getErrorList().add("The Target Field, "+ convertArrayToString(selectedTarget, hashMapTarget, hashMap) +" can only be associated with one hide/unhide Source Field. ");
    				request.setAttribute("errors", mrForm.getErrorList());  
    				request.setAttribute("reload", "true");
   			       return (mapping.findForward(ManageRulesAction.ADD_BUSINESS_RULE));
    			}
            ...
            HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        try{
	    	...
	    	request.setAttribute("codeDesc", codeDesc);
