...
public class MessageQueueAction extends DispatchAction
{
            ...
            HttpServletResponse response) throws IOException, ServletException
    {
        ...
        try
        {
            ...
            messageVOs = (ArrayList) getFilteredMessages(messageVOs, messageForm.getSearchCriteriaArrayMap());
     ...
     * @return
     */
    public Collection<Object> getFilteredMessages(Collection<Object> messageVOs, Map searchCriteriaMap)
    {
        for (String key : FILTER_KEYS)
        {
            ...
            {
                messageVOs = filterMessagesByKey(messageVOs, filterArr, key);
            }
        }
        return messageVOs;
    }
     ...
     * @return
     */
    private Collection<Object> filterMessagesByKey(Collection<Object> messageVOs, String[] filterArr, String key)
    {
        try {
