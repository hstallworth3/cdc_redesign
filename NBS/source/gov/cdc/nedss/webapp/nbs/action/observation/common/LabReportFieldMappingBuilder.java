...
public class LabReportFieldMappingBuilder {
	 ...
	 * @return TreeMap
	 */
	public TreeMap<Object,Object> createLabReportLoadTreeMap(LabResultProxyVO labResultProxy,
			Long labUid, String processingDecision) {

		TreeMap<Object,Object> loadMap = new TreeMap<Object,Object>();
		LabReportProxyVOExtractor extractor = new LabReportProxyVOExtractor(
				labResultProxy, labUid);
		...
		try {
			...
			for (Iterator<Object> it = keys.iterator(); it.hasNext();) {
				...
				if (key != null && key.trim().equalsIgnoreCase("LAB201")) {
					...
					if (obsVO != null){
						reportDate = StringUtils.formatDate(obsVO.getTheObservationDT()
								.getRptToStateTime());
				...
				//Reporting Source UID
					...
					loadMap.put(labMap.get(key), ((orgUID == null) ? null
				...
				//Reporting Source Details
					...
					Object orderingFacilityDetails = extractor
							.extractOrderingFacilityDetails();
					loadMap.put(labMap.get(key),
							((orderingFacilityDetails == null) ? null
									: orderingFacilityDetails.toString().trim()));
				...
				//Physician UID
					...
					Object personUID = extractor
							.extractPhysicianAttr("NPP001UID");
					loadMap.put(labMap.get(key), (personUID == null) ? null
