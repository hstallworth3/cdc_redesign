	    ...
	    <nedss:container id="editBlock" name='<%= String.valueOf(request.getAttribute("sectionTitle") == null ? "" : request.getAttribute("sectionTitle")) %>' classType="sect" displayImg ="false">
		    <nedss:container id="editBlock_metadata" name="Aggregate Report Details" classType="subSect">
	            ...
	            <tr>
	                ...
	                <td>
	                    <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM100.state.disabled}" name="aggregateSummaryForm" property="answerMap(SUM100)" styleId = "SUM100">
	            ...
	            <tr>
	                ...
	                <td>
                      <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM101.state.disabled}" name="aggregateSummaryForm" property="answerMap(SUM101)" styleId = "SUM101" onchange="populateMMWRYear('SUM101','SUM102')">
	            ...
	            <tr>
	                ...
	                <td>
	                    <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM102.state.disabled}" name="aggregateSummaryForm" property="answerMap(SUM102)" styleId = "SUM102">
	            ...
	            <tr>
	                ...
	                <td>
	                    <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM106.state.disabled}" name="aggregateSummaryForm" property="answerMap(SUM106)" styleId = "SUM106">
	            ...
	            <tr>
	                ...
	                <td>
	                    <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM117.state.disabled}" name="aggregateSummaryForm" property="answerMap(SUM117)" styleId = "SUM117">
	                ...
	                <td>
		                <html:text styleId="SUM131" 
	                        ...
	                        onkeydown="checkMaxLength(this);isNumericCharacterEntered(this)"  onkeyup="checkMaxLength(this);isNumericCharacterEntered(this)"
	                         title="${PamForm.formFieldMap.SUM131.tooltip}" maxlength="4" 
	            ...
	            <tr>
	                ...
	                <td>
		                <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" styleId="SUM105" 
	                ...
	                <nedss:container id="editBlock_${cTable.nbsTableUid}" name="${cTable.tableName}" classType="subSect">
			          <bean:define id="tableId" value='<%= "Table_" + categoryIndex %>' />
			           <tr> <td style="padding-left:1em;">
		                    <table class="gridTable aggregateDataEntryTable" style="float:left; margin-left: 0px" id="<bean:write name="tableId" />">
		                        <thead>
		                            <tr>
		                               <logic:iterate id="headCell" name="cTable" property="headers" indexId="headColIndex">
		                                   <th class='<%= "h" + headColIndex %>'> <bean:write name="headCell" property="indicatorLabel" /> </th>
		                               </logic:iterate>
		                            </tr>
		                        </thead>
		                        <tbody>
	        ...
	        <logic:present name="categoryTables">
	            <logic:iterate id="cTable" name="categoryTables">
	               <nedss:container id="viewBlock_${cTable.nbsTableUid}" name="${cTable.tableName}" classType="subSect">
	                   <tr> <td style="padding-left:1em;">
	                        <table class="gridTable aggregateDataEntryTable" style="float:left">
	                            <thead>
	                                <tr>
	                                   <logic:iterate id="headCell" name="cTable" property="headers">
	                                       <th> <bean:write name="headCell" property="indicatorLabel" /> </th>
	                                   </logic:iterate>
	                                </tr>
	                            </thead>
	                            <tbody>
