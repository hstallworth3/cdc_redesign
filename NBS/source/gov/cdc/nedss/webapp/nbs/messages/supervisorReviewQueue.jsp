       ...
       <html:form action="LoadSupervisorReviewQueue.do" >
        ...
        <div id="bd">
				...
				<div id="whitebar" style="background-color:#FFFFFF; width: 100%; height:1px;margin-top:1%" align="right"></div>
                  ...
                  <display:table name="investigationList" class="dtTable" style="margin-top:0em;" pagesize="${supervisorReviewForm.attributeMap.queueSize}" id="parent"  requestURI="/LoadSupervisorReviewQueue.do?method=loadQueue&existing=true" sort="external" export="true" excludedParams="method existing initLoad">
                    <display:column  style="width:2%; text-align:center;" media="html">
                      <img src="page_white_get.gif" class="cursorHand" title="Approve" onclick="showRejectMessageDialog(${parent.publicHealthCaseUid}, 'Approval Notes')"/>
                    </display:column>
                    <display:column title="" style="width:2%;text-align:center;" media="html">
                      <img src="page_white_delete.gif" class="cursorHand" title="Reject" onclick="showRejectMessageDialog(${parent.publicHealthCaseUid}, 'Reject Notes')" />
                    </display:column>
            ...
            <div id="filterTopDiv" style="width: 250; display: none" class="multiTextOptions1">
              ...
              <div id="submitDate" style="z-index: 99999; display: none; width:98%">
                <table style="width: 100%">
                  <tr class="selectAll"><td class="selectAll">&nbsp;<input type="checkbox" id="submitDateSelectAll" class="selectAll" name="submitDateSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="dateFilterList">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(STARTDATE)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="textCond" style="z-index: 99999; display: none;width:98%">
                <table style="width: 100%">
                  <tr class="selectAll"><td>&nbsp;<input type="checkbox" id="textCondSelectAll" class="selectAll" name="textCondSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="conditionList">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(CONDITION)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="patient" style="z-index: 99999; display:none;width:98%">
                ...
                <label class="pText">
                  <input type="text" size="25" name="answerArray(PATIENT)" onkeyup="enableDisableOk('patient')" value="<%=request.getAttribute("PATIENT")!=null? request.getAttribute("PATIENT") : "" %>"/>
                </label>
              </div>
              <div id="investigator" style="z-index: 99999; display:none;width:98%">
                <table style="width: 100%"> 
                  <tr class="selectAll"><td>&nbsp;<input type="checkbox" id="investigatorSelectAll" class="selectAll" name="investigatorSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="investigatorNames">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(INVESTIGATOR)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="supervisor" style="z-index: 99999; display:none;width:98%">
                <table style="width: 100%"> 
                  <tr class="selectAll"><td>&nbsp;<input type="checkbox" id="supervisorSelectAll" class="selectAll" name="supervisorSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="supervisorNames">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(SUPERVISOR)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="referralBasis" style="z-index: 99999; display:none;width:98%">
                <table style="width: 100%"> 
                  <tr class="selectAll"><td>&nbsp;<input type="checkbox" id="referralBasisSelectAll" class="selectAll" name="referralBasisSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="referralBasisList">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(REFERRALBASIS)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="activityType" style="z-index: 99999; display:none;width:98%">
                <table style="width: 100%"> 
                  <tr class="selectAll"><td>&nbsp;<input type="checkbox" id="activityTypeSelectAll" class="selectAll" name="activityTypeSelectAll" />(Select All)</td></tr>
                  <logic:iterate id="iterObj" name="supervisorReviewForm" property="typeList">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(TYPE)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <br/>
          ...
          <div id="rejectMessageDiv" class="multiTextOptions1" style="width:30%; height:150; display:none">
            ...
            &nbsp;<textarea rows="4" name="supervisorVO.comments" style="width:95%"></textarea>
            <br/><br/>
