...
<html>
  ...
  <body onload="attachIcons();displayTooltips();showCount();">
                  ...
                  <display:table name="messageList" class="dtTable" style="margin-top:0em;" pagesize="${messageLogForm.attributeMap.queueSize}" id="parent" requestURI="/LoadMessageQueue.do?method=loadQueue&existing=true" sort="external" export="true" excludedParams="method">
                    <display:column  style="width:2%; text-align:center;" media="html">
                      ...
                      <logic:equal name="parent" property="messageLogDT.messageStatusCd" value="R">
                        <img src="email-icon.gif" border="0" height="15" width="15" id="igMsgStatus${parent.messageLogDT.messageLogUid}"/>
                      </logic:equal>
                      <logic:notEqual name="parent" property="messageLogDT.messageStatusCd" value="R">
                        <img src="page_white_get.gif" border="0" height="15" width="15" id="igMsgStatus${parent.messageLogDT.messageLogUid}" class="cursorHand" title="Mark as Read" onclick='markMessageRead(${parent.messageLogDT.messageLogUid})'/>
                      </logic:notEqual>
                    </display:column>
                    <display:column title="" style="width:2%;text-align:center;"  media="html">
                      <img src="page_white_delete.gif" class="cursorHand" title="Delete" onclick="submitDeleteForm(${parent.messageLogDT.messageLogUid})" />
                    </display:column>
            ...
            <div id="filterTopDiv" style="display: none; width: 250" class="multiTextOptions1"> 
              ...
              <div id="messageStatus" style="z-index: 99999; display: none; width: 97%">
                <table style="width: 100%">
                  <tr class="selectAll"><td class="selectAll">&nbsp;<input class="selectAll" id="messageStatusSelectAll" type="checkbox"  name="messageStatusSelectAll" /><label>(Select All)</label></td></tr>
                  <logic:iterate id="iterObj" name="messageLogForm" property="statusList">
                    <tr><td>&nbsp;<input type="checkbox" name="answerArray(MESSAGESTATUS)" value="${iterObj.key}"/>${iterObj.value}</td></tr>
                  </logic:iterate>
                </table>
              </div>
              <div id="sdate" style="z-index: 99999; display: none; width:97%; border-color: green; border: 1">
                <table style="width: 100%">
                  <tr class="selectAll"><td class="selectAll">&nbsp;<input type="checkbox" id="sdateSelectAll" class="selectAll" name="sdateSelectAll" />(Select All)</td></tr>
              ...
              <div id="testCond" style="z-index: 99999; display: none;width:97%">
                <table style="width: 100%">
                  <tr class="selectAll"><td class="selectAll">&nbsp;<input type="checkbox" id="testCondSelectAll" class="selectAll" name="testCondSelectAll" />(Select All)</td></tr>
              ...
              <div id="submittedBy" style="z-index: 99999; display:none;width:97%">
                ...
                <label><b>Contains:</b></label>&nbsp;
                <label class="pText">
                  <input type="text" size="25" name="answerArray(SUBMITEDBY)" onKeyUp="enableDisableOk('submittedBy')" value="<%=request.getAttribute("SUBMITEDBY")!=null? request.getAttribute("SUBMITEDBY"): ""%>"/>
                </label>
              </div>
              <div id="messageText" style="z-index: 99999; display:none;width:97%">
                ...
                <label><b>Contains:</b></label>&nbsp;
                <label class="pText">
                  <input type="text" size="25" name="answerArray(MESSAGETEXT)" onKeyUp="enableDisableOk('messageText')" value="<%=request.getAttribute("MESSAGETEXT")!=null? request.getAttribute("MESSAGETEXT"): ""%>" />
                </label>
              </div>
              <br/>
