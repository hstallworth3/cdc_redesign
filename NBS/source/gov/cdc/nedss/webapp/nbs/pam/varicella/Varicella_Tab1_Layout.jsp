        ...
        <tr>
            ...
            <td>
                <html:text disabled ="${PamForm.formFieldMap.INV147.state.disabled}" 
                        ...
                        styleId="INV147" onkeyup="DateMask(this,null,event)" size="10"/>
                <html:img src="calendar.gif" onclick="getCalDate('INV147','INV147Icon'); return false;" 
	                ...
	                <span id="INV207SearchControls">
                       <input type="Button" class="Button" value="Search" 
                        ...
                        <html:text property="pamClientVO.answer(INV207)" styleId="INV207Text"
                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV207Text','INV207_qec_list')" title="${PamForm.formFieldMap.INV207.tooltip}"/>
            ...
            <tr>
	           <td class="fieldName">
	            ...
	            <td>
	                ...
	                <html:img src="calendar.gif" onclick="getCalDate('INV110','INV110Icon'); return false;" 
	 ...
	 <!--7. Date of Report:-->
		 <tr>
		     ...
		     <td class="topBorder">
	             ...
	             <html:img src="calendar.gif" onclick="getCalDate('INV111','INV111Icon'); return false;" 
		 ...
		 <tr>
	         ...
	         <td class="topBorder">
	             ...
	             <html:img src="calendar.gif" onclick="getCalDate('INV120','INV120Icon'); return false;" 
		 ...
		 <tr>
	         ...
	         <td class="topBorder">
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV121.state.disabled}" 
	                     property="pamClientVO.answer(INV121)" maxlength="10" 
	                     styleId="INV121" onkeyup="DateMask(this,null,event)" size="10"/>
	             <html:img src="calendar.gif" onclick="getCalDate('INV121','INV121Icon'); return false;" 
...
<!-- SUBSECTION: Condition -->	
	...
	<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Signs and Symptoms: Rash" classType="subSect" >
	 <!--12. Rash Onset Date:-->
		 <tr>
		     ...
		     <td>
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR102.state.disabled}" property="pamClientVO.answer(VAR102)" maxlength="10" 
	                     styleId="VAR102" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange=""/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR102','VAR102con'); return false;" 
		 ...
		 <tr>
		     ...
		     <td> 
	             <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR103.state.disabled}" property="pamClientVO.answer(VAR103)" 
		 ...
		 <tr>
		     ...
		     <td> 
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR104.state.disabled}" property="pamClientVO.answer(VAR104)" maxlength="100" size="25" styleId="VAR104"  onblur="fireRule('VAR104', this)" 
	                      title="${PamForm.formFieldMap.VAR104.tooltip}"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <td>
	             <div class="multiSelectBlock">
	                  ...
	                  <html:select property="pamClientVO.answerArray(VAR105)" 
	                          styleId="VAR105" 
		 ...
		 <tr>
		     ...
		     <td> 
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR106.state.disabled}" property="pamClientVO.answer(VAR106)" maxlength="100" size="25"  styleId="VAR106"  onblur="fireRule('VAR106', this)" 
	                    title="${PamForm.formFieldMap.VAR106.tooltip}"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR100.state.disabled}" property="pamClientVO.answer(VAR100)" styleId="VAR100" onchange="fireRule('VAR100', this)" >
		 ...
		 <tr>
		     ...
		     <td> 
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR163.state.disabled}" property="pamClientVO.answer(VAR163)" maxlength="2" size="5" styleId="VAR163"   title="${PamForm.formFieldMap.VAR163.tooltip}" onkeyup="isNumericCharacterEntered(this)" onblur="fireRule('VAR163', this)"/>
	        </td>
		 </tr>
		<!--Macules (flat) present:-->
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR107.state.disabled}" property="pamClientVO.answer(VAR107)" styleId="VAR107"   onchange="fireRule('VAR107', this)">
		 ...
		 <tr>
		     ...
		     <td> 
	             <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR108.state.disabled}" property="pamClientVO.answer(VAR108)" maxlength="2" size="5" styleId="VAR108" onblur="fireRule('VAR108', this)" 
	                    title="${PamForm.formFieldMap.VAR108.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <!--TODO add the drop down forVAR109-->
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR109.state.disabled}" property="pamClientVO.answer(VAR109)" styleId="VAR109"  onchange="fireRule('VAR109', this)" >
		 ...
		 <tr>
		     ...
		     <td> 
		     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR110.state.disabled}"  property="pamClientVO.answer(VAR110)" maxlength="2" size="5" styleId="VAR110" onblur="fireRule('VAR110', this)"
		     		title="${PamForm.formFieldMap.VAR110.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR111.state.disabled}" property="pamClientVO.answer(VAR111)" styleId="VAR111"  onchange="fireRule('VAR111', this)">
		 ...
		 <tr>
		     ...
		     <td> 
		     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR112.state.disabled}" property="pamClientVO.answer(VAR112)" maxlength="2" size="5" styleId="VAR112" onblur="fireRule('VAR112', this)"
		     		title="${PamForm.formFieldMap.VAR112.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR113.state.disabled}" property="pamClientVO.answer(VAR113)" styleId="VAR113" >
		 ...
		 <tr>
		     ...
		     <!--TODO add the drop down for VAR114-->
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR114.state.disabled}" property="pamClientVO.answer(VAR114)" styleId="VAR114">
		 ...
		 <tr>
		     ...
		     <!--TODO add the drop down for VAR115-->
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR115.state.disabled}" property="pamClientVO.answer(VAR115)" styleId="VAR115" >
		 ...
		 <tr>
		     ...
		     <!--TODO add the drop down for VAR116-->
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR116.state.disabled}"  property="pamClientVO.answer(VAR116)" styleId="VAR116" >
		 ...
		 <tr>
		     ...
		     <!--TODO add the drop down for VAR117-->
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR117.state.disabled}" property="pamClientVO.answer(VAR117)" styleId="VAR117"> 
		 ...
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR118.state.disabled}" property="pamClientVO.answer(VAR118)" styleId="VAR118" >
		 ...
		 <tr>
		     ...
		     <td> 
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR119.state.disabled}" property="pamClientVO.answer(VAR119)" styleId="VAR119"  onchange="fireRule('VAR119', this)">
		 ...
		 <tr>
		     ...
		     <td> 
		     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR120.state.disabled}" property="pamClientVO.answer(VAR120)" maxlength="3" size="5" styleId="VAR120"  onblur="fireRule('VAR120', this)"
		     		title="${PamForm.formFieldMap.VAR120.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        </td>
		 </tr>
		 ...
		 <tr>
		     ...
		     <td> 
		     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR121.state.disabled}" property="pamClientVO.answer(VAR121)" maxlength="3" size="5" styleId="VAR121"  onblur="fireRule('VAR121', this)"
		     		title="${PamForm.formFieldMap.VAR121.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        </td>
		 </tr>
    ...
    <tr>
        ...
        <td> 
            <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR122.state.disabled}" property="pamClientVO.answer(VAR122)" styleId="VAR122" onchange="fireRule('VAR122', this)"> 
    ...
    <tr>
        ...
        <td> 
           <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR123.state.disabled}"  property="pamClientVO.answer(VAR123)" maxlength="10" 
	                     styleId="VAR123"  onblur="fireRule('VAR123', this)" onchange="fireRule('VAR123', this)" onkeyup="DateMask(this,null,event)" size="10"  
	                    />
	             <html:img src="calendar.gif" onclick="getCalDate('VAR123','VAR123con'); return false;" 
 ...
 <!--20. Highest measured temperature:-->
		 <tr>
		     ...
		     <td> 
		     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR124.state.disabled}"  property="pamClientVO.answer(VAR124)" maxlength="6" size="7" styleId="VAR124"  onblur="fireRule('VAR124', this)"
		     		title="${PamForm.formFieldMap.VAR124.tooltip}" onkeyup="isDecimalCharacterEntered(this)"/>
		     		
			     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR211.state.disabled}" property="pamClientVO.answer(VAR211)" styleId="VAR211"  onchange="fireRule('VAR211', this)" >
	 ...
	 <tr>
	     ...
	     <td> 
	     	<html:text name="PamForm"  disabled ="${PamForm.formFieldMap.VAR125.state.disabled}" property="pamClientVO.answer(VAR125)" maxlength="3" size="5" styleId="VAR125" onblur="fireRule('VAR125', this)"
	     		title="${PamForm.formFieldMap.VAR125.tooltip}" onkeyup="isNumericCharacterEntered(this)"/></td>
	 	</td>
	 </tr>
	...
	<!--22. Is patient immunocompromised due to medical condition or treatment-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR126.state.disabled}" property="pamClientVO.answer(VAR126)" styleId="VAR126"  onchange="fireRule('VAR126', this)" >
...
<!--Specify Medical Condition or Treatment:-->
	 <tr>
	     ...
	     <td> 
	     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR127.state.disabled}" property="pamClientVO.answer(VAR127)" maxlength="100" size="25" styleId="VAR127" onblur="fireRule('VAR127', this)"
	     		title="${PamForm.formFieldMap.VAR127.tooltip}"/></td>
	 	</td>
	 </tr>
	...
	<!--23. Did the patient visit a healthcare provider during this illness:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR128.state.disabled}" property="pamClientVO.answer(VAR128)" styleId="VAR128" >
	 ...
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR129.state.disabled}" property="pamClientVO.answer(VAR129)" styleId="VAR129" onchange="fireRule('VAR129', this)" >
...
<!--Skin/Soft Tissue Infection:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR130.state.disabled}" property="pamClientVO.answer(VAR130)" styleId="VAR130"  onchange="fireRule('VAR130', this)" >
...
<!--Cerebellitis/Ataxia:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR131.state.disabled}" property="pamClientVO.answer(VAR131)" styleId="VAR131" onchange="fireRule('VAR131', this)" >
...
<!--Encephalitis:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR132.state.disabled}" property="pamClientVO.answer(VAR132)" styleId="VAR132"  onchange="fireRule('VAR132', this)" >
...
<!--Dehydration:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR133.state.disabled}" property="pamClientVO.answer(VAR133)" styleId="VAR133" onchange="fireRule('VAR133', this)" >
...
<!--Hemorrhagic Condition:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR134.state.disabled}"  property="pamClientVO.answer(VAR134)" styleId="VAR134" onchange="fireRule('VAR134', this)">
...
<!--Pneumonia:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR135.state.disabled}" property="pamClientVO.answer(VAR135)" styleId="VAR135"  onchange="fireRule('VAR135', this)" >
...
<!--How was pneumonia diagnosed:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR136.state.disabled}" property="pamClientVO.answer(VAR136)" styleId="VAR136"  onchange="fireRule('VAR136', this)">
...
<!--Other Complications::-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR137.state.disabled}" property="pamClientVO.answer(VAR137)" styleId="VAR137"  onchange="fireRule('VAR137', this)">
...
<!--Specify Other Complications:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR138.state.disabled}"  property="pamClientVO.answer(VAR138)" maxlength="100" size="25" styleId="VAR138" onblur="fireRule('VAR138', this)"
	     		title="${PamForm.formFieldMap.VAR138.tooltip}"/></td>
	 	</td>
	 </tr>
	 <!-- Complications: -->
	...
	<!--25. Was the patient treated with acyvlovir, famvir, or any licensed antiviral for this illness:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR139.state.disabled}" property="pamClientVO.answer(VAR139)" styleId="VAR139" onchange="fireRule('VAR139',this)" >
...
<!--Name of Medication:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR140.state.disabled}" property="pamClientVO.answer(VAR140)" styleId="VAR140"  onchange="fireRule('VAR140', this)" >
	 ...
	 <tr>
	     ...
	     <td> 
	     	<html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR210.state.disabled}" property="pamClientVO.answer(VAR210)" maxlength="100" size="25" styleId="VAR210"  onblur="fireRule('VAR210', this)" 
	     		title="${PamForm.formFieldMap.VAR210.tooltip}"/></td>
	 	</td>
	 </tr>
<!--Start Date of Medication -->
    <tr>
        ...
        <td> 
           <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR141.state.disabled}" property="pamClientVO.answer(VAR141)" maxlength="10" 
	                     styleId="VAR141"  onblur="fireRule('VAR141', this)"  onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR141', this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR141','VAR141con'); return false;" 
...
<!--Stop Date of Medication:-->
    <tr>
        ...
        <td> 
           <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR142.state.disabled}" property="pamClientVO.answer(VAR142)" maxlength="10" 
	                     styleId="VAR142" onblur="fireRule('VAR142', this)" 
 onkeyup="DateMask(this,null,event)" size="10"  onchange="fireRule('VAR142', this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR142','VAR142con'); return false;" 
	...
	<!--27. Did the patient die from varicella or complications (including secondary infection) associated with varicella:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV145.state.disabled}"  property="pamClientVO.answer(INV145)" styleId="INV145" onchange="displayDeathWS('INV145', 'resultSpanRowId');fireRule('INV145', this);">
...
<!--Date of Death:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV146.state.disabled}" property="pamClientVO.answer(INV146)" maxlength="10" 
	                     styleId="INV146" onblur="fireRule('INV146', this);" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('INV146', this);"/>
	             <html:img src="calendar.gif" onclick="getCalDate('INV146','INV146con'); return false;" 
...
<!--Autopsy performed:-->
	 <tr>
	     ...
	     <td> 
	     	   <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR143.state.disabled}" property="pamClientVO.answer(VAR143)" styleId="VAR143" onchange="fireRule('VAR143', this);">
	 ...
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR144.state.disabled}" property="pamClientVO.answer(VAR144)" maxlength="100" size="25" styleId="VAR144" onblur="fireRule('VAR144', this);"
	     		title="${PamForm.formFieldMap.VAR144.tooltip}"/></td>
	 	</td>
	 </tr>
		...
		<tr id="resultSpanRowId">
			...
			<td valign=bottom>
				<span>
					...
					<a href="<%= lnkUrl%>" target="_blank"><%= hyperLnk%> </a>
				</span>
			</td>
		</tr>

	 <!-- Death: -->
     <%= request.getAttribute("2217") == null ? "" :  request.getAttribute("2217") %>    
	</nedss:container>
	</nedss:container>
...
<!--28. Was laboratory testing done for varicella::-->
	 <tr>
	     ...
	     <td> 
	     	   <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR170.state.disabled}"  property="pamClientVO.answer(VAR170)" styleId="VAR170" onchange="fireRule('VAR170', this)" >
	...
	<!--29. Was direct fluorescent antibody (DFA) testing performed:-->
	 <tr>
	     ...
	     <td> 
	     	   <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR171.state.disabled}" property="pamClientVO.answer(VAR171)" styleId="VAR171" onchange="fireRule('VAR171', this)">
...
<!--Date of DFA:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR172.state.disabled}" property="pamClientVO.answer(VAR172)" maxlength="10" 
	                     styleId="VAR172"  onblur="fireRule('VAR172', this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR172', this)" />
	             <html:img src="calendar.gif" onclick="getCalDate('VAR172','VAR172con'); return false;" 
...
<!--DFA Result:-->
	 <tr>
	     ...
	     <td> 
	     	   <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR173.state.disabled}" property="pamClientVO.answer(VAR173)" styleId="VAR173" onchange="fireRule('VAR173', this)"  >
	...
	<!--30. PCR Specimen:-->
	 <tr>
	     ...
	     <td> 
	     	   <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR174.state.disabled}" property="pamClientVO.answer(VAR174)" styleId="VAR174" onchange="fireRule('VAR174', this)"> 
	 ...
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR175.state.disabled}" property="pamClientVO.answer(VAR175)" maxlength="10" 
	                     styleId="VAR175"   onblur="fireRule('VAR175', this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR175', this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR175','VAR175con'); return false;" 
...
<!--Source of PCR Specimen:-->
	 <tr>
	     ...
	     <td>
	         <div class="multiSelectBlock">
	             <i> (Use Ctrl to select more than one) </i> <br/>  
	             <html:select property="pamClientVO.answerArray(VAR176)" disabled ="${PamForm.formFieldMap.VAR176.state.disabled}" 
	                     styleId="VAR176" 
	 ...
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR177.state.disabled}" property="pamClientVO.answer(VAR177)" maxlength="100" size="25" styleId="VAR177"  onblur="fireRule('VAR177', this)"
	     		title="${PamForm.formFieldMap.VAR177.tooltip}"/> 
	 	</td>
	 </tr>
...
<!--PCR Result:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR178.state.disabled}" property="pamClientVO.answer(VAR178)" styleId="VAR178"  onchange="fireRule('VAR178',this)" >
...
<!--Specify Other PCR Result:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR179.state.disabled}" property="pamClientVO.answer(VAR179)" maxlength="100" size="25" styleId="VAR179" onblur="fireRule('VAR179', this)"
	     		title="${PamForm.formFieldMap.VAR179.tooltip}"/> 
	 	</td>
	 </tr>
	 <!-- PCR Testing: -->
	...
	<!--31. Culture Performed:-->
	 <tr>
	     ...
	     <td> 
	     	 <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR180.state.disabled}" property="pamClientVO.answer(VAR180)" styleId="VAR180" onchange="fireRule('VAR180',this)" >
...
<!--Date of Culture Specimen:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR181.state.disabled}" property="pamClientVO.answer(VAR181)" maxlength="10" 
	                     styleId="VAR181" onblur="fireRule('VAR181',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR181',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR181','VAR181con'); return false;" 
...
<!--Culture Result:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR182.state.disabled}" property="pamClientVO.answer(VAR182)" styleId="VAR182" onchange="fireRule('VAR182',this)"  >
...
<!--SUBSECTION:Other Testing:::-->
	...
	<!--32. Was other laboratory testing done:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR183.state.disabled}" property="pamClientVO.answer(VAR183)" styleId="VAR183" onchange="fireRule('VAR183',this)" >
...
<!--Specify Other Test:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR184.state.disabled}" property="pamClientVO.answer(VAR184)" styleId="VAR184" onchange="fireRule('VAR184',this)" >
...
<!--Date of Other Test:-->
	 <tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR185.state.disabled}" property="pamClientVO.answer(VAR185)" maxlength="10" 
	                     styleId="VAR185" onblur="fireRule('VAR185',this)" onchange="fireRule('VAR185',this)" onkeyup="DateMask(this,null,event)" size="10"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR185','VAR185con'); return false;" 
...
<!--Other Lab Test Result:-->
	 <tr>
	     ...
	     <td> 
	     	<html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR186.state.disabled}" property="pamClientVO.answer(VAR186)" styleId="VAR186" onchange="fireRule('VAR186',this)" >
	 ...
	 <tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR187.state.disabled}" property="pamClientVO.answer(VAR187)" maxlength="100" size="25"   styleId="VAR187"  onblur="fireRule('VAR187',this)" 
	     		title="${PamForm.formFieldMap.VAR187.tooltip}"/> 
	 	</td>
	 </tr>
	 <!-- Other Testing: -->
	...
	<tr>
	     ...
	     <td> 
	     	<html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR188.state.disabled}"  property="pamClientVO.answer(VAR188)" styleId="VAR188"  onchange="fireRule('VAR188',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	<html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR189.state.disabled}" property="pamClientVO.answer(VAR189)" styleId="VAR189" onchange="fireRule('VAR189',this)">
...
<!--Type of IgM Test-->
	<tr>
	     ...
	     <td> 
	     	<html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR190.state.disabled}" property="pamClientVO.answer(VAR190)" styleId="VAR190" onchange="fireRule('VAR190',this)">
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR191.state.disabled}" property="pamClientVO.answer(VAR191)" maxlength="100" size="25" styleId="VAR191" onblur="fireRule('VAR191',this)"
	     		title="${PamForm.formFieldMap.VAR191.tooltip}"/> 
	 	</td>
	 </tr>
<!--Date IgM Specimen Taken:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR192.state.disabled}"  property="pamClientVO.answer(VAR192)" maxlength="10" 
	                     styleId="VAR192" onblur="fireRule('VAR192',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR192',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR192','VAR192con'); return false;" 
...
<!--IgM Test Result:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR193.state.disabled}" property="pamClientVO.answer(VAR193)" styleId="VAR193" onchange="fireRule('VAR193',this)" >
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR194.state.disabled}" property="pamClientVO.answer(VAR194)" maxlength="50" size="25"
	     		title="${PamForm.formFieldMap.VAR194.tooltip}" styleId="VAR194" onblur="fireRule('VAR194',this)"  /> 
	 	</td>
	 </tr>
	 <!-- IgM Testing: -->
...
<!--SUBSECTION : IgG Testing::-->
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR195.state.disabled}" property="pamClientVO.answer(VAR195)" styleId="VAR195" onchange="fireRule('VAR195',this)"> 
...
<!--Type of IgG Test::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR196.state.disabled}" property="pamClientVO.answer(VAR196)" styleId="VAR196" onchange="fireRule('VAR196',this)"> 
...
<!--If "Whole Cell ELISA," specify manufacturer::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR197.state.disabled}" property="pamClientVO.answer(VAR197)" styleId="VAR197" onchange="fireRule('VAR197',this)">
...
<!--If "gp ELISA," specify manufacturer:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR198.state.disabled}" property="pamClientVO.answer(VAR198)" styleId="VAR198" onchange="fireRule('VAR198',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR199.state.disabled}" property="pamClientVO.answer(VAR199)" maxlength="100" size="25" styleId="VAR199" onblur="fireRule('VAR199',this)"
	     		title="${PamForm.formFieldMap.VAR199.tooltip}"/> 
	 	</td>
	 </tr>
<!--Date of IgG - Acute:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR200.state.disabled}" property="pamClientVO.answer(VAR200)" maxlength="10" 
	                     styleId="VAR200" onblur="fireRule('VAR200',this)"  onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR200',this)" />
	             <html:img src="calendar.gif" onclick="getCalDate('VAR200','VAR200con'); return false;" 
...
<!--IgG - Acute Result:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR201.state.disabled}" property="pamClientVO.answer(VAR201)" styleId="VAR201" onchange="fireRule('VAR201',this)">
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR202.state.disabled}" property="pamClientVO.answer(VAR202)" maxlength="50" styleId="VAR202" onblur="fireRule('VAR202',this)"  
	     		title="${PamForm.formFieldMap.VAR202.tooltip}"/> 
	 	</td>
	 </tr>
<!--Date of IgG - Convalescent:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR203.state.disabled}" property="pamClientVO.answer(VAR203)" maxlength="10" 
	                     styleId="VAR203" onchange="fireRule('VAR203',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onblur="fireRule('VAR203',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR203','VAR203con'); return false;" 
...
<!--IgG - Convalescent Result:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR204.state.disabled}"  property="pamClientVO.answer(VAR204)" styleId="VAR204" onchange="fireRule('VAR204',this)" >
...
<!--IgG - Convalescent Test Result Value:-->
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR205.state.disabled}" property="pamClientVO.answer(VAR205)" maxlength="50" styleId="VAR205" onchange="fireRule('VAR205',this)"  
	     		title="${PamForm.formFieldMap.VAR205.tooltip}"/> 
	 	</td>
	 </tr>
	 <!-- IgG Testing: -->
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR206.state.disabled}" property="pamClientVO.answer(VAR206)" styleId="VAR206" onchange="fireRule('VAR206',this)"> 
...
<!--Date sent for genotyping-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR207.state.disabled}" property="pamClientVO.answer(VAR207)" maxlength="10" 
	                     styleId="VAR207" onblur="fireRule('VAR207',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR207',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR207','VAR207con'); return false;" 
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR208.state.disabled}" property="pamClientVO.answer(VAR208)" styleId="VAR208" onchange="fireRule('VAR208',this)">
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR209.state.disabled}" property="pamClientVO.answer(VAR209)" styleId="VAR209" onchange="fireRule('VAR209',this)" >
