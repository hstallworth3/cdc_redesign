    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Case Verification"  classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select property="pamClientVO.answer(TUB266)" styleId="TUB266" disabled ="${PamForm.formFieldMap.TUB266.state.disabled}" onchange="populateAsUserEntered();populateProviderDiagnosisDetails('prvdetails_279');fireRule('TUB266', this);">
			 ...
			 <tr id="prvdetails_279">
               <td class="fieldName">
                ...
                <td>
                    <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" styleId="TUB279" disabled ="${PamForm.formFieldMap.TUB279.state.disabled}"  
            ...
            <tr>
                ...
                <td>
                    <html:select property="pamClientVO.answer(INV163)" styleId="INV163"  disabled ="${PamForm.formFieldMap.INV163.state.disabled}">
            ...
            <tr>
                ...
                <td>
                   <html:select  property="pamClientVO.answer(TUB108)" onchange="enableFieldLabels();;fireRule('TUB108', this)" styleId="TUB108">
            ...
            <tr>
                ...
                <td>
                   <html:select  property="pamClientVO.answer(TUB109)" styleId="TUB109" onchange="fireRule('TUB109', this)" disabled ="${PamForm.formFieldMap.TUB109.state.disabled}" >
            ...
            <tr>
                ...
                <td>
                    <html:text maxlength="10" property="pamClientVO.answer(TUB110)" styleId="TUB110" 
                            size="10" title="${PamForm.formFieldMap.TUB110.tooltip}" 
                            ...
                            />
                    <html:img src="calendar.gif" onclick="getCalDate('TUB110','fieldMMWRDateIcon'); return false;" 
            ...
            <tr>
                ...
                <td>
                   <html:text  maxlength="2"  size="3" property="pamClientVO.answer(INV165)" styleId="INV165"  disabled ="${PamForm.formFieldMap.INV165.state.disabled}" title="${PamForm.formFieldMap.INV165.tooltip}" onkeyup="isNumericCharacterEntered(this)"> </html:text>
                </td>
            </tr>
			 <!--MMWR Year -->
            <tr>
                ...
                <td>
                   <html:text  maxlength="4"  size="4" property="pamClientVO.answer(INV166)" styleId="INV166" disabled ="${PamForm.formFieldMap.INV166.state.disabled}"  title="${PamForm.formFieldMap.INV166.tooltip}" onkeyup="isNumericCharacterEntered(this);YearMask(this)"></html:text>
                </td>
            </tr>
