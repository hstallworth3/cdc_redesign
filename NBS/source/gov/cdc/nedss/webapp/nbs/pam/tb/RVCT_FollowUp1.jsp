    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="38.Genotyping Accession Number" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB192.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB192)" styleId = "TUB192" onchange="fireRule('TUB192', this)">
		 ...
		 <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="39. Initial Drug Susceptibility Testing" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB194.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB194)" styleId = "TUB194" onchange="fireRule('TUB194', this); handleFollowUp1_DrugTestBtns('TUB194');">
            ...
            <tr>
                ...
                <html:img src="calendar.gif" onclick="getCalDate('TUB195','fieldDateFirstIsolateCollectedIcon'); return false;" styleId="fieldDateFirstIsolateCollectedIcon"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                     <html:select disabled ="${PamForm.formFieldMap.TUB196.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB196)" styleId="TUB196" 
                            title="${PamForm.formFieldMap.TUB196.tooltip}" onchange="fireRule('TUB196', this)" >
            ...
            <tr>
                ...
                <td>
                     <html:select disabled ="${PamForm.formFieldMap.TUB197.state.disabled}"
		...
		<nedss:container id="<%= tabId  + (++subSectionIndex) %>" name="40. Initial Drug Susceptibility Results" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB198.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB198)" styleId = "TUB198" onchange="fireRule('TUB198', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB199.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB199)" styleId = "TUB199" onchange="fireRule('TUB199', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB200.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB200)" styleId = "TUB200" onchange="fireRule('TUB200', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB201.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB201)" styleId = "TUB201" onchange="fireRule('TUB201', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB202.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB202)" styleId = "TUB202" onchange="fireRule('TUB202', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB209.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB209)" styleId = "TUB209" onchange="fireRule('TUB209', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB212.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB212)" styleId = "TUB212" onchange="fireRule('TUB212', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB203.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB203)" styleId = "TUB203" onchange="fireRule('TUB203', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB208.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB208)" styleId = "TUB208" onchange="fireRule('TUB208', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB204.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB204)" styleId = "TUB204" onchange="fireRule('TUB204', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB206.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB206)" styleId = "TUB206" onchange="fireRule('TUB206', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB210.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB210)" styleId = "TUB210" onchange="fireRule('TUB210', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB213.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB213)" styleId = "TUB213" onchange="fireRule('TUB213', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB211.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB211)" styleId = "TUB211" onchange="fireRule('TUB211', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB214.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB214)" styleId = "TUB214" onchange="fireRule('TUB214', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB215.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB215)" styleId = "TUB215" onchange="fireRule('TUB215', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB205.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB205)" styleId = "TUB205" onchange="fireRule('TUB205', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB207.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB207)" styleId = "TUB207" onchange="fireRule('TUB207', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB216.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB216)" styleId = "TUB216" onchange="fireRule('TUB216', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB218.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB218)" styleId = "TUB218" onchange="fireRule('TUB218', this)">
            ...
            <tr>
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB219.state.disabled}"  styleId = "TUB219"  onblur="fireRule('TUB219', this)" maxlength="100"
                            property="pamClientVO.answer(TUB219)" title="${PamForm.formFieldMap.TUB219.tooltip}" />                        
                </td>
            </tr>
			<!--Clear -->
            <tr>
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Follow Up 1 Comments" classType="subSect" >			
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" disabled ="${PamForm.formFieldMap.TUB270.state.disabled}" 
