        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Risk Assessment" classType="subSect" >
          <!-- Contact Investigation Priority -->
              <tr>
                    ...
                    <td>
                        <html:select disabled ="${PamForm.formFieldMap.INV257.state.disabled}" name="PamForm" property="pamClientVO.answer(INV257)" styleId = "INV257">
           ...
           <!-- Infectious Period From -->
            <tr>
                ...
                <td class="topBorder">
                    <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV258.state.disabled}" 
                            property="pamClientVO.answer(INV258)" maxlength="10" 
                            styleId="INV258" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('INV258','INV258Icon'); return false;" 
            ...
            <tr>
                ...
                <td class="topBorder">
                    <html:text disabled ="${PamForm.formFieldMap.INV259.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(INV259)" maxlength="10" 
                            styleId="INV259" onkeyup="DateMaskFuture(this)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('INV259','INV259Icon'); return false;" 
          ...
          <!-- Contact Investigation Priority -->
               <tr>
                    ...
                    <td>
                        <html:select disabled ="${PamForm.formFieldMap.INV260.state.disabled}" name="PamForm" property="pamClientVO.answer(INV260)" styleId = "INV260">
            ...
            <tr>
                ...
                <td> <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" property="pamClientVO.answer(INV261)" 
                        title="${PamForm.formFieldMap.INV261.tooltip}" onkeydown="checkMaxLength(this)" 
