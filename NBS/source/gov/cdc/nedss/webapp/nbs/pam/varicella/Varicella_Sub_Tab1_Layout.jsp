...
String []sectionNames = {"Investigation Information", "Reporting Information", "Clinical Information",
 ...
 String sectionId = request.getParameter("param3").toString();
%> 
...
<!-- SUBSECTION :Varicella-Containing Vaccine Information: --> 
 ...
 <!--38. Did the patient receive Varicellacontaining vaccine::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR101.state.disabled}" property="pamClientVO.answer(VAR101)" styleId="VAR101" onchange="fireRule('VAR101',this)">
 ...
 <!--Reason why patient did not receive varicella-containing vaccine:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR145.state.disabled}" property="pamClientVO.answer(VAR145)" styleId="VAR145" onchange="fireRule('VAR145',this)">
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR146.state.disabled}" property="pamClientVO.answer(VAR146)" maxlength="100" size="25" styleId="VAR146" onblur="fireRule('VAR146',this)"
	     		title="${PamForm.formFieldMap.VAR146.tooltip}"/> 
	 	</td>
	 </tr>
	...
	<tr>
	     ...
	     <td> 
	     	 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR147.state.disabled}" property="pamClientVO.answer(VAR147)" maxlength="1" size="2" styleId="VAR147" onblur="fireRule('VAR147',this)"
	     		title="${PamForm.formFieldMap.VAR147.tooltip}" onkeyup="isNumericCharacterEntered(this)"/> 
	 	</td>
	 </tr>
<!--40. Reason patient is >= 6 years old and received one dose on or after 6th birthday but never received second dose::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR162.state.disabled}" property="pamClientVO.answer(VAR162)" styleId="VAR162" onchange="fireRule('VAR162',this)" >
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR149.state.disabled}" property="pamClientVO.answer(VAR149)" maxlength="100" size="25" styleId="VAR149" onblur="fireRule('VAR149',this)"
	     	      		title="${PamForm.formFieldMap.VAR149.tooltip}"/></td>
	 </tr>
...
<!-- SUBSECTION :Varicella-Containing Vaccine Information: --> 
 ...
 <!--Vaccination Date:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR216.state.disabled}" property="pamClientVO.answer(VAR216)" styleId="VAR216" onblur="fireRule('VAR216',this)"
 maxlength="10" 
	                      onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR216',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR216','VAR216con'); return false;" 
...
<!--Vaccine Type::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR217.state.disabled}"  property="pamClientVO.answer(VAR217)" styleId="VAR217" onchange="fireRule('VAR217',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR218.state.disabled}"  property="pamClientVO.answer(VAR218)" styleId="VAR218" onchange="fireRule('VAR218',this)">
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR219.state.disabled}" property="pamClientVO.answer(VAR219)" maxlength="50" styleId="VAR219" onblur="fireRule('VAR219',this)"
	     		title="${PamForm.formFieldMap.VAR219.tooltip}"/></td>
	 </tr>
	 <!-- Vaccine 1: -->
...
<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Vaccine 2" classType="subSect" >
 <!--Vaccination Date:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR220.state.disabled}" property="pamClientVO.answer(VAR220)" maxlength="10" 
	                     styleId="VAR220" onblur="fireRule('VAR220',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR220',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR220','VAR220con'); return false;" 
...
<!--Vaccine Type::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR221.state.disabled}" property="pamClientVO.answer(VAR221)" styleId="VAR221" onchange="fireRule('VAR221',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR222.state.disabled}"  property="pamClientVO.answer(VAR222)" styleId="VAR222" onchange="fireRule('VAR222',this)" >
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR223.state.disabled}" property="pamClientVO.answer(VAR223)" styleId="VAR223" onblur="fireRule('VAR223',this)" maxlength="50" 
	     		title="${PamForm.formFieldMap.VAR223.tooltip}"/>	 	</td>
	 </tr>
	 <!-- Vaccine 2: -->
...
<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Vaccine 3" classType="subSect" >
 <!--Vaccination Date:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR224.state.disabled}" property="pamClientVO.answer(VAR224)" maxlength="10" 
	                     styleId="VAR224" onblur="fireRule('VAR224',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR224',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR224','VAR224con'); return false;" 
...
<!--Vaccine Type::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR225.state.disabled}" property="pamClientVO.answer(VAR225)" styleId="VAR225" onchange="fireRule('VAR225',this)"> 
 ...
 style="${PamForm.formFieldMap.VAR226.errorStyleClass}"
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR226.state.disabled}" property="pamClientVO.answer(VAR226)" styleId="VAR226" onchange="fireRule('VAR226',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR227.state.disabled}" property="pamClientVO.answer(VAR227)" styleId="VAR227"  onblur="fireRule('VAR227',this)" maxlength="50" 
	     		title="${PamForm.formFieldMap.VAR227.tooltip}"/></td>
	 </tr>
	 <!-- Vaccine 3: -->
...
<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Vaccine 4" classType="subSect" >
 <!--Vaccination Date:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR228.state.disabled}" property="pamClientVO.answer(VAR228)" maxlength="10" 
	                     styleId="VAR228" onblur="fireRule('VAR228',this)" onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR228',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR228','VAR228con'); return false;" 
...
<!--Vaccine Type::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR229.state.disabled}" property="pamClientVO.answer(VAR229)" styleId="VAR229"  onchange="fireRule('VAR229',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR230.state.disabled}" property="pamClientVO.answer(VAR230)" styleId="VAR230"  onchange="fireRule('VAR230',this)">
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR231.state.disabled}" property="pamClientVO.answer(VAR231)" styleId="VAR231"  maxlength="50" onblur="fireRule('VAR231',this)"
	     		title="${PamForm.formFieldMap.VAR231.tooltip}"/>	 	</td>
	 </tr>
	 <!-- Vaccine 4: -->
...
<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Vaccine 5" classType="subSect" >
 <!--Vaccination Date:-->
	<tr>
	     ...
	     <td> 
	     	  <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR232.state.disabled}"  property="pamClientVO.answer(VAR232)" styleId="VAR232" onblur="fireRule('VAR232',this)" maxlength="10" 
	                    onkeyup="DateMask(this,null,event)" size="10"  
	                     onchange="fireRule('VAR232',this)"/>
	             <html:img src="calendar.gif" onclick="getCalDate('VAR232','VAR232con'); return false;" 
...
<!--Vaccine Type::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR233.state.disabled}" property="pamClientVO.answer(VAR233)" styleId="VAR233" onchange="fireRule('VAR233',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR234.state.disabled}" property="pamClientVO.answer(VAR234)" styleId="VAR234" onchange="fireRule('VAR234',this)">
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR235.state.disabled}" property="pamClientVO.answer(VAR235)" styleId="VAR235" onblur="fireRule('VAR235',this)" maxlength="50" 
	     		title="${PamForm.formFieldMap.VAR235.tooltip}"/></td>
	 </tr>
	 <!-- Vaccine 5: -->
...
<!-- SUB_SECTION : Patient History: -->
 <nedss:container id='<%= (sectionNames[sectionIndex++].replaceAll(" ", "")) + (++subSectionIndex) %>' name="Patient History" classType="subSect" >
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR150.state.disabled}" property="pamClientVO.answer(VAR150)" styleId="VAR150" onchange="fireRule('VAR150',this)"> 
...
<!--Age at Diagnosis:-->
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR151.state.disabled}" property="pamClientVO.answer(VAR151)" maxlength="3" size="5" styleId="VAR151"  onblur="fireRule('VAR151',this)"
	     		title="${PamForm.formFieldMap.VAR151.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>	
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR212.state.disabled}" property="pamClientVO.answer(VAR212)" styleId="VAR212"  onchange="fireRule('VAR212',this)">
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR152.state.disabled}" property="pamClientVO.answer(VAR152)" styleId="VAR152" onchange="fireRule('VAR152',this)">
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR153.state.disabled}" property="pamClientVO.answer(VAR153)" maxlength="100" size="25" styleId="VAR153"  onblur="fireRule('VAR153',this)"
	     		title="${PamForm.formFieldMap.VAR153.tooltip}"/>	 	</td>
	 </tr>
	 <!--44. Where was the patient born::-->
		<tr>
		     ...
		     <td> 
		     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR215.state.disabled}" property="pamClientVO.answer(VAR215)" styleId="VAR215" >
...
<nedss:container id="<%= sectionId + (++subSectionIndex) %>" name="Epi-Link" classType="subSect" >
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR154.state.disabled}"  property="pamClientVO.answer(VAR154)" styleId="VAR154" onchange="fireRule('VAR154',this)" >
...
<!--Type of case this case is epi-linked to:-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR155.state.disabled}" property="pamClientVO.answer(VAR155)" styleId="VAR155" onchange="fireRule('VAR155',this)" > 
...
<!--46. Transmission Setting (Setting of Exposure)::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR156.state.disabled}" property="pamClientVO.answer(VAR156)" styleId="VAR156" onchange="fireRule('VAR156',this)"> 
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR157.state.disabled}" property="pamClientVO.answer(VAR157)" maxlength="100" size="25" styleId="VAR157" onblur="fireRule('VAR157',this)" 
	     		title="${PamForm.formFieldMap.VAR157.tooltip}"/>	 	</td>
	 </tr>
<!--47. Is this case a healthcare worker::-->
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR158.state.disabled}" property="pamClientVO.answer(VAR158)" styleId="VAR158" onchange="fireRule('VAR158',this)"  >
...
<!--Outbreak Name:-->
	<tr  class="${PamForm.formFieldMap.INV151.state.visibleString}">
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV151.state.disabled}" property="pamClientVO.answer(INV151)" styleId="INV151" onchange="fireRule('INV151',this)" > 
...
<!-- Is this person a food handler:-->
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV163.state.disabled}" property="pamClientVO.answer(INV163)" styleId="INV163" >
	...
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV165.state.disabled}" property="pamClientVO.answer(INV165)" maxlength="2" size="5" styleId="INV165" 
	     		title="${PamForm.formFieldMap.INV165.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>	 	</td>
	 </tr>
	  <!--51. MMWR Year:-->
	<tr>
	     ...
	     <td>
	         <html:text  maxlength="4"  size="4"  disabled ="${PamForm.formFieldMap.INV166.state.disabled}" property="pamClientVO.answer(INV166)" styleId="INV166"  title="${PamForm.formFieldMap.INV166.tooltip}" onkeyup="isNumericCharacterEntered(this),YearMask(this)"></html:text>
	      </td>
	 </tr>
	 <!-- Case Status: -->
...
<nedss:container id="<%= sectionId + (++subSectionIndex) %>" name="Pregnant Women" classType="subSect" >
	...
	<tr>
	     ...
	     <td> 
	     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV178.state.disabled}" property="pamClientVO.answer(INV178)" styleId="INV178" onchange="fireRule('INV178',this)">
...
<!--Number of weeks gestation at onset of illness (1-45 weeks):-->
	<tr>
	     ...
	     <td> 
	     	   <html:text name="PamForm" disabled ="${PamForm.formFieldMap.VAR159.state.disabled}" property="pamClientVO.answer(VAR159)" maxlength="2" size="5" styleId="VAR159" onblur="fireRule('VAR159',this)"
	     		title="${PamForm.formFieldMap.VAR159.tooltip}" onkeyup="isNumericCharacterEntered(this)"/></td>
	 </tr>
	...
	<tr>
	     ...
	     <td> 
	     	    <html:select name="PamForm" disabled ="${PamForm.formFieldMap.VAR160.state.disabled}" property="pamClientVO.answer(VAR160)" styleId="VAR160" onchange="fireRule('VAR160',this)">
