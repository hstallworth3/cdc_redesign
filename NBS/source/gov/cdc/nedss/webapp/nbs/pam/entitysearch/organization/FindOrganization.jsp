...
<html>
	...
	<base target="_self">
		...
		{
			var org = '<%=request.getAttribute("identifier")%>';
	...
	<body class="popup" onload="autocompTxtValuesForJSP();focusOnFirstBodyElement();" onkeypress="SubmitOnEnter();" style="overflow:hidden">
	   <!-- Page title -->
        ...
        <div class="popupButtonBar">
            <input type="submit" name="Submit" value="Submit" onclick="return findOrganization('<%=queId%>');"/>
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td class="conditionControl" style="white-space:nowrap"> 
                            <html:select name="organizationSearchForm" property="organizationSearch.nmTxtOperator" 
                                    styleId="lnoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_SNDX)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td>
                            <html:text styleId ="lastNameTxt" name="organizationSearchForm" property="organizationSearch.nmTxt"/>
                        </td> 
                   ...
                   <!-- Street Address -->
                    <tr>
                        ...
                        <td class="conditionControl"> 
                            <html:select name="organizationSearchForm" property="organizationSearch.streetAddr1Operator" 
                                    styleId="saoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td>
                            <html:text name="organizationSearchForm" property="organizationSearch.streetAddr1"/>
                        </td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="conditionControl"> 
                            <html:select name="organizationSearchForm" property="organizationSearch.cityDescTxtOperator"  
                                    styleId="cdoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td>
                            <html:text name="organizationSearchForm" property="organizationSearch.cityDescTxt"/>
                        </td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap">
                            <html:select name="organizationSearchForm" property="organizationSearch.stateCd"  styleId="stoperator">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text name="organizationSearchForm" property="organizationSearch.zipCd"/>
                        </td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text name="organizationSearchForm" property="organizationSearch.phoneNbrTxt" onkeyup="TeleMask(this,event)"/>
                        </td> 
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="white-space:nowrap">
                            <html:select name="organizationSearchForm" property="organizationSearch.typeCd"  styleId="tcoperator">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text name="organizationSearchForm" property="organizationSearch.rootExtensionTxt"/>
                        </td> 
                    </tr>
                </tbody>
            </table>
