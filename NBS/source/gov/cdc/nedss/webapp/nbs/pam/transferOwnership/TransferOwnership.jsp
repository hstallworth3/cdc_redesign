		...
		<html:form>
	            ...
	            <td colspan="2" width="100%">
	               ...
	               <tr>
	                <td class="fieldName" id="assignAuCD">
	                 ...
	                 <td>
			             <html:select name="PamForm" property="pamClientVO.answer(TUB237)"  onchange="enableCommentAndRecipientFields()"  styleId ="TUB237">
	     ...
	     <tr  id="exportList">
	                <td class="fieldName" id="transferTo">
	                 ...
	                 <td>
			             <html:select name="PamForm" property="pamClientVO.oldPamProxyVO.notificationVO_s.theNotificationDT.exportReceivingFacilityUid"     styleId ="exportFacility">
