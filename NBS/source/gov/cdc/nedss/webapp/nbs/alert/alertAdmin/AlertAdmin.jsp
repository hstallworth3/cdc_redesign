                ...
                <html:form onsubmit="return setOptionValue();">
                    ...
                    <div class="sect" id="searchCriteria">
                        ...
                        <div class="sectBody">
                            <table class ="subSect" >
                                <tr>
                                    <td class="fieldName" id="cond"><span style="color:#FF0000;">* </span>Condition:
                                    </td>
                                    <td>
                                        <html:select styleId="sCondCd" name="alertAdminForm" property="searchParamsVO.condition_CD">
                                            <html:optionsCollection property="conditionList" value="key" label="value"/>
                                        </html:select>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldName" id="jur"><span style="color:#FF0000;">*</span>Jurisdiction:
                                    </td>
                                    <td>
                                        <html:select styleId="sJurisCd" name="alertAdminForm" property="searchParamsVO.jurisdiction_CD">
                                ...
                                <tr>
                                    <td  class="fieldName" id="phe"><span style="color:#FF0000;">*</span>
                                        Public Health Event:
                                    </td>
                                    <td>
                                    <html:select styleId="sEventCd" name="alertAdminForm" property="searchParamsVO.event_CD">
                        ...
                        <div class="sectBody">
                            <table  class ="subSect">
                                ...
                                <tr>
                                    ...
                                    <td colspan= "3">
                                        <html:select styleId="aCondCd" name="alertAdminForm" property="alertClientVO.condition_code" disabled="true">
                                            <html:optionsCollection property="conditionList" value="key" label="value"/>
                                        </html:select>					
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan= "3">
                                        <html:select styleId="aJurisCd" name="alertAdminForm" property="alertClientVO.jurisdiction_code" disabled="true">
                                            <html:option value="" ></html:option>
                                            <html:optionsCollection property="jurisdictionList" value="key" label="value"/>
                                        </html:select>					
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan= "3">
                                        <html:select styleId="aEventCd" name="alertAdminForm" property="alertClientVO.event_code" disabled="true" >
                                            <html:option value="" ></html:option>
                                            <html:optionsCollection property="eventList" value="key" label="value"/>
                                        </html:select>			      
                                    </td>
                                ...
                                <tr>
                                    <td  class="fieldName" id="user"><span style="color:#FF0000;">* </span>Select User: </td>
                                    <td  style="width:11;">
                                        <html:select styleId="aUserList" name="alertAdminForm" property="alertUserIds" multiple="true" size="10" style="width:185" >
                                    ...
                                    <td>
                                        <html:select styleId="sUserList" name="alertAdminForm" property="selectedAlertUserIds" multiple="true" size="10" style="width:185">
                                ...
                                <tr>
                                    <td class="fieldName" id="sev"><span style="color:#FF0000;">* </span> Severity: </td>
                                    <td colspan= "3">
                                        <html:select styleId="aSevCd" name="alertAdminForm" property="alertClientVO.severity_code">
                                ...
                                <tr>
                                	...
                                	<td colspan= "3">
                                	<html:textarea style="WIDTH: 425px; HEIGHT: 100px;" name="alertAdminForm" property="alertClientVO.alertExtendedMessage" styleId ="ExtendedMessage" onkeyup="checkTextAreaLength(this, 1800)"/>
                                	</td>
								</tr>	
