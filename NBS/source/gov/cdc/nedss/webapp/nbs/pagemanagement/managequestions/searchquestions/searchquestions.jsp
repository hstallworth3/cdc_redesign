			...
			<tr><td>&nbsp;</td></tr>
	           <% if (request.getAttribute("searchConfirmMsgNoResult") != null) { %>
				  <div class="infoBox messages">
				  	<%=(String)request.getAttribute("searchConfirmMsgNoResult")%>&nbsp;<a href='<%=request.getAttribute("clickHereLk")%>' >Click Here</a> to add a new question.<br/>
				  </div>    
	           <% } %>
	            ...
	            <nedss:container id="sect_search" name="Search Criteria" classType="sect" 
	                ...
	                <nedss:container id="subsect_basicInfo" name="" classType="subSect" displayImg="false" includeBackToTopLink="no">
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <html:radio styleId="IncludeY" name="manageQuestionsForm"  property="searchCriteria(recordStatusCd)"  value="Y"/> Yes
	                            &nbsp;<html:radio  styleId= "IncludeN"   name="manageQuestionsForm" property="searchCriteria(recordStatusCd)"   value="N"  /> No
	                        </td>                          
	                    </tr>  
	                </nedss:container>
	            </nedss:container>
