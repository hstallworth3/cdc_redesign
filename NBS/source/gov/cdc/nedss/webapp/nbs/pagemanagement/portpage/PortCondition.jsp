 ...
 <body onload="showCount();disableConvBtn();tabBrowsing();">
    <div id="blockparent"></div>
      <html:form action="/PortPage.do" styleId="reviewPageForm">
								...
								<nedss:container id="subsec2" classType="subSect" name="Select Condition" displayImg="false">
									<tr> 
	               					...
	               					<tr>
	               						...
	               						<td>
	               							<html:select name="portPageForm" property="selectedConditionCode" styleId="conditionListId" onchange="disableBtns()">
							...
							<!-- Pre Run -->
								...
								<tr>
								   <td class="fieldName" id="NumOfCases">
               					    ...
               					    <td>
               					    	<input type="text" name="numberOfCasesToMigrate" id="numberOfCasesToMigrate" size="5" disabled="disabled"> 
               					    	<logic:equal name="portPageForm" property="mappingType" value="<%=PortPageUtil.MAPPING_LEGACY%>">
        ...
        <input type="hidden" id="preRunSuccess" value="<%=request.getAttribute("preRunSuccess") %>"/>
        <input type="hidden" id="prodRunSuccess" value="<%=request.getAttribute("prodRunSuccess") %>"/>
