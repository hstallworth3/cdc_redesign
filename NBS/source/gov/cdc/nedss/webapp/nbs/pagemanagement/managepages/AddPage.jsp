...
<html>
    <head>
     ...
     $j(document).ready(function() {
    		var preventAnotherVACPage = getElementByIdOrByName("preventAnotherVACPage");
    		if(preventAnotherVACPage!=null && preventAnotherVACPage.value == 'true'){
 ...
 <body onload="autocompTxtValuesForJSP();startCountdown();reconcileSelects('availableConditions','selectedConditions');">
    <div id="blockparent"></div>
      <html:form action="/ManagePage.do" styleId="addPageForm">
        				...
        				<tr> 
        					<td colspan=5>
           					...
           					<!-- Event Type - currently always Investigation -->
          						<tr>
          						    ...
          						    <td>
            							<html:select property="selection.waTemplateDT.busObjType" styleId="busObjType" onchange="getBusinessObjectTypeDD(this)">
 							...
 							<tr>
 	 						    ...
 	 						    <td>
                						<html:select property="selection.waTemplateDT.waTemplateRefUid" styleId="existingTemplate">
       						...
       						<!-- Select Mapping Guide -->
							    ...
							    <td style="white-space:nowrap">
	    							<html:select property="selection.waTemplateDT.messageId" styleId = "mappingGuide">
   						...
   						<!-- Page Name -->
   							<tr>
   							    ...
   							    <td>
   								<html:text property="selection.waTemplateDT.templateNm" size="50" maxlength="50" onkeyup="isSpecialCharEnteredForName(this);"  styleId="uniquePageName"/>
							    </td>
							</tr>
            						<!-- Page Description -->
   							<tr>
							    ...
							    <td>
								<html:textarea style="WIDTH: 500px; HEIGHT: 100px;" property="selection.waTemplateDT.descTxt" styleId="descTxt" onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)"/>
							    </td>
  							</tr>
							...
							&nbsp;If the condition you would like to map is not listed in the available condition list below, please search the page library to ensure the condition has not already been &nbsp;mapped to another page. If the condition was previously mapped, it cannot be mapped to this page (it must be cloned).
  								    ...
  								    <tr>
        								...
        								<td style="width:11;">
        									<html:select styleId="availableConditions" name="pageBuilderForm" property="conditionCodes" multiple="true" size="10" style="width:310">
         								...
         								<td style="width:11;">
	                							<html:select styleId="selectedConditions" name="pageBuilderForm" property="selectedConditionCodes" multiple="true" size="10" style="width:310">
		...
		<input type="hidden" id="preventAnotherVACPage" value="<%= request.getAttribute("preventAnotherVACPage") %>"/>  
