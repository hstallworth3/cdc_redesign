    ...
    <div>
        ...
        <nedss:container id="DateCompare" name="Rule Details" classType="subSect" includeBackToTopLink="no" isHidden="<%= NEDSSConstants.TRUE %>">
            ...
            <tr>
                ...
                <td>
                    <html:select property="seletedLogicDateComp" styleId="logicDC">
        ...
        <nedss:container id="Enabled" name="Rule Details" classType="subSect" 
            ...
            <tr>
               <td class="fieldName"> 
                ...
                <td>
                <html:select property="seletedLogDisOrEnabled"
                            styleId="logicED">
        ...
        <nedss:container id="RequireSection" name="Rule Details" classType="subSect" 
            ...
            Any Source Value: </td><td><html:checkbox name="manageRulesForm" property="anySourceValueInd" value="1" styleId="anyValIndRQ" onclick="handleAnySourceVal('anyValIndRQ','logicRQ','sourceValueRQ','selectedSourceValueRQ')" /></td>
            </tr>            
            <tr>
                <td class="fieldName"> 
                <span class="boldRed">*</span>
