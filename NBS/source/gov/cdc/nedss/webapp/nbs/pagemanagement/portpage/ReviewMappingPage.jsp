...
/* 		function cancelForm()
	    ...
	    function makeMSelects() {
           ...
           $j("#fromLab").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
           $j("#fromDtTyp").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
           $j("#mapQue").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
           ...
           $j("#fromAnswer").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
           $j("#mapAns").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
           $j("#toAnswer").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
       }
