					...
					<logic:equal name="BaseForm" property="securityMap(printCDCFRForm)"
						...
						<tr>
							<td class="InputFieldLabel" id="selform"><span
								style="color: #FF0000">*</span><span style="">Select
									Form:</span></td>
							<td style="white-space:nowrap" class="InputField"><html:select property="formName"
									styleId="formNameid">
									<html:optionsCollection property="codedValue(INV_CDC_FORMS)"
						...
						<tr>
							<td class="InputFieldLabel" id="selcon"><span style="">Select
									Content:</span></td>
							<td class="InputField"><html:radio property="formContent"
									value="<%=NEDSSConstants.CDC_BLANK%>"><%=NEDSSConstants.CDC_BLANK%></html:radio>
								<html:radio property="formContent"
				...
				<nedss:container id="sect_coinf"
					...
					<nedss:container id="subsect_coinf" name="" classType="subSect"
						...
						<logic:equal name="BaseForm"
							...
							<tr>
							<td class="InputFieldLabel" id="selform"><span
								style="color: #FF0000">*</span><span style="">Include another condition on the
									form?:</span></td>
