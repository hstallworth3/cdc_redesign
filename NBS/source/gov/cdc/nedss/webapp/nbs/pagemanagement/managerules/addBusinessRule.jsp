    ...
    <div>
        ...
        <nedss:container id="question" name="Rule Description" classType="subSect" includeBackToTopLink="no">
            ...
            <tr>
                ...
                <td><html:select property="seletedFunction" styleId="function" onchange="callBusinessRule(this)">
            ...
            <tr>
                ...
                <td><html:textarea property="ruleDescription" 
        ...
        <nedss:container id="DateCompare" name="Rule Details" classType="subSect" includeBackToTopLink="no" isHidden="<%= NEDSSConstants.TRUE %>">
            <tr>
                ...
                <td>
                    <html:select property="seletedSourceDateComp" styleId="sourceDC">
            ...
            <tr>
                ...
                <td><html:select property="seletedLogicDateComp" styleId="logicDC">
            ...
            <tr>
                ...
                <html:select property="seletedTargetDateComp" styleId="targetDC" size="4" multiple="true" 
        ...
        <nedss:container id="Enabled" name="Rule Details" classType="subSect" 
            ...
            <tr>
                <td class="fieldName" title="The source question associated with this business rule (i.e., the field that 'triggers' the business rule)."><span class="boldRed">*</span> Source:</td>
                <td>
                <html:select property="seletedSourceDisOrEnabled" styleId="sourceED" 
            ...
            Any Source Value: </td><td><html:checkbox name="manageRulesForm" property="anySourceValueIndDisOrEnabled" value="1" styleId="anyValIndED" onclick="handleAnySourceVal('anyValIndED','logicED','sourceValueED','selectedSourceValueED')" /></td>
            </tr>
            <tr>              
            ...
            <tr>
               <td class="fieldName"> 
                ...
                <td><html:select property="seletedLogDisOrEnabled"
                    styleId="logicED">
		...
		Source Value(s):</span></td>
			...
			<i> <span class=" InputFieldLabel" id="sourceValueEDComment">(Use Crtl to select more than one value)</span> </i> <br/><br/>
                            <html:select property="seletedSourceValDisOrEnabled"
                ...
                <td>
                	<html:select property="selectedTargetType" styleId="targetType" onchange="getDWRTargetTypeValues(this, 'targetED');">
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        ...
                        <br/><i> (Use Crtl to select more than one value) </i> <br/><br/>
                        <html:select property="seletedTarDisOrEnabled" styleId="targetED"  size="4" multiple="true" 
        ...
        <nedss:container id="RequireSection" name="Rule Details" classType="subSect" 
            ...
            <tr>
                <td class="fieldName" title="The source question associated with this business rule (i.e., the field that 'triggers' the business rule)."><span class="boldRed">*</span> Source:</td>
                <td>
                <html:select property="selectedSourceRequired" styleId="sourceRQ" 
            ...
            Any Source Value: </td><td><html:checkbox name="manageRulesForm" property="anySourceValueInd" value="1" styleId="anyValInd" onclick="handleAnySourceVal('anyValInd','logicRQ','sourceValueRQ','selectedSourceValueRQ')" /></td>
            </tr>
            <tr>            
            <tr>
                <td class="fieldName"> 
                ...
                Logic/Comparator:</span></td>
                <td><html:select property="selectedLogicRequired"
                    styleId="logicRQ">
                ...
                <td>
                    <div class="multiSelectBlock">
                          <i> <span class=" InputFieldLabel" id="sourceValueRQComment">(Use Crtl to select more than one value)</span> </i> <br/><br/>
                            <html:select property="selectedSourceValRequired"
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        ...
                        <br/><i> (Use Crtl to select more than one value) </i> <br/><br/>
                        <html:select property="selectedTargetRequired" styleId="targetRQ"  size="4" multiple="true" 
        ...
        <nedss:container id="HideShowSection" name="ShowHide Rule Details" classType="subSect" 
            ...
            <tr>
                <td class="fieldName" title="The source question associated with this business rule (i.e., the field that 'triggers' the business rule)."><span class="boldRed">*</span> Source:</td>
                <td>
                <html:select property="selectedSourceHideOrUnhide" styleId="sourceHD" 
            ...
            <tr>
            <td class="fieldName" title="Select the checkbox to indicate that any value selected will trigger the rule.">
            Any Source Value: </td><td><html:checkbox name="manageRulesForm" property="anySourceValueIndHideOrUnhide" value="1" styleId="anyValIndHD" onclick="handleAnySourceVal('anyValIndHD','logicHD','sourceValueHD','selectedSourceValueHD')" /></td>
            </tr>       
            ...
            <tr>
               <td class="fieldName"> 
                ...
                Logic/Comparator:</span></td>
                <td><html:select property="selectedLogicHideOrUnhide"
                    styleId="logicHD">
		...
		Source Value(s):</span></td>
			...
			<i> <span class=" InputFieldLabel" id="sourceValueHDComment">(Use Crtl to select more than one value)</span> </i> <br/><br/>
                            <html:select property="selectedSourceValHideOrUnhide"
                ...
                <td>
                	<html:select property="selectedTargetTypeHD" styleId="targetTypeHD" onchange="getDWRTargetHideShowValues(this, 'targetHD');">
                    	<html:optionsCollection property="targetType" value="key" label="value" />
                	</html:select>                     
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        ...
                        <br/><i> (Use Crtl to select more than one value) </i> <br/><br/>
                        <html:select property="selectedTargetHideOrUnhide" styleId="targetHD"  size="4" multiple="true" 
