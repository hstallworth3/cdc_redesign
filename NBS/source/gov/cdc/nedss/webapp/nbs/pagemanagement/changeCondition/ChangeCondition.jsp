...
<html>
	...
	<body class="popup" style="width:100%;margin:0em;" onload="handlePageOnload();" onunload="closeChangeConditionDialogBox()">	
	...
	<div id="changeConditionBlock">
	  ...
	  <div id="popupButtonBottom" class="grayButtonBar" style="text-align:right; margin-top:5px;">
		...
		<table style="display:none" id="confirmationText">	
		...
		<ul><li><font color="red">A notification has already been sent to the CDC for ${PageForm.attributeMap.oldConditionDesc}. An updated message will be sent to the CDC indicating the change in condition to newDesc. Please review the case status and update notification comments accordingly.</font></li></ul>
		</logic:equal>
		</td></tr>
		<br />
