...
<html>
    ...
    <logic:notEmpty name="batchType">
    	<body class="popup" onload="autocompTxtValuesForJSP();handlePageOnload();startCountdown();isValidAggregateWidth();OnloadRepeatingBlock();" onunload="handleBatchPageUnload(false, event); return false;" style="text-align:center;">   
    </logic:notEmpty>
    <logic:empty name="batchType">
    	<body class="popup" onload="autocompTxtValuesForJSP();handlePageOnload();startCountdown();isValidAggregateWidth();OnloadRepeatingBlock();" onunload="handlePageUnload(false, event); return false;" style="text-align:center;">
    </logic:empty>	
                ...
                <nedss:container id="sect_section" name="<%= strPageTitle %>" displayLink="false"  classType="sect" displayImg="false" includeBackToTopLink="no">
                    <nedss:container id="subsect_basicInfo" name="Subsection Details" classType="subSect" displayImg="false" includeBackToTopLink="no">
                     <tr>
                            ...
                            <td>
                                <html:text property="pageEltVo.waUiMetadataDT.questionLabel" maxlength="300" size="40" styleId="tabNameTd" onkeyup="isSpecialCharEnteredForName(this)"/>
                            </td>
                        </tr>
                        <!--
                        <tr>
													  ...
													  <tr>
													  	...
													  	<input type="hidden" id="<%="display_" + index%>" value="<bean:write name="pageElementForm" property="batchQuestionMap(${mList.key}).displayInd" />" />
														    ...
														    <td width="35%" style="text-align:left" id="<%="select_" + index%>">
														    	<html:select name="pageElementForm" property="batchQuestionMap(${mList.key}).batchTableAppearIndCdForJsp"  styleId='<%="code_"+index%>' onchange='<%="displayElementProp(this,"+ index +");"%>' style="text-align:left;" >
												                     <html:optionsCollection property="codedValue(YN)" value="key" label="value"/>
												                 </html:select>
														    </td>
														    <td width="35%"><html:text name="pageElementForm" property="batchQuestionMap(${mList.key}).batchTableHeader" value="${mList.value.batchTableHeader}" styleId='<%="header_"+index%>' maxlength="50"/></td>
														    <!--Add this for validation of width  onkeyup="return isValidAggregateWidth();" -->
														    <td width="35%"><html:text property="batchQuestionMap(${mList.key}).batchTableColumnWidth" value="${mList.value.batchTableColumnWidth}" styleId='<%="width_"+index%>' onkeyup="return isValidAggregateWidth();"/></td>
													  </tr>
												</logic:iterate>
												<tr><td width="65%" colspan="3" ></td><td height="25px" ><input type="text" id="a_tbox" name="a_tbox" value="" readonly="readonly" style="border: 0px solid #000000;"/> </td></tr>
					                        </tbody>
				                     </table>
	                              </td></tr>        
	                        </nedss:container>
