        ...
        <div id="doc3">
				...
				<% if(request.getAttribute("CloneError") != null) { %>
					<div class="infoBox errors">
						...
						<%= request.getAttribute("CloneError")%>
					</div>
				<% }%>          	   		
    				...
    				<nedss:container id="section1" name="Clone Page" classType="sect" displayImg ="false" displayLink="false" includeBackToTopLink="no">
					    ...
					    &nbsp;Select a reporting mechanism and enter a page name to create a new page.
 							...
 							<tr>
 	 						    ...
 	 						    <td>
                						<html:select disabled="true" property="selection.waTemplateDT.waTemplateRefUid" styleId="existingTemplate">
   						...
   						<!-- Page Name -->
   							<tr>
   							    <td class="fieldName">
   								<font class="boldTenRed" >*</font>
   							   	<span class="InputFieldLabel" id="uniquePageNameL" style="" title="Unique Page Name">
   							    	<b>Page Name:</b></span>
   							    </td>
   							    <td>
   								<html:text property="selection.waTemplateDT.templateNm" size="50" maxlength="50" title="The unique name for the page" styleId="uniquePageName"/>
							    </td>
							</tr>
            						<!-- Page Description -->
   							<tr>
