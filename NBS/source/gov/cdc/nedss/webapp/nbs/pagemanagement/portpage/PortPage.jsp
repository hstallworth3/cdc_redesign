...
<body onload="autocompTxtValuesForJSP();startCountdown();onLoadAction();getFieldsAfterPageLoad();">
				...
				<td>
					...
					<div id="bd">
						...
						<div id="PortPageError" class="infoBox errors">
							...
							<%= request.getAttribute("PortPageError")%>
						...
						<nedss:container id="section1"
							...
							<nedss:container id="subSection1" name="" classType="subSect" displayImg="false">
								...
								<td width="25%">
   								<html:text property="mapName" size="50" maxlength="100" styleId="mapName"/>
							    </td>
							    <td>
								...
								<tr>
					            <td>&nbsp;</td>
					            <td id="fileSelected" style="font-style:italic;font-size:90%"></td>
								...
								<tr>
					                <td style="padding:0.5em;">	
					                    <div id="addAttachmentBlock" class="boxed" width="100%" style="background:#CEE3F6">
				                           ...
				                           <table class="formTable" style="width:100%; margin:0px">
									        ...
									        <!-- File Attachment -->
									        <tr>
									            <td class="fieldName" id="chooseFileLabel"> <span style="color:red;">*</span><b>Map Name:</b></td>
									            <td width="60%"><html:file name="portPageForm" property="importFile" styleId="importFile" style="height: 1.8em;" maxlength="70" size= "70"> </html:file></td>
								...
								<nedss:container id="subSection2" name="From Page Selection" classType="subSect" displayImg="false">
									...
									<tr>
										...
										<td><html:select styleId="fromTemplate" name="portPageForm" property="fromPageFormCd" size="10" style="width:210" onchange="getFieldsByFromPage(this)" >
									...
									<nedss:container id="subSection3" name="To Page Selection" classType="subSect" displayImg="false">
										...
										<tr>
											...
											<td><html:select styleId="toTemplate" name="portPageForm" property="toPageFormCd" size="10" style="width:210" onchange="getFieldsByToPage(this)" >
	...
	<input type="hidden" id="fileName" value="<%= request.getAttribute("fileName")%>"/>
	<input type="hidden" id="filePath" value="<%= request.getAttribute("filePath")%>"/>
