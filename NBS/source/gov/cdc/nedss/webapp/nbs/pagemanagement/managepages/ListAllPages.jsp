    ...
    <head>
		...
		*/
        ...
        function makeMSelects() {
             $j("#busObjType").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
             $j("#lastUpdated").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
             $j("#lastUpdatedBy").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
             $j("#status").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
             $j("#templateNm").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
             $j("#relatedConditions").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
        }
