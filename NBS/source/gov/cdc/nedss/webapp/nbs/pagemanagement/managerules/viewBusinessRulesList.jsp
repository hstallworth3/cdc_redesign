    ...
    <head>
        ...
        function cancelFilter(key) {                    
         ...
         function makeMSelects() {                         
              $j("#function").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});              
              $j("#sourceField").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
              $j("#values").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
              $j("#logic").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
              $j("#targetField").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
