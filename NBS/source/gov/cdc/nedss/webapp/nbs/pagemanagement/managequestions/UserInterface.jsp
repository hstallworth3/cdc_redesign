...
<tr>
    ...
    <td>
        <html:text property="selection.questionLabel" size="50" maxlength="100" style="width:500px;" styleId="questionLabel" />      
    </td>
</tr>
...
<tr>
    ...
    <td>
        <html:textarea style="width:500px; height:100px;" property="selection.questionToolTip" styleId="questionToolTip" />      
    </td>
</tr>
...
<logic:notEqual name="manageQuestionsForm" property="selection.standardQuestionIndCd" value="<%= NEDSSConstants.TRUE %>">                     
   <tr>
      ...
      <td>
        <html:select property="selection.nbsUiComponentUid" styleId = "defaultDisplayControl" onchange="hidesec(this);">
