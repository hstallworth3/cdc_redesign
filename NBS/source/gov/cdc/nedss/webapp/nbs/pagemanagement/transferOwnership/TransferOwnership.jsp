...
<html>
	...
	function validateTransferInputFields()
	{
		...
		if( newJur != null && newJur.length == 0) {
			...
			getElementByIdOrByName("newJurisEle").style.color="red";
			isError = true;		
		}
		else {
				...
				if(trim(mySplitResult[i]).length>0){
				    ...
				    if(newJur==mySplitResult[i]  && trim(getElementByIdOrByName("INV107").value).length>0){
						...
						if (theDocumentType != null && theDocumentType.length == 0) {
							...
							getElementByIdOrByName("documentTypeLabel").style.color = "red";
							isError = true;
						} else
		   ...
		   <tr style="background:#FFF;">
		     ...
		     <tr>
	                <td class="fieldName" id="newJurisEle">
	                 ...
	                 <td>
			             <html:select name="PageForm" property="pageClientVO.answer(INV107)"  onchange="enableCommentAndRecipientFields()" styleId ="INV107">
	                ...
	                <td class="fieldName" id="transferTo">
	                 ...
	                 <td>
			             <html:select name="PageForm" property="pageClientVO.oldPageProxyVO.notificationVO_s.theNotificationDT.exportReceivingFacilityUid"     styleId ="exportFacility">
