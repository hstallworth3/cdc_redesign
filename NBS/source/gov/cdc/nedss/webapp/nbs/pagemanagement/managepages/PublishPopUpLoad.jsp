	        ...
	        <nedss:container id="sect_publish" name="Publish Page" classType="sect" displayImg="false" includeBackToTopLink="no" displayLink="no">
	            <nedss:container id="subsect_publish_ss" name="" classType="subSect" displayImg="false" includeBackToTopLink="no">
	                <html:form action="/ManagePage.do">
	                    <tr>
		              		<td colspan="2"> 
		                         You have indicated that you would like to publish the <B><%=request.getSession().getAttribute("pgPageName")%></B> page. 
								...
								then select Submit to continue, or select Cancel to return to View Page. 
		                      </td>                 	                  
	                   </tr>
	                   <tr>
	                      <td colspan="2"> &nbsp;
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" property="selection.versionNote" styleId="versionNote" onkeydown="checkMaxLength(this)" 
