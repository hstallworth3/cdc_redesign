<html>
            ...
            */
            ...
            function submitForm()
            {
                ...
                var sERadio = $j("input#staticEltRadioOption");
                  var str ='<%=request.getSession().getAttribute("SubsectionId")%>';
                ...
                if (jQuery.trim(eltType) == "") {
                    ...
                    // hyperlink 
                        ...
                        if (jQuery.trim(questionLabel) == "") {
                            ...
                            $j("#questionLabelL").css("color", "red");
                        }
                        else {
                    ...
                    if (adminComments.length > 2000) {
                        ...
                        $j("#adminCommentsL").css("color", "red");
                    }
                    else {
    ...
    <body class="popup" onload="handlePageOnload();startCountdown();autocompTxtValuesForJSP();" onunload="handlePageUnload(false, event); return false;">
        ...
        <div style="text-align:left; margin:0.5em 0em; padding:5px 0px;">
            ...
            <input id="searchQuestionsRadioOption" type="radio" checked value="questions" name="manageOption" onclick="javascript:showDivOption(this)"/>Question Element &nbsp;&nbsp;&nbsp;
            <input id="staticEltRadioOption" type="radio" value="staticElt" name="manageOption" onclick="javascript:showDivOption(this)"/> Static Element
        </div>
                    ...
                    <nedss:container id="subsect_basicInfo" name="" classType="subSect" displayImg="false" includeBackToTopLink="no">
                        <html:form action="/SearchManageQuestions.do">
	                        <tr>
	                            ...
	                            <td>
	                                <html:select property="searchCriteria(questionType)" styleId = "questionType">
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                <html:text property="searchCriteria(questionIdentifier)"  size="40"  styleId="questionIdentifier" />      
	                            </td>
	                        </tr>
	                        <tr>
	                            <td class="fieldName"><span title="Unique Name">Unique Name:</span></td>
	                            <td>
	                                <html:text property="searchCriteria(questionNm)" size="40"  styleId="questionNm" />      
	                            </td>
	                        </tr>
	                        <tr>
	                            <td class="fieldName"> 
	                            ...
	                            <td>
	                                <html:select property="searchCriteria(subGroup)" styleId = "subGroup">
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                <html:text  property="searchCriteria(label)" styleId="label" size="40"/>      
	                            </td>
	                        </tr>
                        </html:form>   
                    </nedss:container>
                    ...
                    <nedss:container id="subsect_staticElt" name="" classType="subSect" 
                        ...
                        <html:form action="/ManagePageElement.do?action=editSubmit">
	                        <tr>
	                            ...
	                            <td>
	                                <select id="eltType" name="pageEltVo.waUiMetadataDT.nbsUiComponentUid" onchange="displayElementProperties(this)">
	                                    <option value=""></option>
	                        ...
	                        <tr class="eltProperty hyperlinkProperty" style="display:none;">
	                            ...
	                            <td>
	                               <html:text styleId="questionLabel" property="pageEltVo.waUiMetadataDT.questionLabel" maxlength="300" size="40"/>
	                               <br/>
	                        ...
	                        <tr class="eltProperty hyperlinkProperty" style="display:none;">
	                            ...
	                            <td>
	                               <html:text styleId="linkUrl" property="pageEltVo.waUiMetadataDT.defaultValue" maxlength="300" size="50"/>
                                   <br/>
	                        ...
	                        <tr class="eltProperty readOnlyCommentsProperty" style="display:none;">
	                            ...
	                            <td>
	                               <html:textarea styleId="commentsText" property="pageEltVo.waUiMetadataDT.questionLabel" rows="3" cols="30" onkeyup="chkMaxLength(this,300)" onkeydown="chkMaxLength(this,300)" />
	                           </td>
	                        </tr>
	                        <tr class="eltProperty allElementsProperty" style="display:none;">
	                            ...
	                            <td>
	                               <html:textarea styleId="adminComments" property="pageEltVo.waUiMetadataDT.adminComment" rows="5" cols="30"/>
	                            </td>
	                        </tr>
                        </html:form>
                    </nedss:container>
