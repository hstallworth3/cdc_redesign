	...
	<%  sectionIndex = 0; %>
	                  ...
	                  <!-- ################# SECTION ################  -->
						<nedss:container id="patSearch1" name="Simple Search" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F" classType="sect">
						...
						<nedss:container id="patSearch2" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F"  classType="subSect" >
			                    ...
			                    <tr>
			                        <td class="fieldName" valign="middle">
			                        
			                        <span class="InputFieldLabel" valign="middle" id="DEM102L" style="" title="Patient's Last Name"> Last Name: </span> &nbsp; </td> 
			                       
			                        <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;"> 
			                        <table style="background:#CEE3F6" width="98%" align="center"><tr><td style="background:#CEE3F6" width="1%">&nbsp;&nbsp;</td><td style="background:#CEE3F6; min-width:120px" width="98%">
			                        
			                        <html:select name="personSearchForm" property="personSearch.lastNameOperator" styleId="DEM102O" >
			                        
				                      <option value="SW" selected>Starts With</option><option value="CT">Contains</option><option value="=">Equal</option>
				                         <option value="!=">Not Equal</option><option value="SL">Sounds Like</option> 	 
				                        
				                        </html:select> 
				                     <SCRIPT Language="JavaScript" Type="text/javascript">setSelectedIndex(getElementByIdOrByName("DEM102O"),"<%=request.getAttribute("LNameOp")%>");</SCRIPT>
				                   </td><td style="background:#CEE3F6" width="1%"></td>
				                      </tr> 
			                    ...
			                    <tr>                                                    
			                        ...
			                        <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;"> 
			                        <table style="background:#CEE3F6" width="98%" align="center"><tr><td style="background:#CEE3F6" width="1%">&nbsp;&nbsp;</td>
			                        <td style="background:#CEE3F6" width="98%">
			                        
			                         <html:select name="personSearchForm" property="personSearch.firstNameOperator" styleId="DEM104O" >
			                             <option value="SW" selected>Starts With</option><option value="CT">Contains</option><option value="=">Equal</option>
				                        <option value="!=">Not Equal</option><option value="SL">Sounds Like</option>
				                      
				                        
				                        </html:select>
				                         <SCRIPT Language="JavaScript" Type="text/javascript">setSelectedIndex(getElementByIdOrByName("DEM104O"),"<%=request.getAttribute("FNameOp")%>");</SCRIPT>
			                        </td><td style="background:#CEE3F6" width="1%"></td>
				                      </tr> 
			                    ...
			                    <tr>   
			                          <td class="fieldName"> 
			                           ...
			                           <span class="InputFieldLabel" id="DEM105L" style="" title="Patient's Date of Birth">Date of Birth:</span>&nbsp;</td> 	                            
									  ...
									  <table style="background:#CEE3F6" width="98%" align="center"><tr><td style="background:#CEE3F6" width="1%">&nbsp;&nbsp;</td>
			                              <td style="background:#CEE3F6" width="98%">
												...
												<html:select name="personSearchForm" property="personSearch.birthTimeOperator" styleId="DEM105O"  onchange="flipDate(this);">
															                     
							                      <option value="BET">Between&nbsp;&nbsp;&nbsp;&nbsp;</option><option value="=" selected>Equal</option>
							                          
							                         </html:select>
							                          <SCRIPT Language="JavaScript" Type="text/javascript">setSelectedIndex(getElementByIdOrByName("DEM105O"),"<%=request.getAttribute("DOBOp")%>");</SCRIPT>
											...
											<div id ="betweendate">
											<html:text  property="personSearch.beforeBirthTime" styleId="patientDOBBet1" size="10" maxlength="10" onkeyup="DateMask(this,null,event);" title="Date of Birth from"/>
											...
											<a href="#"><img align="bottom" alt="Select Date" border="0" src="calendar.gif" name="N10090_button" onclick="getCalDate('personSearch.beforeBirthTime','N10090_button');return false;"></a> - 
											<html:text  property="personSearch.afterBirthTime" styleId="patientDOBBet2" size="10" maxlength="10" onkeyup="DateMask(this,null,event);" title="Date of Birth to"/>
											...
											<nobr><a href="#"><img align="bottom" alt="Select Date" border="0" src="calendar.gif" name="N1009A_button" onclick="getCalDate('personSearch.afterBirthTime','N1009A_button');return false;"></a>
												...
												<tr>
													...
													<td>
															...
															<td valign="middle" align="left">
																<table cellspacing="0" cellpadding="0" border="0">
																<tr>
																<td><input id="personSearch.beforeBirthTime" type="TEXT" onkeydown="if (SubmitOnEnter()==false) return false;" name="personSearch.beforeBirthTime" size="10" maxlength="10" onkeyup="DateMask(this,null,event)" value="" validate="dateRange" errorCode="" fieldLabel="DOB Begin Date" requiredPartner="personSearch.afterBirthTime" onload="this.value='yes';"><nobr><a href="#"><img align="bottom" alt="Select Date" border="0" src="calendar.gif" name="N10090_button" onclick="getCalDate('personSearch.beforeBirthTime','N10090_button');return false;"></a>
																...
																<table cellspacing="0" cellpadding="0" border="0">
																<tr>
																<td><input id="personSearch.afterBirthTime" type="TEXT" onkeydown="if (SubmitOnEnter()==false) return false;" name="personSearch.afterBirthTime" size="10" maxlength="10" onkeyup="DateMask(this,null,event)" value="" validate="dateRange" errorCode="" dateBeforeRef="personSearch.beforeBirthTime" fieldLabel="DOB End Date" requiredPartner="personSearch.beforeBirthTime" onload="this.value='yes';"><nobr><a href="#"><img align="bottom" alt="Select Date" border="0" src="calendar.gif" name="N1009A_button" onclick="getCalDate('personSearch.afterBirthTime','N1009A_button');return false;"></a>
																<center>mm/dd/yyyy</center>
			                    ...
			                    <tr>
			                        ...
			                        <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;"></td>
			                        	<td width="1%"></td>
			                        <td>
					                     <html:select name="personSearchForm" property="personSearch.currentSex" styleId="DEM114" title="The patient's current sex">
			                    ...
			                    <tr>
			                        ...
			                        <table style="background:#CEE3F6" width="98%" align="center"><tr><td style="background:#CEE3F6" width="1%">&nbsp;&nbsp;</td>
			                        <td style="background:#CEE3F6" width="98%">
			                         <html:select name="personSearchForm" property="personSearch.streetAddr1Operator" styleId="DEM106O" >
			                        
				                       <option value="CT" selected>Contains&nbsp;&nbsp;&nbsp;</option><option value="=">Equal</option><option value="!=">Not Equal</option>
				                        
				                        </html:select>
				                         <SCRIPT Language="JavaScript" Type="text/javascript">setSelectedIndex(getElementByIdOrByName("DEM106O"),"<%=request.getAttribute("StrAddOp")%>");</SCRIPT>
				                  		</td><td style="background:#CEE3F6" width="1%"></td>
				                      </tr> 				                            
			                            </table>
				                  				                    </td>
			                     ...
			                     <tr>
			                        ...
			                        <table style="background:#CEE3F6" width="98%" align="center"><tr><td style="background:#CEE3F6" width="1%">&nbsp;&nbsp;</td>
			                        <td style="background:#CEE3F6" width="98%">
			                         <html:select name="personSearchForm" property="personSearch.cityDescTxtOperator" styleId="DEM107O" >
			                        
				                       <option value="CT" selected>Contains&nbsp;&nbsp;&nbsp;</option><option value="=">Equal</option><option value="!=">Not Equal</option>
				                        
				                        </html:select>
				                         <SCRIPT Language="JavaScript" Type="text/javascript">setSelectedIndex(getElementByIdOrByName("DEM107O"),"<%=request.getAttribute("CityOp")%>");</SCRIPT>
								          </td><td style="background:#CEE3F6" width="1%"></td>
				                      </tr> 				                            
			                            </table>
								                    </td>
			                    ...
			                    <tr>
			                        ...
			                        <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    	...
				                    	<td width="1%"></td>
				                    <td>
				                    <html:select name="personSearchForm" property="personSearch.state" styleId="DEM108O" title="Patient's State">
			                    ...
			                    <tr>
			                     ...
			                     <tr>
			                        <td class="fieldName">
			                           <span class="InputFieldLabel" id="DEM119L" style="" title="Patient's ID"> Patient ID(s):</span>&nbsp; </td> 
			                          <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    </td>
				                    	<td width="1%"></td>
				                    <td>
				                    <html:text size="35" property="personSearch.localID" styleId="DEM229" title="The patient's local (system) ID. To search multiple patient IDs, separate IDs by commas, semicolons, or spaces."/>
			                   ...
			                   <nedss:container id="patSearch3" name="Advanced Search" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F" classType="sect">
			
						    <!-- ########### SUB SECTION ###########  -->
						     <nedss:container id="patSearch4" name="" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F" classType="subSect" >
			                    ...
			                    <tr>
			                        <td class="fieldName"> 
			                           <span class="InputFieldLabel" id="DEM222L" style="" title="Patient's ID Type">ID Type:</span>&nbsp; </td> 
			                           <td style="background:#CEE3F6; width=13%; min-width:84px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			                           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				                    </td>
				                    <td width="1%"></td>
			                        <td>
					                     <html:select name="personSearchForm" property="personSearch.typeCd" styleId="DEM222" title="Patient's ID Type">
					                        <html:optionsCollection property="codedValue(EI_TYPE_PAT)" value="key" label="value"/>
					                    </html:select>	                                                    
			                        </td>
			                    ...
			                    <tr>
			                        <td class="fieldName"> 
			                           <span class="InputFieldLabel" id="DEM223L" style="" title="Patient's ID Value">ID Number: </span>&nbsp;</td> 
			                          <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    </td>
				                    <td width="1%"></td>
				                    <td>
				                     <html:text  property="personSearch.rootExtensionTxt" size="" maxlength="50"  styleId="DEM223" title="Any associated patient ID (e.g., SSN, State HIV Case ID, Medicaid Number, Medicare Number, etc.)" />
			                    ...
			                    <tr>
			                        <td class="fieldName"> 
			                           <span class="InputFieldLabel" id="DEM238L" style="" title="Patient's Telephone">Phone: </span>&nbsp; </td> 
				                    ...
				                    <html:text  property="personSearch.phoneNbrTxt" styleId="DEM238"
			                    ...
			                    <tr>
			                        <td class="fieldName">
			                           <span class="InputFieldLabel" id="DEM182L" style="" title="Patient's Email Address."> Email: </span>&nbsp;</td> 
			                          <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    </td>
				                    <td width="1%"></td>
			                        <td>
					                     <html:text  property="personSearch.emailAddress" styleId="DEM182"
			                            maxlength="50" 
			                            title="Any associated patient email address"  />                                                    
			                        </td>
			                    ...
			                    <tr>
			                        <td class="fieldName">
			                           <span class="InputFieldLabel" id="DEM221L" style="" title="Patient's Ethnicity"> Ethnicity: </span>&nbsp;</td> 
			                          <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    </td>
				                    <td width="1%"></td>
			                        <td>
					                     <html:select name="personSearchForm" property="personSearch.ethnicGroupInd" styleId="DEM221" title="Indicates if the patient is hispanic or not">
					                        <html:optionsCollection property="codedValue(P_ETHN_GRP)" value="key" label="value"/>
					                    </html:select>	                                                    
			                        </td>
			                    ...
			                    <tr>
			                        <td class="fieldName">
			                           <span class="InputFieldLabel" id="personSearch.raceCdL" style="DEM176L" title="Patient's Race"> Race: </span> &nbsp;</td> 
			                         <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
				                    </td>
				                    <td width="1%"></td>
			                        <td>
			                        <html:select name="personSearchForm" property="personSearch.raceCd" styleId="DEM176" title="Reported race">
			                   ...
			                   <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;">
			                    ...
			                    <td><html:checkbox  name="personSearchForm" property="personSearch.active" styleId="recordAct"  value="true"></html:checkbox> <nobr>Active</nobr>
			                    
								&nbsp;
								<html:checkbox  name="personSearchForm" property="personSearch.inActive" styleId="recordDel" value="true"></html:checkbox> 
								<nobr>Deleted</nobr>
								
								<html:checkbox  name="personSearchForm" property="personSearch.superceded" styleId="recordSup" value="true"></html:checkbox> 
								<nobr>Superceded</nobr>
