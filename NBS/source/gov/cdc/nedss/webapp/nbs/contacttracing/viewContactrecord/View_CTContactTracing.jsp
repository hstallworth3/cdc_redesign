...
<html>
	...
	<%
       ...
       if (printMode.equals("print")) { %>
	       <body class="popup" onload="shiftFocusToFirstTabElement();disablePrintLinks();" onunload="return handlePrinterFriendlyPageClose();">
	   <% } else { %>
	       <body class="popup" onload="shiftFocusToFirstTabElement();loadPage();" onunload="handlePageUnload(false, event); return false;">
        <% } 
    %>
