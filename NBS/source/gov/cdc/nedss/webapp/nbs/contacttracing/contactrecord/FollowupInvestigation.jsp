...
<td>
<html:text  name="contactTracingForm" property="cTContactClientVO.answer(INV147)"  maxlength="10" size="10" styleId="INV147" onkeyup="DateMask(this,null,event)"/>
...
<td>
<html:text  name="contactTracingForm" property="cTContactClientVO.answer(INV110)" maxlength="10" size="10" styleId="INV110" onkeyup="DateMask(this,null,event)"/>
...
<td>
<html:select name="contactTracingForm" property="cTContactClientVO.answer(NBS142)" styleId="NBS142">
...
<td>
<html:select name="contactTracingForm" property="cTContactClientVO.answer(NBS143)" styleId="NBS143">
