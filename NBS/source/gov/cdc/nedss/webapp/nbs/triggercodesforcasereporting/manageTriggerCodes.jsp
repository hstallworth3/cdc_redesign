	...
	<div id="doc3">
		...
		<html:form action="/TriggerCodes.do">
                            ...
                            <nedss:container id="subsec1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    <td class="fieldName" id="reqDisplayName"><font class="boldTenRed" ></font><span>Display Name:</span></td>
									 ...
									 <td id="contains">
										<html:select value = "Contains" name = "triggerCodeForm" property="displayNameOperatorSelected" styleId="srchCriteria">
			...
			<div id="tableResults" style="<%= request.getAttribute("displayTable")%>">
								...
								<table width="100%">
									<tr>
										<td align="center"><display:table name="manageList"
											...
											<display:column title="" style="width:3%;" media="html">
                                        	&nbsp;&nbsp;&nbsp;
                                        	
                                        		<img src="page_white_text.gif" onclick="viewTriggerCode(<%=((TriggerCodesDT)parent).getNbsUid()%>)" class="cursorHand" title="View" align="middle" cellspacing="2" cellpadding="3" border="55">
                                        
												</display:column>
												<display:column title="" style="width:3%;" media="html">
                            				 &nbsp;&nbsp;&nbsp;<img onclick = "editTriggerCode(<%=((TriggerCodesDT)parent).getNbsUid()%>)"
					...
					<table width="100%" style="<%= request.getAttribute("displayTable")%>">
						<tr>
							<td align="right">
