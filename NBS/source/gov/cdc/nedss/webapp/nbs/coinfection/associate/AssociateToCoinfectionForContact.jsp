...
<html>
	...
	<title>${BaseForm.pageTitle}</title>
	<base target="_self">	
	...
	function isValidCheck(){
		...
		var isFFSelected = false;
	  	function showFieldFollouwpFields() {
		  	var totalInfections = '<%= request.getAttribute("queueCount") %>';
		  	var isFFSet = false;
		...
		function validateBeforSubmit(){
			...
			if(isFFSelected==true){
				...
				if (INV147.value == null || INV147.value == "") {
					getElementByIdOrByName("INV147L").style.color="red";
				...
				if (INV110.value == null || INV110.value == "") {
					getElementByIdOrByName("INV110L").style.color="red";
				...
				if (NBS143.value == null || NBS143.value == "") {
					getElementByIdOrByName("NBS143L").style.color="red";
...
<body class="popup"  onload="showCount();autocompTxtValuesForJSP();" onunload="closePopup()">
 ...
 <tr> <td>
	...
	<tr> <td align="center">
       ...
       <input type="hidden" id="ContextAction" value="<%= request.getAttribute("ContextAction") %>"/>  
       <input type="hidden" id="SourceUid" value="<%= request.getAttribute("SourceUid") %>"/> 
			...
			<nedss:container id="GA30102" name="Investigation Details" isHidden="F" classType="subSect" >
					...
					<tr>
						...
						<td>
							...
							<html:img src="calendar.gif" onclick="getCalDate('INV147','INV147Icon');return false;" styleId="INV147Icon"></html:img>
						</td> 
					</tr>
					...
					<tr>
						...
						<td>
							...
							<html:img src="calendar.gif" onclick="getCalDate('INV110','INV110Icon');return false;" styleId="INV110Icon"></html:img>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<html:select name="associateToCoinfectionForm" property="cTContactClientVO.answer(NBS142)" styleId="NBS142">
					...
					<tr>
						...
						<td>
							<html:select name="associateToCoinfectionForm" property="cTContactClientVO.answer(NBS143)" styleId="NBS143">
