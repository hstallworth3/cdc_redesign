...
public class MarshallPageXML {
	...
	public String GeneratePageXMLFile(PageManagementProxyVO pmProxyVO, String fileToMake) throws NEDSSSystemException
    {
		...
		java.util.HashMap<String, PageElementType> quesMap = new java.util.HashMap();
		//batchQUesMap has question Identifier and subsection Question Identifier
		java.util.HashMap<String, String> batchQuesMap = new java.util.HashMap();
		...
		java.util.HashMap<String, OnBatchAddFunctionType> batchQuesAddFunctionMap = new java.util.HashMap();
		...
		String errorMsg = "Error writing XML file.";
