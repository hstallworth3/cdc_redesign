		...
		<table  class="dtTable" align="center" >
		  <thead >
		   ...
		   <tbody id="questionbody]]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2">
		      ...
		      <td style="width:3%;text-align:center;"><input id="view" type="image" src="page_white_text.gif" onclick="viewClicked2(this.id,']]></xsl:text><xsl:value-of select="QuestionUniqueName"/><xsl:text disable-output-escaping="yes"><![CDATA[_2');return false" 		name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">                            
