...
public class NNDMsgOutErrorLogDAOImpl
  ...
  public static final String SELECT_PROCESSED_LOG_ORACLE =
  ...
  public static final String UPDATE_PROCESSED_LOG_ORACLE =
  ...
  public Collection<Object>  getMsgOutStatus() throws NEDSSSystemException {
    ...
    if (PropertyUtil.getInstance().getDatabaseServerType() != null &&
      ...
      sqlStmt = SELECT_PROCESSED_LOG_ORACLE;
    }
    else {
  ...
  public void updateProcessedLog(MsgOutErrorLogDT dt) throws
    ...
    if (PropertyUtil.getInstance().getDatabaseServerType() != null &&
        PropertyUtil.getInstance().
        getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
      sqlStmt = UPDATE_PROCESSED_LOG_ORACLE;
    }
    else {
