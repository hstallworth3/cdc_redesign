...
public class PHDCMessageBuilder {
	...
	private String buildMessage(Collection<Object> caseNotificationDataDTCollection, Collection<Object> diseaseSpecificCaseDataDTCollection, NotificationDT notificationDT,
		...
		if(notificationDT.getCaseConditionCd()!=null & !(notificationDT.getCaseConditionCd().equals(NEDSSConstants.TUBERCULOSIS_KEY)|| notificationDT.getCaseConditionCd().equals(NEDSSConstants.VARICELLA_KEY)))
		...
		try {
			...
			while (iter.hasNext()) {
				...
				if (dataType.equalsIgnoreCase(NEDSSConstants.DATATYPE_TEXT)) {
					...
					if (xmlDataType.equalsIgnoreCase("nonNegativeInteger")) {
