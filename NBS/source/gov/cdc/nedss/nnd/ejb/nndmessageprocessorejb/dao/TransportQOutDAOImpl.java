...
public class TransportQOutDAOImpl extends BMPBase{
 ...
 public Long create(TransportQOutDT dt) throws NEDSSSystemException{
   ...
   try {
     if(dbType.equalsIgnoreCase("oracle"))
       recordId = insertOracleRecord(dt);
 ...
 private Long insertOracleRecord(TransportQOutDT dt) throws Exception {
   Connection dbConn = null;
   ...
   try {
         ...
         ResultSet uidSet = stmt.executeQuery("select transport_record_count.nextval from dual");
         ...
         pstmt = (PreparedStatement)dbConn.prepareStatement(INSERT_TRANSPORTQOUT_ORACLE);
         ...
         blobRS.next();
		  messageBLOB = (java.sql.Blob) blobRS.getBlob("payloadcontent");
