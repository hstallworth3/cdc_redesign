...
public class WumSqlQuery {
  ...
  public static final String SELECT_OBS_VALUE_DATE =
     ...
     " to_time \"toTime\" FROM " +
      DataTables.OBS_VALUE_DATE_TABLE + " WHERE observation_uid = ?";
  ...
  public static final String SELECT_WORKUP_SQL =
      ...
      "Public_health_case.status_cd  statusCd " + "from Person p " +
      "LEFT OUTER JOIN  participation par  ON P.person_uid = par.subject_entity_uid " +
      "LEFT OUTER JOIN Public_health_case Public_health_case "+
      ...
      "..Condition_code cond ON cond.condition_cd = Public_health_case.cd " +
      " LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..code_value_general code2 ON " +
      "code2.code_set_nm = 'PHC_CLASS' "+
     " and  Public_health_case.case_class_cd = code2.code " +
      "LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..Jurisdiction_code jcd ON Public_health_case.jurisdiction_cd = jcd.code " +
      "where person_uid= ?";
  ...
  public static final String SELECT_WORKUP_SQL_IN =
      ...
      "from Person p " +
      "inner JOIN  participation par "  +
      "ON P.person_uid = par.subject_entity_uid " +
      "inner JOIN Public_health_case Public_health_case " +
      "ON par.act_uid = Public_health_case.Public_health_case_uid " +
      "and Public_health_case.investigation_status_cd IN ( 'O', 'C') "  +
      ...
      "inner JOIN nbs_srte..code_value_general code1 "  +
      "ON code1.code_set_nm = 'PHC_IN_STS' "  +
      "and Public_health_case.investigation_status_cd = code1.code "  +
      "inner JOIN nbs_srte..Condition_code cond " +
      "ON cond.condition_cd = Public_health_case.cd "  +
      "LEFT OUTER JOIN (select target_act_uid,source_act_uid from act_relationship where source_act_uid "+
      "in (select notification_uid from notification where cd = 'NOTF') "+
      ") ar on Public_health_case.public_health_case_uid = ar.target_act_uid "+
      "LEFT OUTER JOIN notification noti on ar.source_act_uid = noti.notification_uid "+
      "and noti.cd='NOTF' "+
      "LEFT OUTER JOIN (select subject_entity_uid,act_uid from participation where type_cd='InvestgrOfPHC') par1 on par1.act_uid = Public_health_case.public_health_case_uid "+
      "LEFT OUTER JOIN person_name on par1.subject_entity_uid = person_name.person_uid "+
      "LEFT OUTER JOIN nbs_srte..code_value_general code2 " +
      "ON code2.code_set_nm = 'PHC_CLASS' "  +
      "and  Public_health_case.case_class_cd = code2.code " +
      "LEFT OUTER JOIN nbs_srte..Jurisdiction_code jcd " +
      "ON Public_health_case.jurisdiction_cd = jcd.code "  +
      "LEFT OUTER JOIN Person p2 on p2.person_uid  =  person_name.person_uid "+
      "LEFT OUTER JOIN case_management cm " +
      "ON Public_health_case.public_health_case_uid = cm.public_health_case_uid "  +
      "where p.person_parent_uid= ";

  public static final String SELECT_WORKUP_ORACLE =
      "SELECT phc.investigation_status_cd \"investigationStatusCd\", " +
      "phc.local_id \"localId\", " +
      "phc.public_health_case_uid \"publicHealthCaseUid\", " +
      "phc.activity_from_time \"activityFromTime\", " +
      "phc.cd \"cd\", " +
      "phc.case_class_cd \"caseClassCd\", " +
      "phc.record_status_cd \"recordStatusCd\", " +
      "phc.jurisdiction_cd \"jurisdictionCd\", " +
      "phc.status_cd \"statusCd\" " +
      "FROM participation par, person p, public_health_case phc " +
      "WHERE " +
      "p.person_uid = par.subject_entity_uid(+) " +
      "and par.act_uid = phc.public_health_case_uid(+) " +
      "and phc.investigation_status_cd IN ('O', 'C') " +
      "and phc.record_status_cd <> '" +
      NEDSSConstants.RECORD_STATUS_LOGICAL_DELETE + "' " +
      "and par.act_class_cd ='CASE' " +
      "and par.record_status_cd = 'ACTIVE' " +
      "and par.type_cd = 'SubjOfPHC' " +
  ...
  public static final String SELECT_WORKUP_ORACLE_IN =
      "select Public_health_case.investigation_status_cd \"investigationStatusCd\", "+
      "code1.code_short_desc_txt \"investigationStatusDescTxt\", " +
      "Public_health_case.local_id \"localId\", " +
      "Public_health_case.public_health_case_uid \"publicHealthCaseUid\", " +
  ...
  public static final String SELECT_NOTIFICATION_SQL =
      ...
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..Condition_code code1, " + " " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..code_value_general code2 " + " where " +
  ...
  public static final String SELECT_NOTIFICATION_ORACLE =
      "select Notification.notification_uid \"NotificationUid\", "+
      " Notification.add_time \"AddTime\",Notification.rpt_sent_time \"RptSentTime\", "+
      " Public_health_case.cd \"Cd\", "+
      " Public_health_case.case_class_cd \"CaseClassCd\", "+
      " cc.nnd_ind \"nndInd\" , " +
      " Notification.local_id \"LocalId\", Notification.txt \"Txt\" " +
      "from Public_health_case Public_health_case, act_relationship ar, nbs_srte.condition_code cc, "+
      " notification Notification " +
      "" +
       " where " +
      " Public_health_case.Public_health_case_uid = ar.target_act_uid " +
      ...
      "'  " + "and ar.status_cd = 'A' " +
      "and ar.source_act_uid  = Notification.notification_uid(+) " +
  ...
  public static final String SELECT_NOTIFICATION_FOR_INVESTIGATION_SQL =
      ...
      " from Public_health_case Public_health_case, act_relationship ar, nbs_srte..condition_code cc, "+
      " notification Notification  " +
      "LEFT JOIN Export_receiving_facility exportReceiving " +
  ...
  public static final String SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_SQL =
      ...
      " exportReceiving.receiving_system_nm recipient " +
      " from Public_health_case Public_health_case, act_relationship ar, nbs_srte..condition_code cc, "+
      " notification Notification, notification_hist notHist  " +
      "LEFT JOIN Export_receiving_facility exportReceiving " +
  ...
  public static final String SELECT_NOTIFICATION_FOR_INVESTIGATION_SQL1 =
     ...
     "  Notification.add_time AddTime, " +
      ...
      " inner join  act_relationship ar on " +
      " Public_health_case.Public_health_case_uid = ar.target_act_uid  " +
      " and ar.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "'" +
      " and ar.target_class_cd = 'CASE'  " +
      " inner join notification Notification on " +
      " Notification.notification_uid = ar.source_act_uid " +
      " inner join nbs_srte..condition_code cc on " +
  ...
  public static final String SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_SQL1 =
      ...
      " inner join nbs_srte..condition_code cc on " +
	  " Notification.case_condition_cd = cc.condition_cd " +
      " inner join notification_hist notHist on" +
  ...
  public static final String SELECT_NOTIFICATION_FOR_INVESTIGATION_ORACLE =
      "select Notification.notification_uid \"notificationUid\",  "+
      ...
      " cc.nnd_ind \"nndInd\" , " +
      "exportReceiving.receiving_system_nm \"recipient\" " +
      " from public_health_case phc, act_relationship ar, nbs_srte.condition_code cc, notification Notification " +
      "LEFT JOIN Export_receiving_facility exportReceiving " +
      " ON exportReceiving.export_receiving_facility_uid = Notification.export_receiving_facility_uid " +
      "where " +
      ...
      "and Notification.notification_uid = ar.source_act_uid " +
      "and Notification.case_condition_cd = cc.condition_cd " +
      " and Notification.record_status_cd <> '" +
      NEDSSConstants.RECORD_STATUS_LOGICAL_DELETE + "'" +
      "and phc.public_health_case_uid = ?";

  public static final String SELECT_NOTIFICATION_AUTO_RESEND_ORACLE = " " +
  ...
  public static final String SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_ORACLE =
      "select notHist.notification_uid \"notificationUid\","+
     " notHist.add_time \"addTime\", notHist.rpt_sent_time \"rptSentTime\", notHist.cd \"cdNotif\"," +
     " notHist.record_status_time \"recordStatusTime\", " +
      "notHist.case_condition_cd \"Cd\", "+
     " notHist.jurisdiction_cd \"jurisdictionCd\" , "+
     " notHist.program_jurisdiction_oid \"programJurisdictionOid\" , "+
      ...
      " cc.nnd_ind \"nndInd\" , " +
      " exportReceiving.receiving_system_nm \"recipient\" " +
      "from public_health_case phc, act_relationship ar, "+
      " notification Notification, nbs_srte.condition_code cc, notification_hist notHist " +
      "LEFT JOIN Export_receiving_facility exportReceiving " +
      " ON exportReceiving.export_receiving_facility_uid = notHist.export_receiving_facility_uid " +
      "where " +
      "phc.public_health_case_uid = ar.target_act_uid " +
  ...
  public static final String SELECT_NOTIFICATION_FOR_INVESTIGATION_ORACLE1 =
      "select Notification.notification_uid \"notificationUid\", "+
      " Notification.add_time \"addTime\", Notification.rpt_sent_time \"rptSentTime\", Notification.cd \"cdNotif\"," +
      " Notification.record_status_time \"recordStatusTime\", " +
      " Notification.case_class_cd \"CaseClassCd\","+
      " Notification.case_condition_cd \"Cd\", "+
      " Notification.jurisdiction_cd \"jurisdictionCd\" , "+
      ...
      " from Public_health_case Public_health_case,  act_relationship ar, nbs_srte.condition_code cc, " +
      " notification Notification  " +
      " LEFT OUTER JOIN Export_receiving_facility exportReceiving " +
      " ON exportReceiving.export_receiving_facility_uid = Notification.export_receiving_facility_uid " +
      " where    Public_health_case.Public_health_case_uid = ar.target_act_uid   " +
      " and ar.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "'" +
      " and ar.target_class_cd = 'CASE'   " +
      " and Notification.notification_uid = ar.source_act_uid  " +
      " and Notification.case_condition_cd = cc.condition_cd " +
  ...
  public static final String SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_ORACLE1 =
      " select notHist.notification_uid \"notificationUid\", "+
      " notHist.add_time \"addTime\", notHist.rpt_sent_time \"rptSentTime\", notHist.cd \"cdNotif\"," +
      " notHist.record_status_time \"recordStatusTime\", " +
      " notHist.case_class_cd \"CaseClassCd\","+
      ...
      " from Public_health_case Public_health_case,  act_relationship ar, " +
      " notification Notification, " +
      " nbs_srte.condition_code cc , notification_hist notHist " +
      " LEFT OUTER JOIN Export_receiving_facility exportReceiving " +
      " ON exportReceiving.export_receiving_facility_uid = notHist.export_receiving_facility_uid " +
      " where Public_health_case.Public_health_case_uid = ar.target_act_uid " +
  ...
  public static final String SELECT_MY_INVESTIGATIONS_SQL =
      "select " +
      "person.last_nm investigatorLastName, person.first_nm investigatorFirstName, person.local_id investigatorLocalId, "+
      ...
      "Public_health_case.jurisdiction_cd  jurisdictionCd, " +
      "ISNULL(person1.last_nm,'No Last') patientLastName, ISNULL(person1.first_nm,'No First') patientFirstName, person1.person_parent_uid MPRUid, " +
      ...
      DataTables.PUBLIC_HEALTH_CASE_TABLE +
      " LEFT OUTER JOIN   participation PAR121 ON "   +
      "PAR121.type_cd = 'InvestgrOfPHC' " +
      "and Public_health_case.Public_health_case_uid = PAR121.act_uid  "+
      " LEFT OUTER JOIN       person person ON " +
      "person.person_uid= PAR121.subject_entity_uid "  +
        "LEFT OUTER JOIN  participation PAR116 ON PAR116.type_cd = 'SubjOfPHC' "+
        "and Public_health_case.Public_health_case_uid = PAR116.act_uid   LEFT OUTER JOIN person person1 ON person1.person_uid= PAR116.subject_entity_uid "+
        //Support for Notification.Record_Status_Cd
        "LEFT OUTER JOIN  (Select source_act_uid,target_act_uid, type_cd from act_relationship ar, notification noti where ar.source_act_uid = noti.notification_uid and noti.cd='NOTF') "+
      ...
      "Notification AS Notification ON Notification.Notification_uid = ARNOTF.source_act_uid " +
  ...
  public static final String SELECT_MY_INVESTIGATIONS_ORACLE =
      "select /*+ FIRST_ROWS */ " +
      " person.last_nm \"investigatorLastName\", person.first_nm \"investigatorFirstName\", "+
      "person.local_id \"investigatorLocalId\", "+
      "Public_health_case.investigation_status_cd  \"investigationStatusCd\", " +
      "Public_health_case.local_id  \"localId\", " +
      "Public_health_case.activity_from_time \"activityFromTime\", " +
      "Public_health_case.cd  \"cd\", " +
      ...
      "Public_health_case.case_class_cd  \"caseClassCd\", " +
      "Public_health_case.jurisdiction_cd  \"jurisdictionCd\", " +
      "NVL(person1.last_nm, 'No Last') \"patientLastName\",    NVL(person1.first_nm, 'No First') \"patientFirstName\", person1.person_parent_uid \"MPRUid\", " +
      "Public_health_case.public_health_case_uid \"publicHealthCaseUid\", " +
      "Public_health_case.status_cd \"statusCd\", " +
      "Public_health_case.record_status_cd \"recordStatusCd\", " +
      "Notification.record_status_cd \"notifRecordStatusCd\" " +
      "from Public_health_case Public_health_case , person person, person person1, "+
      "Participation PAR121, Participation PAR116, "+
      "(Select source_act_uid,target_act_uid,type_cd from act_relationship ar, notification noti where ar.source_act_uid = noti.notification_uid and noti.cd='NOTF') ARNOTF, "
      +"Notification notification " +
      "where " +
      "Public_health_case.Public_health_case_uid = PAR121.act_uid(+) "+
      "and Public_health_case.Public_health_case_uid = PAR116.act_uid(+) "+
      "and Public_health_case.Public_health_case_uid = ARNOTF.target_act_uid(+) "+
      "and PAR121.subject_entity_uid=person.person_uid(+) "+
      "and PAR116.subject_entity_uid=person1.person_uid(+) "+
      "and ARNOTF.source_act_uid=notification.notification_uid(+) "+
      "and PAR121.type_cd(+) = 'InvestgrOfPHC' " +
      "and PAR116.type_cd(+) = 'SubjOfPHC' " +
      "and notification.cd(+) = 'NOTF' " +
      "and ARNOTF.type_cd(+) = 'Notification' and " ;
  ...
  public static final String SELECT_LAB_REPORTS_EVENT_SEARCH_SQL=
		  " SELECT  obs.observation_uid \"ObservationUid\", "
                  ...
                  + " and (obs.record_status_cd = 'PROCESSED')"  
                  + " and obs.ctrl_cd_display_form = 'LabReport' ";

  public static final String SELECT_LAB_REPORTS_EVENT_SEARCH_ORACLE=
		  " SELECT /*+ FIRST_ROWS */ obs.observation_uid \"ObservationUid\", "
				  + " obs.local_id \"LocalId\", "
				  + " obs.add_user_id \"AddUserId\", "
   		          + " obs.shared_ind \"sharedInd\", "
          		  + " OBS.electronic_ind \"electronicInd\", "
  ...
  public static final String SELECT_MY_INVESTIGATIONS_EVENT_SEARCH_SQL =
	  ...
	  public static final String SELECT_MY_INVESTIGATIONS_EVENT_SEARCH_ORACLE =
	      "select /*+ FIRST_ROWS */ " +
	      " person.last_nm \"investigatorLastName\", person.first_nm \"investigatorFirstName\", "+
	      "person.local_id \"investigatorLocalId\", "+
	      "person.person_uid \"investigatorUid\", "+
	      "Public_health_case.investigation_status_cd  \"investigationStatusCd\", " +
	      "Public_health_case.local_id  \"localId\", " +
	      "Public_health_case.activity_from_time \"activityFromTime\", " +
	      "Public_health_case.cd  \"cd\", " +
      ...
      "INNER JOIN Participation ON Intervention.intervention_uid = Participation.act_uid and Participation.subject_class_cd='PAT' and upper(Participation.type_cd)= 'SUBOFVACC' "+
      "LEFT OUTER JOIN   "+NEDSSConstants.SYSTEM_REFERENCE_TABLE+"..code_value_general code1   ON "+
      ...
      "FROM " +
      "Public_Health_Case phc inner join " +
      "Act_Relationship ar on "
      + "phc.public_health_case_uid = ar.target_act_uid "
      + "AND UPPER(ar.record_status_cd) = 'ACTIVE' "
  ...
  public static final String
      SELECT_MORB_OBSERVATION_SUMMARY_LIST_FOR_WORKUP_ORACLE =
      "select obs.observation_uid \"observationUid\", " +
      "obs.add_time \"addTime\", " +
      "obs.ctrl_cd_display_form \"ctrlCdDisplayForm\", " +
      "obs.local_id \"localId\", " +
      ...
      "code1.code_short_desc_txt \"morbidityReportTypeSRTText\", " +
      "code2.condition_desc_txt \"MorbidityConditionSRTText\" " +
      "from person p, participation par, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".code_value_general code1, observation obs, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".condition_code code2, obs_value_coded obsv, Obs_value_date obsd " +
      "where " +
      "p.person_uid = par.subject_entity_uid " +
      "and par.act_class_cd = '" + NEDSSConstants.PART_ACT_CLASS_CD + "' " +
      "and upper(par.record_status_cd) = '" +
      ...
      "and par.subject_class_cd = '" +
      NEDSSConstants.PAR_SUB_CLASS_CD + "' " +
      "and par.act_uid = obs.observation_uid " +
      "and obs.record_status_cd in('" +
      NEDSSConstants.OBS_PROCESSED + "'" +
      ") " +
      "and code2.condition_codeset_nm(+) = 'PHC_TYPE' " +
      "and obs.cd = code2.condition_cd(+) " +
      "and obs.observation_uid = obsv.observation_uid(+) " +
      "and obs.observation_uid = obsd.observation_uid(+) " +
      "and code1.code_set_nm = 'MORB_RPT_TYPE' " +
      "and obsv.code = code1.code(+) " +
      "and obs.ctrl_cd_display_form = 'MorbReport' " +
      "and p.person_uid = ? ";
  public static final String
      SELECT_MORB_OBSERVATION_SUMMARY_LIST_FOR_WORKUP_ORACLE_IN =
      "select obs.observation_uid \"observationUid\", " +
      "obs.add_time \"addTime\", " +
      "obs.ctrl_cd_display_form \"ctrlCdDisplayForm\", " +
      "obs.local_id \"localId\", " +
  ...
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_FOR_WORKUP_ORACLE =
      "select obs.observation_uid \"observationUid\", " +
      "obs.add_time \"addTime\", " +
      "obs.effective_from_time \"activityFromTime\", " +
      "obs.ctrl_cd_display_form \"ctrlCdDisplayForm\", " +
      ...
      "obs.record_status_cd \"recordStatusCd\" " +
//      "code1.nbs_test_desc_txt \"CdShortDescTxt\" " +
      "from person per, participation par, observation obs " +
//      NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".NBS_LAB_TEST code1 " +
...
//      "and obs.cd = code1.nbs_test_code(+) " +
      "and obs.ctrl_cd_display_form = 'LabReport' and per.person_uid = ?";
...
public static final String SELECT_LABSUMMARY_FORWORKUPNEW =
    ...
    "AND Participation.record_status_cd = 'ACTIVE' " +
    "AND person_parent_uid = ?";
  public static final String SELECT_LABRESULTED_REFLEXTEST_SUMMARY_FORWORKUP_ORA =
	"SELECT  /*+ FIRST_ROWS */  "+
  ...
  public static final String
      SELECT_MORB_OBSERVATION_SUMMARY_LIST_FOR_INVESTIGATION_ORACLE =
      "select ar.source_act_uid \"observationUid\", " +
      "obs.add_time \"addTime\", " +
      "obs.ctrl_cd_display_form \"ctrlCdDisplayForm\", " +
      "obs.local_id \"localId\", " +
      ...
      "from public_health_case phc, " + "act_relationship ar, " +
      "observation obs,  Obs_value_coded obsv ," +
      " Obs_value_date obsd ," + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".code_value_general code1," + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".condition_code code2 " +
      "where phc.public_health_case_uid = ? " +
      ...
      "and ar.source_class_cd ='OBS' " +
      "and ar.target_class_cd ='CASE' " +
      "and obs.observation_uid = ar.source_act_uid " +
      "and obs.cd = code2.condition_cd(+) " +
      "and obsv.observation_uid(+) = obs.observation_uid " +
      "and obsd.observation_uid(+) = obs.observation_uid " +
      "and code1.code_set_nm(+) = 'MORB_RPT_TYPE' " +
      "and obsv.code = code1.code(+) ";
  public static final String
      ...
      ".public_health_case_uid = ? ";
  public static final String
      SELECT_OBSERVATION_SUMMARY_LIST_FOR_INVESTIGATION_ORACLE =
      "select ar.source_act_uid \"ObservationUid\", " +
      "obs.add_time \"AddTime\", " +
      "obs.effective_from_time \"ActivityFromTime\", " +
      "obs.ctrl_cd_display_form \"CtrlCdDisplayForm\", " +
...
//      ".code_value_general code1 " +
      ...
      "and ar.type_cd in ('LabReport') " +
      "and obs.observation_uid = ar.source_act_uid " ;
//      "and code1.code_set_nm(+) = 'AR_TYPE' " +
//      "and ar.type_cd = code1.code(+) ";
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_FOR_MANAGE_SQL =
      ...
      " and phc.public_health_case_uid = ? ";
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_FOR_MANAGE_ORACLE =
      "select ar.source_act_uid \"ObservationUid\", " +
      "obs.add_time \"AddTime\", " +
      "obs.effective_from_time \"ActivityFromTime\", " +
      "obs.ctrl_cd_display_form \"CtrlCdDisplayForm\", " +
...
//      ".code_value_general code1 " +
      ...
      "and upper(ar.record_status_cd) = 'ACTIVE' " +
      "and ar.status_cd = 'A' " + "and ar.type_cd = 'LabReport' " +
      "and ar.source_class_cd='OBS' " + "and ar.target_class_cd='CASE' " +
      "and obs.observation_uid = ar.source_act_uid " +
 //     "and code1.code_set_nm (+)= 'AR_TYPE' " ;
//      "and  ar.type_cd = code1.code(+) " +
      "and phc.public_health_case_uid = ? ";
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_FOR_MANAGE1_SQL =
      ...
      "') " +
      "where obs.ctrl_cd_display_form = 'LabReport' and per.person_uid = ? ";
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_FOR_MANAGE1_ORACLE =
      "select obs.observation_uid \"ObservationUid\", " +
      "obs.add_time \"AddTime\", " +
      "obs.effective_from_time \"ActivityFromTime\", " +
      "obs.ctrl_cd_display_form \"CtrlCdDisplayForm\", " +
      ...
      "obs.cd \"Cd\", " + "par.type_cd \"ParTypeCd\", " +
      "par.record_status_cd \"RecordStatusCd\" " + "from person per, " +
      "participation par, " + "observation obs " +
      "where par.subject_entity_uid(+) = per.person_uid " +
      "and par.act_class_cd = 'OBS' " +
      "and par.subject_class_cd = 'PSN' " +
      "and upper(par.record_status_cd) = 'ACTIVE' " +
      "and par.type_cd = 'PATSBJ' " +
      "and obs.observation_uid = par.act_uid " +
      "and obs.record_status_cd IN ('" +
      NEDSSConstants.OBS_PROCESSED + "','" + NEDSSConstants.OBS_UNPROCESSED +
      "') " +
      "and per.person_uid = ?";
  ...
  public static final String SELECT_MORB_OBSERVATION_SUMMARY_PART1_ORACLE =
      "SELECT obs.add_time \"AddTime\", " +
      "'Y' AS \"IsAssociated\", " +
      "obsd.from_time \"FromTime\", " +
      "code1.code_desc_txt \"MorbidityReportType\", " +
      ...
      "code2.condition_desc_txt \"MorbidityConditionSRTText\", " +
      "phc.cd \"MorbidityCondition\" " +
      "FROM public_health_case phc, act_relationship act, observation obs, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".condition_code code2, " +
      "Obs_value_coded obsv, Obs_value_date obsd, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general code1 " +
      "WHERE " +
      "phc.public_health_case_uid = ? " +
      "and obs.cd = code2.condition_cd(+) " +
      "and code2.condition_codeset_nm = 'PHC_TYPE' " +
      "and phc.public_health_case_uid = act.target_act_uid " +
      "and obs.observation_uid = obsv.observation_uid(+) " +
      "and obs.observation_uid = obsd.observation_uid(+) " +
      "and code1.code_set_nm = 'MORB_RPT_TYPE' and  obsv.code = code1.code(+) " +
      "and act.source_class_cd = 'OBS' " +
      "and act.target_class_cd = 'CASE' " +
      "and obs.observation_uid = act.source_act_uid " +
      "and upper(obs.ctrl_cd_display_form)= 'MORBREPORT' " +
      "and (obs.record_status_cd IN ('" +
      NEDSSConstants.OBS_PROCESSED + "')) ";

  public static final String SELECT_MORB_OBSERVATION_SUMMARY_PART2_ORACLE =
      "SELECT obs.add_time \"AddTime\", " +
      "'N' AS \"IsAssociated\", " +
      "obsd.from_time \"FromTime\", " +
      "code1.code_desc_txt \"MorbidityReportType\", " +
      ...
      "code2.condition_desc_txt \"MorbidityConditionSRTText\", " +
      "phc.cd \"MorbidityCondition\" " +
      "FROM Observation obs, act_relationship act, public_health_case phc, "+
      " participation par, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".condition_code code2, Obs_value_coded obsv, Obs_value_date obsd, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".code_value_general code1 " +
  ...
  public static final String
      SELECT_MORB_OBSERVATION_SUMMARY_LIST_FOR_MANAGE_ORACLE =
      "SELECT obs.add_time \"AddTime\", " +
      "'Y' AS \"IsAssociated\", " +
      "obsd.from_time \"FromTime\", " +
      "code1.code_desc_txt \"MorbidityReportType\", " +
  ...
  public static final String NOTIFICATIONS_FOR_APPROVAL_SQL =
      "select " + "Notification.add_time \"addTime\", " +
      "Notification.add_user_id \"addUserId\", " +
      "Notification.txt \"txt\", " +
      "Notification.cd \"notificationCd\", " +
      "Notification.notification_uid \"notificationUid\", " +
      "Notification.local_id \"localId\", " +
      "Public_health_case.local_id \"publicHealthCaseLocalId\", " +
      "Public_health_case.cd \"cd\", " +
      "code1.condition_desc_txt \"CdTxt\", " +
      "code1.nnd_ind \"nndInd\" , " +
      "Public_health_case.case_class_cd \"caseClassCd\", " +
      "code2.code_short_desc_txt \"CaseClassCdTxt\" , " +
      "Notification.jurisdiction_cd \"jurisdictionCd\", " +
      "code3.code_desc_txt \"jurisdictionCdTxt\" , " +
      "Public_health_case.public_health_case_uid \"publicHealthCaseUid\", " +
      ...
      "per.birth_time_calc \"birthTimeCalc\" ," +
      "exportReceiving.receiving_system_nm \"recipient\" " +
      "from " + DataTables.NOTIFICATION_TABLE + " Notification " +
      "INNER JOIN " + DataTables.ACT_RELATIONSHIP + " act " +
      ...
      "INNER JOIN " + DataTables.PARTICIPATION_TABLE + " par " +
      "ON par.act_uid = Public_health_case.public_health_case_uid " +
      "INNER JOIN " + DataTables.PERSON_TABLE + " per " +
      "ON per.person_uid = par.subject_entity_uid " +
      "LEFT JOIN "+ DataTables.EXPORT_RECEIVING_FACILITY +
      " exportReceiving "+
      "ON exportReceiving.export_receiving_facility_uid = Notification.export_receiving_facility_uid "+
      "LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..condition_code code1 " +
      ...
      "LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..code_value_general code2 " +
      "ON code2.code_set_nm = 'PHC_CLASS' "+
      " and Public_health_case.case_class_cd = code2.code " +
      "LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..Jurisdiction_code code3 " +
  ...
  public static final String NOTIFICATIONS_FOR_APPROVAL_ORACLE =
      "select /*+ FIRST_ROWS */ " + "Notification.add_time \"addTime\", " +
      "Notification.add_user_id \"addUserId\", " +
      "Notification.txt \"txt\", " +
      "Notification.cd \"notificationCd\", " +
      "Notification.notification_uid \"notificationUid\", " +
      ...
      "code3.code_desc_txt \"jurisdictionCdTxt\" , " +
      "Public_health_case.public_health_case_uid \"publicHealthCaseUid\", " +
      "NVL(per.last_nm, 'No Last') \"lastNm\",    NVL(per.first_nm, 'No First') \"firstNm\"," +
      "per.curr_sex_cd \"currSexCd\", " +
      "per.person_parent_uid \"MPRUid\", " +
      "per.birth_time_calc \"birthTimeCalc\"," +
      "exportReceiving.receiving_system_nm \"recipient\" " +
      "from " + DataTables.NOTIFICATION_TABLE + " Notification, " +
      DataTables.ACT_RELATIONSHIP + " act, " +
      DataTables.PUBLIC_HEALTH_CASE_TABLE +" Public_health_case, " +
      DataTables.PARTICIPATION_TABLE + " par, " +
      DataTables.PERSON_TABLE + " per ," +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".condition_code code1, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".code_value_general code2, " +
      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      ".Jurisdiction_code code3 ," +
      DataTables.EXPORT_RECEIVING_FACILITY +" exportReceiving "+
      " WHERE Notification.notification_uid = act.source_act_uid " +
      " and act.target_act_uid = Public_health_case.public_health_case_uid " +
     // " and  code1.CONDITION_CODESET_NM(+) = 'PHC_TYPE' " +
      " AND Public_health_case.public_health_case_uid = par.act_uid  " +
      "AND exportReceiving.export_receiving_facility_uid (+) = Notification.export_receiving_facility_uid " +
      " AND par.subject_entity_uid = per.person_uid " +
      "AND Public_health_case.cd = code1.condition_cd (+) " +
      //?         " and code1.seq_num = " + NEDSSConstants.STATE + " " +
     " and code2.code_set_nm(+) = 'PHC_CLASS' "+
     " and Public_health_case.case_class_cd = code2.code(+) " +
      //?         " and code3.code_set_nm(+)= 'S_JURDIC_C'
      " and Notification.jurisdiction_cd = code3.code(+) " +
      " and '" + NEDSSConstants.NOTIFICATION_PENDING_CODE +"' = Notification.record_status_cd " +
      " and '" + NEDSSConstants.ACT106_TYP_CD +"' = act.type_cd " +
      " AND '" + NEDSSConstants.PHC_PATIENT +"' = par.type_cd " +
      " AND par.act_uid = act.target_act_uid ";
  ...
  public static final String SELECT_COUNT_OF_NOTIFICATIONS_FOR_APPROVAL_SQL_REVISITED =
      "select count(*) from " +
      DataTables.NOTIFICATION_TABLE + " Notification  " +
      "INNER JOIN " + DataTables.ACT_RELATIONSHIP + " act " +
      "ON  act.source_act_uid = Notification.notification_uid " +
      "INNER JOIN " +
      DataTables.PUBLIC_HEALTH_CASE_TABLE + " Public_health_case " +
  ...
  public static final String SELECT_COUNT_OF_NOTIFICATIONS_FOR_APPROVAL_ORACLE_REVISITED =
      "select /*+ USE_NL(ACT,NOTIFICATION) */ count(*) from " +
      DataTables.PUBLIC_HEALTH_CASE_TABLE + " Public_health_case, " +
      DataTables.NOTIFICATION_TABLE + " Notification,  " +
      DataTables.ACT_RELATIONSHIP + " act " +
      ...
      "AND act.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "' "+
      "AND act.target_act_uid = Public_health_case.public_health_case_uid + 0 "+
      "AND act.source_act_uid = Notification.notification_uid + 0 ";
    ...
    public static final String SELECT_COUNT_OF_UPDATED_NOTIFICATIONS_FOR_APPROVAL_SQL_REVISITED =
        "select count(*) from nbs_odse..updated_notification " +
        "INNER JOIN "
        + DataTables.NOTIFICATION_TABLE + " " + " on " +
        ...
        "and " +
        "Public_health_case.record_status_cd <> '" +
        NEDSSConstants.RECORD_STATUS_LOGICAL_DELETE + "' " +
        "AND act.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "' ";


    public static final String SELECT_COUNT_OF_UPDATED_NOTIFICATIONS_FOR_APPROVAL_ORACLE_REVISITED =
        "select /*+ USE_NL(ACT,NOTIFICATION,UPDATED_NOTIFICATION) */ count(*) "+
        "FROM Public_Health_Case Public_health_case, "+
        "updated_notification, Notification, " + DataTables.ACT_RELATIONSHIP + " act " +
        "WHERE updated_notification.status_cd = 'A' "+
        "and Public_health_case.record_status_cd <> '" +
        NEDSSConstants.RECORD_STATUS_LOGICAL_DELETE + "' " +
        "AND act.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "' "+
        "AND act.target_act_uid = Public_health_case.public_health_case_uid + 0 "+
        "AND act.source_act_uid = Notification.notification_uid + 0 "+
        "AND notification.notification_uid = updated_notification.notification_uid + 0 ";
 ...
 /* public static final String SELECT_OBSERVATION_SUMMARY_LIST_ORACLE =
      "select obs.observation_uid \"ObservationUid\"," +
      " obs.add_time \"AddTime\"," +
      " obs.effective_from_time \"ActivityFromTime\"," +
      " obs.cd_desc_txt \"CdDescTxt\"," + " obs.local_id \"LocalId\"," +
      ...
      " par.type_cd \"ParTypeCd\"," +
      " par.record_status_cd \"RecordStatusCd\"," +
      " ar.target_act_uid \"TargetActUid\"," + " ar.type_cd \"TypeCd\" " +
//      " code1.code_short_desc_txt \"CdShortDescTxt\"" +
      " from person per, participation par, observation obs," +
      " act_relationship ar " +
//      NEDSSConstants.SYSTEM_REFERENCE_TABLE +
...
//      " and ar.type_cd = code1.code(+)" +
      " and per.person_uid = ?";
  public static final String SELECT_OBSERVATION_SUMMARY_LIST_SQL =
      "select distinct obs.observation_uid \"ObservationUid\", " +
      "obs.add_time \"AddTime\", " +
      "obs.effective_from_time \"ActivityFromTime\", " +
      "obs.cd_desc_txt \"CdDescTxt\", " +
      "obs.ctrl_cd_display_form \"CtrlCdDisplayForm\", " +
      "obs.local_id \"LocalId\", " + "par.type_cd \"ParTypeCd\", " +
      "ar.record_status_cd \"RecordStatusCd\", " +
      "ar.type_cd \"TypeCd\", " +
      "convert( varchar(20), ar.target_act_uid)  \"TargetActUid\", " +
      "code1.code_short_desc_txt \"CdShortDescTxt\" " +
      "from person per " +
      "INNER  JOIN  participation par on per.person_uid = par.subject_entity_uid " +
      "and par.status_cd='A' " +
      "and par.type_cd in ('SubjOfLabGen', 'SubjOfGenObs') " +
      "INNER  JOIN observation obs ON par.act_uid = obs.observation_uid " +
      "LEFT OUTER JOIN act_relationship ar ON obs.observation_uid = ar.source_act_uid " +
      "LEFT OUTER JOIN " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +
      "..code_value_general code1 ON " +
      "code1.code_set_nm = 'AR_TYPE'  and  ar.type_cd = code1.code " +
      "where per.person_uid = ? "; */
  /*public static final String SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP_ORACLE =
      "select per.person_uid \"personUid\", " +
      "Intervention.intervention_uid \"interventionUid\", " +
      "par2.type_cd \"par2TypeCd\", " + "mt.nm \"vaccineNameCode\", " +
      "Intervention.local_id \"localId\", " +
      "Intervention.activity_from_time \"activityFromTime\", " +
      "par.record_status_cd \"recordStatusCd\", " +
      "par.type_cd \"parTypeCd\", " + "mt.material_uid \"materialUid\" " +
  //    "code1.code_short_desc_txt \"VaccineAdministered\" " +
      "from " +
 //     NEDSSConstants.SYSTEM_REFERENCE_TABLE +
 //     ".code_value_general code1, " +
      "person per, participation par, intervention Intervention, "+
      " participation par2, material mt " +
      "where " + "per.person_uid = par.subject_entity_uid " +
      "and par.type_cd = '" + NEDSSConstants.SUBJECT_OF_VACCINE +
      "' " + "and upper(par.record_status_cd) = 'ACTIVE' " +
      "and par.subject_class_cd = 'PSN' " +
      "and par.act_uid = Intervention.intervention_uid " +
      "and Intervention.intervention_uid = par2.act_uid " +
      "and par2.record_status_cd='ACTIVE' " +
      "and upper(par2.type_cd) = 'VACCGIVEN' " +
      "and par2.act_class_cd = 'INTV' " +
      "and par2.subject_entity_uid =  mt.material_uid " +
   //   "and code1.code_set_nm(+) = 'VAC_NM' and mt.nm = code1.code(+) " +
      "and Intervention.record_status_cd= 'ACTIVE' " +
      "and per.person_parent_uid = ?";*/
  
  public static final String SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP_ORACLE_IN =
	  " SELECT per.person_uid \"PersonUid\", "+
	  " Intervention.intervention_uid \"InterventionUid\", par2.type_cd \"par2TypeCd\", "+
	  " Intervention.add_time \"createDate\", "+ 
	  " Intervention.material_cd \"Nm\", Intervention.local_id \"LocalId\", "+
	  " Intervention.activity_from_time \"ActivityFromTime\", "+
	  " Intervention.effective_from_time \"EffectiveFromTime\", "+
	  " par.record_status_cd  \"RecordStatusCd\", "+
	  " par.type_cd \"TypeCd\", "+ 
	  ...
	  " AND par.subject_class_cd = 'PAT' INNER JOIN Intervention Intervention "+
	  " ON par.act_uid = Intervention.intervention_uid "+
	  " AND Intervention.record_status_cd = 'ACTIVE' INNER JOIN "+
	  " Participation par2 ON Intervention.intervention_uid = par2.act_uid "+
	  " AND par2.record_status_cd = 'ACTIVE' "+ 
	  " AND (upper(par2.type_cd)= 'SUBOFVACC' OR upper(par2.type_cd)='VACCGIVEN')  AND par2.act_class_cd = 'INTV' "+
	  " LEFT OUTER JOIN "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE +".Code_value_general code1 "+
  ...
  public static final String SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP =
      ...
      " on per.person_uid = par.subject_entity_uid " +
      " and par.type_cd= 'SubOfVacc' and par.record_status_cd = 'ACTIVE' " +
      " and par.subject_class_cd = 'PAT'  Inner  JOIN intervention Intervention ON " +
  ...
  public static final String SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP_SQL_IN =
	  ...
	  " FROM Person AS per INNER JOIN Participation AS par "+
	  " ON per.person_uid = par.subject_entity_uid "+
	  " AND par.type_cd = 'SubOfVacc' AND par.record_status_cd = 'ACTIVE' "+ 
	  " AND par.subject_class_cd = 'PAT' INNER JOIN Intervention AS Intervention "+
	  " ON par.act_uid = Intervention.intervention_uid "+
	  " AND Intervention.record_status_cd = 'ACTIVE' INNER JOIN "+
	  " Participation AS par2 ON Intervention.intervention_uid = par2.act_uid "+
	  " AND par2.record_status_cd = 'ACTIVE' "+ 
	  " AND (upper(par2.type_cd)= 'SubOfVacc'  OR upper(par2.type_cd)='VaccGiven')  AND par2.act_class_cd = 'INTV' "+
	  " LEFT OUTER JOIN "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE +"..Code_value_general AS code1 "+
	  " ON Intervention.material_cd = code1.code AND code1.code_set_nm = 'VAC_NM' "+
	  " WHERE  (Intervention.record_status_cd = 'ACTIVE') AND per.person_parent_uid IN ";

  public static final String GET_ASSOCIATED_VACCINE_RECORDS =
      "SELECT COUNT(*) FROM Act_relationship WHERE type_cd = '1180' "+
      " AND record_status_cd = 'ACTIVE' AND source_act_uid = ?";
  public static final String GET_ASSOCIATED_TREATMENT_RECORDS =
	      "SELECT COUNT(*) FROM Act_relationship WHERE type_cd = 'TreatmentToPHC' "+
	      " AND record_status_cd = 'ACTIVE' AND source_act_uid = ?";
  ...
  public static final String ASSOC_MORB_COUNT_ORACLE =
  ...
  public static final String SELECT_TREATMENT_SUMMARY_LIST_FOR_WORKUP_ORACLE =
     ...
     "FROM  "+ DataTables.TREATMENT_TABLE +", treatment_administered treatment_administered " + " WHERE Treatment.Treatment_uid in " +
    "(SELECT act_uid FROM Participation WHERE Participation.subject_entity_uid in (select person_uid from person where "+
  ...
  public static final String SELECT_TREATMENT_SUMMARY_LIST_FOR_WORKUP_ORACLE_IN =
      ...
      "FROM " +    DataTables.PERSON_TABLE + " per, " +
                   DataTables.PARTICIPATION_TABLE + " par, " +
                   DataTables.ACT_RELATIONSHIP + " ar, " +
  ...
  public static final String TREATMENTS_FOR_A_PHC_ORACLE =
      ...
      "Treatment.activity_from_time \"activityFromTime\",  " +
      "Treatment.local_id \"localId\" " +
      "FROM " +     DataTables.PUBLIC_HEALTH_CASE_TABLE + " phc, " +
                    DataTables.ACT_RELATIONSHIP + " ar, " +
                    DataTables.TREATMENT_TABLE + " Treatment, " +
                    DataTables.PARTICIPATION_TABLE + " par " +
  ...
  public static final String TREATMENTS_FOR_A_PHC_SQL =
      "SELECT       phc.public_health_case_uid phcUid, " +
      "Treatment.treatment_uid treatmentUid, " +
      "Treatment.activity_from_time activityFromTime, " +
      "Treatment.local_id localId, " +
      ...
      "WHERE        phc.public_health_case_uid = ar.target_act_uid " +
      "AND          UPPER(ar.record_status_cd) = 'ACTIVE' " +
      "AND          ar.type_cd = '" + NEDSSConstants.SUBJECT_OF_TREATMENT +"' " +
      "AND          ar.source_class_cd = '" + NEDSSConstants.TREATMENT_CLASS_CODE + "' " +
      "AND          ar.target_class_cd = '" + NEDSSConstants.PUBLIC_HEALTH_CASE_CLASS_CODE + "' " +
      "AND          Treatment.treatment_uid = ar.source_act_uid " +
      "AND          par.act_uid =  Treatment.treatment_uid " +
  ...
  public static final String SELECT_MORBSUMMARY_FORWORKUP =
          ...
          " record_status_cd \"recordStatusCd\" " +
          " from observation where observation_uid = ?";
  ...
  public static final String SELECT_OBSERVATIONMORBUIDS_FOR_WORKUP_IN =
     ...
     public static final String SELECT_OBSERVATIONMORBUIDS_FOR_SUMMARY_WORKUP_IN =
      ...
      public static final String REVERSE_TRANS_LABID_LABTEXTDESCTXT_PA_CONDDESCTXT_ORACLE = "SELECT lab_test_cd  \"str1\" FROM " +
     ...
     public static final String GET_SOURCE_ACT_UID_FOR_SUSCEPTIBILITES_SQL = "SELECT distinct " +
                ...
                "AND (act.record_status_cd = 'ACTIVE') " +
                "AND (act.TARGET_ACT_UID = ?) )";
     public static final String GET_SOURCE_ACT_UID_FOR_SUSCEPTIBILITES_ORA = "SELECT /*+ FIRST_ROWS */ " +
                 "act.source_act_uid \"uid\" " +
                 "FROM " +
                 "act_relationship act " +
                 "WHERE ( (act.target_class_cd = 'OBS') " +
  ...
  " AND act.TARGET_ACT_UID in ("+GET_SOURCE_ACT_UID_FOR_SUSCEPTIBILITES_SQL+")";
   ...
   public static final String SELECT_LABSUSCEPTIBILITES_REFLEXTEST_SUMMARY_FORWORKUP_ORACLE =
	"SELECT  /*+ FIRST_ROWS */ " +
   "obs.observation_uid \"observationUid\" ," +
  ...
  "FROM observation obs, observation obs1, " +
  " act_relationship act, " +
  "     obs_value_numeric obsnumeric, " +
  " obs_value_coded obsvaluecoded  " +
  "WHERE " +
  "                    act.target_act_uid = obs.observation_uid" +
  " AND act.source_act_uid = obs1.observation_uid  " +
  " AND obsnumeric.observation_uid (+)= obs1.observation_uid" +
  ...
  " AND act.TARGET_ACT_UID = ? ";
   ...
   public static final String SELECT_LABSUSCEPTIBILITES_REFLEXTEST_SUMMARY_FORWORKUP_ORACLE_DRRQ =
		   "SELECT  /*+ FIRST_ROWS */   " +
		   "obs.observation_uid \"observationUid\" ," +
		    "                 obs.ctrl_Cd_User_Defined_1 \"ctrlCdUserDefined1\", " +
		    "                 act.source_act_uid \"sourceActUid\",  " +
		  ...
		  " AND act.source_class_cd = 'OBS' " +
		  " AND act.record_status_cd = 'ACTIVE'" +
		  " AND act.TARGET_ACT_UID in ("+GET_SOURCE_ACT_UID_FOR_SUSCEPTIBILITES_ORA+")";
...
public static final String SELECT_COUNT_OF_REJECTED_NOTIFICATIONS_FOR_APPROVAL_SQL_REVISITED =
    "SELECT count(*) FROM Act_relationship, Public_health_case, Notification " +
    "where Act_relationship.target_act_uid =   Public_health_case.public_health_case_uid " +
    "and Act_relationship.source_act_uid =   Notification.notification_uid " +
    "and Notification.record_status_cd = 'REJECTED' " +
    "and (getdate() -Notification.LAST_CHG_TIME) < ";
public static final String REJECTED_NOTIFICATIONS_ORACLE = "SELECT  /*+ FIRST_ROWS */  Public_health_case.public_health_case_uid \"publicHealthCaseUid\",  " +
" Public_health_case.cd \"conditionCode\",   " +
" NVL(Person_name.first_nm, 'No First') \"firstName\", NVL(Person_name.last_nm, 'No Last') \"lastName\", "+
...
"                         Notification.add_time \"addTime\",   Person.person_parent_uid \"patientUid\", " +
" ccode.nnd_ind \"nndInd\" , " +
"exportReceiving.receiving_system_nm \"recipient\", " +
"                       Notification.add_user_id \"addUserId\", ccode.condition_short_nm \"condition\" " +
" FROM                   Person_name, Person, Participation, Act_relationship, Public_health_case,  nbs_srte.condition_code ccode, Notification " +
...
" ccode.nnd_ind \"nndInd\" , " +
"exportReceiving.receiving_system_nm \"recipient\" " +
" FROM                       Person p  Left outer join   Person_name pnm on p.person_uid=pnm.person_uid ,Participation, Act_relationship, Public_health_case, nbs_srte..condition_code ccode,Notification " +
"LEFT OUTER JOIN  EXPORT_RECEIVING_FACILITY"+
" exportReceiving "+
"ON exportReceiving.export_receiving_facility_uid = Notification.export_receiving_facility_uid "+
...
public static final String PAM_QUESTION_OID_METADATA_ORACLE = "SELECT "
    + "NBS_UI_METADATA.nbs_question_uid \"nbsQuestionUid\", "
    + "NBS_UI_METADATA.add_time \"addTime\", "
    + "NBS_UI_METADATA.add_user_id \"addUserId\", "
    + "NBS_UI_METADATA.code_set_group_id \"codeSetGroupId\", "
    ...
    + "NBS_UI_METADATA.last_chg_time \"lastChgTime\", "
    + "NBS_UI_METADATA.last_chg_user_id \"lastChgUserId\", "
    + "NBS_UI_Metadata.question_label \"questionLabel\", "
    + "NBS_UI_Metadata.question_tool_tip \"questionToolTip\", "
    + "NBS_UI_METADATA.version_ctrl_nbr \"questionVersionNbr\", "
    + "NBS_UI_METADATA.tab_order_id \"tabId\", "
    + "NBS_UI_METADATA.enable_ind \"enableInd\", "
    + "NBS_UI_METADATA.order_nbr \"orderNbr\", "
...
public static final String RULES_METADATA_ORACLE = "SELECT "
     + "R.rule_uid \"ruleUid\", "
     + "R.rule_name \"ruleName\", "
     + "R.comments \"ruleComment\", "
     + "RI.rule_instance_uid \"ruleInstanceUid\", "
...
public static final String RULES_METADATA_SOURCE_ORACLE="SELECT "
    + "SF.source_field_uid \"sourceFieldUid\", "
    + "SF.rule_instance_uid \"ruleInstanceUid\", "
    + "SF.source_field_seq_nbr \"sourceFieldSeqNbr\", "
    + "NMR.component_identifier \"questionIdentifier\", "
...
public static final String RULES_METADATA_SOURCE_VALUE_ORACLE="SELECT "
    + "SV.source_field_uid \"sourceFieldUid\", "
    + "SV.source_value \"sourceValue\", "
    + "OT.operator_type_code \"operatorTypeCode\" "
    + "FROM "
...
public static final String RULES_METADATA_TARGET_ORACLE = "SELECT "
    + "TF.target_field_uid \"targetFieldUid\", "
    + "TF.rule_instance_uid \"ruleInstanceUid\", "
    + "NMR.component_identifier \"questionIdentifier\", "
    + "NQ.question_label \"questionLabel\" "
    + "FROM "
    + "Target_Field TF, NBS_Metadata_Rule NMR, NBS_Question NQ "
    + "WHERE "
    + "TF.nbs_metadata_rule_uid =  NMR.nbs_metadata_rule_uid "
    + "AND "
    + "NMR.component_uid = NQ.nbs_question_uid ";
...
public static final String RULES_METADATA_TARGET_VALUE_ORACLE="SELECT "
     + "TV.target_value_uid \"targetValueUid\", "
     + "TV.target_field_uid \"targetFieldUid\", "
     + "TV.target_value \"targetValue\", "
     + "CI.conseq_ind_code \"conseqIndCode\", "
     ...
     + "FROM "
     + "Target_Value TV "
     + "JOIN Target_Field TF ON "
     + "TV.target_field_uid = TF.target_field_uid "
     + "JOIN consequence_indicator CI ON "
     + "TV.conseq_ind_uid = CI.conseq_ind_uid "
     + "JOIN Error_Message EM ON "
     + "TV.error_message_uid = EM.error_message_uid "
     + "JOIN operator_type OT ON "
     + "OT.operator_type_uid = TV.operator_type_uid";
...
public static final String RULES_LIST_ORACLE = "SELECT distinct "
    + "R.rule_uid ruleUid, "
    + "R.rule_name ruleName "
    + "FROM "
    + "rule R "
...
public static final String RULES_INSTANCES_LIST_ORACLE = "SELECT distinct "
    + "C.rule_instance_uid \"ruleInstanceUid\", "
    + "A.rule_name \"ruleName\", "
    + "B.conseq_ind_desc_txt \"conseqIndtxt\", "
    + "C.comments \"comments\", "
...
public static final String SOURCE_FIELDS_LIST_ORACLE = "SELECT distinct "
    + "C.source_field_uid \"sourceFieldUid\","
    + "A.question_label \"questionLabel\", "
    + "A.question_identifier \"questionIdentifier\" "
    + "FROM "
    + "nbs_question A,source_field C,nbs_ui_metadata D";
...
public static final String TARGET_FIELDS_LIST_ORACLE = "SELECT distinct "
    + "C.target_field_uid \"targetFieldUid\","
    + "A.question_label \"questionLabel\", "
    + "A.question_identifier \"questionIdentifier\" "
    + "FROM "
...
public static final String SOURCE_VALUES_LIST_ORACLE = "SELECT distinct "
    + "A.source_value_uid \"sourceValueUid\", "
    + "A.source_field_uid \"sourceFieldUid\", "
    + "A.source_value \"sourceValue\", "
    + "B.operator_type_desc_txt \"operatorTypeDesc\" "
...
public static final String TARGET_VALUES_LIST_ORACLE = "SELECT distinct "
    + "A.target_value_uid \"targetValueUid\", "
    + "A.target_field_uid \"targetFieldUid\", "
    + "A.target_value \"targetValue\", "
    + "B.error_desc_txt errorDescTxt, "
    ...
    + "D.operator_type_desc_txt \"operatorTypeDesc\" "
    + "FROM "
    + "source_value A,error_message B,consequence_indicator C,operator_type D ";
...
public static final String CONSEQ_IND_LIST_ORACLE = "SELECT distinct "
    + "conseq_ind_uid \"conseqIndUID\", "
    + "conseq_ind_desc_txt \"conseqIndtxt\" "
    + "FROM "
    + "consequence_indicator order by conseq_ind_desc_txt ";
...
public static final String ERR_MESSAGE_LIST_ORACLE = "SELECT distinct "
    + "error_message_uid \"errMessageUID\", "
    + "error_cd \"errMessagetxt\" "
    + "FROM "
    + " error_message order  by error_cd ";
...
public static final String OPERATOR_TYPE_LIST_ORACLE = "SELECT distinct "
    + "operator_type_uid \"opTypeUID\", "
    + "operator_type_desc_txt \"opTypetxt\" "
    + "FROM "
    + "from error_message order  by error_cd ";
...
public static final String PAM_LABELS_LIST_ORACLE = "SELECT distinct "
    + "A.nbs_metadata_rule_uid \"nbsMetadataRuleUID\", "
    + "C.question_label \"pamLabeltxt\", "
    + "A.component_identifier \"pamIdentifiertxt\" "
    + "FROM "
...
public static final String DELETE_SOURCE_VALUE_ORACLE = "delete source_value where source_field_uid "
...
public static final String DELETE_TARGET_VALUE_ORACLE ="delete target_value "
...
public static final String DELETE_SOURCE_FIELD_ORACLE = "delete source_field where rule_instance_uid in "
    +"(select rule_instance_uid from rule_instance where rule_instance_uid = ?)";

public static final String DELETE_SOURCE_FIELD_SQL = "delete source_field where rule_instance_uid in "
    +"(select rule_instance_uid from rule_instance where rule_instance_uid = ?)";

public static final String DELETE_TARGET_FIELD_ORACLE =  "delete target_field where rule_instance_uid in "
    +"(select rule_instance_uid from rule_instance where rule_instance_uid = ?)";

public static final String DELETE_TARGET_FIELD_SQL = "delete target_field where rule_instance_uid in "
    +"(select rule_instance_uid from rule_instance where rule_instance_uid = ?)";

public static final String DELETE_RULE_INSTANCE_ORACLE  =  "delete rule_instance where rule_instance_uid = ?";
public static final String DELETE_RULE_INSTANCE_SQL =  "delete rule_instance where rule_instance_uid = ?";

public static final String ADD_RULE_INSTANCE_ORACLE  = "INSERT INTO rule_instance ( conseq_ind_uid, rule_uid, comments) VALUES(?,?,?)";
public static final String ADD_RULE_INSTANCE_SQL  = "INSERT INTO rule_instance ( conseq_ind_uid, rule_uid, comments) VALUES(?,?,?)";

public static final String MAX_RULE_INSTANCEUID_ORACLE  = "Select max(rule_instance_uid) as RuleInsUid from rule_instance";
public static final String MAX_RULE_INSTANCEUID_SQL  = "Select max(rule_instance_uid) as RuleInsUid from rule_instance";

public static final String ADD_SF_INSTANCE_ORACLE  =  "INSERT INTO source_field (nbs_metadata_rule_uid, rule_instance_uid) VALUES(?,?)";
public static final String ADD_SF_INSTANCE_SQL  =  "INSERT INTO source_field (nbs_metadata_rule_uid, rule_instance_uid) VALUES(?,?)";

public static final String MAX_SF_INSTANCEUID_ORACLE  = "Select max(source_field_uid) as SourceFUID from Source_field";
public static final String MAX_SF_INSTANCEUID_SQL  = "Select max(source_field_uid) as SourceFUID from Source_field";

public static final String ADD_TF_INSTANCE_ORACLE  =  "INSERT INTO target_field (nbs_metadata_rule_uid, rule_instance_uid) VALUES(?,?)";
public static final String ADD_TF_INSTANCE_SQL  =  "INSERT INTO target_field (nbs_metadata_rule_uid, rule_instance_uid) VALUES(?,?)";

public static final String MAX_TF_INSTANCEUID_ORACLE  = "Select max(target_field_uid) as TargetFUID from Target_field";
public static final String MAX_TF_INSTANCEUID_SQL  = "Select max(target_field_uid) as TargetFUID from Target_field";

public static final String ADD_SV_INSTANCE_ORACLE  =   "INSERT INTO source_value (source_field_uid, source_value,operator_type_uid) VALUES(?,?,?)";
...
public static final String MAX_SV_INSTANCEUID_ORACLE  = "Select max(source_value_uid) as SourceVUID from source_value";
public static final String MAX_SV_INSTANCEUID_SQL  = "Select max(source_value_uid) as SourceVUID from source_value";

public static final String ADD_TV_INSTANCE_ORACLE  =   "INSERT INTO target_value (target_field_uid, target_value,error_message_uid,conseq_ind_uid,operator_type_uid) VALUES(?,?,?,?,?)";
...
public static final String MAX_TV_INSTANCEUID_ORACLE  = "Select max(target_value_uid) as TargetVUID from target_value";
public static final String MAX_TV_INSTANCEUID_SQL  = "Select max(target_value_uid) as TargetVUID from target_value";

public static final String UPDATE_SV_INSTANCE_ORACLE = "UPDATE source_value" +
...
public static final String UPDATE_TV_INSTANCE_ORACLE = "UPDATE target_value" +
...
public static final String DELETE_SOURCE_VALUE_SF_ORACLE = "delete source_value where source_field_uid in (?)";

public static final String DELETE_SOURCE_VALUE_SF_SQL = "delete source_value where source_field_uid in (?)";

public static final String DELETE_TARGET_VALUE_TF_ORACLE ="delete target_value where target_field_uid in (?)";

public static final String DELETE_TARGET_VALUE_TF_SQL = "delete target_value where target_field_uid in (?)";


public static final String DELETE_SOURCE_FIELD_SF_ORACLE = "delete source_field where source_field_uid = ?";

public static final String DELETE_SOURCE_FIELD_SF_SQL = "delete source_field where source_field_uid = ?";

public static final String DELETE_TARGET_FIELD_TF_ORACLE =  "delete target_field where target_field_uid = ?";

public static final String DELETE_TARGET_FIELD_TF_SQL = "delete target_field where target_field_uid = ?";

public static final String INSERT_FRM_CODE_ORACLE  =  "INSERT INTO form_rule_instance (rule_instance_uid, form_code,record_status_cd) VALUES(?,?,?)";
...
public static final String FRM_CODE_LIST_ORACLE = "SELECT distinct "
    + "A.rule_instance_uid \"ruleInstanceUid\", "
    + " A.form_code \"formCode\" "
    + " FROM "
    + " form_rule_instance A "
...
public static final String DELETE_FRM_CODE_ORACLE =  "delete form_rule_instance where rule_instance_uid =  ?";
...
public static final String GET_ASSIGNING_AUTH_STATE_CASE_ORACLE = "SELECT Act_id.root_extension_txt"
                                + " FROM Public_health_case INNER JOIN"
                                + " Act_id ON"
                                + " Public_health_case.public_health_case_uid = Act_id.act_uid"
                                + " INNER JOIN nbs_srte.condition_code cc "
                                + " on Public_health_case.cd = cc.condition_cd"
                                + " and cc.investigation_form_cd=?"
                                + " and act_id_seq=? and Act_id.root_extension_txt=? where Public_health_case.local_id<>?";
...
public static final String CREATE_ASSIGNING_AUTH_STATE_CASE_ORACLE = "SELECT Act_id.root_extension_txt"
                               + " FROM Public_health_case INNER JOIN"
                               + " Act_id ON"
                               + " Public_health_case.public_health_case_uid = Act_id.act_uid"
                               + " INNER JOIN nbs_srte.condition_code cc "
...
public static final String AGGREGATE_METADATA_QUERY_ORA = "SELECT  NT.nbs_table_uid \"nbsTableUid\", "
    + "NTM.nbs_table_metadata_uid \"nbsTableMetaDataUid\","
    + "NT.nbs_table_nm \"nbsTableName\","
    + "NQ.question_identifier \"questionIdentifier\", "
    + "NTM.nbs_indicator_uid \"nbsIndicatorUid\", "
    ...
    + "NBS_Question NQ ON NTM.nbs_question_uid = NQ.nbs_question_uid INNER JOIN "
    + "NBS_table NT ON NTM.nbs_table_uid = NT.nbs_table_uid "
    + "WHERE NTM.RECORD_STATUS_CD='Active' ORDER BY NTM.aggregate_seq_nbr,NTM.indicator_seq_nbr ";
...
public static final String SELECT_RECEIVING_FACILITY_ORACLE="SELECT "
    +" receiving_system_nm  \"receivingSystemNm\","
    +" receiving_system_short_nm  \"receivingSystemShortName\","
    +" receiving_system_oid  \"receivingSystemOid\","
    +" receiving_system_owner \"receivingSystemOwner\","
...
public static final String UPDATE_TRIGGER_CODE_ORA="UPDATE "
	    + "NBS_SRTE.code_to_condition "
	    + "SET code_desc_txt=?, " +
	    "disease_nm=?, " +
	    "condition_cd=?, " +
...
public static final String CREATE_TRIGGER_CODE_ORA="INSERT INTO "
	    + "NBS_SRTE.code_to_condition "
...
public static final String SELECT_TRIGGER_CODE_ORA="SELECT  cc.code_system_cd \"codeSystemCd\" "
		+", cc.code_system_desc_txt \"codingSystem\" "
		+",cc.code \"code\""
		+", cc.code_desc_txt \"codeDescTxt\""
		+",cc.code_system_version_id \"codeSystemVersionId\" "
		+", cc.condition_cd \"conditionCd\""
		+",NVL(cc.disease_nm,'') \"diseaseNm\""
		+",cc.status_cd \"statusCd\""
		+",cc.status_time \"statusTime\" "
		+ ",cc.nbs_uid \"nbsUid\" "
		+ ",cc.effective_from_time \"effectiveFromTime\" "
...
public static final String SELECT_AllTRIGGER_CODE_SQL="SELECT  code_system_cd \"codeSystemCd\" "
		...
		+ ",effective_from_time \"effectiveFromTime\" "
		+ ",effective_to_time \"effectiveToTime\" "
		+" FROM " + NEDSSConstants.SYSTEM_REFERENCE_TABLE +"..code_to_condition  ";
	
public static final String SELECT_ALLTRIGGER_CODE_ORA="SELECT  code_system_cd \"codeSystemCd\" "
		+", code_system_desc_txt \"codingSystem\" "
		+",code \"code\""
		+", code_desc_txt \"codeDescTxt\""
		+",code_system_version_id \"codeSystemVersionId\" "
...
public static final String SELECT_EXPORT_TRIGGERFIELDS_SQL= "SELECT "
...
public static final String GET_NBS_INTERFACE_FIELDS_ORA = " SELECT "
    +" nbs_interface_uid \"nBSInterfaceUid\","
    +" payload \"payload\", "
    +" imp_exp_ind_cd \"impExpIndCd\","
    +" record_status_cd \"recordStatusCd\","
...
public static final String GET_DOCUMENTS_FOR_REVIEW_ORA = " SELECT"
    + " nbsdoc.nbs_document_uid  \"nbsDocumentUid\", "
    + " nbsdoc.local_id  \"localId\","
    + " nbsdoc.doc_type_cd  \"docType\","
    + " per.person_parent_uid \"MPRUid\","
...
public static final String SELECT_SUMMARY_NOTIFICATION_SQL =
    ...
    "..code_value_general code2 " + " where " +
    " Public_health_case.Public_health_case_uid = ar.target_act_uid " +
    " and ar.type_cd = '" + NEDSSConstants.ACT128_TYP_CD + "'" +
    " and ar.status_cd = 'A' " +
    " and Notification.notification_uid = ar.source_act_uid" +
    " and code1.condition_codeset_nm = 'PHC_TYPE' "+
    " and Public_health_case.cd = code1.condition_cd " +
...
public static final String SELECT_SUMMARY_NOTIFICATION_ORACLE =
    "select Notification.notification_uid \"NotificationUid\", "+
    " Notification.add_time \"AddTime\",Notification.rpt_sent_time \"RptSentTime\", "+
    " Public_health_case.cd \"Cd\", "+
    " Public_health_case.case_class_cd \"CaseClassCd\", "+
...
public static final String CONTACT_QUESTION_OID_METADATA_ORACLE = "SELECT "
    ...
    + "NVL(NBS_UI_Metadata.question_label, NBS_Question.question_label)  \"questionLabel\", "
    + "NVL(NBS_UI_Metadata.question_tool_tip, NBS_Question.question_tool_tip) \"questionToolTip\", "
    ...
    + " and  NBS_UI_Metadata.nbs_question_uid IS NOT NULL "
...
public static final String DMB_QUESTION_OID_METADATA_ORACLE = "SELECT "
    + "NBS_UI_METADATA.nbs_question_uid \"nbsQuestionUid\", "
    + "NBS_UI_METADATA.add_time \"addTime\", "
    + "NBS_UI_METADATA.add_user_id \"addUserId\", "
    + "NBS_UI_METADATA.code_set_group_id \"codeSetGroupId\", "
...
public static final String GENERIC_QUESTION_OID_METADATA_SQL ="SELECT " +
     "wa_ui_metadata.wa_ui_metadata_uid \"nbsQuestionUid\", " +
     "wa_ui_metadata.question_unit_identifier \"questionUnitIdentifier\", " +
     "wa_ui_metadata.add_time \"addTime\", " +
     "wa_ui_metadata.add_user_id \"addUserId\", " +
     "wa_ui_metadata.code_set_group_id \"codeSetGroupId\", " +
     "wa_ui_metadata.data_type \"dataType\", " +
     "wa_ui_metadata.mask \"mask\", " +
     "wa_template.template_nm \"investigationFormCd\", " +
     "wa_template.template_type \"templateType\", " +
     "wa_ui_metadata.last_chg_time \"lastChgTime\", " +
     "wa_ui_metadata.last_chg_user_id \"lastChgUserId\", " +
     "wa_ui_metadata.question_label \"questionLabel\", " +
     "wa_ui_metadata.question_tool_tip \"questionToolTip\", " +
     "wa_ui_metadata.version_ctrl_nbr \"questionVersionNbr\", " +
     "wa_ui_metadata.enable_ind \"enableInd\", " +
     "wa_ui_metadata.order_nbr \"orderNbr\", " +
     "wa_ui_metadata.default_value \"defaultValue\", " +
     "wa_ui_metadata.required_ind \"requiredInd\", " +
     "wa_ui_metadata.display_ind \"displayInd\", " +
     "wa_nnd_metadata.wa_nnd_metadata_uid \"nndMetadataUid\", " +
     "wa_ui_metadata.question_identifier \"questionIdentifier\", " +
     "wa_nnd_metadata.question_identifier_nnd \"questionIdentifierNnd\"," +
     "wa_nnd_metadata.question_required_nnd \"questionRequiredNnd\"," +
     "wa_ui_metadata.question_oid \"questionOid\", " +
     "wa_ui_metadata.question_oid_system_txt \"questionOidSystemTxt\", " +
     "CODE_SET.code_set_nm \"codeSetNm\", " +
     "CODE_SET.class_cd \"codeSetClassCd\", " +
     "wa_ui_metadata.data_location \"dataLocation\", " +
     "wa_ui_metadata.data_cd \"dataCd\", " +
     "wa_ui_metadata.data_use_cd \"dataUseCd\", " +
     "wa_ui_metadata.field_size \"fieldSize\", " +
     "wa_ui_metadata.parent_uid \"parentUid\", " +
     "wa_ui_metadata.wa_ui_metadata_uid \"nbsUiMetadataUid\", " +
     "NBS_UI_Component.nbs_ui_component_uid \"nbsUiComponentUid\", " +
     "wa_ui_metadata.unit_type_cd \"unitTypeCd\", " +
     "wa_ui_metadata.unit_value \"unitValue\", " +
     "wa_ui_metadata.coinfection_ind_cd \"coinfectionIndCd\", " +
     "wa_ui_metadata.standard_nnd_ind_cd \"standardNndIndCd\",     " +
     "wa_nnd_metadata.HL7_segment_field \"hl7SegmentField\", " +
     "wa_ui_metadata.question_group_seq_nbr \"questionGroupSeqNbr\"    " +
     "FROM " +
     "wa_template inner join wa_ui_metadata on " +
     "wa_template.wa_template_uid = wa_ui_metadata.wa_template_uid " +
     "and wa_template.template_nm like 'Generic Investigation%' " +
     "and wa_template.template_type = 'TEMPLATE' " +
     "INNER JOIN NBS_UI_Component ON wa_ui_metadata.nbs_ui_component_uid = NBS_UI_Component.nbs_ui_component_uid " +
     "LEFT OUTER JOIN " +
     "wa_nnd_metadata ON wa_ui_metadata.wa_ui_metadata_uid = wa_nnd_metadata.wa_ui_metadata_uid LEFT OUTER JOIN " +
     "(SELECT DISTINCT code_set_group_id, code_set_nm, class_cd FROM " +
     NEDSSConstants.SYSTEM_REFERENCE_TABLE +"..CODESET) CODE_SET " +
     "ON CODE_SET.code_set_group_id = wa_ui_metadata.code_set_group_id " +
     "where upper(wa_ui_metadata.record_status_cd) = 'ACTIVE' and wa_ui_metadata.question_identifier is not null " +
     "order by wa_template.template_nm, wa_ui_metadata.order_nbr"  ;


public static final String GENERIC_QUESTION_OID_METADATA_ORACLE ="SELECT " +
    "wa_ui_metadata.wa_ui_metadata_uid \"nbsQuestionUid\", " +
    "wa_ui_metadata.question_unit_identifier \"questionUnitIdentifier\", " +
    "wa_ui_metadata.add_time \"addTime\", " +
    "wa_ui_metadata.add_user_id \"addUserId\", " +
    ...
    public static final String INSERT_EDX_DOCUMENT = "INSERT INTO EDX_DOCUMENT"
            ...
            + " record_status_time, add_time, doc_type_cd, nbs_document_metadata_uid) "
            + " VALUES (?, ?, ?, ?, ?, ?, ?)";
    public static final String SELECT_EDX_DOCUMENT_COLLECTION = "SELECT EDX_Document_uid \"eDXDocumentUid\", act_uid \"actUid\", "
            + " add_time \"addTime\" FROM " + " EDX_Document WHERE act_uid = ? order by add_time desc";
    ...
    public static final String SELECT_INDIVIDUAL_EDX_DOCUMENT_ORA = "SELECT ed.EDX_Document_uid \"eDXDocumentUid\", ed.act_uid \"actUid\", "
            + " ed.payload.getClobVal() \"payload\" , "
            + " ed.record_status_cd \"recordStatusCd\" , "
            + " ed.record_status_time \"recordStatusTime\" , "
            + " ed.add_time \"addTime\" , "
            + " ed.doc_type_cd \"docTypeCd\" , "
            + " NBS_document_metadata.document_view_xsl \"documentViewXsl\" , "
            + " NBS_document_metadata.xml_schema_location \"xmlSchemaLocation\"  "
            + " FROM EDX_Document ed, NBS_document_metadata "
            + " WHERE ed.nbs_document_metadata_uid=NBS_document_metadata.nbs_document_metadata_uid "
            + " and ed.EDX_Document_Uid  = ?";

    public static final String COUNT_MESSAGE_LOG = "select count(*) from Message_Log ml, Person_Name p, Auth_User au, Public_health_case phc  "
    ...
    public static final String SELECT_MESSAGE_LOG_ORACLE = "select ml.message_log_uid \"messageLogUid\", ml.message_txt \"messageTxt\", phc.public_health_case_uid \"eventUid\","
            + " phc.cd_desc_txt \"conditionCd\", ml.event_type_cd \"eventTypeCd\", ml.message_status_cd \"messageStatusCd\","
            + " ml.add_time \"addTime\", NVL(p.first_nm,'No First') \"firstNm\", NVL(p.last_nm,'No Last') \"lastNm\", au.user_first_nm \"userFirstNm\", "
            + " au.user_last_nm \"userLastNm\" "
            + " from Message_Log ml, Person_Name p, Auth_User au, Public_health_case phc  "
            + " where ml.person_uid = p.person_uid and au.nedss_entry_id = ml.add_user_id and assigned_to_uid = ? "
            + " and ml.record_status_cd != 'LOG_DEL' and p.nm_use_cd = 'L' and phc.public_health_case_uid = ml.event_uid  and phc.record_status_cd != 'LOG_DEL'";
    ...
    public static final String SUPERVISOR_REVIEW_COUNT = " SELECT count(*) from case_management cm, Public_Health_Case phc "
	...
	public static final String COINFECTION_INV_LIST_ORA = "select distinct phc.public_health_case_uid \"publicHealthCaseUid\", "
			+ "phc.local_id \"localId\", "
			+ "phc.coinfection_id \"coinfectionId\", "
			+ "pn.last_nm \"investigatorLastNm\", "
			+ "pn.first_nm \"intestigatorFirstNm\", "
	...
	public static final String COINFECTION_SPECIFIED_INV_LIST_SQL = "select distinct phc.public_health_case_uid \"publicHealthCaseUid\", "
			...
			+ "left outer join Person_name pn on "
			+ "nae2.entity_uid = pn.person_uid "
			+ "where phc.coinfection_id in (select coinfection_id from public_health_case where public_health_case_uid = ?) "
			+ "order by phc.add_time desc";
	//retrieve all INVs associated with a particular co-infection id passing a public_health_case_uid
	public static final String COINFECTION_SPECIFIED_INV_LIST_ORA = "select distinct phc.public_health_case_uid \"publicHealthCaseUid\", "
			+ "phc.local_id \"localId\", "
			+ "phc.coinfection_id \"coinfectionId\", "
			+ "pn.last_nm \"investigatorLastNm\", "
			+ "pn.first_nm \"intestigatorFirstNm\", "
