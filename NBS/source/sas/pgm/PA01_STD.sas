...
D_provider.provider_last_name, d_contact_record.LOCAL_ID as INV_LOCAL_ID , a.CA_PATIENT_INTV_STATUS, a.INVESTIGATOR_INTERVIEW_KEY, a.INVESTIGATOR_INTERVIEW_QC
...
create table partner2 as 
 select distinct a.INVESTIGATION_KEY, provider_last_name,e.LOCAL_ID as INV_LOCAL_ID, a.INIT_FUP_INITIAL_FOLL_UP,
...
create table partner2_dte as 
 select distinct  a.INVESTIGATION_KEY, provider_last_name,e.LOCAL_ID as INV_LOCAL_ID,
 f.FL_FUP_DISPOSITION,  a.FL_FUP_DISPO_DT, a.FL_FUP_INIT_ASSGN_DT, datepart(a.FL_FUP_DISPO_DT)-datepart(a.FL_FUP_INIT_ASSGN_DT) as days,
 a.INVESTIGATOR_INTERVIEW_KEY, a.INVESTIGATOR_INTERVIEW_QC
from STD_HIV_DATAMART1 a inner join 
 nbs_rdb.F_INTERVIEW_CASE b on a.INVESTIGATION_KEY = b.INVESTIGATION_KEY
...
'C - Infected, Brought to Treatment',
'D - Infected, Not Treated',
'F - Not Infected') and datepart(a.FL_FUP_DISPO_DT) ge datepart(a.FL_FUP_INIT_ASSGN_DT)
order by INVESTIGATOR_INTERVIEW_KEY ;
quit;
...
inner join nbs_rdb.D_INTERVIEW c  on c.D_INTERVIEW_KEY = b.D_INTERVIEW_KEY and c.RECORD_STATUS_CD~='LOG_DEL'
inner join nbs_rdb.D_provider d  on d.provider_key = a.INVESTIGATOR_INTERVIEW_KEY
where   f.FL_FUP_DISPOSITION in ('A - Preventative Treatment','C - Infected, Brought to Treatment') 
group by A.INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by A.INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
quit;
...
proc sql;
create table src as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct INV_LOCAL_ID) as var_p 
from pa1_new
...
proc sql;
create table pa as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pa 
from partner2  
...
proc sql;
create table pb as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pb 
from partner2  
...
proc sql;
create table pc as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pc 
from partner2  
...
proc sql;
create table pd as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pd 
from partner2  
...
proc sql;
create table pf as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pf 
from partner2  
...
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pn 
from pn  
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
quit;
...
proc sql;
create table pg as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pg 
from pn  
...
proc sql;
create table ph as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_ph 
from pn  
where FL_FUP_DISPOSITION in (
'H - Unable to Locate')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table pj as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pj 
from pn  
where FL_FUP_DISPOSITION in (
'J - Located, Not Examined and/or Interviewed')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table pk as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pk 
from pn  
where FL_FUP_DISPOSITION in (
'K - Sent Out Of Jurisdiction')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table pl as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pl
from pn  
where FL_FUP_DISPOSITION in (
'L - Other')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table pz as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pz
from pn  
where FL_FUP_DISPOSITION in (
'Z - Previous Preventative Treatment')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table PE as 
 select distinct b.D_INTERVIEW_KEY, c.IX_TYPE, a.INVESTIGATION_KEY, provider_last_name,e.LOCAL_ID as INV_LOCAL_ID,
...
proc sql;
create table pee as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_pe
from pe  
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
quit;
...
proc sql;
create table peo as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_po
from PP
...
'X - Patient Deceased',
'Z - Previous Preventative Treatment')
where datepart(a.FL_FUP_DISPO_DT) ge datepart(a.FL_FUP_INIT_ASSGN_DT); /*Sameer to change it to _CD*/
quit;


proc sql;
create table Co as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_co
from cluster 
where FL_FUP_DISPOSITION IS NULL
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
...
proc sql;
create table cmm as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cm
from cm 
where FL_FUP_DISPOSITION in (
'A - Preventative Treatment',
'B - Refused Preventative Treatment',
...
proc sql;
create table ca as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_ca
from cm 
where FL_FUP_DISPOSITION in (
...
proc sql;
create table cb as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cb
from cm 
where FL_FUP_DISPOSITION in (
...
proc sql;
create table cc as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cc
from cm 
where FL_FUP_DISPOSITION in (
'C - Infected, Brought to Treatment')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
...
proc sql;
create table cd as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cd
from cm 
where FL_FUP_DISPOSITION in ('D - Infected, Not Treated')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
...
proc sql;
create table cf as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cf
from cm 
where FL_FUP_DISPOSITION in ('F - Not Infected')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
...
proc sql;
create table cn as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cn
from cm 
...
proc sql;
create table cg as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cg
from cm 
where FL_FUP_DISPOSITION in ('G - Insufficient Info to Begin Investigation')
group by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME
order by INVESTIGATOR_INTERVIEW_KEY, PROVIDER_LAST_NAME;
...
proc sql;
create table ch as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_ch
from cm 
...
proc sql;
create table cj as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cj
from cm 
...
proc sql;
create table ck as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_ck
from cm 
...
proc sql;
create table cl as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cl
from cm 
...
proc sql;
create table cz as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_cz
from cm  
...
proc sql;
create table ce as 
select PROVIDER_LAST_NAME,  INVESTIGATOR_INTERVIEW_KEY, count(distinct inv_local_id) as var_ce
from cm 
