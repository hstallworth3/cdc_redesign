...
define  Hang_Out_Name / group ' '  style(column)= { cellwidth=40mm  just=left font_face="Calibri" font_size = 10pt};
define  Type_of_place /group  ' '  style(column)= {cellwidth=35mm font_face="Calibri" font_size = 10pt};
