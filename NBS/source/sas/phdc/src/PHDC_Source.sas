...
SET &OUT_DATA;
	...
	IF X> 0 THEN ANS_CODE_SYSTEM_CD='2.16.840.1.113883.5.1008';
	IF X> 0 THEN ANS_CODE_SYSTEM_DESC_TXT='NullFlavor';
	IF X> 0 THEN ANS_DISPLAY_TXT=ANSWER_TXT;
...
/*	PUBLIC_HEALTH_CASE.INVESTIGATOR_ASSIGNED_TIME AS INV110  'INV110',*/
	...
	STATE.ROOT_EXTENSION_TXT  LENGTH = 100 format=$100. AS INV_STATE_ID,
	LEGACY.ROOT_EXTENSION_TXT LENGTH = 100 format=$100. AS INV_LEGACY_CASE_ID
