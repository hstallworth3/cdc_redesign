...
insert into nbs_rdb.EVENT_METRIC 
	...
	WHERE  DATEPART(phc.add_time) >=  TODAY()-&METRICS_GOBACKBY_DAYS ;
...
insert into nbs_rdb.EVENT_METRIC 
	...
	ON 
	  ...
	  c.code_set_nm='REC_STAT'
	LEFT JOIN nbs_ods.nbs_act_entity as part
	ON 
	...
	LEFT outer join nbs_ods.user_profile as up2
	 ...
	 WHERE  DATEPART(i.add_time) >=  TODAY()-&METRICS_GOBACKBY_DAYS ;
...
insert into nbs_rdb.EVENT_METRIC 
	...
	ON 
	  ...
	  part.type_cd = 'PATSBJ'
	left outer join nbs_srt.code_value_general as cvgst
	...
	WHERE
	  ...
	  DATEPART(o.add_time) >=  TODAY()-&METRICS_GOBACKBY_DAYS ;
...
insert into nbs_rdb.EVENT_METRIC 
	...
	ON
	  o.jurisdiction_cd = j.code
	LEFT OUTER JOIN nbs_srt.code_value_general as c1
...
insert into nbs_rdb.EVENT_METRIC 
	...
	ON
	  o.prog_area_cd = p.prog_area_cd
	LEFT OUTER JOIN nbs_srt.condition_code as q
	ON
	  o.cd = q.condition_cd
	LEFT OUTER JOIN nbs_srt.code_value_general as cvgst
