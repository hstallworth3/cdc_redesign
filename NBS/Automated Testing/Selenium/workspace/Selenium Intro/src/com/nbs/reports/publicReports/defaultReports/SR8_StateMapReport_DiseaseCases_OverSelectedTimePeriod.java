...
public class SR8_StateMapReport_DiseaseCases_OverSelectedTimePeriod {
	...
	@Test
	public void Populate_SR8_report() throws Exception {
		comUtils.setUpDriver(driver);
		log = new Log("SR8_Report", Log_File_Path);
		df = new DataFile(Data_File_Path, "SR8");
		...
		for (int col = 1; col <= colCount; col++) {
			try {
				...
				log.write("Disease: " + disease + "; " + " State: " + state + "; " + " From Date: " + from_Date + "; "
						+ " To Date: " + to_Date + ";");
				...
				// SR8: State Map Report of Disease Cases Over Selected Time
				// Period
				int index = 0;
				...
				while (itr.hasNext()) {
					...
					if (tableRows.get(index).getText()
							.contains("SR8: State Map Report of Disease Cases Over Selected Time Period"))
						break;
				}
				...
				if (!comUtils.isElementDisplayed(By.id("error1"))) {
					...
					if (comUtils.isElementDisplayed(
							By.xpath("html/body/div[1]/table[1]/tbody/tr[3]/td/div/table/tbody/tr[1]/td/b/u"))) {
						System.out.println(driver
								.findElement(
										By.xpath("html/body/div[1]/table[1]/tbody/tr[3]/td/div/table/tbody/tr[1]/td/b"))
								.getText());
						if (driver
								.findElement(
										By.xpath("html/body/div[1]/table[1]/tbody/tr[3]/td/div/table/tbody/tr[1]/td/b"))
