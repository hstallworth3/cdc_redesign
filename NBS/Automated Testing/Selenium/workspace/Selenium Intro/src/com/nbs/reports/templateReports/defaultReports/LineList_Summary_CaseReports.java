...
public class LineList_Summary_CaseReports {
	...
	@Test
	public void Populate_LineList_Summary_CaseReport() throws Exception {
		comUtils.setUpDriver(driver);
		log = new Log("LineList_SummaryCase_Report", Log_File_Path);
		df = new DataFile(Data_File_Path, "LineList_Summary_CaseReport");
		...
		for (int col = 1; col <= colCount; col++) {
			try {
				...
				// log.write("Disease "+"'"+disease+"'"+ " State
				// "+"'"+state+"'"+" From Date " +"'"+from_Date+"'"+" To Date "
				// +"'"+to_Date+"'");
				...
				if ((disease_selectall).equalsIgnoreCase("Yes") && (counties_selectall).equalsIgnoreCase("Yes"))
					log.write("Disease: " + "Select All;" + "   State: " + state + ";" + "   Counties: " + "Select All;"
							+ "   From Date: " + from_Date + ";" + "  To Date:  " + to_Date);
				else if ((disease_selectall).equalsIgnoreCase("Yes") && !counties_selectall.equalsIgnoreCase("Yes"))
					log.write("Disease: " + "Select All;" + "   State: " + state + ";" + "   Counties: " + counties
							+ ";" + "  From Date: " + from_Date + "  To Date: " + to_Date);
				else if (!disease_selectall.equalsIgnoreCase("Yes") && counties_selectall.equalsIgnoreCase("Yes"))
					log.write("Disease: " + disease + ";" + "   State: " + state + ";" + "   Counties: " + "Select All;"
							+ ";" + "  From Date: " + from_Date + "  To Date: " + to_Date);
				else
					log.write("Disease: " + disease + ";" + "   State: " + state + ";" + "   Counties: " + counties
							+ ";" + "  From Date: " + from_Date + "  To Date: " + to_Date);
				...
				// Line List of Summary Case Reports
				int index = 0;
				...
				while (itr.hasNext()) {
					index = index + 1;
					if (tableRows.get(index).getText().contains("Line List of Summary Case Reports"))
						break;
				}
				...
				if (!comUtils.isElementDisplayed(By.id("error1"))) {
					...
					if (comUtils.isElementDisplayed(By.xpath("html/body/div[1]/table[1]/tbody/tr[1]/td/p"))) {
						...
						if (driver.findElement(By.xpath("html/body/div[1]/table[1]/tbody/tr[1]/td")).getText()
								.contains("Custom Report For Table: SR100"))
