...
public class SR12_CasesOf_SelectedDisease_ByCounty_ByYear {
	...
	@Test
	public void Populate_SR12() throws Exception {
		comUtils.setUpDriver(driver);
		log = new Log("SR12_Report", Log_File_Path);
		df = new DataFile(Data_File_Path, "SR12");		
		...
		for(int col=1; col <=colCount; col++){	
			try {
				...
				//Read the values of  Disease, State, Counties, From_Date, To_Date from excel and write them to log
				...
				if((counties_selectall).equalsIgnoreCase("Yes"))
				...
				//Click on Run - Get the index of the Run button with Text - SR12: Cases of Selected Disease By County By Year
				int index = 0;
				...
				while(itr.hasNext()) {
					index = index+1;
					if (tableRows.get(index).getText().contains("SR12: Cases of Selected Disease By County By Year"))
					break;	
				}
				...
				if (!(comUtils.isElementDisplayed(By.id("error1")))){
					...
					if (comUtils.isElementDisplayed(By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b/u"))){
						System.out.println(driver.findElement(By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b")).getText());
						if (driver.findElement(By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b")).getText().contains("Report content"))
