...
public class HIVInvestigation_MorbidityReport {
	...
	public void setUp() throws Exception {
		...
		Data_File_Path = login.Data_File_Path + "investigations\\HIVInvestigation_MorbidityReport.xls";
		Log_File_Path = login.Log_File_Path;
	}

	@Test
	public void HIVInvestigation_MorbReport() throws Exception {
		comUtils.setUpDriver(driver);
		log = new Log("HIVInvestigation_MorbidityReport", Log_File_Path);
