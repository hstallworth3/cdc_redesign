...
and a.CC_CLOSED_DT~=. and a.CA_PATIENT_INTV_STATUS in ('I - Interviewed') and a.DIAGNOSIS_CD in('900','950');
quit;
...
proc sql;
	...
	left outer join nbs_rdb.D_INTERVIEW c on  c.D_INTERVIEW_KEY = f.CONTACT_INTERVIEW_KEY and c.RECORD_STATUS_CD~='LOG_DEL'
...
from PA04  
where CC_CLOSED_DT is not null and CA_PATIENT_INTV_STATUS in ('I - Interviewed') 
and HIV_900_RESULT = '1 - Positive/Reactive'
;
...
if find(descrip,'DISPO. 1:','i') ge 1 then &name = "&val_PA" ;
if find(descrip,'DISPO. 2:','i') ge 1 then &name = "&val_PB" ;
...
if find(descrip,'DISPO. 3:','i') ge 1 then &name = "&val_PC";
if find(descrip,'DISPO. 4:','i') ge 1 then &name = "&val_PD";

if find(descrip,'DISPO. 5:','i') ge 1 then &name = "&val_PE" ;
if find(descrip,'DISPO. 6:','i') ge 1 then &name = "&val_PF" ;
if find(descrip,'DISPO. 7:','i') ge 1 then &name = "&val_P7" ;
if find(descrip,'PARTNERS NOT EXAMINED:','i') ge 1 then &name = "&val_PQ" ;
if find(descrip,'DISPO. G:','i') ge 1 then &name = "&val_PG" ;
if find(descrip,'DISPO. H:','i') ge 1 then &name =  "&val_PH" ;
if find(descrip,'DISPO. J:','i') ge 1 then &name =  "&val_PJ" ;
if find(descrip,'DISPO. K:','i') ge 1 then &name = "&val_PK" ;
if find(descrip,'DISPO. L:','i') ge 1 then &name = "&val_PL" ;
if find(descrip,'DISPO. V:','i') ge 1 then &name =  "&val_PV" ;
if find(descrip,'DISPO. X:','i') ge 1 then &name = "&val_PX" ;


if find(descrip,'CLUSTERS INITIATED:','i') ge 1 then &name = "&val_CM" ;
if find(descrip,'CLUSTERS EXAMINED:','i') ge 1 then &name = "&val_CN" ;
if find(descrip,'DISPO 1:','i') ge 1 then &name = "&val_CA" ;
if find(descrip,'DISPO 2:','i') ge 1 then &name = "&val_CB" ;
...
if find(descrip,'DISPO 3:','i') ge 1 then &name = "&val_CC";
if find(descrip,'DISPO 4:','i') ge 1 then &name = "&val_CD";

if find(descrip,'DISPO 5:','i') ge 1 then &name = "&val_CE" ;
if find(descrip,'DISPO 6:','i') ge 1 then &name = "&val_CF" ;
if find(descrip,'DISPO 7:','i') ge 1 then &name = "&val_C7" ;
if find(descrip,'CLUSTERS NOT EXAMINED:','i') ge 1 then &name = "&val_CQ" ;
if find(descrip,'DISPO G:','i') ge 1 then &name = "&val_CG" ;
if find(descrip,'DISPO H:','i') ge 1 then &name =  "&val_CH" ;
if find(descrip,'DISPO J:','i') ge 1 then &name =  "&val_CJ" ;
if find(descrip,'DISPO K:','i') ge 1 then &name = "&val_CK" ;
if find(descrip,'DISPO L:','i') ge 1 then &name = "&val_CL" ;
if find(descrip,'DISPO V:','i') ge 1 then &name =  "&val_CV" ;
if find(descrip,'DISPO X:','i') ge 1 then &name = "&val_CX" ;
...
if find(descrip,'DISPO. 1:','i') ge 1 then &per = put(round("&per_PA",0.001),percent8.1) ;
if find(descrip,'DISPO. 3:','i') ge 1 then &per = put(round("&per_PC",0.001),percent8.1) ;

if find(descrip,'DISPO. 2:','i') ge 1 then &per = put(round("&per_PB",0.001),percent8.1) ;
if find(descrip,'DISPO. 4:','i') ge 1 then &per = put(round("&per_PD",0.001),percent8.1) ;
if find(descrip,'DISPO. 5:','i') ge 1 then &per = put(round("&per_PE",0.001),percent8.1) ;
if find(descrip,'DISPO. 6:','i') ge 1 then &per = put(round("&per_PF",0.001),percent8.1) ;
if find(descrip,'PARTNERS NOT EXAMINED:','i') ge 1 then &per = put(round("&per_PQ",0.001),percent8.1) ;
if find(descrip,'DISPO. 7:','i') ge 1 then &per = put(round("&per_P7",0.001),percent8.1) ;
if find(descrip,'DISPO. G:','i') ge 1 then &per = put(round("&per_PG",0.001),percent8.1) ;
if find(descrip,'DISPO. H:','i') ge 1 then &per = put(round("&per_PH",0.001),percent8.1) ;
if find(descrip,'DISPO. J:','i') ge 1 then &per = put(round("&per_PJ",0.001),percent8.1) ;
if find(descrip,'DISPO. K:','i') ge 1 then &per = put(round("&per_PK",0.001),percent8.1) ;
if find(descrip,'DISPO. L:','i') ge 1 then &per = put(round("&per_PL",0.001),percent8.1) ;
if find(descrip,'DISPO. V:','i') ge 1 then &per = put(round("&per_PV",0.001),percent8.1) ;
if find(descrip,'DISPO. X:','i') ge 1 then &per = put(round("&per_PX",0.001),percent8.1) ;
...
if find(descrip,'DISPO 1:','i') ge 1 then &per = put(round("&per_CA",0.001),percent8.1) ;
if find(descrip,'DISPO 3:','i') ge 1 then &per = put(round("&per_CC",0.001),percent8.1) ;

if find(descrip,'DISPO 2:','i') ge 1 then &per = put(round("&per_CB",0.001),percent8.1) ;
if find(descrip,'DISPO 4:','i') ge 1 then &per = put(round("&per_CD",0.001),percent8.1) ;
if find(descrip,'DISPO 5:','i') ge 1 then &per = put(round("&per_CE",0.001),percent8.1) ;
if find(descrip,'DISPO 6:','i') ge 1 then &per = put(round("&per_CF",0.001),percent8.1) ;
if find(descrip,'DISPO 7:','i') ge 1 then &per = put(round("&per_C7",0.001),percent8.1) ;
if find(descrip,'CLUSTERS NOT EXAMINED:','i') ge 1 then &per = put(round("&per_CQ",0.001),percent8.1) ;
if find(descrip,'DISPO G:','i') ge 1 then &per = put(round("&per_CG",0.001),percent8.1) ;
if find(descrip,'DISPO H:','i') ge 1 then &per = put(round("&per_CH",0.001),percent8.1) ;
if find(descrip,'DISPO J:','i') ge 1 then &per = put(round("&per_CJ",0.001),percent8.1) ;
if find(descrip,'DISPO K:','i') ge 1 then &per = put(round("&per_CK",0.001),percent8.1) ;
if find(descrip,'DISPO L:','i') ge 1 then &per = put(round("&per_CL",0.001),percent8.1) ;
if find(descrip,'DISPO V:','i') ge 1 then &per = put(round("&per_CV",0.001),percent8.1) ;
if find(descrip,'DISPO X:','i') ge 1 then &per = put(round("&per_CX",0.001),percent8.1) ;
run;
%Mend ;
%fills(col1,col2);
...
define descrip /ORDER=internal ' '  left WIDTH=30 style(column)={asis=on cellwidth=50mm rules=none CELLHEIGHT = 4mm  }
style(header)={just=center cellwidth=50mm rules=none};
