...
<script language="JavaScript">
		function makeMSelects() {
			$j("#fApplicationName").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	        $j("#fDisplayName").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#owner").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#sen").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#reci").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#trans").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#reportType").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
...
<body>
								...
								<table width="98%">
									<tr>
										<td align="center"><display:table name="manageList"
                                        	...
                                        	&nbsp;&nbsp;&nbsp;<img
														src="page_white_text.gif" class="cursorHand" title="View"
												...
												<display:column title="" style="width:5%;" media="html">
                            				 &nbsp;&nbsp;&nbsp;<img
														src="page_white_edit.gif" class="cursorHand" title="Edit"
	...
	<input type='hidden' id='SearchText1' value="<%= request.getAttribute("FILTERBYAPPLICATIONNAME")!=null? request.getAttribute("FILTERBYAPPLICATIONNAME"):""%>"/>
		   <input type='hidden' id='SearchText2' value="<%= request.getAttribute("FILTERBYDISPLAYNAME")!=null? request.getAttribute("FILTERBYDISPLAYNAME"):""%>"/>
