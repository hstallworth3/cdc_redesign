...
function viewClicked(eleid,subSecNm) {		               		    
  ...
  <% String printMode = (request.getAttribute("mode") == null) ? "" : ((String)request.getAttribute("mode"));
    ...
    if (printMode.equals("print")) { %>
        <body class="popup" onload="startCountdown();checkPageDelete();disablePrintLinks();populateBatchRecords();cleanupPatientRacesViewDisplay();" onunload="return closePrinterFriendlyWindow();selectTabOnSubmit();">
    <% } else { %> 
        <body class="popup" onload="startCountdown();checkPageDelete();selectTabOnSubmit();populateBatchRecords();cleanupPatientRacesViewDisplay();" onunload="handleWindowUnload(); return false;">
    <% } %>
