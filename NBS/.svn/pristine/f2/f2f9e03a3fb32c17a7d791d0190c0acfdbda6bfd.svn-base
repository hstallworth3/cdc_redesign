...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            /* page header */
            div.pageHeader {margin:0.25em 0em 0em 0em; width:98%; color:#DF9F61; height:20px; line-height:20px; 
        ...
        <script type="text/javascript">
            ...
            function cancelPageChanges() {
	                  ...
	                  if (choice) {
	                     var context = '<%=request.getAttribute("fromWhere")%>';
                ...
                <div id="canvas" style="border-top-width:0px;">
                    ...
                    <form name="pageForm" style="text-align:center;">
                        ...
                        <div style="width:98%; text-align:right; margin:0 auto;">
                            <a href="javascript:addNewTab()"> <img src="add.gif" /> Add New Tab </a>
                        </div>
