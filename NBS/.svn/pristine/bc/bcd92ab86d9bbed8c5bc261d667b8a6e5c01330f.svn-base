        ...
        <fieldset style="border-width:0px;"  id="labresults">
            <nedss:container id="subsec3" classType="subSect" displayImg ="false">
                ...
                <tr>
                    ...
                    <td>
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                            <html:text property="selection.labResultCd" size="20" maxlength="20" onkeyup="isSpecialCharEnteredForCode(this)"/>
                        </logic:equal>
                ...
                <tr>
                    ...
                    <td>
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="Edit">
                            <html:text property="selection.labResultDescTxt" size="60" maxlength="50"/>
                        </logic:equal> 
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                            <html:text property="selection.labResultDescTxt" size="60" maxlength="50"/>
                        </logic:equal> 
                ...
                <tr>
                    ...
                    <td>
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                            <html:select property="selection.defaultProgAreaCd" styleId="progCd">
                ...
                <tr>
                    ...
                    <td>
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                            <html:checkbox name="SRTAdminManageForm" property="selection.organismNameInd" value="1"/>
                        ...
                        <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            <html:checkbox name="SRTAdminManageForm" property="selection.organismNameInd" value="1" disabled="true"/>
                        </logic:equal> 
                    </td>
                </tr>
                <tr>
