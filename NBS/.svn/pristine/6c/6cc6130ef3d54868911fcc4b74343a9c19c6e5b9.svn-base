...
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%NEDSS_DIR%\libraries\ORACLE\ojdbc6.jar
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%NEDSS_DIR%\libraries\ORACLE\xdb6.jar
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%NEDSS_DIR%\libraries\ORACLE\xmlparserv2.jar
...
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%NEDSS_DIR%\libraries\PartnerServices\PartnerServices_v2.jar
