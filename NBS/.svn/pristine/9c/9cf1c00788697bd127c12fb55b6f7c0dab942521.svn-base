...
<html:form styleId="fileAttachmentForm" action="/UploadFiles.do" enctype="multipart/form-data" method="post">
    <table class="formTable" style="background:red; width:100%; height:100%; margin:0px;">
        <tr>
            <td colspan="2">
        ...
        <tr>
            ...
            <td><html:file property="ctFile" onchange="handleNewFileSelection(this.value)" name="fileUploadForm"> </html:file></td>
        </tr>
        <tr>
