...
public class NotificationsQueueForm extends BaseForm 
{
	...
	public void setNotifications(Collection<Object> notifications) {
	...
	{
		jurisdictionOptions = notificationsQueueUtil.getJurisdictionOptions(getNotifications());
		submittedByOptions  = notificationsQueueUtil.getSubmittedByOptions(getNotifications());
		caseStatusOptions = notificationsQueueUtil.getCaseStatusOptions(getNotifications());
		conditionOptions = notificationsQueueUtil.getConditionOptions(getNotifications());
		patientNameOptions = notificationsQueueUtil.getPatientNameOptions(getNotifications());
		notificationCodeOptions = notificationsQueueUtil.getNotificationCodeOptions(getNotifications());
		recipientOptions = notificationsQueueUtil.getRecipientOptions(getNotifications());
