...
import gov.cdc.nedss.proxy.ejb.entityproxyejb.bean.EntityProxyEJB;
...
public class PatientCreateSubmit
   ...
   /**
    * Instance of the Long class to hold a UID value
    */
      ...
      if (ids != null) {
        ...
        Iterator<Object>  itrIds = ids.iterator();
         ...
         while (itrIds.hasNext()) {
            ...
            if (id.getEntityUid() == null  || ( id.getEntityUid().intValue()==0)) { // this is a new one
