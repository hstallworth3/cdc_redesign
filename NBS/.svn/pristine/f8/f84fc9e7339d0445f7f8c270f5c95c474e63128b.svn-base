    ...
    <script type="text/javascript">
        ...
        function submitForm()
        {
            ...
            if(loincd != null && loincd.value.length == 0)
            {
                ...
                getElementByIdOrByName("cLoinc").style.color="red";
                isError = true;		
            }
            else {
            ...
            if( cname != null && cname.value.length == 0) {
                ...
                getElementByIdOrByName("descLoinc").style.color="red";
                isError = true;		
            }
            else {
                    ...
                    <fieldset style="border-width:0px;" id="loinc">
                        <nedss:container id="subsec3" classType="subSect" displayImg ="false">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:text styleId="loinc_cd" property="selection.loincCd" size="20" maxlength="20"/>
                                    </logic:equal>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text styleId="compName" property="selection.componentName" size="60" maxlength="200"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.property" size="60" maxlength="10"/>  
                                    </logic:notEqual>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.time_aspect" size="60" maxlength="10"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.system_cd" size="60" maxlength="50"/>
                                    </logic:notEqual>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.scale_type" size="60" maxlength="20"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.method_type" size="60" maxlength="50"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Edit">
                                        <html:text property="selection.display_name" size="60" maxlength="300"/>
                                    </logic:equal>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:text property="selection.display_name" size="60" maxlength="300"/>
                                    </logic:equal>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.related_class_cd" size="60" maxlength="50"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
