...
public class LegacyToPBConverterProcessor {
	...
	private static void loadMappingAndConversionMaps(Long conditionCdGroupId, HttpServletRequest request){
		try{
			...
			logger.error("Exception thrown while loading conversion mapping: conditionCdGroupId"+conditionCdGroupId+" ,Exception: "+ex.getMessage(), ex);
			throw new NEDSSSystemException(ex.getMessage());
		}
	}
	...
	private static Map<Long, String> getNotConvertedInterventionUids(Long conditionCdGroupId, HttpServletRequest request){
		try{
			...
			logger.error("Exception thrown getNotConvertedInterventionUids, conditionCdGroupId: "+conditionCdGroupId+", Exception: "+ex.getMessage(), ex);
			throw new NEDSSSystemException(ex.getMessage());
		}
	}
	...
	public static VaccinationProxyVO getVaccinationProxy(Long interventionUid, HttpServletRequest request){
		try{
			...
			logger.error("Exception thrown getVaccinationProxy interventionUid: "+interventionUid+", Exception: "+ex.getMessage(), ex);
			throw new NEDSSSystemException(ex.getMessage());
		}
	}
	...
	private static Long convertVaccination(long interventionUid, String busObjType, HttpServletRequest request){
		try{
			...
			logger.error("Exception thrown convertVaccination interventionUid: "+interventionUid+", Exception: "+ex.getMessage(), ex);
			throw new NEDSSSystemException(ex.getMessage());
		}
	}
	...
	private static Collection<Object> createActEntityFromParticipation(Collection<Object> participationCollection, VaccinationProxyVO vaccinationProxyVO)
	{
		try{
			...
			logger.error("Exception thrown createActEntityFromParticipation Exception: "+ex.getMessage(), ex);
			throw new NEDSSSystemException(ex.getMessage());
		}
	}
}
