 				...
 				title="${contactTracingForm.formFieldMap.CON129.tooltip}">
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON129.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON129)" maxlength="10" 
                            styleId="CON129" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON129','CON129Icon'); return false;" 
                ...
                <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON118.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON118)" maxlength="10" 
                            styleId="CON118" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON118','CON118Icon'); return false;" 
  ...
  title="${contactTracingForm.formFieldMap.CON121.tooltip}">
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON121.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON121)" maxlength="10" 
                            styleId="CON121" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON121','CON121Icon'); return false;" 
                 ...
                 <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON124.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON124)" maxlength="10" 
                            styleId="CON124" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON124','CON124Icon'); return false;" 
