...
public class LabResultProxyManager {
   ...
   * @throws Exception
   */
  public LabResultProxyVO getLabResultProxyVO(Long observationId, NBSSecurityObj nbsSecurityObj)throws Exception{
    entityMap.clear();
    ...
    checkMethodArgs(observationId, nbsSecurityObj);
     ...
     try{
       boolean exists = NNDMessageSenderHelper.getInstance().
           checkForExistingNotifications(lrProxyVO).booleanValue();
     ...
     try
     {
       ...
       ArrayList<Object> ldfList = (ArrayList<Object> )ldfHelper.getLDFCollection(observationId,null,nbsSecurityObj);

       if (ldfList != null)
       {
         lrProxyVO.setTheStateDefinedFieldDataDTCollection(ldfList);
       }
