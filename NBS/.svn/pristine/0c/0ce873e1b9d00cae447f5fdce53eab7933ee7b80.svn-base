...
public class SRTDisplayCodeDAOImpl extends DAOBase {
 ...
 private static final LogUtils logger = new LogUtils(SRTDisplayCodeDAOImpl.class.getName());
  private String SRTLabTestDisplayMappingORCL =
  ...
  private String SRTLoincDisplayMappingORCL =
...
private String AllDisplayCodesORCL =
...
public Collection<Object>  getLabTestDisplayMappingDTs(){
	...
	try{
		if (propertyUtil.getDatabaseServerType() != null &&
		  ...
		  query = SRTLabTestDisplayMappingORCL;
		}
		else {
...
public Collection<Object>  getLoincDisplayMappingDTs(){
	...
	try{
		if (propertyUtil.getDatabaseServerType() != null &&
		    propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
		  query = SRTLoincDisplayMappingORCL;
		}
		else {
