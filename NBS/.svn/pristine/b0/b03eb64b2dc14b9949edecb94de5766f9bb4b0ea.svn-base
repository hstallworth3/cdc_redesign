...
<script type="text/javaScript">
		...
		//the following code for Queue
	       ...
	       function makeMSelects() {
	    	    $j("#leventID").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	        	$j("#laction").multiSelect({actionMode: '<%=request.getAttribute("ActionMode")%>'});
	        	$j("#lalgorithmName").multiSelect({actionMode: '<%=request.getAttribute("ActionMode")%>'});
	        	$j("#lstatus").multiSelect({actionMode: '<%=request.getAttribute("ActionMode")%>'});
	            $j("#lmessageId").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	            $j("#lsrcName").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	            $j("#lentityNm").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	            $j("#laccessionNbr").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	            $j("#lobservationID").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	}
					...
					<nedss:container id="subsec0" classType="subSect"
						...
						<tr>
							...
							<td><html:text name="dsmActivityLogForm"
									...
									onkeyup="DateMask(this,null,event)" /> <html:img src="calendar.gif"
						...
						<tr>
							...
							<td>< html:multibox name="dsmActivityLogForm"
								property="activityLogClientVO.processStatus"
								value="Success"/>Success &nbsp;&nbsp;
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;< html:multibox
								name="dsmActivityLogForm"
								property="activityLogClientVO.processStatus"
