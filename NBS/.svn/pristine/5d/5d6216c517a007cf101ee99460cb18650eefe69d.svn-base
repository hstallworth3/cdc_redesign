...
//    public static final String ELR_PROCESS_CD_PROGRAM_ASSIGN = "PROGRAM_ASSIGN";
  ...
  "user_affiliation_txt \"UserAffiliationTxt\" from MsgIn_Person_ethnic_group ";
   ...
   //     ", 1 \"value\"  FROM "
    ...
    //+ " WHERE process_time > convert(datetime, ?) and process_time < convert(datetime, ?) ";
      ...
      public static final String SELECT_LOCAL_RESULT_DEFAULT_PROGRAM_AREA_CD_ORACLE =
 ...
 //     ", 1 \"value\"  FROM "
      ...
      public static final String SELECT_LOCAL_RESULT_DEFAULT_CONDITION_PROGRAM_AREA_CD_ORACLE =
      ...
      public static final String SELECT_LOCAL_TEST_DEFAULT_PROGRAM_AREA_CD_ORACLE =
       "select default_prog_area_cd \"key\" "+
       //     ", 1 \"value\"  FROM "
      " FROM " +        NEDSSConstants.SYSTEM_REFERENCE_TABLE+
      ...
      public static final String SELECT_LOCAL_TEST_DEFAULT_CONDITION_PROGRAM_AREA_CD_ORACLE =
		"SELECT prog_area_cd  \"key\" FROM   " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".Condition_code  " +
		" WHERE condition_cd = ( SELECT default_condition_cd FROM " +
	 ...
	 "SELECT "
	  ...
	  public static final String JURISDICTION_SELECT_ORACLE = "Select b.jurisdiction_cd \"key\", 1 \"value\" " +
		...
		public static final String JURISDICTION_CITY_SELECT_ORACLE = "select a.jurisdiction_cd \"key\", 1 \"value\" " +
			"from " + NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".jurisdiction_participation a, " +
			NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".city_code_value b " +
			"where a.fips_cd= b.code " +
			"and a.type_cd = ? " +
			"and UPPER(substr(b.code_desc_txt, 0, length(b.code_desc_txt)- 4)) =  UPPER(?) " +
			"and b.parent_is_cd = ? ";
