...
<script language="JavaScript">
	function editForm() 
	{
     ...
     {
     	var algorithmName = '<%=request.getAttribute("AlgorithmNm")%>';
     ...
     {
      	var algorithmUid = '<%=request.getAttribute("algorithmUid")%>';
...
<html:form>
    ...
    <% } %>
	<input type="hidden" id="actionMode" value="${decisionSupportForm.actionMode}"/> 
	<!-- Algorithm Summary Bar --> <%@ include file="AlgorithmSummary.jsp"%>
	<!-- Tab container -->
