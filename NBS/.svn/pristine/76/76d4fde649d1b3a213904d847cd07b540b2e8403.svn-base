...
set CASE_MANAGEMENT;
	...
	FL_FUP_EXPECTED_IN_IND_CD = PUT(FL_FUP_PROV_DIAGNOSIS, $R_YNF.);
...
PROC SQL;
	CREATE TABLE CLINICAL AS SELECT
		...
		CLN_PROVIDER_DIAG AS CLN_SURV_PROVIDER_DIAG_CD, 'CLN_SURV_PROVIDER_DIAG_CD',
		STD_HIV_CASE.INVESTIGATION_KEY
	FROM
