...
public class GenerateJSPTabs {
	 ...
	 * 
	 */
	public void processIndex (String xmlInputFile, String xpath, String xsltFile,String mode, String dir,String Jsptype)throws Exception {
	...
	public void processTabs (String xmlInputFile, String xpath, String xsltFile,String mode,String dir,String Jsptype, String businessObjectType)throws Exception {
		...
		try {
	      ...
	      if (businessObjectType.equalsIgnoreCase(NEDSSConstants.INVESTIGATION_BUSINESS_OBJECT_TYPE)) {
	    	  trans.setParameter("the_form", "PageForm");
	      	  trans.setParameter("the_prop", "pageClientVO");
		  } else if (businessObjectType.equalsIgnoreCase(NEDSSConstants.CONTACT_BUSINESS_OBJECT_TYPE)) {
			  trans.setParameter("the_form", "contactTracingForm");
	      	  trans.setParameter("the_prop", "cTContactClientVO");
		  } else if (businessObjectType.equalsIgnoreCase(NEDSSConstants.INTERVIEW_BUSINESS_OBJECT_TYPE)) {
			  trans.setParameter("the_form", "PageForm");
	      	  trans.setParameter("the_prop", "pageClientVO");
		  } else if (businessObjectType.equalsIgnoreCase(NEDSSConstants.VACCINATION_BUSINESS_OBJECT_TYPE)) {
			  trans.setParameter("the_form", "PageForm");
	      	  trans.setParameter("the_prop", "pageClientVO");
		  }
		} catch (TransformerConfigurationException ex) {
