...
//		}
	...
	public static void appendElectronicLabIcon(PatientSrchResultVO observationSummaryDisplayVO){
		...
		//if(observationSummaryDisplayVO.getType().trim().equals("Lab Report")){
			if(observationSummaryDisplayVO.getElectronicInd()!=null && observationSummaryDisplayVO.getElectronicInd().equals("Y")){
				observationSummaryDisplayVO.setDocumentType(event+"<br><img src=\"ind_electronic.gif\" title=\"Electronic Lab\">");
			}else
	...
	/**
  	...
  	public void setDateFormat(SummaryDT summaryDt, ObservationSummaryDisplayVO observationSummaryDisplayVO){
  		String startDate = summaryDt.getAddTime()==null?"No Date":StringUtils.formatDate(summaryDt.getAddTime());
		startDate = startDate+"<br>"+StringUtils.formatDatewithHrMin(summaryDt.getAddTime());

		String startDatePrint = summaryDt.getAddTime()==null?"No Date":StringUtils.formatDate(summaryDt.getAddTime());
		startDatePrint = startDatePrint+"\n"+StringUtils.formatDatewithHrMin(summaryDt.getAddTime());
           
		observationSummaryDisplayVO.setDateReceived(startDate);   
		observationSummaryDisplayVO.setDateReceived(summaryDt.getAddTime()); 
