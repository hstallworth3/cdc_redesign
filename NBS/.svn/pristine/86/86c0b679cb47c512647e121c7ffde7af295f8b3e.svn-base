...
"C:\Program Files\SASHome\x86\SASFoundation\9.3\sas.exe" -sysin C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\dw\etl\src\CreateRDBMetadataTable.sas -nosyntaxcheck -log C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\AlterTableUpdate.log -config  "C:\Program Files\SASHome\x86\SASFoundation\9.3\SASV9.CFG" -autoexec C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\autoexec.sas
...
:true
@rem ORACLE SETTINGS
sqlplus nbs_rdb/rdb@nbs_rdb @C:\wildfly-10.0.0.Final\nedssdomain\Nedss\BatchFiles\Refresh_Oracle_RDB_tables.sql > C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\Drop_Create_Tables.log
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\Drop_Create_Tables.log
GOTO END
:false 
@rem SQL SERVER SETTINGS
sqlcmd -U nbs_rdb -P rdb -S nnnnnnn\sqlexpress -d rdb -i C:\wildfly-10.0.0.Final\nedssdomain\Nedss\BatchFiles\Refresh_SQL_RDB_tables.sql > C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\Drop_Create_Tables.log
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\Drop_Create_Tables.log 
GOTO END
:END	
@rem execute the SAS MasterEtl program 
"C:\Program Files\SASHome\x86\SASFoundation\9.3\sas.exe" -sysin C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\dw\etl\src\MasterETL.sas -nosyntaxcheck -print C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\MasterETL.lst -log C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\MasterETL.log -config  "C:\Program Files\SASHome\x86\SASFoundation\9.3\SASV9.CFG" -autoexec C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\autoexec.sas
@rem type C:\wildfly-10.0.0.Final\nedssdomain\Nedss\report\log\MasterETL.log 
osql -U nbs_rdb -P rdb -S a27704\sqlexpress -d rdb -i C:\wildfly-10.0.0.Final\nedssdomain\Nedss\BatchFiles\RedefineTablespace.sql
:cannotproceed
