...
<div class="view" id="<%= tabId %>" style="text-align:center;"> 
		...
		<xsl:if test="TextQuestion">
			...
			<xsl:comment>processing ReadOnly Textbox Text Question</xsl:comment>            
                		...
                		<xsl:if test="$thisReq= 'T'"><xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#FF0000">*</span>]]></xsl:text></xsl:if> 
			...
			<xsl:choose>
				...
				<xsl:if test="$thisReq= 'T'">
				    <xsl:text disable-output-escaping="yes"><![CDATA[<span style="color:#FF0000">*</span>]]></xsl:text>					
				</xsl:if>
