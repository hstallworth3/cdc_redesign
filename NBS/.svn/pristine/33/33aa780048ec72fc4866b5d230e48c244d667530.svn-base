...
import java.util.Collection;
  ...
  public class SummaryDataDAOImpl extends BMPBase
  {
    ...
    public static final String SELECT_PUBLCI_HEALTH_CASE=
                               ...
                               "CASE_TYPE_CD=?";
    public static final String SELECT_PROG_AREA_CD_SQL = "SELECT PROG_AREA_CD FROM "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE + "..CONDITION_CODE WHERE CONDITION_CD=?";
    public static final String SELECT_PROG_AREA_CD_ORA = "SELECT PROG_AREA_CD FROM "+ NEDSSConstants.SYSTEM_REFERENCE_TABLE + ".CONDITION_CODE WHERE CONDITION_CD=?";
                                               ...
                                               throws NEDSSSystemException
    {
    	try{
	      ...
	      if (propertyUtil.getDatabaseServerType() != null &&
	              ...
	              statement =  SummaryDataDAOImpl.SELECT_PUBLCI_HEALTH_CASE;
	      else
	              statement =  SummaryDataDAOImpl.SELECT_PUBLCI_HEALTH_CASE;
    ...
    public String getProgAreaCd(String conditionCd)
    {
        ...
        try
        {
    		...
    		if (propertyUtil.getDatabaseServerType() != null
    			...
    			codeSql = SELECT_PROG_AREA_CD_ORA;
    		} else {
