...
public class SRTLabResultDAOImpl extends DAOBase {
 ...
 private static PropertyUtil propertyUtil= PropertyUtil.getInstance();	
  private String srtLabTestLabResultMappingORCL =
  ...
  private String allLabResultsQueryORCL =
      ...
      " lr.NBS_UID \"labResultNbsUid\" " +
      " from "+NEDSSConstants.SYSTEM_REFERENCE_TABLE+".lab_result lr "+
      " order by upper(lr.LAB_RESULT_DESC_TXT)";
...
public Collection<Object> getLabResultsSRTLabTestLabResultMapping(){
	  ...
	  try{
		  if (propertyUtil.getDatabaseServerType() != null &&
		    ...
		    query = srtLabTestLabResultMappingORCL;
		  }
		  else {
