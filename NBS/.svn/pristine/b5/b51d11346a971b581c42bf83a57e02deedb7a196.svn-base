			...
			if (!idDT.getRecordStatusCd().equals(
				...
				try {
					...
					if (coded.getCode() != null
						...
						idDT.setAssigningAuthorityDescTxt(coded
								.getCodeDescription());
...
// null if this is new
   ...
   public static void convertPersonToRequestObj(PersonVO personVO,
     ...
     public static void convertEntityLocatorCollectionToRequestObj(PersonVO
       personVO, HttpServletRequest request, String action, ArrayList<Object> stateList) {
   ...
   public static void convertRaceAndEthnicityToRequestObj(PersonVO personVO,
      ...
      if (races != null) {
        ...
        Iterator<Object>  iter = races.iterator();
         ...
         request.setAttribute("americanIndian", sAmericanIndian.toString());
         request.setAttribute("white", sWhite.toString());
         request.setAttribute("africanAmerican", sAfricanAmerican.toString());
    ...
    public static void convertIdsCollectionToRequestObj(PersonVO personVO,
      ...
      if (ids != null) {
        ...
        Iterator<Object>  iter = ids.iterator();
         ...
         logger.info("ID parsed String: " + combinedIds.toString());
	   ...
	   for(int i=0;i<list.size();i++){
		   ...
		   if(be != null){
			   ...
			   if(map != null){
	               ...
	               idDt.setTypeCd(map.get("idType"));
	               idDt.setAssigningAuthorityCd(map.get("idAssgn"));
