...
<tr>
    ...
    <td>
        <html:radio  styleId="nndIndY" onclick="handleMessagingFields(true)" name="manageQuestionsForm"  property="selection.nndMsgInd"  value="<%= NEDSSConstants.TRUE %>"/> Yes
        &nbsp;<html:radio  styleId="nndIndN" onclick="handleMessagingFields(false)" name="manageQuestionsForm"  property="selection.nndMsgInd"  value="<%= NEDSSConstants.FALSE %>"/> No
    </td>               
</tr>
...
<tr class="messagingFieldTr">
    ...
    <td>
        <html:text property="selection.questionIdentifierNnd" size="25" maxlength="50" styleId="msgVariableId"/>      
    </td>
</tr>
...
<tr class="messagingFieldTr">
    ...
    <td>
        <html:text property="selection.questionLabelNnd" size="50" maxlength="100" style="width:500px;" styleId="msgLabel"/>      
    </td>
</tr>
...
<tr class="messagingFieldTr">
    ...
    <td>
        <html:select   name="manageQuestionsForm" property="selection.questionOidCode" styleId="msgcodeSysName" acomplete="false" > 
...
<tr class="messagingFieldTr">
    ...
    <td>
        <html:radio styleId="reqInMsgY" name="manageQuestionsForm" property="selection.questionReqNnd" value="<%= NEDSSConstants.REQUIRED %>"/> Yes	
        &nbsp;
        <html:radio styleId="reqInMsgN" name="manageQuestionsForm" property="selection.questionReqNnd" value="<%= NEDSSConstants.OPTIONAL %>"/> No		
    </td>               
</tr>
...
<tr class="messagingFieldTr">
    ...
    <td>
        <html:select property="selection.questionDataTypeNnd" styleId = "hl7Datatype" >
