			...
			<nedss:container id="section3" name="Action" classType="sect"
				...
				<nedss:container id="subsec4" classType="subSect"
					...
					<tr>
						...
						<td><html:select name="decisionSupportForm"
					...
					<tr>
						...
						<td id="RelatedField"><logic:equal name="decisionSupportForm"
								...
								<html:select name="decisionSupportForm"
					...
					<tr>
						...
						<td id="PublishedConditionField"><html:select
					...
					<tr>
						...
						<td id="onFailField"><html:select name="decisionSupportForm"
					...
					<tr>
						<td class="fieldName" id="onFailReviewLabel"><font
							class="boldTenRed"> * </font><span>On Failure to Mark as
								Reviewed:</span></td>
						<td id="onFailReviewField"><html:select
								name="decisionSupportForm"
				...
				<nedss:container id="IdAdvancedSubSection" classType="subSect"
					...
					<tr>
						...
						<td>
							<div id="advDate">
								<html:text name="decisionSupportForm"
							...
							</div> <html:textarea style="WIDTH: 500px; HEIGHT: 100px;"
					...
					<tr>
						<td colspan="3" width="100%">
							<span><b>If the number of days falls within the timeframe specified below, the action specified in the algorithm will be 
																...
																and existing investigations for the same patient and condition (specimen collection date of earliest associated lab or investigation 
																create date if no associated lab).
													</span></td>
											</tr>
											
											<tr>
												<td nowrap class="fieldName" id="applyTimeFrameLogicL"><font
													class="boldTenRed"> * </font><span>Apply
														timeframe logic to this algorithm: </span></td>
												<td colspan="2">
													<html:radio onclick="enableDisableTimeLogic(this);"  name="decisionSupportForm"
													...
													</html:radio> <html:radio onclick="enableDisableTimeLogic(this)"  name="decisionSupportForm"
														property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.USE_EVENT_DATE_LOGIC+")"%>'
											...
											<tr>
												...
												<td colspan="2">
													<html:select name="decisionSupportForm"
														...
														<html:optionsCollection property="codedValue(NBS_EVENT_DATE)" 	value="key" label="value" />
														</html:select>
													</td>
											</tr>
											<tr>
												<td class="fieldName" id="TimeFrameOpSelL"><font
													class="boldTenRed"> * </font><span>Timeframe: </span></td>
												<td colspan="2">
													<table id="timeFrameTable" style="padding: 0; margin: 0; border: 0;">
														<tr>
															<td>
																<html:select name="decisionSupportForm"
																...
																<html:optionsCollection property="codedValue(NBS_BRE_LOGIC_1)" 	value="key" label="value" />
																</html:select>
															</td>
															<td valign="center">&nbsp;
																<html:text name="decisionSupportForm" property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.TIMEFRAME_DAYS+")"%>'
																	size="4" maxlength="4" title="The number of days." styleId="TimeFrameDays" onkeyup="isNumericCharacterEntered(this)"  disabled="true"/>
											...
											<tr>
															...
															<td colspan="2"><html:radio name="decisionSupportForm"
				...
				<nedss:container id="ElrIdAdvancedSubSection" classType="subSect"
					...
					<tr>
						...
						<td colspan="3">
							<table id="numericResultTable" style="padding: 0; margin: 0; border: 0;">
								<tr>
									<td>
										<html:select name="decisionSupportForm"
					...
					<tr>
						<td class="fieldName"><font class="boldTenRed"> * </font><span
							class="InputFieldLabel" id="textResultL" title="Text Result">
								Text Result: </span></td>
						<td colspan="3">
							<table id="textResultTable" style="padding: 0; margin: 0; border: 0;">
								<td valign="top">
									<html:select name="decisionSupportForm" property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.TEXT_RESULT_CRITERIA+")"%>' styleId="resultOperatorList" 
								...
								<td>&nbsp;</td>
								<td><html:text name="decisionSupportForm"
				...
				<nedss:container id="IdSubSection" classType="subSect"
											...
											<tbody id="questionbodyIdSubSection">
												<tr id="patternIdSubSection" class="odd"
													...
													<td style="width: 3%; text-align: center;"><input
														...
														title="Edit"></td>
													<td style="width: 3%; text-align: center;"><input
														id="deleteIdSubSection" type="image" src="cross.gif"
					...
					<tr>
						...
						<td>
							<div id="date">
							<html:radio name="decisionSupportForm"
							...
							<div id="Part_Per_Div">
								...
								<html:text property="decisionSupportClientVO.answer(CriteriaValue)" styleId="PartPerText" size="5" maxlength="10" />
					...
					<tr id="defaultidNote" style="display: none">
						...
						<td><html:textarea style="WIDTH: 500px; HEIGHT: 100px;"
					...
					<tr>
						...
						<td><input type="hidden" name="approval1" value="N">
							<html:radio name="decisionSupportForm"
								...
								<FONT COLOR="#808080"> Yes</FONT>
							</html:radio> <html:radio name="decisionSupportForm"
								property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.QUEUE_FOR_APPROVAL+")"%>'
								styleId="approval" value="N" disabled="true">
								<FONT COLOR="#808080"> No</FONT>
							</html:radio></td>
					</tr>
					<tr>
