...
public class NedssFrontLogController extends HttpServlet implements SingleThreadModel
{
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        out.println("<html>" + "<head>" + "<title>Reload Logger</title>" + "</head>" + "<body>" + "<p><b>NEDSS Management Console</b><p>" + "<form name=\"input\" action=\"" + strNedssFrontLogContorllerURL + "\"" + "method=\"get\">");
