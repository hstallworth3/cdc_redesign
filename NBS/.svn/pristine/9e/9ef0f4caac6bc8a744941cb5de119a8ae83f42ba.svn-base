                        ...
                        <fieldset style="border-width:0px;" id="search">
                            <nedss:container id="subsec1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:text styleId="srchLabTest" property="searchCriteria(LABTEST)" maxlength="20"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldName" id="labDes"><font class="boldTenRed" > * </font> <span>Lab Test Description:</span></td>
                                    <td>
                                        <html:select styleId="srchCriteria" property="searchCriteria(SRCH_CRITERIA)" acomplete="false">
                                            <html:optionsCollection property="searchCriteriaDropDown" value="key" label="value"/>
                                        </html:select>						 
                                        <html:text styleId="srchLabTestDesc" property="searchCriteria(TEST_DESC)" size="50" maxlength="100"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fieldName" id="lab"><font class="boldTenRed" > * </font><span>Lab Name:</span></td>
                                    <td>
                                        <html:select property="searchCriteria(LABID)" styleId="srchLabId">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:select styleId="testType" property="searchCriteria(TEST_TYPE)">
