...
public class AssociatedInvestigationUpdateUtil {
	 ...
	 * @throws RemoteException
	 */
	public void updateForConInfectionId(PageActProxyVO pageActProxyVO,PageActProxyVO supersededProxyVO,Long mprUid, Map<Object, Object> coInSupersededEpliLinkIdMap, Long currentPhclUid, Collection<Object> coinfectionSummaryVOCollection, String coinfectionIdToUpdate, NBSSecurityObj nbsSecurityObj) throws RemoteException {
		try {
			...
			if(nbsQuestionUidCollection!=null) {
				...
				while(iterator.hasNext()) {
					...
					}else if(repeatingAnswermapMap.get(dropDownCodeDT.getLongKey()+"")!=null 
				...
				while(coinfectionsummIterator.hasNext()) { 
					...
					if(coninfectionSummaryVO.getPublicHealthCaseUid().compareTo(currentPhclUid)!=0){	
						if(coinfectionIdToUpdate!=null){//Merge Case investigation scenario
							updateCoInfectionInvest(updatedValuesMap, mapFromQuestions, pageActProxyVO.getPublicHealthCaseVO(), supersededProxyVO.getPublicHealthCaseVO(), coInSupersededEpliLinkIdMap, coninfectionSummaryVO, coinfectionIdToUpdate, nbsSecurityObj);
														/**Update for closed/open cases that are part of any co-infection groups */
							}
									
						else{
								updateCoInfectionInvest(updatedValuesMap, mapFromQuestions, pageActProxyVO.getPublicHealthCaseVO(), null, null, coninfectionSummaryVO, null, nbsSecurityObj);
						}
					}
					}
				}
	...
	private  void updateCoInfectionInvest(Map<Object, Object> mappedCoInfectionQuestions,Map<Object, Object>  fromMapQuestions ,PublicHealthCaseVO publicHealthCaseVO,PublicHealthCaseVO supersededPublicHealthCaseVO, Map<Object, Object> coInSupersededEpliLinkIdMap, CoinfectionSummaryVO coninfectionSummaryVO, String coinfectionIdToUpdate,  NBSSecurityObj nbsSecurityObj) throws RemoteException {
