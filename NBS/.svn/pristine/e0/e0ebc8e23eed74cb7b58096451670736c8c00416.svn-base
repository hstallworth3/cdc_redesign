                    ...
                    <fieldset style="border-width:0px;"  id="labtests">
                        <nedss:container id="subsec3" classType="subSect" displayImg ="false">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:text property="selection.labTestCd" size="20" maxlength="20" onkeyup="isSpecialCharEnteredForCode(this)"/>
                                    </logic:equal>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.labTestDescTxt" size="60"  maxlength="100"/>
                                    </logic:notEqual>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:select property="selection.defaultProgAreaCd" styleId="progAreaCd">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:select property="selection.defaultConditionCd" styleId="condCd">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.drugTestInd" value="1"/>
                                        <input type="hidden" name="selection.drugTestInd" value="0">
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.drugTestInd" value="1" disabled="true"/>              
                                    </logic:equal>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.organismResultTestInd" value="1"/>              
                                        <input type="hidden" name="selection.organismResultTestInd" value="0">
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.organismResultTestInd" value="1" disabled="true"/>              
                                    </logic:equal>              
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.indentLevelNbr" value="1"/>
                                        <input type="hidden" name="selection.indentLevelNbr" value="0">
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:checkbox name="SRTAdminManageForm" property="selection.indentLevelNbr" value="1" disabled="true"/>	           
                                    </logic:equal>              
                                </td>
                            </tr>
                            <% 
                            ...
                            <tr>
	        	                ...
	        	                <td>
	        	                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
	        	                        <html:checkbox name="SRTAdminManageForm" property="selection.paDerivationExcludeCd" value="1"/>
	        	                        <input type="hidden" name="selection.paDerivationExcludeCd" value="0">
	        	                    </logic:notEqual>
	        	                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
	        	                        <html:checkbox name="SRTAdminManageForm" property="selection.paDerivationExcludeCd" value="1" disabled="true"/>	           
	        	                    </logic:equal>              
	        	                </td>
	        	            </tr>
	        	            <%}%>
