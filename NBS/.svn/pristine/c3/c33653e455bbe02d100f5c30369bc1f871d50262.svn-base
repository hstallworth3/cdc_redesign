...
public class  HL7SpecimenProcessor{
	...
	public static void process251Specimen(HL7PatientResultSPMType hL7PatientResultSPMType, LabResultProxyVO labResultProxyVO, ObservationDT observationDT, PersonVO collectorVO, EdxLabInformationDT edxLabInformationDT) throws NEDSSAppException{
		try {
	...
	public static void processSpecimen(HL7OBRType hl7OBRType, LabResultProxyVO labResultProxyVO, ObservationDT observationDT, PersonVO collectorVO, EdxLabInformationDT edxLabInformationDT) throws NEDSSAppException{
	...
	private static void processMaterialVO(LabResultProxyVO labResultProxyVO,PersonVO collectorVO,MaterialVO materialVO,  EdxLabInformationDT edxLabInformationDT) throws NEDSSAppException{
		try {
			...
			if(collectorVO!=null){
				...
				role2DT.setRoleSeq(new Integer(2));
