...
<html>
	<head>
	 <base target="_self">
	    ...
	    <SCRIPT LANGUAGE="JavaScript" >
			...
			{
				var lab = '<%=request.getAttribute("identifier")%>';
			...
			function findProvider(id)
			{
				...
				if(msg.length > 0) {
					...
					isError = true;	
					getElementByIdOrByName("zipCodeLabel").style.color="#FF0000";
				}
				else {
				...
				if(atLeastOneSearchCriteria==true )
				{
					...
					if( ph.value.length< 12 && ph.value!=null && ph.value!="")
					{
						...
						isError = true;
						getElementByIdOrByName("phoneNumberLabel").style.color="#F00";
				     }
				     else {
				...
				if( idType.value.length == 0 && idValue.value.length > 0) {
					...
					errorMsgArray.push(errorText);
					isError = true;
					getElementByIdOrByName("idTypeLabel").style.color="#F00";
				}
				else {
				...
				if(idType.value.length > 0 && idValue.value.length == 0) {
					...
					errorMsgArray.push(errorText);				
					isError = true;
					getElementByIdOrByName("idValueLabel").style.color="#F00";
				} 
				else {
	...
	<body class="popup" onload="autocompTxtValuesForJSP();focusOnFirstBodyElement();" onkeypress="SubmitOnEnter();">
        <!-- Page title -->
        ...
        <div class="popupButtonBar">
            <input type="submit" name="Submit" value="Submit" onclick="return findProvider('<%=queId%>');"/>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="conditionControl" style="white-space:nowrap"> 
                            <html:select name="providerSearchForm" property="providerSearch.lastNameOperator" 
                                    styleId="lnoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_SNDX)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td style="white-space:nowrap">
                            <html:text styleId ="lastNameTxt" name="providerSearchForm" property="providerSearch.lastName"/>
                        </td> 
                    </tr>
                    <!-- First Name -->
                    <tr>
                        ...
                        <td class="conditionControl"> 
                            <html:select name="providerSearchForm" property="providerSearch.firstNameOperator"  
                                    styleId="fnoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_SNDX)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td >
                            <html:text name="providerSearchForm" property="providerSearch.firstName"/>
                        </td> 
                    </tr>
                    <!-- Street Address -->
                    <tr>
                        ...
                        <td class="conditionControl"> 
                            <html:select name="providerSearchForm" property="providerSearch.streetAddr1Operator"  
                                    styleId="saoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td>
                            <html:text name="providerSearchForm" property="providerSearch.streetAddr1"/>
                        </td> 
                    </tr>
                    <!-- City -->
                    <tr>
                        ...
                        <td class="conditionControl"> 
                            <html:select name="providerSearchForm" property="providerSearch.cityDescTxtOperator"  
                                    styleId="cdoperator">
                                <html:optionsCollection property="codedValueNoBlnk(SEARCH_ALPHA)" value="key" label="value"/>
                            </html:select>
                        </td>
                        <td>
                            <html:text name="providerSearchForm" property="providerSearch.cityDescTxt"/>
                        </td> 
                    </tr>
                    <!-- State -->
                    <tr>
                        ...
                        <td style="white-space:nowrap">
                            <html:select name="providerSearchForm" property="providerSearch.state"  styleId="stoperator">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text name="providerSearchForm" property="providerSearch.zipCd"/>
                        </td> 
                    </tr>
                    <!-- Telephone -->
                    <tr>
                        ...
                        <td>
                            <html:text name="providerSearchForm" property="providerSearch.phoneNbrTxt" onkeyup="TeleMask(this,null,event)"/>
                        </td> 
                    </tr>
                    <!-- ID Type -->
                    <tr>
                        ...
                        <td style="white-space:nowrap">
                            <html:select name="providerSearchForm" property="providerSearch.typeCd"  styleId="tcoperator">
                    ...
                    <tr>
                        ...
                        <td>
                            <html:text name="providerSearchForm" property="providerSearch.rootExtensionTxt"/>
                        </td> 
                    </tr>
                </tbody>
            </table>
