...
public class DataSourceColumnDAO extends BMPBase
{
    ...
    public DataSourceColumnDT view(long uid) throws NEDSSDAOSysException
    {
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                dt.setColumnTitle(rs.getString("column_title"));
                ...
                dt.setDisplayable(rs.getString("displayable"));
                dt.setFilterable(rs.getString("filterable"));
    ...
    public ArrayList<Object> list(long uid) throws NEDSSDAOSysException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                dt.setDisplayable(rs.getString("displayable"));
                dt.setFilterable(rs.getString("filterable"));
                String codeset = rs.getString("codeset_nm") == null ? "" : rs.getString("codeset_nm");
                if(codeset.startsWith("CODE_VALUE_GENERAL"))
    ...
    public void edit(DataSourceColumnDT dt) throws NEDSSDAOSysException
    {
        ...
        if(dt.getCodesetNm() == null && (dt.getDataSourceCodesetUid() != null && dt.getDataSourceCodesetUid().length() > 0))
        	deleteDataSourceCodeSet(dt.getColumnUID());
        else if(dt.getDataSourceCodesetUid() == null && (dt.getCodesetNm()!= null && dt.getCodesetNm().length() > 0 ))
        	addDataSourceCodeSet(dt);
        else if((dt.getCodesetNm() != null && dt.getCodesetNm().length() > 0) && (dt.getDataSourceCodesetUid() != null && dt.getDataSourceCodesetUid().length() > 0))
        	updateDataSourceCodeSet(dt);
