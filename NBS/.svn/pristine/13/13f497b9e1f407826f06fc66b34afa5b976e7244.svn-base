        ...
        <!-- Jurisdiction -->
            <tr>
                ...
                <td class="conditionControl"> 
                    <html:select disabled ="${contactTracingForm.formFieldMap.CON134.state.disabled}" name="contactTracingForm" property="cTContactClientVO.answerMap(CON134)" styleId = "CON134">
	               ...
	               <td class="fieldName">
	                ...
	                <td>
	                    <html:text disabled="true"
	                            name="contactTracingForm" property="cTContactClientVO.answer(CON138)" maxlength="10"
	                            styleId="CON138" value="" onkeyup="DateMask(this,null,event)" size="10"/>
	                    <html:img src="calendar.gif" onclick="getCalDate('CON138','CON138Icon'); return false;"
               ...
               <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON140.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON140)" maxlength="10" 
                            styleId="CON140" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON140','CON140Icon'); return false;" 
                ...
                <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON101.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON101)" maxlength="10" 
                            styleId="CON101" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON101','CON101Icon'); return false;" 
                ...
                <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON107.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON107)" maxlength="10" 
                            styleId="CON107" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON107','CON107Icon'); return false;" 
                ...
                <td class="fieldName"> 
	          	...
	          	<td>
	                <html:text disabled ="${contactTracingForm.formFieldMap.CON108.state.disabled}" 
                            name="contactTracingForm" property="cTContactClientVO.answer(CON108)" maxlength="10" 
                            styleId="CON108" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('CON108','CON108Icon'); return false;" 
