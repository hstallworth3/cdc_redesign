        	   ...
        	   for(var i=0; i<checkElements.length; i++){
        		  var isChecked = checkElements[i].checked;
        		   if(isChecked){
        			   ...
        			   var phc = href.substring(href.lastIndexOf("=")+1,href.lastIndexOf("=")+9);
...
<% } %> 
			...
			<logic:equal name="viewInves" value="true">
				...
				<display:table name="strInvestigationEventList" class="bluebardtTable"  id="eventSumaryInv">
		 		<logic:equal name="mergeInves" value="true">
   				    <display:column style="width:1.5%;text-align:center;" media="html" title="" ><input type="checkbox" name="selectCheckBox"/> </display:column>
   				</logic:equal>
				   ...
				   <display:column property="mergeInvStatus" style="width:18%;text-align:left;" title="" class="hidden" headerClass="hidden"/> 
				</display:table> 
			</td></tr>
			</logic:equal>
	...
	<input id="ContextAction" type="hidden" name="ContextAction" value="<%=request.getAttribute("ContextAction")==null?"":request.getAttribute("ContextAction")%>">	
	</div>
