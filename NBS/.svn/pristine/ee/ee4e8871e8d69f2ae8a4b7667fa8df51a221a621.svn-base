...
if find(descrip,'DISPO. A:','i') ge 1 then &name = "&val_PA" ;
if find(descrip,'DISPO. C:','i') ge 1 then &name = "&val_PC" ;
...
if find(descrip,'DISPO. B:','i') ge 1 then &name = "&val_PB";
if find(descrip,'DISPO. D:','i') ge 1 then &name = "&val_PD";

if find(descrip,'DISPO. E:','i') ge 1 then &name = "&val_PE" ;
if find(descrip,'DISPO. F:','i') ge 1 then &name = "&val_PF" ;
...
if find(descrip,'DISPO. Z:','i') ge 1 then &name = "&val_PZ" ;

if find(descrip,'CLUSTERS INITIATED:','i') ge 1 then &name = "&val_CM" ;
if find(descrip,'CLUSTERS EXAMINED:','i') ge 1 then &name = "&val_CN" ;
if find(descrip,'DISPO A:','i') ge 1 then &name = "&val_CA" ;
if find(descrip,'DISPO C:','i') ge 1 then &name = "&val_CC" ;
...
if find(descrip,'DISPO B:','i') ge 1 then &name = "&val_CB";
if find(descrip,'DISPO D:','i') ge 1 then &name = "&val_CD";

if find(descrip,'DISPO E:','i') ge 1 then &name = "&val_CE" ;
if find(descrip,'DISPO F:','i') ge 1 then &name = "&val_CF" ;
...
if find(descrip,'DISPO Z:','i') ge 1 then &name = "&val_CZ" ;
...
if find(descrip,'DISPO. A:','i') ge 1 then &per = put(round("&per_PA",0.001),percent8.1) ;
if find(descrip,'DISPO. C:','i') ge 1 then &per = put(round("&per_PC",0.001),percent8.1) ;

if find(descrip,'DISPO. B:','i') ge 1 then &per = put(round("&per_PB",0.001),percent8.1) ;
if find(descrip,'DISPO. D:','i') ge 1 then &per = put(round("&per_PD",0.001),percent8.1) ;
if find(descrip,'DISPO. E:','i') ge 1 then &per = put(round("&per_PE",0.001),percent8.1) ;
if find(descrip,'DISPO. F:','i') ge 1 then &per = put(round("&per_PF",0.001),percent8.1) ;
...
if find(descrip,'DISPO. Z:','i') ge 1 then &per = put(round("&per_PZ",0.001),percent8.1) ;
...
if find(descrip,'DISPO A:','i') ge 1 then &per = put(round("&per_CA",0.001),percent8.1) ;
if find(descrip,'DISPO C:','i') ge 1 then &per = put(round("&per_CC",0.001),percent8.1) ;

if find(descrip,'DISPO B:','i') ge 1 then &per = put(round("&per_CB",0.001),percent8.1) ;
if find(descrip,'DISPO D:','i') ge 1 then &per = put(round("&per_CD",0.001),percent8.1) ;
if find(descrip,'DISPO E:','i') ge 1 then &per = put(round("&per_CE",0.001),percent8.1) ;
if find(descrip,'DISPO F:','i') ge 1 then &per = put(round("&per_CF",0.001),percent8.1) ;
...
if find(descrip,'DISPO Z:','i') ge 1 then &per = put(round("&per_CZ",0.001),percent8.1) ;
run;
%Mend ;
%fills(col1,col2);
