...
public class ProviderLoad
  ...
  //  stores the states so i can retrieve the counties for view
  private ArrayList<Object> stateList = null;
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form,
   ...
   if(err111 != null) {
     ...
     if(sCurrTask.startsWith("Add"))
      ...
      convertProviderToRequestObj(providerForm.getProvider(),request);
     ...
     if(strUID!=null)
     {
       if (!strUID.equals("")) {
        ...
        if (person != null) {
          ...
          convertProviderToRequestObj(person, request);
    ...
    //  EDIT
      ...
      if (!strUID.equals(null)) {
        ...
        PersonVO personVO = getOldProviderObject(
            ...
            providerForm,
            session);
        convertProviderToRequestObj(personVO, request);
                ...
                sParsedAddresses.append(NEDSSConstants.BATCH_SECT).append("address[i].thePostalLocatorDT_s.streetAddr1").append(NEDSSConstants.BATCH_PART);
                 ...
                 if (postal.getStateCd() != null){
                   ...
                   if(this.stateList==null)
                	   this.stateList = new ArrayList<Object> ();
                   this.stateList.add(postal.getStateCd());
                 }
  ...
  private void prepareAddressCounties(HttpServletRequest request) {
    ...
    if (this.stateList != null) {
     ...
     Iterator<Object>  i = this.stateList.iterator();
