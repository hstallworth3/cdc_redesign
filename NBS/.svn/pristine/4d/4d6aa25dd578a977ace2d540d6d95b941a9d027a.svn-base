...
function labTestFilterFromMorb()
{
	...
	//getLabTestData(labCode, progAreaCode,labTestType, target);
	var target = "labResults_s[i].observationVO_s[1].theObservationDT.cdDescTxt\" header=\"Resulted Test Name\" parent=\"Lab Report\" isNested=\"yes\" validate=\"required\" fieldLabel=\"Resulted Test Name\" onchange=\"getOrganismIndicatorMorb();\" entitysearch=\"yes";
	//var labId= getElementByIdOrByName("labId").value;
	var labId="DEFAULT";
...
function codeLookup(button, type)
{
	...
	if(morbType != null)
	{
		target = "labResults_s[i].observationVO_s[1].theObservationDT.cdDescTxt\" header=\"Resulted Test Name\" parent=\"Lab Report\" isNested=\"yes\" validate=\"required\" fieldLabel=\"Resulted Test Name\" onchange=\"getOrganismIndicatorMorb();\" entitysearch=\"yes";
