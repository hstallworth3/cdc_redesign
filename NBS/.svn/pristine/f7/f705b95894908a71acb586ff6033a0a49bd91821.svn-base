...
<html>
    <head>
        ...
        function exportQueue() {
        	 ...
        	 var activityLogUid = '<%=request.getAttribute("edxActivityLogUid")%>';
						   		...
						   		<div class="grayButtonBar nonPrintPreviewModeOnly">
							   		<table width="100%"  >
								   		 <tr>
										   	...
										   	-->  &nbsp;</td>
										 	<td align="right"> 							                   
								            	<input type="Button"  value="Print" id=" " onclick="return printQueue('<%= request.getAttribute("edxActivityLogUid")%>');"/> 
  								  ...
  								  <!-- SUB_SECTION : Investigation Details -->  								   
			                              ...
			                              <nedss:container id="subsec1" name="Failure Reason" classType="subSect" displayLink="false">
		                                    <tr>
			                                   ...
			                                   <% }else{ %>		
			                                     <td align="center">	                                    
			                                        <html:textarea property="selection.exception" style="overflow: scroll; overflow-y: scroll; overflow-x: hidden; overflow:-moz-scrollbars-vertical;" rows="20" cols="100" readonly="true"/>
			                                       </td>		
			                                   	<% } %>			                                 
