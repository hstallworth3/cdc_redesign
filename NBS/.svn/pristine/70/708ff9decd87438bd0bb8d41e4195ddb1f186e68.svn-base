        ...
        <html:form action="/LabTestLoincLink.do">
       	<nedss:container id="subsec0" classType="subSect" displayImg="false">
        	<tr>
	            ...
	            <td>				 
	            	<html:text styleId="codedResult" name="labResultedTestForm" property="searchCriteria(CODEDRESULT)" size="25" maxlength="100"/>
	            </td>
	        </tr>             
	        <tr>
				...
				<td> 
					...
					<table>
						<tr>
						<td>
							<html:radio name="labResultedTestForm" property="searchCriteria(CODESEARCHLIST)" styleId="searchResultList" value="LOCALRESULT" >Short list, includes local coded results</html:radio>
						</td>
						</tr>
						<tr>
						<td>
							<html:radio name="labResultedTestForm" property="searchCriteria(CODESEARCHLIST)" styleId="searchResultList" value="SNOMEDRESULT" >Long list, provides standard coded results</html:radio>
						</td>
						</tr>
					</table> 
				</td>
