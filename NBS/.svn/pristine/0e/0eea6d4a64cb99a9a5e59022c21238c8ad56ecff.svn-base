...
public class NbsQuestionDAOImpl extends DAOBase {
	...
	public Collection<Object>  retrievePamOuestions()
		...
		try {
	      ...
	      if (propertyUtil.getDatabaseServerType() != null &&
	    	  ...
	    	  sqlQuery = WumSqlQuery.PAM_QUESTION_OID_METADATA_ORACLE;
	      }
	      else{
	...
	private Collection<Object>  retrieveRules()
			...
			if (propertyUtil.getDatabaseServerType() != null &&
					propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				rulesSqlQuery = WumSqlQuery.RULES_METADATA_ORACLE;
			}
			else{
	...
	private Collection<Object>  retrieveRuleSources()
		...
		if (propertyUtil.getDatabaseServerType() != null &&
				propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			ruleSourceQuery = WumSqlQuery.RULES_METADATA_SOURCE_ORACLE;
		}
		else{
	...
	if (propertyUtil.getDatabaseServerType() != null &&
			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
		ruleSourceValueQuery = WumSqlQuery.RULES_METADATA_SOURCE_VALUE_ORACLE;
	}
	else{
	...
	if (propertyUtil.getDatabaseServerType() != null &&
			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
		ruleTargetQuery = WumSqlQuery.RULES_METADATA_TARGET_ORACLE;
	}
	else{
	...
	private Collection<Object>  retrieveRuleTargetsValues() throws NEDSSSystemException {
		...
		if (propertyUtil.getDatabaseServerType() != null
			...
			ruleTargetValQuery = WumSqlQuery.RULES_METADATA_TARGET_VALUE_ORACLE;
		} else {
	...
	/***************Start of methods added for Rule Admin UI Tools  *************************************/
	 	 ...
	 	 public ArrayList<Object> getRuleList() throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.RULES_LIST_ORACLE;
	    	}
	    	else{
		...
		public ArrayList<Object> findRuleInstances(String whereclause) throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.RULES_INSTANCES_LIST_ORACLE + whereclause;
		...
		public ArrayList<Object> findSourceFields(String whereclause) throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.SOURCE_FIELDS_LIST_ORACLE + whereclause;
		...
		public ArrayList<Object> findTargetFields(String whereclause) throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.TARGET_FIELDS_LIST_ORACLE + whereclause;
		...
		public ArrayList<Object> findSourceValues(String whereclause) throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.SOURCE_VALUES_LIST_ORACLE + whereclause;
		...
		public ArrayList<Object> findTargetValues(String whereclause) throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.TARGET_VALUES_LIST_ORACLE + whereclause;
		...
		public ArrayList<Object> getConseqInd() throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.CONSEQ_IND_LIST_ORACLE ;
		...
		public ArrayList<Object> getErrorMessages() throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.ERR_MESSAGE_LIST_ORACLE ;
		...
		public ArrayList<Object> getOperatorTypes() throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.OPERATOR_TYPE_LIST_ORACLE ;
		...
		public ArrayList<Object> getPAMLabels() throws NEDSSSystemException {
	    	...
	    	if (propertyUtil.getDatabaseServerType() != null &&
	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    		ruleTargetQuery = WumSqlQuery.PAM_LABELS_LIST_ORACLE ;
		 ...
		 public String deleteRuleIns(String str_RuleInstanceUID){
				...
				String deleteFrmCodeRuleIns ="";
				    ...
				    //  logic to check if code has separate table
		    	    	if (propertyUtil.getDatabaseServerType() != null &&
		    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
		    	    		deleteTargetValue = WumSqlQuery.DELETE_TARGET_VALUE_ORACLE ;
			            ...
			            try
				         ...
				         if(status.equalsIgnoreCase("deletesuccess"))  {
				            ...
				            //  logic to check if code has separate table
				      	    	if (propertyUtil.getDatabaseServerType() != null &&
				      	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				      	    		deleteTargetfield = WumSqlQuery.DELETE_TARGET_FIELD_ORACLE ;
				         ...
				         if(status.equalsIgnoreCase("deletesuccess"))  {
					            try
							    {
					            	...
					            	if (propertyUtil.getDatabaseServerType() != null &&
					            			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					            		deleteSourceValue = WumSqlQuery.DELETE_SOURCE_VALUE_ORACLE ;
				         ...
				         if(status.equalsIgnoreCase("deletesuccess"))  {
					            ...
					            //  logic to check if code has separate table
					    	    	if (propertyUtil.getDatabaseServerType() != null &&
					    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					    	    		deleteSourceField = WumSqlQuery.DELETE_SOURCE_FIELD_ORACLE ;
				         ...
				         if(status.equalsIgnoreCase("deletesuccess"))  {
					            ...
					            //  logic to check if code has separate table
					    	    	if (propertyUtil.getDatabaseServerType() != null &&
					    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					    	    		deleteFrmCodeRuleIns = WumSqlQuery.DELETE_FRM_CODE_ORACLE ;
				         ...
				         if(status.equalsIgnoreCase("deletesuccess"))  {
					            ...
					            //  logic to check if code has separate table
					    	    	if (propertyUtil.getDatabaseServerType() != null &&
					    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					    	    		deleteRuleInstance = WumSqlQuery.DELETE_RULE_INSTANCE_ORACLE ;
				...
				String deleteSourceField = "";			
			    	...
			    	PreparedStatement preparedStmt = null;			   		
					            try
							    {
					            	...
					            	if (propertyUtil.getDatabaseServerType() != null &&
					            			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					            		deleteSourceValue = WumSqlQuery.DELETE_SOURCE_VALUE_SF_ORACLE ;
				         ...
				         if(status)  {
					            ...
					            //  logic to check if code has separate table
					    	    	if (propertyUtil.getDatabaseServerType() != null &&
					    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					    	    		deleteSourceField = WumSqlQuery.DELETE_SOURCE_FIELD_SF_ORACLE ;
		 ...
		 public boolean deleteTargetField(String str_RuleInstanceUID){
				...
				String deleteTargetfield = "";
				    ...
				    //  logic to check if code has separate table
		    	    	if (propertyUtil.getDatabaseServerType() != null &&
		    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
		    	    		deleteTargetValue = WumSqlQuery.DELETE_TARGET_VALUE_TF_ORACLE ;
			            ...
			            try
				         ...
				         if(status)  {
				            ...
				            //  logic to check if code has separate table
				      	    	if (propertyUtil.getDatabaseServerType() != null &&
				      	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				      	    		deleteTargetfield = WumSqlQuery.DELETE_TARGET_FIELD_TF_ORACLE ;
		 ...
		 public String addRuleInstance(RulesDT rulesDT){
	    	...
	    	ArrayList<Object> aryl_rules = new ArrayList<Object> ();
		    	...
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		ruleInstanceInsertQuery = WumSqlQuery.ADD_RULE_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
	            ...
	            try
		            ...
		            if(status.equalsIgnoreCase("insertsuccess")){				 
				    	...
				    	if (propertyUtil.getDatabaseServerType() != null &&
				    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				    		findmaxRuleIns = WumSqlQuery.MAX_RULE_INSTANCEUID_ORACLE ;
		 ...
		 public String addSourceField(SourceFieldDT srcFieldDT){
			    	...
			    	ResultSet resultSet = null;
				    	...
				    	try
					    {
			    	    	...
			    	    	if (propertyUtil.getDatabaseServerType() != null &&
			    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			    	    		srcFInstanceInsertQuery = WumSqlQuery.ADD_SF_INSTANCE_ORACLE ;
			    	    	}
			    	    	else{
			            ...
			            try
				            ...
				            if(status.equalsIgnoreCase("insertsuccess")){				 
						    	...
						    	if (propertyUtil.getDatabaseServerType() != null &&
						    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
						    		findmaxSFIns = WumSqlQuery.MAX_SF_INSTANCEUID_ORACLE ;
		 ...
		 public String addTargetField(TargetFieldDT tarFieldDT){
	    	...
	    	ResultSet resultSet = null; 	
		    	...
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		tarFInstanceInsertQuery = WumSqlQuery.ADD_TF_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
	            ...
	            try
		            ...
		            if(status.equalsIgnoreCase("insertsuccess")){				 
				    	...
				    	if (propertyUtil.getDatabaseServerType() != null &&
				    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				    		findmaxTFIns = WumSqlQuery.MAX_TF_INSTANCEUID_ORACLE ;
		 ...
		 public String addSourceValue(SourceValueDT srcValueDT){
	    	...
	    	ResultSet resultSet = null;
		    	...
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		SVInstanceInsertQuery = WumSqlQuery.ADD_SV_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
	            ...
	            try
		            ...
		            if(status.equalsIgnoreCase("insertsuccess")){				 
				    	...
				    	if (propertyUtil.getDatabaseServerType() != null &&
				    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				    		findmaxSVIns = WumSqlQuery.MAX_SV_INSTANCEUID_ORACLE ;
		 ...
		 public String addTargetValue(TargetValueDT tarValueDT){
	    	...
	    	ResultSet resultSet = null;   	
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		tarVInstanceInsertQuery = WumSqlQuery.ADD_TV_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
	            ...
	            try
		            ...
		            if(status.equalsIgnoreCase("insertsuccess")){				 
				    	...
				    	if (propertyUtil.getDatabaseServerType() != null &&
				    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				    		findmaxTVIns = WumSqlQuery.MAX_TV_INSTANCEUID_ORACLE ;
		 ...
		 public boolean updateSourceValue(SourceValueDT srcValueDT){
	    	...
	    	ResultSet resultSet = null;
		    	...
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		SVInstanceInsertQuery = WumSqlQuery.UPDATE_SV_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
		 ...
		 public boolean updateTargetValue(TargetValueDT tarValueDT){
	    	...
	    	ResultSet resultSet = null;   	
		    	try
			    {
	    	    	...
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		tarVInstanceUpdateQuery = WumSqlQuery.UPDATE_TV_INSTANCE_ORACLE ;
	    	    	}
	    	    	else{
			    	...
			    	while(iter.hasNext()){
				    	...
				    	try {
				    		...
				    		if(resultSet!=null){
				    			...
				    			while (resultSet.next())
						        {
				    				whereRClause = whereRClause + "'" + resultSet.getString("formCode").toString()+ "'" + "," ;	
				    				if(count == questionIdentColl.size()){
				    					rulesFormLst.add(resultSet.getString("formCode").toString());
				    				}
					    			logger.debug("returned questions list"); 			    					
						        }
		 ...
		 public boolean associateFormCode(ArrayList<Object>  dDT){
	    	...
	    	try{
			    ...
			    //  logic to check if code has separate table
	    	    	if (propertyUtil.getDatabaseServerType() != null &&
	    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
	    	    		deletefrmCode = WumSqlQuery.DELETE_FRM_CODE_ORACLE ;
	    	  ...
	    	  try
			    {
			        ...
			        if(dDT != null && i<dDT.size()){		         
						...
						while (iter.hasNext()) {
			    	    	...
			    	    	if (propertyUtil.getDatabaseServerType() != null &&
			    	    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			    	    		frmCodeInsertQuery = WumSqlQuery.INSERT_FRM_CODE_ORACLE ;
			    	    	}
			    	    	else{
		 ...
		 public ArrayList<Object> findfrmCodes(String strRuleInsUid) throws NEDSSSystemException {
		    	...
		    	if (propertyUtil.getDatabaseServerType() != null &&
		    			propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
		    		ruleTargetQuery = WumSqlQuery.FRM_CODE_LIST_ORACLE ;
		...
		public Collection<Object>  retrieveQuestionRequiredNnd(String formCd) throws NEDSSDAOSysException, NEDSSSystemException {
			...
			String ora = "SELECT distinct num.nbs_question_uid  \"nbsQuestionUid\","  + 
						"nnd.question_identifier \"questionIdentifier\","+
						"num.question_label  \"questionLabel\","+
						"num.data_location  \"dataLocation\"  "+
						"FROM NND_Metadata nnd INNER JOIN NBS_UI_Metadata num " +
	...
	public Collection<Object>  retrieveAggregateData() throws NEDSSSystemException {
		...
		String sqlQuery = WumSqlQuery.AGGREGATE_METADATA_QUERY;
  	    ...
  	    if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID))
  	    	sqlQuery = WumSqlQuery.AGGREGATE_METADATA_QUERY_ORA;
	...
	public Collection<Object>  retrieveContactOuestions() throws NEDSSSystemException {
		...
		if (propertyUtil.getDatabaseServerType() != null &&
				propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			sqlQuery = WumSqlQuery.CONTACT_QUESTION_OID_METADATA_ORACLE;
		}
		else{
	...
	public Collection<Object>  retrieveDMBOuestions()throws NEDSSSystemException {
			...
			try {
			  ...
			  if (propertyUtil.getDatabaseServerType() != null &&
			      propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
				  sqlQuery = WumSqlQuery.DMB_QUESTION_OID_METADATA_ORACLE;
			  }
			  else{
	...
	public Collection<Object>  retrieveGenericTemplateOuestions() throws NEDSSSystemException {
		...
		try {
		  ...
		  if (propertyUtil.getDatabaseServerType() != null &&
		      propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
			  sqlQuery = WumSqlQuery.GENERIC_QUESTION_OID_METADATA_ORACLE;
		  }
		  else{
 ...
 /**
	...
	public Collection<Object>  getCoinfectionQuestionListForFormCd(String formCd) throws NEDSSSystemException {
		...
		String sqlQuery = null;
		 ...
		 sqlQuery = "select question_identifier \"key\", nbs_question_uid, question_group_seq_nbr \"intValue\", nbs_question_uid \"longKey\" from nbs_ui_metadata where investigation_form_cd=? and coinfection_ind_cd='T'";
		  try {
