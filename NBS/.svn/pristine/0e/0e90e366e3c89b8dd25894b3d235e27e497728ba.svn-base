...
<html:form styleId="fileAttachmentForm" action="/InvUploadFiles.do" enctype="multipart/form-data" method="post">
    <table class="formTableNA" style=" width:100%; height:100%; margin:0px;">
        <tr>
            <td colspan="2">
        ...
        <tr>
            ...
            <td><html:file size="62" property="ctFile" style="height: 1.8em;" onchange="handleNewFileSelection(this.value)" name="fileUploadForm"> </html:file></td>
        </tr>

        <!-- File Name -->
        <tr>
            <td class="fieldName" id="fileNameLabel"> <span style="color:red; font-weight:bold;">*</span> Name:</td>
...
blockEnterKey();
    <% if (request.getAttribute("confirmation") != null && 
   		...
   		var appnd ='<tr class="odd"><%= request.getAttribute("newAttachment")%></tr>';
	...
	function submitAttachment() {
        ...
        if (jQuery.trim(document.fileUploadForm.fileName.value) == "") {
            ...
            hasErrors = true;
            $j("td#fileNameLabel").css("color", "red");
        }
        else {
