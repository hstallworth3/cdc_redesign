                    ...
                    <fieldset style="border-width:0px;" id="laboratory">
                        <nedss:container id="subsec3" classType="subSect" displayImg ="false">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:text property="selection.laboratoryId" size="20" maxlength="20" styleId="labId"/>
                                    </logic:equal>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.laboratorySystemDescTxt" size="60" maxlength="100" styleId="labDesc" />      			
                                    </logic:notEqual>                
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.codingSystemCd" size="20" maxlength="20" styleId="cdSysCd"/>      			
                                    </logic:notEqual>                
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.codeSystemDescTxt" size="60" maxlength="100" styleId="cdSysDesc"/>      			
                                    </logic:notEqual>                
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.assigningAuthorityCd" size="20" maxlength="300" styleId="assignAuthCd"/>
                                    </logic:notEqual>                
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:text property="selection.assigningAuthorityDescTxt" size="60" maxlength="100" styleId="assignAuthDesc"/>      			
                                    </logic:notEqual>                
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        ...
                                        -->  
                                        <html:select property="selection.electronicLabInd" styleId = "eLab">
