		                    ...
		                    <span id="INV207SearchControls">
		                       <input type="Button" class="Button" value="Search" 
		                        ...
		                        <html:text property="pamClientVO.answer(INV207)" styleId="INV207Text"
		                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV207Text','qec_list')" title="${PamForm.formFieldMap.INV207.tooltip}"/>
    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
            ...
            <tr>
                ...
                <td class="topBorder">
                    <html:text disabled ="${PamForm.formFieldMap.INV121.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(INV121)" maxlength="10" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="3. Case Numbers" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                     <html:text disabled ="${PamForm.formFieldMap.INV173.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.INV173.tooltip}" maxlength="17" size="17"
            ...
            <tr>
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.INV198.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.INV198.tooltip}" maxlength="17" size="17"
                            onkeyup="CaseNumberMask(this)" 
                            onblur="FormatCaseNumberMask(this)" />
                    (example : 2008-OK-ABCD56789)                            
                </td>
            ...
            <tr>
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB100.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.TUB100.tooltip}" maxlength="17"
                            onkeyup="CaseNumberMask(this)"
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB101.state.disabled}" 
            ...
            <tr>
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB102.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.TUB102.tooltip}" maxlength="17" size="17"
                            onkeyup="CaseNumberMask(this);"
    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Previous Diagnosis" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB111.state.disabled}"
            ...
            <tr>
                ...
                <td>
                    <html:text maxlength="4" property="pamClientVO.answer(TUB112)" styleId="TUB112" onblur="fireRule('TUB112', this)"
                            ...
                            size="4" title="${PamForm.formFieldMap.TUB112.tooltip}"/>                        
                </td>
            </tr>
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Origin" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB277.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.TUB277.tooltip}">
           ...
           <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB276.state.disabled}"
            ...
            <tr>
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB273.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB273)" maxlength="10" 
                            styleId="TUB273" onblur="fireRule('TUB273', this)" onchange="fireRule('TUB273', this)"  onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB273','TUB273Icon'); return false;" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="14. Pediatric TB Patients (<15 years old)" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB115.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB116.state.disabled}"
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB113.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <div class="multiSelectBlock">
                        ...
                        <html:select property="pamClientVO.answerArray(TUB114)" 
                                styleId="TUB114" 
	...
	<%@ include file="/pam/ext/Condition.jsp" %>
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="15. Status at TB Diagnosis" classType="subSect" >
           ...
           <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB117.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.INV146.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(INV146)" maxlength="10" 
                            styleId="INV146" onblur="fireRule('INV146', this)"  onchange="fireRule('INV146', this)" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('INV146','INV146Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.INV145.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="16. Site of TB Disease" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB119)" 
                                styleId="TUB119" 
    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="17. Sputum Smear" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB120.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB121.state.disabled}"
                            ...
                            styleId="TUB121" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB121','TUB121Icon'); return false;" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="18. Sputum Culture" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                  <html:select disabled ="${PamForm.formFieldMap.TUB122.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB123.state.disabled}"
                            ...
                            styleId="TUB123" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB123','TUB123Icon'); return false;" 
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB124.state.disabled}"
                            ...
                            styleId="TUB124" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB124','TUB124Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    ...
                    <html:select disabled ="${PamForm.formFieldMap.TUB125.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="19. Smear/Pathology/Cytology of Tissue and Other Bodily Fluids" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                  <html:select disabled ="${PamForm.formFieldMap.TUB126.state.disabled}"
           ...
           <!-- Date Collected -->
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB127.state.disabled}"
                            ...
                            styleId="TUB127" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB127','TUB127Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB128.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB129)" 
                                styleId="TUB129" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="20. Culture of Tissue and Other Body Fluids" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                  <html:select disabled ="${PamForm.formFieldMap.TUB130.state.disabled}"
           ...
           <!-- Date Collected -->
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB131.state.disabled}"
                            ...
                            styleId="TUB131"   onchange="fireRule('TUB131', this)"    onblur="fireRule('TUB131', this)"  onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB131','TUB131Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB132.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB133.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB133)" maxlength="10" 
                            styleId="TUB133" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB133','TUB133Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB134.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="21. Nucleic Acid Amplification Test Result" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                  <html:select disabled ="${PamForm.formFieldMap.TUB135.state.disabled}"
           ...
           <!-- Date Collected -->
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB136.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB136)" maxlength="10" 
                            styleId="TUB136" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB136','TUB136Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB137.state.disabled}"
           ...
           <!-- Speciment Type Not Sputum -->
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB138.state.disabled}"
           ...
           <!-- Date Result Reported -->
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB139.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB139)" maxlength="10" 
                            styleId="TUB139" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB139','TUB139Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB140.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB150.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB151.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB151)" maxlength="10" 
                            styleId="TUB151" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB151','TUB151Icon'); return false;" 
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB152.state.disabled}" maxlength="100"
                            property="pamClientVO.answer(TUB152)" title="${PamForm.formFieldMap.TUB152.tooltip}" />
                </td>
            </tr>
	         <!-- Interferon... LDFs -->
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="25. Primary Reason Evaluated" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB153.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="26. HIV Status at Time of Diagnosis" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB154.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB155.state.disabled}"
                            ...
                            title="${PamForm.formFieldMap.INV155.tooltip}" />
                </td>
            </tr>
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB156.state.disabled}"
                            ...
                            maxlength="10"
                            size="10" 
                            title="${PamForm.formFieldMap.TUB156.tooltip}" />
                </td>
            </tr>
             <!-- HIV Status LDFs -->
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Residence" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB157.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB158.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB159.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB160.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB161.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB162.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Occupation" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB163.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Drug and Alcohol Use" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB164.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB165.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB166.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Additional Risk Factors" classType="subSect" >
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB167)" 
                                styleId="TUB167" 
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB168.state.disabled}"
	                    ...
	                    title="${PamForm.formFieldMap.INV168.tooltip}"  onchange="fireRule('TUB168', this);"/>
                </td>
            </tr>
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB169.state.disabled}" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="37. Initial Drug Regimen" classType="subSect" >
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB170.state.disabled}"
                           name="PamForm" property="pamClientVO.answer(TUB170)" maxlength="10" 
                            styleId="TUB170" onkeyup="DateMask(this,null,event)" size="10"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB170','TUB170Icon'); return false;" 
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select property="pamClientVO.answer(TUB171)" styleId="TUB171" onchange="fireRule('TUB171', this)">
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB172.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB173.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB174.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB175.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB182.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB185.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB176.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB181.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB177.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB179.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB183.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB186.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB184.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB187.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB178.state.disabled}"
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB180.state.disabled}" property="pamClientVO.answer(TUB180)" styleId="TUB180" onchange="fireRule('TUB180', this)">
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB188.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB189.state.disabled}"
                            property="pamClientVO.answer(TUB189)" title="${PamForm.formFieldMap.TUB189.tooltip}"  
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB190.state.disabled}"
               ...
               <td class="fieldName">
                ...
                <td>
                    <html:text disabled ="${PamForm.formFieldMap.TUB191.state.disabled}" maxlength="100"
                            property="pamClientVO.answer(TUB191)"  styleId="TUB191" onblur="fireRule('TUB191', this)"  title="${PamForm.formFieldMap.TUB191.tooltip}" />
                </td>
            </tr>
            <!-- Clear -->
            <tr>
          ...
          <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Epi-Link" classType="subSect" >
			<!-- Is this person associated with a day care facility:-->	 
				<tr class="${PamForm.formFieldMap.INV148.state.visibleString}">
				     ...
				     <td> 
				     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV148.state.disabled}" property="pamClientVO.answer(INV148)" styleId="INV148"> 
			...
			<!-- Is this person a food handler:-->
				<tr class="${PamForm.formFieldMap.INV149.state.visibleString}">
				     ...
				     <td> 
				     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV149.state.disabled}" property="pamClientVO.answer(INV149)" styleId="INV149"> 
				...
				<tr class="${PamForm.formFieldMap.INV150.state.visibleString}">
				     ...
				     <td> 
				     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV150.state.disabled}" property="pamClientVO.answer(INV150)" styleId="INV150" onchange="fireRule('INV150', this)">
				...
				<tr class="${PamForm.formFieldMap.INV151.state.visibleString}">
				     ...
				     <td> 
				     	  <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV151.state.disabled}" property="pamClientVO.answer(INV151)" styleId="INV151"> 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Investigation Comments" classType="subSect" >
            <tr>
               <td class="${PamForm.formFieldMap.INV167.state.visibleString}">
                ...
                <td>
                    <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" disabled ="${PamForm.formFieldMap.INV167.state.disabled}"  styleId ="INV167"
