...
public Collection<Object>  retrieveInvestgationSummaryVO(Long uid,
    ...
    try{
	    ...
	    logger.info("propertyUtil.getDatabaseServerType() = " +
	    ...
	    if (propertyUtil.getDatabaseServerType() != null &&
	      ...
	      aQuery = WumSqlQuery.SELECT_WORKUP_ORACLE + dataAccessWhereClause;
	    }
	    else {
...
public Collection<Object>  retrieveInvestgationSummaryVO(Collection<Object> uidList,
    ...
    try{
	    ...
	    if (propertyUtil.getDatabaseServerType() != null &&
	        ...
	        getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	                                            //dataAccessWhereClause);
	    	aQuery = WumSqlQuery.SELECT_WORKUP_ORACLE_IN ;
	    }
	    else {
    ...
    try {
	    ...
	    if (personUID != null) {
	      ...
	      if (propertyUtil.getDatabaseServerType() != null &&
	        ...
	        SELECT_VACC = WumSqlQuery.SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP.replaceAll(NEDSSConstants.SYSTEM_REFERENCE_TABLE+"..", NEDSSConstants.SYSTEM_REFERENCE_TABLE+".");
	      }
	      else {
...
protected HashMap<Object,Object> getVaccinationSummaryListForWorkup(Collection<Object> uidList,
    ...
    try {
	    ...
	    if (uidList != null) {
	      ...
	      if (propertyUtil.getDatabaseServerType() != null
	          &&
	          propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.
	          ORACLE_ID)) {
	        SELECT_VACC = WumSqlQuery.
	            SELECT_VACCINATION_SUMMARY_LIST_FOR_WORKUP_ORACLE_IN;
	      }
	      else {
	        SELECT_VACC = WumSqlQuery.
...
public HashMap<Object,Object> retrieveVaccinationSummaryVOForInv(Long publicHealthUID,
    ...
    try {
	    ...
	    if (propertyUtil.getDatabaseServerType() != null &&
	        propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	    	aQuery = WumSqlQuery.VACCINATIONS_FOR_A_PHC.replaceAll(NEDSSConstants.SYSTEM_REFERENCE_TABLE+"..", NEDSSConstants.SYSTEM_REFERENCE_TABLE+".") + dataAccessWhereClause;
	    }else {
  ...
  public Collection<Object>  retrieveAutoResendSummaries(String sourceClassCd,String typeCd,
    ...
    if (propertyUtil.getDatabaseServerType() != null &&
        propertyUtil.
        getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
      statement = WumSqlQuery.SELECT_NOTIFICATION_AUTO_RESEND_ORACLE;
    }
    else {
    ...
    if (publicHealthUID != null) {
      ...
      if(caseTypeCd != null && caseTypeCd.equalsIgnoreCase(NEDSSConstants.CASETYPECD_AGGREGATE_SUMMARY)) {
          if (propertyUtil.getDatabaseServerType() != null &&propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID))
        	  statement = WumSqlQuery.SELECT_SUMMARY_NOTIFICATION_ORACLE;
          else
	      ...
	      if (propertyUtil.getDatabaseServerType() != null &&
	              propertyUtil.
	              getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	            statement = WumSqlQuery.SELECT_NOTIFICATION_ORACLE +
	                dataAccessWhereClause;
	          }
	          else {
...
public Collection<Object>  retrieveNotificationSummaryListForInvestigation(Long
    ...
    if (publicHealthUID != null) {
      ...
      if (propertyUtil.getDatabaseServerType() != null &&
          propertyUtil.
          getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
        statement[0] = WumSqlQuery.SELECT_NOTIFICATION_FOR_INVESTIGATION_ORACLE ;
        statement[1] = WumSqlQuery.
            SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_ORACLE + " ORDER BY notHist.version_ctrl_nbr DESC";
      }
      else {
    ...
    try {
	    if (publicHealthUID != null) {
	      ...
	      if (propertyUtil.getDatabaseServerType() != null &&
	          propertyUtil.
	          getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	        statement[0] = WumSqlQuery.
	            SELECT_NOTIFICATION_FOR_INVESTIGATION_ORACLE1 +
	            dataAccessWhereClause;
	        statement[1] = WumSqlQuery.
	            SELECT_NOTIFICATION_HIST_FOR_INVESTIGATION_ORACLE1 +
...
public ArrayList<Object> retrieveTreatmentSummaryVOForInvForManage(Long publicHealthUID,
    ...
    try{
	    if (propertyUtil.getDatabaseServerType() != null &&
	          propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
	        aQuery = "SELECT source_act_uid \"uid\" FROM Act_relationship " +
...
public HashMap<Object,Object> retrieveTreatmentDetailsForMorbForManage(Long publicHealthUID,
 ...
 logger.info("propertyUtil.getDatabaseServerType() = " + propertyUtil.getDatabaseServerType());
      aQuery = "SELECT source_act_uid \"uid1\", observation.OBSERVATION_UID \"uid2\",observation.CD \"str1\"  FROM Act_relationship, observation "+
       " WHERE target_act_uid IN(SELECT source_act_uid FROM Act_relationship "+
       " WHERE record_status_cd = 'ACTIVE' "+
       " AND target_act_uid =  "+ publicHealthUID +
...
public HashMap<Object,Object> retrieveTreatmentAndObservationMorbForManage(String inClause,
    ...
    aQuery = "SELECT source_act_uid \"uid1\", "+
        ...
        "observation.CD \"str1\" "+
        "FROM Act_relationship, observation "+
...
public HashMap<Object,Object> retrieveDocumentSummaryVOForInv(Long publicHealthUID,
			  ...
			  try{
			    String dataAccessWhereClause = nbsSecurityObj.getDataAccessWhereClause(
				  ...
				  String ASSOCIATED_DOC_QUERY = 
					  ...
					  "from nbs_document " +
					  "inner join act_relationship on " +
	...
	public Map<Object, Object> getAssociatedDocumentMapBysourceEventId(
		...
		try {
			...
			String ASSOCIATED_DOC_QUERY = "select nbs_document.local_id \"localId\", "
					+ "nbs_document.cd \"cd\" "
					+ "from nbs_document "
					+ "inner join edx_event_process on "
	...
	public ArrayList<Object> getCoinfectionInvList(Long mprUid,
		...
		if (propertyUtil.getDatabaseServerType() != null &&
		        propertyUtil.
		        getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
			coinfectionQuery=WumSqlQuery.COINFECTION_INV_LIST_ORA;
		}else{
	...
	public ArrayList<Object> getSpecificCoinfectionInvList(Long public_health_case_uid) throws NEDSSAppException {
		...
		if (propertyUtil.getDatabaseServerType() != null &&
		        propertyUtil.
		        getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)) {
			coinfectionQuery=WumSqlQuery.COINFECTION_SPECIFIED_INV_LIST_ORA;
		}else{
			coinfectionQuery=WumSqlQuery.COINFECTION_SPECIFIED_INV_LIST_SQL;
		}
		Connection dbConnection = null;
		PreparedStatement preparedStmt = null;
		ResultSet resultSet = null;
		...
		try {
			...
			logger.fatal(
					"Error: SQLException while getting coinfection Inv List assoc with PHC  "
							+ public_health_case_uid + " in workup"+se.getMessage(), se);
			throw new NEDSSAppException(se.getMessage());
		} catch (Exception ex) {
			logger.fatal(
					"Error: Exception while getting coinfection Inv List assoc with PHC  "
							+ public_health_case_uid + " in workup"+ex.getMessage(), ex);
			throw new NEDSSAppException(ex.toString());
		} finally {
			closeResultSet(resultSet);
			closeStatement(preparedStmt);
