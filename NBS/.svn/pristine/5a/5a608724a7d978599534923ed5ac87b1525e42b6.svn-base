...
function validateReportAdminDS() {
	...
	var errorMsg = "There is no data mart by that name. Please enter a name that matches the name of an existing data mart.  Note that data source name must start with 'nbs_ods.' or 'nbs_rdb.' ";
	...
	if(StartsWith(name, "nbs_ods.") || StartsWith(name, "nbs_rdb.")) {
