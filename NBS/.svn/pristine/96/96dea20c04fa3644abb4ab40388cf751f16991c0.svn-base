		...
		if(busObjType != null && busObjType.value.length == 0)
			{
				...
				getElementByIdOrByName("busObjTypeL").style.color="red";
				isError = true;
			}
			else {
		...
		if(mappingGuide != null && mappingGuide.value.length == 0)
				{
					...
					getElementByIdOrByName("mappingGuideL").style.color="red";
					isError = true;
				}
		else {
		...
		if(uniquePageName != null) 
			{ 
				...
				if (jQuery.trim(pgName).length == 0) {
					...
					getElementByIdOrByName("uniquePageNameL").style.color="red";
					isError = true;
				}
			else {
        ...
        <div id="doc3">
				...
				<% if(request.getAttribute("EditDetailError") != null) { %>
					<div class="infoBox errors">
						...
						<%= request.getAttribute("EditDetailError")%>
					</div>
				<% }%>           	   		
        				...
        				<nedss:container id="subSection1" name="Page Details" classType="subSect" displayImg ="false">
           					<!-- Event Type - currently always Investigation -->
          						<tr>
          						    ...
          						    <td>
            							<html:select property="selection.waTemplateDT.busObjType" styleId="busObjType" disabled='true'>
