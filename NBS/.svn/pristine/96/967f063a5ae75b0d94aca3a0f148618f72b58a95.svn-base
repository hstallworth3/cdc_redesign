...
public class SR5_CasesOf_ReportableDiseases_ByState {
	...
	@Test
	public void Populate_SR5_Report() throws Exception {
		comUtils.setUpDriver(driver);
		log = new Log("SR5_Report", Log_File_Path);
		df = new DataFile(Data_File_Path, "SR5");
		...
		for (int col = 1; col <= colCount; col++) {
			...
			//	public_Report.setUpDataFile(df);
				...
				if ((disease_selectall).equalsIgnoreCase("Yes"))
					log.write("Disease: " + "Select All; " + " State " + state + ";");
				else
					log.write("Disease " + disease + "; " + " State " + state + ";");
			...
			//	public_Report.setUpLog(log);
				...
				while (itr.hasNext()) {
					index = index + 1;
					if (tableRows.get(index).getText().contains("SR5: Cases of Reportable Diseases by State"))
						break;
				}
				...
				if (!comUtils.isElementDisplayed(By.id("error1"))) {
					...
					if (comUtils.isElementDisplayed(
							By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b/u"))) {
						System.out.println(driver
								.findElement(
										By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b"))
								.getText());
						if (driver
								.findElement(
										By.xpath("html/body/div[1]/table[1]/tbody/tr[4]/td/div/table/tbody/tr[1]/td/b"))
