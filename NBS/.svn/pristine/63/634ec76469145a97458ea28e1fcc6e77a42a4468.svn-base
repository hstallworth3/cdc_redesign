...
PROC SQL;
create table  UPDATED_LAB101 AS SELECT RESULTED_LAB_TEST_KEY FROM NBS_RDB.LAB101 WHERE RESULTED_LAB_TEST_KEY IN (SELECT LAB_TEST_KEY FROM rdbdata.updated_lab_test_list);
