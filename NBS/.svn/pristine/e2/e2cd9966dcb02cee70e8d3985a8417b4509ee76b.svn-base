...
var vAddr = '<td>&nbsp;<img src="page_white_text.gif" title="View Address" onclick="viewAddr(_id)"/></td>';
var eAddr = '<td>&nbsp;<img src="page_white_edit.gif" title="Edit Address" onclick="editAddr(_id)"/></td>';
var dAddr = '<td>&nbsp;<img src="cross.gif" title="Delete Address" onclick="deleteAddr(_id)"/></td>';
var sdAddr = '<td>&nbsp;Show Details</td>';

var vPhone = '<td>&nbsp;<img src="page_white_text.gif" title="View Phone" onclick="viewPhone(_id)"/></td>';
var ePhone = '<td>&nbsp;<img src="page_white_edit.gif" title="Edit Phone" onclick="editPhone(_id)"/></td>';
var dPhone = '<td>&nbsp;<img src="cross.gif" title="Delete Phone" onclick="deletePhone(_id)"/></td>'
