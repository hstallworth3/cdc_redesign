                        ...
                        <nedss:container id="searchBlock" name="Search Aggregate Report" classType="sect" displayImg ="false" displayLink="false">
                            <nedss:container id="searchBlock_1" classType="subSect" displayImg ="false">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM100.state.disabled}" name="aggregateSummaryForm" property="searchMap(SUM100)" styleId = "SUM100S">
						            ...
						            <tr>
						                ...
						                <td>
                                        <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM101.state.disabled}" name="aggregateSummaryForm" property="searchMap(SUM101)" styleId = "SUM101S" onchange="populateMMWRYear('SUM101S','SUM102S')">
						            ...
						            <tr>
						                ...
						                <td>
                                        <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM102.state.disabled}" name="aggregateSummaryForm" property="searchMap(SUM102)" styleId = "SUM102S">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <html:select disabled ="${aggregateSummaryForm.formFieldMap.SUM106.state.disabled}" name="aggregateSummaryForm" property="searchMap(SUM106)" styleId = "SUM106S">
                                        ...
                                        <tr>
                                            <td align="center">    
                                                <display:table name="items" class="dtTable" pagesize="10"  id="parent"  style="margin-top:0em;" requestURI="/AggregateReport.do?method=searchSummaryDataSubmit&existing=true" sort="external">
                                                    <display:column property="viewLink" title="" style="width:3%;"/>
                                                    <display:column property="editLink" title=""  style="width:3%;"/>
