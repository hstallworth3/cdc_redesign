		...
		<td>
			...
			<xsl:choose>
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							...
							<nobr style="position: relative">
							     ...
							     <img src="calendar.gif" border="0" alt="Select Date" align="bottom" style="float:left">
								...
								<xsl:if test="not(@size) and not(@autocomplete='disable')">
									<tr>
										...
										<td>
											...
											<img src="type-ahead2.gif" border="0" alt="" align="top">
				...
				<xsl:when test="@type[. = 'data-table']">
					...
					<table width="100%" border="0" id="root">
