...
*   					<img border="0" src="minus_sign.gif" alt="Minimize" title="Collase Block">
*   				</a>
  ...
  public String getButtonLabel() {
    ...
    protected String renderContainerElement()
    {
    	...
    	if(classType!=null && classType.equals("bluebarsect"))
    	{
	        ...
	        sb.append("<table class=\"bluebarsectHeader\"><tr>");
	        else
	        sb.append("<table class=\"bluebarsectHeader\"><tr>");
	        ...
	        if(displayImg==null)
	        {
		        sb.append("<a class=\"toggleIconHref\" href=\"#\" tabindex=-1 onclick=\"return toggleSectionDisplay1('");
		        sb.append(this.getId()).append("');\">");
		        if(this.defaultDisplay!=null && "Collase".equalsIgnoreCase(this.defaultDisplay)){
		        	sb.append("<img border=\"0\" src=\"section_collapse.gif\" alt=\"Minimize\" >");
		        }else if(this.defaultDisplay!=null && "expand".equalsIgnoreCase(this.defaultDisplay)){
		        	sb.append("<img border=\"0\" src=\"section_expand.gif\" alt=\"Maximize\" >");
		        }else{
		        	sb.append("<img border=\"0\" src=\"section_collapse.gif\" alt=\"Minimize\" title=\"Collase Block\">");
		        }
		        sb.append("</a>");
	        }
	        ...
	        if (includeBackToTopLink.equalsIgnoreCase("yes") || addButton || compare ) {
	        	...
	        	if(includeBackToTopLink.equalsIgnoreCase("yes") && addButton  && compare){
        			...
        			sb.append("<a href=\"#pageTop\" tabindex=-1 class=\"backToTopLinkforViewFile\">Back to top</a>&nbsp;");
	        	}
    	...
    	else if(classType!=null && classType.equals("bluebarsubSect"))
    	{
            ...
            if (isHidden != null && isHidden.equals(NEDSSConstants.TRUE)) {
                sb.append("<table class=\"bluebarsubSect\" style=\"display:none;\" id=\"");
            }
            else {
                sb.append("<table class=\"bluebarsubSect");
    	        if (addedClass != null)
			...
			if(displayImg==null){
				sb.append("<a class=\"toggleIconHref\" href=\"#\" tabindex=-1 onclick=\"return toggleSubSectionDisplay('");
				sb.append(this.id).append("');\">");
