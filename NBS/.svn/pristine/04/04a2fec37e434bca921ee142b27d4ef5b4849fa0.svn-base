			        ...
			        <!--Top Button bar  -->
			         ...
			         <!-- Confirm Message -->
			           ...
			           <% if (request.getAttribute("ConfirmMesgImport") != null) { %>
						  <div class="infoBox success">
						  	<%=(String)request.getAttribute("ConfirmMesgImport")%>
						  </div>    
			           <% } %>
                        ...
                        <nedss:container id="subsec1" classType="subSect" name="Value Set Details">
                        	<tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:select name="SRTAdminManageForm"  property="selection.valueSetTypeCd" styleId="ValStF"> 
		             		...
		             		<tr>
                                ...
                                <td>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
                                        <html:text property="selection.valueSetCode" styleId="ValSCF" maxlength="256" size="50" onkeyup="isSpecialCharEnteredForCode(this)"/>
                                    </logic:equal>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Edit">
                            ...
                            <tr>
                                ...
                                <td>
								    ...
								    <% }else{ %>
                                        <html:text property="selection.valueSetNm" styleId="ValSNF" size="50" maxlength="256" />
                                     <%} %>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
                                        <nedss:view name="SRTAdminManageForm" property="selection.valueSetNm"/>
                            ...
                            <tr>
                                ...
                                <td>
                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
                                        <html:textarea style="WIDTH: 400px; HEIGHT: 100px;"  styleId="ValSDF" name="SRTAdminManageForm" property="selection.codeSetDescTxt" onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)"/>
                                    </logic:notEqual>
                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		              	...
		              	<logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		              		<input type="hidden" id="queueCnt" value="<%= request.getAttribute("queueConcept") %>"/>
		                                 ...
		                                 <!-- Concept confirm message -->
										  ...
										  <% if (request.getAttribute("confirmConceptMsg") != null) { %>
											 <!-- Edit SuccessMessage is displaying using  confirmConceptMsg -->
											  <div class="infoBox success">
											  	<%=(String)request.getAttribute("confirmConceptMsg")%>
											  </div>    
								           <% } %>	
								           ...
								           <% if (request.getAttribute("confirmAddConceptMsg") != null) { %>
											 <!-- Edit SuccessMessage is displaying using  confirmConceptMsg -->
											  <div class="infoBox success">
											  	<%=(String)request.getAttribute("confirmAddConceptMsg")%>
											  </div>    
								           <% } %>
		                                    ...
		                                    <tr>
		                                        <td align="center">
		                                            <display:table name="CodeValGNList" class="dtTable" pagesize="10"  id="parent" requestURI="/ManageCodeSet.do?method=viewCodeSet&existing=true" >
		                                                <display:column property="viewLink" title="" style="width:4%;text-align:center;"/>
		                                                <display:column property="editLink" title="" style="width:4%;text-align:center;"/>
