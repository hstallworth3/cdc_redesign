...
public class LDFPreviewSubmit
  ...
  public ActionForward execute(
    ...
    String sBusinessObject = request.getParameter("BusinessObject");
    if (sBusinessObject == null || sBusinessObject.equals("") ||
        sBusinessObject.equals(" ")) {
      sBusinessObject = (String) session.getAttribute("businessObjectNm");
    }
    ...
    String sPageName = (request.getParameter("page"));
  ...
  public void setSubformValidations(HttpServletRequest request) {
    if(sv == null ) {
      ...
      sv.append("<span>");
      sv.append("<TABLE BORDER=\"0\" WIDTH=\"100%\">");
      sv.append("<TR>");
      sv.append("<TD>");
      sv.append(
