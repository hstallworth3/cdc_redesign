								...
								<%@ include file="../../jsp/feedbackMessagesBar.jsp" %>
							 	...
							 	<% if (request.getAttribute("fromConditionLib") != null ) { %>
								  <div class="infoBox info">
								  	This condition has been related to the <b><%=(String)request.getAttribute("pageNm")%></b> but 
					           ...
					           <% } %>
							 	<% if (request.getAttribute("ConfirmMesgCreate") != null) { %>
								  <div class="infoBox success">
								  	<%=(String)request.getAttribute("ConfirmMesgCreate")%>&nbsp;<a href='<%=request.getAttribute("clickHereLk")%>' >Click Here</a> to access the Page Library.<br/>
								  </div>    
					           <% } %>
					           <% if (request.getAttribute("ConfirmMesg") != null) { %>
								  <div class="infoBox success">
								  	<%=(String)request.getAttribute("ConfirmMesg")%>
								  </div>    
					           <% } %>
								      ...
								      <!-- Form Entry Errors -->
								              <nedss:container id="subsec2" classType="subSect" name="Condition Details" >
								                  <tr>
								                      ...
								                      <td>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="Create">
								                              <html:select property="selection.codeSystemCd" styleId = "cSysDn">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="Create">
								                              <html:text property="selection.conditionCd" size="16" maxlength="16" styleId="cCodeFld" onkeyup="isSpecialCharEnteredForCode(this)"/>
								                          </logic:equal>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="Create">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              <html:text property="selection.conditionShortNm" size="50" maxlength="50" styleId="condFld" onkeyup="isSpecialCharEnteredForName(this)"/>
								                          </logic:notEqual>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="View">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          ...
								                          <logic:equal name="manageConditionForm" property="actionMode" value="Create">
														  <html:select property="selection.progAreaCd" styleId="pAreaFld" onchange="makeEnabled()">
							                      ...
							                      <td class="fieldName"  id="cFamily"><span>Condition Family:</span>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              <html:select property="selection.familyCd" styleId = "pCon">
							                      ...
							                      <td class="fieldName"  id="cCoInf"><span>Co-infection Group:</span>
								                      ...
								                      <td>
								                      <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
															 <html:select property="selection.coInfGroup" styleId = "pCoIn" >
								              ...
								              <nedss:container id="subsec3" classType="subSect" name="Condition Behavior" >
								                  <tr>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              ...
								                              <html:radio name="manageConditionForm" property="selection.nndInd" styleId="nndInd" value="Y" > Yes </html:radio>
								      						  <html:radio name="manageConditionForm" property="selection.nndInd" styleId="nndInd" value="N" > No </html:radio>
								                          </logic:notEqual>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="View">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              <html:radio name="manageConditionForm" property="selection.reportableMorbidityInd" value="Y"> Yes </html:radio>
								      						  <html:radio name="manageConditionForm" property="selection.reportableMorbidityInd" value="N"> No </html:radio>
								                          </logic:notEqual>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="View">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              <html:radio name="manageConditionForm" property="selection.reportableSummaryInd" value="Y" > Yes </html:radio>
								      						  <html:radio name="manageConditionForm" property="selection.reportableSummaryInd" value="N"> No </html:radio>
								                          </logic:notEqual>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="View">
								                  ...
								                  <tr>
								                      ...
								                      <td>
								                          <logic:notEqual name="manageConditionForm" property="actionMode" value="View">
								                              <html:radio name="manageConditionForm" property="selection.contactTracingEnableInd" value="Y"> Yes </html:radio>
								      						  <html:radio name="manageConditionForm" property="selection.contactTracingEnableInd" value="N"> No </html:radio>
								                          </logic:notEqual>
								                          <logic:equal name="manageConditionForm" property="actionMode" value="View">
