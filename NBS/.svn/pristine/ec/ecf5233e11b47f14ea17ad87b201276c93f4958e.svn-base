...
public class STDInvestigation_Patient {
	...
	public void setUp() throws Exception {
		...
		Data_File_Path = login.Data_File_Path + "investigations\\STDInvestigation_Patient.xls";
	...
	public void newStdInvestigation() throws Exception {
		...
		log = new Log("STDInvestigation_Patient", Log_File_Path);
