    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect" includeBackToTopLink="no">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="General Information" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM215)" maxlength="10"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Name Information" classType="subSect">
            ...
            <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td> 
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM206)" maxlength="10" 
	       ...
	       <!-- Other details As of Date - Edit mode only -->
            <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td>
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM207)" maxlength="10" 
            ...
            <tr>
                ...
                <td> 
                    <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM115)" maxlength="10" 
                            styleId="DEM115" title="${contactTracingForm.formFieldMap.DEM115.tooltip}" onkeyup="DateMask(this,null,event)" 
            ...
            <!-- Mortality Information As of Date - Edit mode only -->
             <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                         <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM208)" maxlength="10" 
             ...
             <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
			    <logic:notEqual name="contactTracingForm" property="actionMode" value="CREATE_SUBMIT">	
                 <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM209)" maxlength="10" 
	       ...
	       <!-- Contact Information As of date - Edit mode only -->
            <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM213)" maxlength="10" 
            ...
            <!-- Telephone Information As of date - Edit mode only -->
             <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM214)" maxlength="10" 
	    ...
	    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Ethnicity & Race Information" classType="subSect" >
           ...
           <logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM211)" maxlength="10" 
        	...
        	<logic:notEqual name="contactTracingForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="contactTracingForm" property="cTContactClientVO.answer(DEM212)" maxlength="10" 
