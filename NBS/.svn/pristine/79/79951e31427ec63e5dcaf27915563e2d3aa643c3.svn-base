...
<tr>
  <td><table cellpadding="0" cellspacing="0" border="0" width="750">
      <tr align="left">
        ...
        <td background="task_button/tb_cel_bak.jpg" valign="top" align="left" width="500"><logic:equal name="BaseForm" property="actionMode" value="View">
	        <logic:equal name="BaseForm" property="securityMap(checkManageEvents)" value="true">
	            <table align="left" cellpadding="0" cellspacing="0" border="0" width="30">
	              <tr>
	                <td valign="top" align="center"><input type="image" src="task_button/fa_submit.jpg" width="30" height="40" border="0" name="manageAssociations" 	id="manageAssociations" 	alt="Manage Associations" class="cursorHand" onclick="managmanageAssociations();"></td>
	              </tr>
	              <tr>
		...
		<logic:equal name="BaseForm" property="securityMap(checkManageNotific)" value="true">            
			  ...
			  <logic:equal name="BaseForm" property="securityMap(checkCaseReporting)" value="true">            
	            <table align="left" cellpadding="0" cellspacing="0" border="0" width="30">
	              <tr>
	                <td valign="top" align="center"><input type="image" src="task_button/fa_submit.jpg" width="30" height="40" border="0" name="caseRep" 	id="caseRep" alt="Case Reporting" class="cursorHand" onclick=" "></td>
	              </tr>
	              <tr>
