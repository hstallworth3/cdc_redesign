...
<html style="overflow-x:hidden">
    <head>
		...
		*/
        ...
        { 
			var codeValGnCd='<%=request.getAttribute("codeValGenCode")%>';
			var codesetNm='<%=request.getAttribute("codesetNm")%>';
	...
	<logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
    	<body class="popup" style="overflow-y:hidden;" onload="startCountdown();" onunload="closeForm(true, event);"> 
    </logic:equal>
    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="Create">
    	<body class="popup" style="overflow-y:hidden;" onload="startCountdown();" onunload="closeForm2(true, event);">
    </logic:notEqual> 
    <!-- Page title -->
	                    	...
	                    	<fieldset style="border-width:0px;" id="codeset">
		                        <nedss:container id="subsec1" classType="subSect" displayImg ="false">
		                        	<tr>
		                                ...
		                                <td>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
		                                        <html:text onkeyup="setConceptCode()" property="codeValGnSelection.code" styleId="ValLC" size="50" maxlength="20"/>
		                                    </logic:equal>
		                                   <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="Create">
				             		...
				             		<tr>
		                                ...
		                                <td>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
		                                        <html:text onkeyup = "setConceptName()" property="codeValGnSelection.codeDescTxt" styleId="ValLDN" size="50" maxlength="256"/>
		                                    </logic:equal>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Edit">
		                                        <html:text property="codeValGnSelection.codeDescTxt" styleId="ValLDN" size="50" maxlength="256"/>
		                                    </logic:equal>
		                                   <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
		                                        <html:text onkeyup="setPreferredConceptName()" property="codeValGnSelection.codeShortDescTxt" styleId="ValSDN" maxlength="256" size="50"/>
		                                    </logic:equal>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Edit">
		                                        <html:text property="codeValGnSelection.codeShortDescTxt" styleId="ValSDN" maxlength="100" size="50"/>
		                                    </logic:equal>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:text property="codeValGnSelection.effectiveFromTime"   maxlength="10" size="10" styleId="ValEFT" onkeyup="DateMaskFuture(this,event)"/>
												<html:img src="calendar.gif" onclick="getCalDateFuture('ValEFT','INV147Icon');return false;" styleId="INV147Icon"></html:img>
		                                    </logic:notEqual>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
									...
									<tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:text property="codeValGnSelection.effectiveToTime"  maxlength="10" size="10" styleId="ValETD" onkeyup="DateMaskFuture(this,event)"/>
												<html:img src="calendar.gif" onclick="getCalDateFuture('ValETD','INV147Icon');return false;" styleId="INV147Icon"></html:img>
		                                    </logic:notEqual>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        ...
		                                        <html:select name="SRTAdminManageForm"  property="codeValGnSelection.statusCd" styleId="valLSC" acomplete="false" > 
									 ...
									 <tr>
		                                ...
		                                </logic:notEqual><span>Adminstrative Comments:</span>
		                                </td>
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:textarea style="WIDTH: 400px; HEIGHT: 100px;"  styleId="ValADC" name="SRTAdminManageForm" property="codeValGnSelection.adminComments" onkeydown="checkMaxLength(this)" onkeyup="checkMaxLength(this)" />
		                                    </logic:notEqual>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
	                    	...
	                    	<fieldset style="border-width:0px;" id="codeset">
		                        <nedss:container id="subsec1" classType="subSect" displayImg ="false">
		                        	<tr style="display:none">
		                                ...
		                                <td>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="Create">
		                                        <html:select name="SRTAdminManageForm"  property="codeValGnSelection.conceptTypeCd" styleId="first" > 
				             		...
				             		<tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:text property="codeValGnSelection.conceptCode" styleId="ValSCF" size="50" maxlength="256"/>
		                                    </logic:notEqual>
		                                   <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:text property="codeValGnSelection.conceptNm" styleId="ValSNF" maxlength="256" size="50"/>
		                                    </logic:notEqual>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
		                                ...
		                                <td>
		                                    <logic:notEqual name="SRTAdminManageForm" property="actionMode" value="View">
		                                        <html:text property="codeValGnSelection.conceptPreferredNm" styleId="ValPSNF" maxlength="256" size="50"/>
		                                    </logic:notEqual>
		                                    <logic:equal name="SRTAdminManageForm" property="actionMode" value="View">
		                            ...
		                            <tr>
										...
										<!-- jayasudha for enable the code system name drop down box
		                                        ...
		                                        <html:select name="SRTAdminManageForm"  property="codeValGnSelection.codeSystemCd" styleId="CodeSNF_DD" acomplete="false" > 
