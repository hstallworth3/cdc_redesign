    ...
    <head>
     ...
     function saveContinue()
     {
	    ...
	    function makeMSelects() {
			$j("#ansStatus").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#fromID").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#fromLabel").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#fromCd").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#ansMap").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
			$j("#toCd").text({actionMode: '<%= request.getAttribute("ActionMode") %>'});
	    }
				...
				<div  style="text-align:right; margin-bottom:8px;">
    				...
    				<!-- To Display Map Name -->
        			   <div class="grayButtonBar" style="text-align:left;font-weight:bold;font-size:14px">
        				...
        				<span ><font color="red"><b>Answers Remaining To Be Mapped:</b>
                     	...
                     	<div id="pageMappingAttributes" style="background:#CEE3F6">
							...
							<table width="90%" style="table-layout:fixed"align="center">
								...
								<tr>
									...
									<td>
									<div id="toCode">
											<html:select name="portPageForm" property='currentQuestion.toCode' styleId="toCodeList" onchange="populateToCodeDesc();">
									...
									<div id="toAnswer">
											<input type="text" name="toAnswerId" id="toAnswerId" size="10">
									</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<html:select name="portPageForm" property="currentQuestion.codeMappingRequired" styleId="answerMappingReq" onchange="disableEnableAnswerTOFields(this.value);">
