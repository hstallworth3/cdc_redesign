	...
	<nedss:container id='<%= "ss" + (++subSectionIndex) %>' name="Condition" classType="subSect" >
	 <!--10. Diagnosis Date:-->
		 <tr class="${PamForm.formFieldMap.INV136.state.visibleString}">
		     ...
		     <td>
                 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV136.state.disabled}" 
                     property="pamClientVO.answer(INV136)" maxlength="10" 
                     styleId="INV136" onkeyup="DateMask(this,null,event)" size="10"/>
	             <html:img src="calendar.gif" onclick="getCalDate('INV136','INV136Icon'); return false;" 
		 ...
		 <tr class="${PamForm.formFieldMap.INV137.state.visibleString}">
		     ...
		     <td>
			     <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV137.state.disabled}" 
	             ...
	             <html:img src="calendar.gif" onclick="getCalDate('INV137','INV137Icon'); return false;" 
		 ...
		 <tr class="${PamForm.formFieldMap.INV138.state.visibleString}">
		     ...
		     <td>
			     <html:text name="PamForm" disabled ="${PamForm.formFieldMap.INV138.state.disabled}" 
		             ...
		             <html:img src="calendar.gif" onclick="getCalDate('INV138','INV138Icon'); return false;" styleId="INV138Icon"></html:img>
	         </td>
		 </tr>
		 <!-- Illness Duration: -->
		 <tr class="${PamForm.formFieldMap.INV139.state.visibleString}">
		     ...
		     <td>
                 ...
                 title="${PamForm.formFieldMap.INV139.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV140.state.disabled}" property="pamClientVO.answer(INV140)" styleId="INV140" >
		 ...
		 <tr class="${PamForm.formFieldMap.INV143.state.visibleString}">
		     ...
		     <td>
                 ...
                 title="${PamForm.formFieldMap.INV143.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
	        
			     <html:select name="PamForm" disabled ="${PamForm.formFieldMap.INV144.state.disabled}" property="pamClientVO.answer(INV144)" styleId="INV144" >
