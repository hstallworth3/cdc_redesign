      ...
      function addClicked( tabNm)
        ...
        function getBatchAnswerMapFromScreen(tabNm)
        {
         ...
         function ValidateNonBatchDateFields()
         {
        	 ...
        	 var dateElts = $j('img[id="AsofDateAdminIcon"],[id="AsOfDateEthIcon"],[id="AsofDateSBIcon"],[id="patientDOB"],[id="AsofDateMorbIcon"],[id="DateOfDeathIcon"],[id="AsOfDateGenInfoIcon"]');
             var j = 0;
         ...
         function AddUpdateRaceBatch(opType) 
        {
        	...
        	if (typeId == 'null' || typeId == "")
			 ...
			 dwr.engine.endBatch();	 
	        	...
	        	//grabbing the calendar icon beside date field
	        	var dateElts = $j(id="RaceAsOfIcon");
	            var j = 0;
	            for (var i = 0; i < dateElts.length; i++)
	            	{
	            	var dateEltsNode=$j(dateElts[i]).parent().children("input[type=text]");
       ...
       function disableBatchEntryFields (tabNm)
	{
	  	  if(tabNm == 'nameTable'){
			  	 ...
			  	 // alert(tabNm);
					...
					$j("#RaceDetailCatL").parent().find("span[title]").css("color", "#BBB");
	  	 ...
	  	 if(tabNm == 'nameTable'){
			...
			clearBatchEntryFields (tabNm);
			  	 ...
			  	 // alert(tabNm);
					...
					$j($j("#RaceDetailCat").parent().parent()).find("img").attr("disabled", false);
   ...
   function SubmitPatient(){
    ...
    if(validateBatchData()){
     ...
     document.DSPersonForm.action ='<%=request.getAttribute("formHref")%>?ContextAction=Submit<%=vo.getThePersonDT().getPersonUid()==null?"":"&personUID="+vo.getThePersonDT().getPersonUid()%>';
   ...
   //when the State is changed, update the counties
    ...
    function getDWRSubRaces(raceType, elementId)
    {
     ...
     function cancelEdit(){
   //alert("<%=request.getAttribute("cancelButtonHref")%>");
     document.DSPersonForm.action ="<%=(String)request.getAttribute("cancelButtonHref")%>";
    document.DSPersonForm.submit();
    return true;  
   }  
	...
	<!-- ################### PAGE TAB ###################### - - -->
	  ...
	  table.bluebardtTable, table.bluebarprivateDtTable {width:100%; border:1px solid #BBB; padding:0.0em; margin:0em auto; margin-top:0em;}
	...
	<tr><td width="100%">
	    <div class="view" id="patDemo" >
         	<div class="showup" style="text-align:right;">
				...
				<div> 
			         <table><tr><td height="05 px"></td></tr></table>  </div>
	...
	<%  sectionIndex = 0; %>
									...
									<td>
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.asOfDateAdmin_s" maxlength="10" size="10" styleId="AsofDateAdmin" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('AsofDateAdmin','AsofDateAdminIcon');return false;" styleId="AsofDateAdminIcon"></html:img>
									</td> </tr>                  
			                         <tr> <td class="fieldName">
									...
									<td>
									<html:textarea style="WIDTH: 500px; HEIGHT: 100px;" name="DSPersonForm" property="person.thePersonDT.description" styleId ="GenComments" onkeyup="checkTextAreaLength(this, 2000)"/>
									</td> </tr>     
			                       ...
			                       <div class="infoBox errors" style="display: none;visibility: none;" id="NameerrorMessages">
									...
									<tbody id="patternnameTable">
								            ...
								            <td style="width:33%;text-align:center;">
											 <input id="viewIdSubSection" type="image" src="page_white_text.gif" onclick="viewClicked(this.id,'nameTable');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td><td style="width:33%;text-align:center;">
											 <input id="editIdSubSection" type="image" src="page_white_edit.gif" onclick="editClicked(this.id,'nameTable');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td><td style="width:33%;text-align:center;">
											 <input id="deleteIdSubSection" type="image" src="cross.gif" onclick="deleteClicked(this.id,'nameTable');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">	</td>
 											</td>	
 											</tr>
 											</table>
 											</td>
									 ...
									 <td colspan="21"> <span>&nbsp; No Data has been entered.
									      ...
									      <td id="nameDate" width="100%"> 
									         <html:text  name="DSPersonForm" styleClass="requiredInputField" property="nmAsOf" maxlength="10" size="10" styleId="NmAsOf"  onkeyup="unhideBatchImg('nameTable');DateMask(this,null,event)"/>
									         <html:img src="calendar.gif" onclick="getCalDate('NmAsOf','NmAsOfIcon');return false;" styleId="NmAsOfIcon"></html:img> 
									      </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"><span class=" InputFieldLabel" id="NmTypeL" title="Type of Name">  Type:</span> </td>
									      <td id="nameType"> 
									      <html:select name="DSPersonForm" property="nmType" styleId="NmType" onchange ="unhideBatchImg('nameTable');">
									      ...
									      <td id="namePrefix"> 
									       <html:select name="DSPersonForm" property="nmPrefix" styleId="NmPrefix" onchange ="unhideBatchImg('nameTable');">
									      ...
									      <td id="nameLast"> <html:text name="DSPersonForm" property="nmLast" styleId="NmLast" onkeyup ="unhideBatchImg('nameTable');" size="50" maxlength="50"/>  </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"><span class=" InputFieldLabel" id="NmSecLastL" title="Second Last Name ">  Second Last:</span> </td>
									      <td id="nameSecLast"> <html:text name="DSPersonForm" property="nmSecLast" onkeyup ="unhideBatchImg('nameTable');" styleId="NmSecLast" size="50" maxlength="50"/>  </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="NmFirstL" title="First Name "> First:</span> </td>
									      <td id="nameFirst"> <html:text name="DSPersonForm" property="nmFirst" onkeyup ="unhideBatchImg('nameTable');"  styleId="NmFirst" size="50" maxlength="50"/>  </td>	
									      </tr>	
									      <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="NmMiddleL" title="Middle Name "> Middle:</span> </td>
									      <td id="nameMiddle"> <html:text name="DSPersonForm" property="nmMiddle" onkeyup ="unhideBatchImg('nameTable');" styleId="NmMiddle" size="50" maxlength="50"/>   </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="NmSecMiddleL" title="Second Middle Name "> Second Middle: </span></td>
									      <td id="nameSecMiddle"> <html:text name="DSPersonForm" property="nmSecMiddle" onkeyup ="unhideBatchImg('nameTable');" styleId="NmSecMiddle" size="50" maxlength="50"/> </td>	
									      </tr>	
									      <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="NmSuffixL" title="Name Suffix "> Suffix: </span></td>
									      <td id="nameSuffix"> 
									      <html:select name="DSPersonForm" property="nmSuffix" styleId="NmSuffix" onchange ="unhideBatchImg('nameTable');">
									      ...
									      <td id="nameDegree">
									        <html:select name="DSPersonForm" property="nmDegree" styleId="NmDegree" onchange ="unhideBatchImg('nameTable');">
			                     ...
			                     <tr> <td colspan="2" width="100%">	
			                      <div class="infoBox errors" style="display: none;visibility: none;" id="AddrerrorMessages">
									...
									<tbody id="patternaddrTable">
								            ...
								            <tr>
								            <td style="width:33%;text-align:center;">
											 <input id="viewIdSubSection" type="image" src="page_white_text.gif" onclick="viewClicked(this.id,'addrTable');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td><td style="width:33%;text-align:center;">
											 <input id="editIdSubSection" type="image" src="page_white_edit.gif" onclick="editClicked(this.id,'addrTable');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td><td style="width:33%;text-align:center;">
											 <input id="deleteIdSubSection" type="image" src="cross.gif" onclick="deleteClicked(this.id,'addrTable');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">	</td>
 											</td>	
 											</tr>
 											</table>
 											</td>
									 ...
									 <td colspan="21"> <span>&nbsp; No Data has been entered.
									   ...
									   <tr>
									      ...
									      <td id="addressNameDate" width="100%">  <html:text  name="DSPersonForm" styleClass="requiredInputField" property="addrAsOf" maxlength="10" size="10"  styleId="AddrAsOf" onkeyup="unhideBatchImg('addrTable');DateMask(this,null,event)"/>
									         <html:img src="calendar.gif" onclick="getCalDate('AddrAsOf','AddrAsOfIcon');return false;" styleId="AddrAsOfIcon"></html:img>  </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"><span class=" InputFieldLabel" id="AddrTypeL" title="Address Type">  Type: </span>  </td>
									      <td id="addressType">  <html:select name="DSPersonForm" property="addrType" styleId="AddrType" onchange ="unhideBatchImg('addrTable');">
									      ...
									      <td id="addressUse">  <html:select name="DSPersonForm" property="addrUse" styleId="AddrUse" onchange ="unhideBatchImg('addrTable');">
									      ...
									      <td id="addressStr1"> <html:text name="DSPersonForm" property="addrStreet1" onkeyup ="unhideBatchImg('addrTable');" styleId="AddrStreet1" size="30" maxlength="100"/>   </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="AddrStreet2L" title="Street Address 2 "> Street Address 2: </span></td>
									      <td id="addressStr2"> <html:text name="DSPersonForm" property="addrStreet2" onkeyup ="unhideBatchImg('addrTable');" styleId="AddrStreet2" size="30" maxlength="100"/>   </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="AddrCityL" title="City "> City: </span></td>
									      <td id="addressCity"> <html:text name="DSPersonForm" property="addrCity" onkeyup ="unhideBatchImg('addrTable');" styleId="AddrCity" size="30" maxlength="100" />   </td>	
									      </tr>	
									      <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="AddrStateL" title="State">  State: </span> </td>
									      <td id="addressState"> <html:select name="DSPersonForm" property="addrState" styleId="AddrState" onchange="unhideBatchImg('addrTable');getDWRPatientCounties(this, 'AddrCnty');">
									      ...
									      <td id="addressCounty"> <html:select name="DSPersonForm" property="addrCnty" styleId="AddrCnty" onchange ="unhideBatchImg('addrTable');">
									      ...
									      <td id="addressCensusTract"> <html:text name="DSPersonForm" property="addrCensusTract" onkeyup ="unhideBatchImg('addrTable');" styleId="AddrCensusTract" size="15" maxlength="100" />   </td>	
									      </tr>
									      <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="AddrCntryL" title="Country "> Country: </span> </td>
									      <td id="addressCountry"> <html:select name="DSPersonForm" property="addrCntry" styleId="AddrCntry" onchange ="unhideBatchImg('addrTable');">
									      ...
									      <td id="addressComments"> <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" name="DSPersonForm" 
			                    ...
			                    <nedss:bluebar id="patSearch10" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F"  classType="bluebarsubSect" >
			                      ...
			                      <tr> <td colspan="2" width="100%">
			                       <div class="infoBox errors" style="display: none;visibility: none;" id="PhoneerrorMessages">
									...
									<tbody id="patternphoneTable">
								            ...
								            <tr>
								            <td style="width:33%;text-align:center;">
											 <input id="viewIdSubSection" type="image" src="page_white_text.gif" onclick="viewClicked(this.id,'phoneTable');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td><td style="width:33%;text-align:center;">
											 <input id="editIdSubSection" type="image" src="page_white_edit.gif" onclick="editClicked(this.id,'phoneTable');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td><td style="width:33%;text-align:center;">
											 <input id="deleteIdSubSection" type="image" src="cross.gif" onclick="deleteClicked(this.id,'phoneTable');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">	</td>
 											</td>	
 											</tr>
 											</table>
 											</td> 															           
									 ...
									 <td colspan="21"> <span>&nbsp; No Data has been entered.
									   ...
									   <tr>
									      ...
									      <td id="phoneNameDate" width="100%">  <html:text  name="DSPersonForm" styleClass="requiredInputField" property="phAsOf" maxlength="10" size="10" styleId="PhAsOf" onkeyup="DateMask(this,null,event)"/>
									         <html:img src="calendar.gif" onclick="getCalDate('PhAsOf','PhAsOfIcon');return false;" styleId="PhAsOfIcon"></html:img>  </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"><span class=" InputFieldLabel" id="PhTypeL" title="Phone Type">  Type: </span>  </td>
									      <td id="phoneType">  <html:select name="DSPersonForm" property="phType" styleId="PhType" onchange ="unhideBatchImg('phoneTable');">
									      ...
									      <td id="phoneUse">  <html:select name="DSPersonForm" property="phUse" styleId="PhUse" onchange ="unhideBatchImg('phoneTable');">
									      ...
									      <td id="phoneCntryCd"> <html:text name="DSPersonForm" property="phCntryCd" styleId="PhCntryCd" onkeyup="unhideBatchImg('phoneTable');isNumericCharacterEntered(this)" />   </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="PhNumL" title="Phone Number"> Phone Number: </span></td>
									      <td id="phoneNum"> <html:text name="DSPersonForm" property="phNum" styleId="PhNum"  onkeyup="unhideBatchImg('phoneTable');TeleMask(this,event)"/>   </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="PhExtL" title="Extension "> Extension: </span></td>
									      <td id="phoneExt"> <html:text maxlength="20" name="DSPersonForm" property="phExt" styleId="PhExt" onkeyup="unhideBatchImg('phoneTable');isNumericCharacterEntered(this)" />   </td>	
									      </tr>	
									      <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="PhEmailL" title="Email">  Email: </span> </td>
									      <td id="phoneEmail"> <html:text name="DSPersonForm" property="phEmail" styleId="PhEmail" onblur="unhideBatchImg('phoneTable');checkEmail(this)"/>  </td>	
									      </tr>
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="PhUrlL" title="URL">  URL: </span> </td>
									      <td id="phoneUrl"> <html:text name="DSPersonForm" property="phUrl" styleId="PhUrl" onkeyup="unhideBatchImg('phoneTable');"/>  </td>	
									      </tr>										      
									       <tr>
									      <td class="fieldName"> <span class=" InputFieldLabel" id="PhCommentsL" title="Comments "> Phone & Email Comments: </span> </td>
									      <td id="phoneComments"> <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" name="DSPersonForm" 
			                     ...
			                     <nedss:bluebar id="patSearch12" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F"  classType="bluebarsubSect" >
			                       ...
			                       <div class="infoBox errors" style="display: none;visibility: none;" id="IdenerrorMessages">
									...
									<tbody id="patternidenTable">
								            ...
								            <tr>
								            <td style="width:33%;text-align:center;">
											 <input id="viewIdSubSection" type="image" src="page_white_text.gif" onclick="viewClicked(this.id,'idenTable');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td><td style="width:33%;text-align:center;">
											 <input id="editIdSubSection" type="image" src="page_white_edit.gif" onclick="editClicked(this.id,'idenTable');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td><td style="width:33%;text-align:center;">
											 <input id="deleteIdSubSection" type="image" src="cross.gif" onclick="deleteClicked(this.id,'idenTable');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">	</td>
 											</td>	
 											</tr>
 											</table>
 											</td> 															           
									 ...
									 <td colspan="21"> <span>&nbsp; No Data has been entered.
									   ...
									   <tr>
									      ...
									      <td id="idenNameDate" width="100%">  <html:text  name="DSPersonForm" styleClass="requiredInputField" property="idAsOf" maxlength="10" size="10" styleId="IdAsOf" onkeyup="unhideBatchImg('idenTable');DateMask(this,null,event)"/>
									         <html:img src="calendar.gif" onclick="getCalDate('IdAsOf','IdAsOfIcon');return false;" styleId="IdAsOfIcon"></html:img>  </td>	
									      </tr>	
									       <tr>
									      <td class="fieldName"><span class=" InputFieldLabel" id="IdTypeL" title="Identification Type">  Type: </span>  </td>
									      <td id="idenType">  <html:select name="DSPersonForm" property="idType" styleId="IdType" onchange ="unhideBatchImg('idenTable');">
									      ...
									      <td id="idenAssgn">  <html:select name="DSPersonForm" property="idAssgn" styleId="IdAssgn" onchange ="unhideBatchImg('idenTable');">
									      ...
									      <td id="idenValue"> <html:text name="DSPersonForm" property="idsValue" styleId="IdValue" onkeyup="unhideBatchImg('idenTable');"/>   </td>	
									      </tr>										      							      
			                     ...
			                     <nedss:bluebar id="patSearch14" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F"  classType="bluebarsubSect" >
			                      ...
			                      <div class="infoBox errors" style="display: none;visibility: none;" id="RaceerrorMessages">
									...
									<tbody id="patternraceTable">
								            ...
								            <tr>
								            <td style="width:33%;text-align:center;">
											 <input id="viewIdSubSection" type="image" src="page_white_text.gif" onclick="viewClicked(this.id,'raceTable');return false" name="image" align="middle" cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="View">
											 </td><td style="width:33%;text-align:center;">
											 <input id="editIdSubSection" type="image" src="page_white_edit.gif" onclick="editClicked(this.id,'raceTable');return false" name="image" align="middle" cellspacing="2" 		cellpadding="3" border="55" class="cursorHand" title="Edit">
											 </td><td style="width:33%;text-align:center;">
											 <input id="deleteIdSubSection" type="image" src="cross.gif" onclick="deleteClicked(this.id,'raceTable');return false" name="image" align="middle" 	cellspacing="2" cellpadding="3" border="55" class="cursorHand" title="Delete">	</td>
 											</td>	
 											</tr>
 											</table>
 											</td> 															           
									 ...
									 <td colspan="21"> <span>&nbsp; No Data has been entered.
									   ...
									   <tr>
									      ...
									      <td id="raceNameDate" width="100%">  <html:text  name="DSPersonForm" styleClass="requiredInputField" property="raceAsOf" maxlength="10" size="10" styleId="RaceAsOf" onkeyup="unhideBatchImg('raceTable');DateMask(this,null,event)"/>
									         <html:img src="calendar.gif" onclick="getCalDate('RaceAsOf','RaceAsOfIcon');return false;" styleId="RaceAsOfIcon"></html:img>  </td>	
									      </tr>	
									       <tr>
									        <td class="fieldName"><span class=" InputFieldLabel" id="RaceTypeL" title="Race Type">  Race: </span>  </td>
									       <td>
									       
									       <html:select name="DSPersonForm" property="raceType" styleId="RaceType" onchange="unhideBatchImg('raceTable');getDWRSubRaces(this, 'RaceDetailCat');">
									      ...
									      <td>
											...
											<html:select name="DSPersonForm" property="raceDetailCat" styleId="RaceDetailCat" multiple="true" size="4"
									...
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.asOfDateEthnicity_s" maxlength="10" size="10" styleId="AsOfDateEth" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('AsOfDateEth','AsOfDateEthIcon');return false;" styleId="AsOfDateEthIcon"></html:img>
									</td></tr>
									<tr><td class="fieldName">									
									<span title="Indicates if the patient is hispanic or not." id="INV2002L">Ethnicity:</span>
									</td>
									<td>
										<html:select name="DSPersonForm" property="person.thePersonDT.ethnicGroupInd" styleId="INV2002" onchange="showHideSpanishOrigin();enableOrDisable('INV2002','ReasonUnknown','UNK');">
										<html:optionsCollection property="codedValue(PHVS_ETHNICITYGROUP_CDC_UNK)" value="key" label="value" /></html:select>
										</td>
									</tr>
									<tr><td class="fieldName">									
									<span title="Reason for unknown etyhnicity." id="ReasonUnknownL">Reason Unknown:</span>
									</td>
									<td>
										<html:select name="DSPersonForm" property="person.thePersonDT.ethnicUnkReasonCd" styleId="ReasonUnknown">
									...
									<td>
									        <div class="multiSelectBlock">
											<i> (Use Ctrl to select more than one) </i> <br/>
											<html:select name="DSPersonForm" property="spanOrigin" styleId="SpanOrigin" multiple="true" size="4"
			                     ...
			                     <nedss:bluebar id="patSearch18" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F"  classType="bluebarsubSect" >
									...
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.asOfDateSex_s" maxlength="10" size="10" styleId="AsofDateSB" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('AsofDateSB','AsofDateSBIcon');return false;" styleId="AsofDateSBIcon"></html:img>
									</td></tr>
	                               <tr><td class="fieldName">									
									<span title="Reported date of birth of patient." id="patientDOBL">DOB:</span>
									</td><td>
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.birthTime_s" maxlength="10" size="10" styleId="patientDOB" onchange="updatePatientDOBInfo(this);" onblur="updatePatientDOBInfo(this);" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('patientDOB','patientDOBIcon');return false;" styleId="patientDOBIcon"></html:img>	
									...
									<input id="today" type="hidden" value="<%=PersonUtil.formatCurrentDate()%>">				
									 ...
									 <td >
						             <html:select name="DSPersonForm" property="person.thePersonDT.currSexCd" styleId="CurrSex" onchange="enableOrDisable('CurrSex','UnknownSpecify','U');pgSelectNextFocus(this);">
									 ...
									 <td >
						             <html:select name="DSPersonForm" property="person.thePersonDT.sexUnkReasonCd" styleId="UnknownSpecify">
									 ...
									 <td >
						             <html:select name="DSPersonForm" property="person.thePersonDT.preferredGenderCd" styleId="TransgenderInformation">
										<html:optionsCollection property="codedValue(TRANSGNDR_INFO)" value="key" label="value" /></html:select>
									 </td>
                                     </tr>
                                     <tr><td class="fieldName"><span title="Additional Gender" id="AdditionalGenderL">Additional Gender:</span></td>
									 <td >
						             	<html:text name="DSPersonForm"  property="person.thePersonDT.additionalGenderCd" maxlength="20" size="30" styleId="AdditionalGender" />
						             </td>
                                     </tr>
                                     <tr><td class="fieldName"><span title="Patient Birth Sex" id="BirSexL">Birth Sex:</span></td>
									 <td >
						              <html:select name="DSPersonForm" property="person.thePersonDT.birthGenderCd" styleId="BirSex">
										<html:optionsCollection property="codedValue(SEX)" value="key" label="value" /></html:select>
						             </td>
                                     </tr>
                                      <tr><td class="fieldName"><span title="Multiple Birth" id="MulBirL">Multiple Birth:</span></td>
									 <td >
									 <html:select name="DSPersonForm" property="person.thePersonDT.multipleBirthInd" styleId="MulBir">
									 ...
									 <td >
									  <html:text name="DSPersonForm"  property="person.thePersonDT.birthOrderNbrStr" maxlength="5" size="30" styleId="BirOrder"  onkeyup="isNumericCharacterEntered(this)" />						 
						             </td>
                                     </tr>
                                      <tr><td class="fieldName"><span title="Birth City" id="BirCityL">Birth City:</span></td>
									 <td >
									    <html:text name="DSPersonForm"  property="birthAddress.thePostalLocatorDT.cityDescTxt" maxlength="100" size="30" styleId="BirCity" />
						             </td>
                                     </tr>
                                      <tr>                                       
                                      <td class="fieldName"><span title="Birth State" id="BirStateL">Birth State:</span></td>
									 <td >
									 <html:select name="DSPersonForm" property="birthAddress.thePostalLocatorDT.stateCd" styleId="BirState" onchange="getDWRPatientCounties(this, 'BirCnty');">
									 ...
									 <td >
									 <html:select name="DSPersonForm" property="birthAddress.thePostalLocatorDT.cntyCd"  styleId="BirCnty">
									 ...
									 <td >
									 <html:select name="DSPersonForm" property="birthAddress.thePostalLocatorDT.cntryCd" styleId="BirCntry">
									...
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.asOfDateMorbidity_s" maxlength="10" size="10" styleId="AsofDateMorb" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('AsofDateMorb','AsofDateMorbIcon');return false;" styleId="AsofDateMorbIcon"></html:img>
									</td></tr>
									
			                       <tr><td class="fieldName">									
									<span title="Is the patient deceased" id="PatDeceasedL">Is the patient Deceased:</span>
									</td><td>
									<html:select name="DSPersonForm" property="person.thePersonDT.deceasedIndCd" styleId="PatDeceased">
										<html:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>	
									</td></tr>
									<tr><td class="fieldName">									
									<span title="Date of Death" id="DateOfDeathL">Date of Death:</span>
									</td><td>
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.deceasedTime_s" maxlength="10" size="10" styleId="DateOfDeath" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('DateOfDeath','DateOfDeathIcon');return false;" styleId="DateOfDeathIcon"></html:img>							
									</td></tr>
									<tr><td class="fieldName">									
									<span title="Death City" id="DeathCityL">Death City:</span>
									</td><td>
									<html:text name="DSPersonForm"  property="deceasedAddress.thePostalLocatorDT.cityDescTxt" maxlength="100" size="30" styleId="DeathCity"    />								
									</td></tr>
									 <tr><td class="fieldName">									
									<span title="Death State" id="DeathStateL">Death State:</span>
									</td><td>
									 <html:select name="DSPersonForm" property="deceasedAddress.thePostalLocatorDT.stateCd" styleId="DeathState" onchange="getDWRPatientCounties(this, 'DeathCnty');">
										<html:optionsCollection property="stateList" value="key" label="value" /></html:select>		
									</td></tr>
									 <tr><td class="fieldName">									
									<span title="Death County" id="DeathCntyL">Death County:</span>
									</td><td>
									 <html:select name="DSPersonForm" property="deceasedAddress.thePostalLocatorDT.cntyCd" styleId="DeathCnty">
									...
									<html:select name="DSPersonForm" property="deceasedAddress.thePostalLocatorDT.cntryCd" styleId="DeathCntry">
	                                   <html:optionsCollection name="DSPersonForm" property="countryList" value="key" label="value"/></html:select>					
									</td></tr>                               
									...
									<html:text  name="DSPersonForm" styleClass="requiredInputField" property="person.thePersonDT.asOfDateGeneral_s" maxlength="10" size="10" styleId="AsOfDateGenInfo" onkeyup="DateMask(this,null,event)"/>
									<html:img src="calendar.gif" onclick="getCalDate('AsOfDateGenInfo','AsOfDateGenInfoIcon');return false;" styleId="AsOfDateGenInfoIcon"></html:img>
									</td></tr>
									
			                       <tr><td class="fieldName">									
									<span title="Marital Status" id="MarStatusL">Marital Status:</span>
									</td><td>
									 <html:select name="DSPersonForm" property="person.thePersonDT.maritalStatusCd" styleId="MarStatus">
									...
									<span title="Mother's Maiden Name" id="MomMNmL">Mother's Maiden Name:</span>
									  ...
									  <html:text name="DSPersonForm"  property="person.thePersonDT.mothersMaidenNm" maxlength="50" size="30" styleId="MomMNm"   />								
									</td></tr>
									<tr><td class="fieldName">									
									<span title="Number of Adults in Residence" id="NumAdultsL">Number of Adults in Residence:</span>
									</td><td>
									<html:text name="DSPersonForm"  property="person.thePersonDT.adultsInHouseNbrStr" maxlength="5" size="30" styleId="NumAdults"  onkeyup="isNumericCharacterEntered(this)"  />								
									</td></tr>
									 <tr><td class="fieldName">									
									<span title="Number of Children in Residence" id="NumChildL">Number of Children in Residence:</span>
									</td><td>
										<html:text name="DSPersonForm"  property="person.thePersonDT.childrenInHouseNbrStr" maxlength="5" size="30" styleId="NumChild"  onkeyup="isNumericCharacterEntered(this)"  />										
									</td></tr>
									 <tr><td class="fieldName">									
									<span title="Primary Occupation" id="PriOccupL">Primary Occupation:</span>
									</td><td>
									 <html:select name="DSPersonForm" property="person.thePersonDT.occupationCd" styleId="PriOccup">
									...
									<html:select name="DSPersonForm" property="person.thePersonDT.educationLevelCd" styleId="HLevelEdu">
									...
									<html:select name="DSPersonForm" property="person.thePersonDT.primLangCd" styleId="PriLang">
									...
									<tr><td class="fieldName"><span title="Speaks English" id="SpeaksEnglishCdL">Speaks English:</span></td>
									 <td >
						              <html:select name="DSPersonForm" property="person.thePersonDT.speaksEnglishCd" styleId="SpeaksEnglishCd">
										<html:optionsCollection property="codedValue(YNU)" value="key" label="value" /></html:select>
						             </td>
                                     </tr>
                                     <logic:equal name="DSPersonForm" property="securityMap.hasHIVPermissions" value="T">
										...
										<td>
										<html:text  name="DSPersonForm" styleId="eHARSID" property="person.thePersonDT.eharsId" size="16" maxlength="16"/>
										</td></tr>				
									</logic:equal>                      
