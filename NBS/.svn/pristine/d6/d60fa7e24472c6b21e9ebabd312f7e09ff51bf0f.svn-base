...

{
	...
	private String buildInvestigationCriteriaFirstQueryInvestigation(PatientSearchVO find, NBSSecurityObj nbsSecurityObj) {
        ...
        if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID))
        {
            query.append(WumSqlQuery.SELECT_MY_INVESTIGATIONS_EVENT_SEARCH_ORACLE +
                    //"where ("+
	...
	private String buildInvestigationCriteriaNestedQueryInvestigation(PatientSearchVO find,
		...
		query.append(" from Notification, Act_relationship act, ( ");
		query.append(nestedQuery);//The nested query contains everything that we need to show
		query.append(" ) ");
		query.append(wqDerivedTableName);
	...
	private String buildDateReportNestedQueryInvestigation(PatientSearchVO find,
		...
		query.append(" from public_health_case, ( ");
		query.append(nestedQuery);//The nested query contains everything that we need to show
		query.append(" ) ");
		query.append(wqDerivedTableName);
	...
	private String buildCreatedUpdatedUserNestedQueryInvestigation(PatientSearchVO find,
		...
		query.append(" from auth_user auth,auth_user auth2, public_health_case,( ");
		query.append(nestedQuery);//The nested query contains everything that we need to show
		query.append(" ) ");
		query.append(wqDerivedTableName);
	...
	private String buildReportingFacilityNestedQueryInvestigation(PatientSearchVO find,
		...
		query.append(" from public_health_case, person, ( ");
		query.append(nestedQuery);//The nested query contains everything that we need to show
		query.append(" ) ");
		query.append(wqDerivedTableName);
	...
	private String buildCityCaseNestedQueryInvestigation(PatientSearchVO find,
		...
		query.append(" from auth_user auth,auth_user auth2, public_health_case, person, ( ");
		query.append(nestedQuery);//The nested query contains everything that we need to show
		query.append(" ) ");
		query.append(wqDerivedTableName);
...
" where source_act_uid in( select target_act_uid from Act_relationship where source_act_uid in "+
 "(select observation_uid from obs_value_coded where code ='"+pregnant.toUpperCase()+"' and observation_uid in(select observation_uid from "+
 " observation where cd ='INV178'))))";
					...
					"FROM Obs_value_coded INNER JOIN "+
					...
					"Observation Observation_1 ON Act_relationship.target_act_uid = Observation_1.observation_uid INNER JOIN "+
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(public_health_case.RPT_FORM_CMPLT_TIME  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( public_health_case.RPT_FORM_CMPLT_TIME > '"
								+ dateFromOracle + "' and public_health_case.RPT_FORM_CMPLT_TIME < '"+dateToOracle+"')");
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(public_health_case.ACTIVITY_TO_TIME  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( public_health_case.ACTIVITY_TO_TIME > '"
								+ dateFromOracle + "' and public_health_case.ACTIVITY_TO_TIME < '"+dateToOracle+"')");
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(public_health_case.ADD_TIME  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( public_health_case.ADD_TIME > '"
								+ dateFromOracle + "' and public_health_case.ADD_TIME < '"+dateToOracle+"')");
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(public_health_case.LAST_CHG_TIME  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( public_health_case.LAST_CHG_TIME > '"
								+ dateFromOracle + "' and public_health_case.LAST_CHG_TIME < '"+dateToOracle+"')");
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(public_health_case.activity_from_time  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( public_health_case.activity_from_time > '"
								+ dateFromOracle + "' and public_health_case.activity_from_time < '"+dateToOracle+"')");
		...
		try{
			...
			if ((find.getDateFrom() != null)
				...
				if (propertyUtil.getDatabaseServerType() != null && propertyUtil.getDatabaseServerType().equalsIgnoreCase(NEDSSConstants.ORACLE_ID)){
					...
					if(oper.equalsIgnoreCase("=") || oper.equalsIgnoreCase("!="))
						strbResult.append( "(add_time  " + oper + "   '"
							+ dateFromOracle + "')");
					else//Between
						strbResult.append( "( add_time > '"
								+ dateFromOracle + "' and add_time < '"+dateToOracle+"')");
