    ...
    <!-- Form Entry Errors -->
                ...
                <tr>
                    ...
                    <td> 
                    	<logic:equal name="decisionSupportForm" property="actionMode" value="Create">
                    		<html:text  property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.ALGORITHM_NM+")"%>' styleId="AlgoNm"/> 
                    	</logic:equal>
                    	<logic:notEqual name="decisionSupportForm" property="actionMode" value="Create">
	                    	<logic:equal name="decisionSupportForm" property="fromImport" value="Yes">
	                    		<html:text  property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.ALGORITHM_NM+")"%>' styleId="AlgoNm"/> 
	                    	</logic:equal>
	                    	<logic:notEqual name="decisionSupportForm" property="fromImport" value="Yes">
            ...
            <nedss:container id="subsec2" classType="subSect" name="Frequency & Scope" >
                <tr>
                    ...
                    <td>
                   		<html:select name="decisionSupportForm" property='<%="decisionSupportClientVO.answer("+DecisionSupportConstants.FREQUENCY+")"%>' styleId = "Freq">
                ...
                <tr>
                    ...
                    <td>
                    	<logic:iterate id="dropDownCodeDT" name="decisionSupportForm" property="codedValueForApplyTo(NBS_ENTRY_METHOD)" type="gov.cdc.nedss.systemservice.util.DropDownCodeDT">
						    ...
						    <html:multibox property='<%="decisionSupportClientVO.answerArray("+DecisionSupportConstants.APPLY_TO+")"%>' styleId="ApplyTo" value="<%=key.toString()%>"> 
						    	<bean:define id="value" name="dropDownCodeDT"  property="value"/>
						        <bean:write name="key"/>
						    </html:multibox>
						       <FONT COLOR="#808080"><bean:write name="value"/></FONT>
						</logic:iterate>
                    </td>
                </tr>
                <tr id ="sendingSystem">
                    ...
                    <td>
                    	<div class="multiSelectBlock">
	                        ...
	                        <html:select property='<%="decisionSupportClientVO.answerArray("+DecisionSupportConstants.SENDING_SYS+")"%>'
	                                styleId="sendSys" 
