...
public class UpdatedNotificationDAOImpl extends DAOBase {
	...
	public static final String UPDATED_NOTIFICATIONS_FOR_AUDIT_SQL =
		...
		"from nbs_odse..updated_notification UpdatedNotification, " +
	...
	public static final String UPDATED_NOTIFICATIONS_FOR_AUDIT_ORACLE =
		"select /*+ FIRST_ROWS */ UpdatedNotification.version_ctrl_nbr \"versionCtrlNbr\", " + 
		"UpdatedNotification.notification_uid \"notificationUid\", " +
		"UpdatedNotification.add_user_id \"addUserId\", " +
		"UpdatedNotification.add_time \"addTime\", " +
		"UpdatedNotification.case_status_chg_ind \"caseStatusChg\", " +
		...
		" Public_health_case, nbs_srte.condition_code cc, " +
		" Export_receiving_facility, " +
		DataTables.PARTICIPATION_TABLE + " par, " +
		DataTables.PERSON_TABLE + " per " +
		" WHERE act.source_act_uid = Notification.notification_uid  " +
		" and Public_health_case.public_health_case_uid = act.target_act_uid " +
        " AND Public_health_case.record_status_cd <> '" + NEDSSConstants.RECORD_STATUS_LOGICAL_DELETE + "' " +
		" AND par.act_uid = Public_health_case.public_health_case_uid " +
		" AND per.person_uid = par.subject_entity_uid " +
		" and act.type_cd = '" + NEDSSConstants.ACT106_TYP_CD + "' " +
		" AND par.type_cd = '" + NEDSSConstants.PHC_PATIENT + "' " +
		" and Notification.notification_uid = UpdatedNotification.notification_uid  " +
		" and Notification.case_condition_cd = cc.condition_cd " +
		" AND UpdatedNotification.status_cd='A' "+
		"AND Export_receiving_facility.Export_receiving_facility_uid(+) = Notification.Export_receiving_facility_uid";
		...
		NBSSecurityObj nbsSecurityObj) throws NEDSSSystemException{
			...
			try {
				...
				if (PropertyUtil.getInstance().getDatabaseServerType() != null
					...
					selectstatement =
						UPDATED_NOTIFICATIONS_FOR_AUDIT_ORACLE
