...
<script type="text/javascript" src="Globals.js"></script>
     ...
     <script type="text/javascript">
	        ...
	        {
                var pageNm = "<%=request.getAttribute("pgPageName")%>";
	...
	function checkForRelatedCondition() {
		...
		if (checkForRelatedCondition() == false) {
            ...
            if (divElt == null) {
	          ...
	          var dlgStyle = "scroll:on;scrollbars=yes;status:no;resizable:yes;help:no;dialog Height:700px;dialogWidth:900px;top="+topVar+";left="+leftVar;
          ...
          function viewPageHistoryPopUp(){      
        	  var conditionCd = "<%=request.getAttribute("pgPageName")%>";
          ...
          function printTemplate() {
              var divElt = getElementByIdOrByName("pageview");
              var templateUid = '<%=request.getAttribute("templateUid")%>';
              divElt.style.display = "block";
              var o = new Object();
              o.opener = self;   
          ...
          {
          	var templateUid = "<%=request.getAttribute("templateUid")%>";
          	var templateNm = "<%=request.getSession().getAttribute("pgPageName")%>";
