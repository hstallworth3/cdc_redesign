...
if(scroll==false)
	...
	if (ixsAssignedSpan != null) {
        ...
        var modWin = openWindow(urlToOpen, o, GetDialogFeatures(780, 700, false, true), divElt, "");
    ...
    function populateContactRecordPopUp(contactRecordUID)
    {
      ...
      // var modWin = window.showModalDialog(urlToOpen,o, GetDialogFeatures(800, 760, false));
