...
public class FindPlaceDAOImpl extends DAOBase
{
    ...
    public static final String  BASENAMEQUERYORACL    = " SELECT o.place_uid \"placeUid\", o.local_id \"localId\", o.nm  \"nm\", o.cd \"cd\", o.cd_desc_txt \"cdDescTxt\", "
                                                              + " o.record_status_cd \"recordStatusCd\", "
                                                              + " o.version_ctrl_nbr \"versionCtrlNbr\"  " 
                                                              + " FROM  place o  "
                                                              + " WHERE o.record_status_cd = 'ACTIVE' ";

    public static final String  BASEADDRESSQUERYORACL = " SELECT o.place_uid \"placeUid\", o.local_id \"localId\", "
                                                              + " o.record_status_cd \"recordStatusCd\", "
                                                              + " o.version_ctrl_nbr \"versionCtrlNbr\", "
                                                              + " pl.postal_locator_uid \"locatorUid\", "
                                                              + " elp1.as_of_date \"asOfDate\","
                                                              ...
                                                              + " pl.street_addr1 \"streetAddr1\", "
                                                              + " pl.street_addr2 \"streetAddr2\", "
                                                              + " pl.city_desc_txt \"city\", "
                                                              + " pl.zip_cd \"zip\",  "
                                                              + " pl.state_cd \"state\", "
                                                              + " pl.cnty_cd \"cntyCd\" "
                                                              + " FROM place o, entity_locator_participation elp1,  postal_locator pl "
                                                              + " WHERE o.place_uid = elp1.entity_uid  "
                                                              + " and elp1.class_cd = 'PST' "
                                                              + " and elp1.status_cd = 'A' "
                                                              + " and elp1.locator_uid = pl.postal_locator_uid " 
    ...
    public static final String  BASEIDQUERYORACL      = " SELECT o.place_uid \"placeUid\", o.local_id \"localId\", o. version_ctrl_nbr \"versionCtrlNbr\",  "
                                                              + " ei.root_extension_txt \"rootExtensionTxt\", ei.type_cd \"typeCd\" "
                                                              + " FROM  place o,  Entity_id ei "
                                                              + " WHERE o.place_uid = ei.entity_uid  "
                                                              + " AND o.record_status_cd = 'ACTIVE' ";

    public static final String  BASETELEQUERYORACL    = "   SELECT o.place_uid \"placeUid\", o.local_id \"localId\", "
                                                              + " o.version_ctrl_nbr \"versionCtrlNbr\", "
                                                              + " tl.tele_locator_uid \"locatorUid\", elp2.as_of_date \"asOfDate\", "
                                                              + " elp2.class_cd \"classCd\", "
                                                              + " elp2.use_cd \"useCd\", elp2.cd \"locatorCd\", "
    ...
    private ArrayList<Object> runNameQuery(String whereClause)
    {
        ...
        if ( NEDSSConstants.ORACLE_ID.equalsIgnoreCase(propertyUtil.getDatabaseServerType()))
            query.append(BASENAMEQUERYORACL);
        else
    ...
    private ArrayList<Object> runAddressQuery(String whereClause)
    {
        ...
        if (NEDSSConstants.ORACLE_ID.equalsIgnoreCase(propertyUtil.getDatabaseServerType()))
            query.append(BASEADDRESSQUERYORACL);
        else
    ...
    private ArrayList<Object> runTeleQuery(String whereClause)
    {
        ...
        if (NEDSSConstants.ORACLE_ID.equalsIgnoreCase(propertyUtil.getDatabaseServerType()) ) 
            query.append(BASETELEQUERYORACL);
        else
