...
<html:form>
<table align="left" bgcolor="white" border="0" cellspacing="0" cellpadding="0"  >
		<tr>
				<td>
						<div id="buttonbartop">
								...
								<tr>
									<td>
										...
										<tr align="left">
											...
											<td background="task_button/tb_cel_bak.jpg" valign="top" align="left" width="500"></td>
											<td valign="top" width="3"><img alt="" border="0" height="54" width="3" 								src="task_button/strip_spacer.jpg"></td>
											<td background="task_button/tb_cel_bak.jpg" valign="top" align="left" width="250">
													<table align="left" cellpadding="0" cellspacing="0" border="0" width="30">
															<tr>
																<td valign="top" align="center"><input type="image" src="task_button/fa_add.jpg" 										width="30" 	height="40" border="0" name="Add" id="Add" alt="Addbutton" 												class="cursorHand" 	onclick="self.close();"></td>
																<td >&nbsp; </td>
																<td valign="top" align="center"><input type="image" src="task_button/fa_submit.jpg" 										width="30" height="40" border="0" name="Cancel" id="Cancel" alt="Cancelbutton" 										class="cursorHand" onclick="self.close();"></td>
															</tr>
															<tr>
...
<tr>
	<td>
		<table align="left" bgcolor="white" border="1" cellspacing="0" cellpadding="0" width="650">
     			  <tr >
									...
									<table cellpadding="0" cellspacing="0" border="0" width="650">
										...
										<tr>
											<td valign="top" align="center"><input type="image" src="task_button/fa_add.jpg" width="30" 	height="40" border="0" 											name="Add" 		id="Add" 			alt="Add 		button" class="cursorHand" 					 									onclick="self.close();">
									       	...
									       	<td >&nbsp; </td>
											<td valign="top" align="center"><input type="image" src="task_button/fa_submit.jpg" width="30" height="40" border="0" 													name="Cancel" 			id="Cancel" 			alt="Cancel 		button" 	 
