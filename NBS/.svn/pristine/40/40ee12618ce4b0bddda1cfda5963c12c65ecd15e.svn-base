...
<script language="JavaScript">
	...
	function cancelForm() {
		var confirmMsg = "You have indicated that you would like to cancel the edits to the ${BaseForm.attributeMap.AlgorithmName} algorithm. Please select OK to continue or Cancel to return to Edit Algorithm.";
	...
	function enableDisableTimeLogicOnLoad(){
		var elementField = getElementByIdOrByName("useEventDateLogicRadioNo");
		if(elementField!=undefined && elementField != null)
			enableDisableTimeLogic(elementField);
	}
...
<logic:equal name="decisionSupportForm" property="actionMode"
	value="Create">
	<body
		onload="onLoadFunction();autocompTxtValuesForJSP();startCountdown();enableDisableTimeLogicOnLoad();">
</logic:equal>
<logic:equal name="decisionSupportForm" property="actionMode"
	value="Edit">
	<%
	...
	%>
	<body
		onload="onLoadFunction();autocompTxtValuesForJSP();startCountdown();getConditionDropDownOnEdit('<%=formCode%>');enableDisableTimeLogicOnLoad();">
</logic:equal>
