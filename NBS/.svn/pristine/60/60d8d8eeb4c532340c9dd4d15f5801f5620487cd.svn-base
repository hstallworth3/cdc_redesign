...
<tr>
  ...
  <!-- ########### SUB SECTION ###########  -->
			      <nedss:container id="patSearch6" name="" displayImg="F" displayLink="F" defaultDisplay="F"  includeBackToTopLink ="F" isHidden="F" classType="subSect" >
					...
					<tr>
                        <td class="fieldName" id="TYPE"><span style="color:red; font-weight:bold;">*</span>  Event Type: </td> 
			...
			<nedss:container id="tab04" name="General Search" defaultDisplay="F" includeBackToTopLink="F" isHidden="F" classType="sect">
				...
				<nedss:container id="patSearch6" name="" displayImg="F" displayLink="F" defaultDisplay="F" includeBackToTopLink="F"	isHidden="F" classType="subSect">
					...
					<tr id = "conditionTR">
						...
						<td width="1%"></td>
						<td style="white-space:nowrap"><html:select name="personSearchForm" property="personSearch.conditionSelected" styleId="COND" title="Please select the condition to search" size="19">
								<html:optionsCollection property="conditionL" value="key" label="value" />
							</html:select>
						</td>
					</tr>
					<!-- Program Area -->
					<tr>
						...
						<html:select name="personSearchForm" property="personSearch.programAreaSelected"
								styleId="PROGRAMAREA"
								title="Please select the program area to search" size="19">
						...
						<html:select name="personSearchForm" property="personSearch.programAreaLabSelected"
						...
						<html:select name="personSearchForm" property="personSearch.programAreaMorbSelected"
						...
						<html:select name="personSearchForm" property="personSearch.programAreaCaseSelected"
						...
						<html:select name="personSearchForm" property="personSearch.programAreaInvestigationSelected"
								styleId="PROGRAMAREAINVEST"
								title="Please select the program area to search" size="19">
								<html:optionsCollection property="programListInvestigation" value="key"
									label="value" />
							</html:select>
					...
					<tr>
						...
						<td><html:select name="personSearchForm"
								...
								title="Please select the jurisdiction to search" size="19">
                    ...
                    <td style="background:#CEE3F6; margin:0.05em; padding:0.05em;"></td>
						...
						<td><html:select name="personSearchForm"
								...
								title="Please select the type of Event to search">
					...
					<tr id="ESR101TR">
						...
						<td style="background: #CEE3F6; margin: 0.05em; padding: 0.05em; width: 7%; white-space: nowrap;">
							<table style="background: #CEE3F6">
								<tr>
									<!-- <td style="background: #CEE3F6" width="1%">&nbsp;&nbsp;</td> -->
									<td style="background: #CEE3F6;white-space: nowrap;">
					...
					<!-- Event DATE Type -->
					 <tr>
						...
						<td style="background:#CEE3F6; margin:0.05em; padding:0.05em;"></td>
			             ...
			             <td>
							<html:select name="personSearchForm" property="personSearch.dateType" styleId="ESR200"  onchange="showHideEventFields();clearEventDateDropdown();" title="Please select the type of Event to search">
				...
				<!-- dateList -->
					...
					<td style="background: #CEE3F6; margin: 0.05em; padding: 0.05em;width: 7%; white-space: nowrap;">
							<table style="background: #CEE3F6" width="7%">
								<tr>
								<!-- 	<td style="background: #CEE3F6" width="1%">&nbsp;&nbsp;</td> -->
									<td style="background: #CEE3F6;white-space: nowrap;">
						...
						<td colspan="2" style="width: 400px"><html:text
								name="personSearchForm" property="personSearch.dateFrom"
						...
						<html:text name="personSearchForm" property="personSearch.dateTo"
					...
					<tr id="enterymethod">
						...
						<td>
						<html:checkbox  name="personSearchForm" property="personSearch.electronicSelected" styleId="ELECTRONIC"></html:checkbox> 
						<span id="ele"><nobr>Electronic</nobr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<html:checkbox  name="personSearchForm" property="personSearch.manualSelected" styleId="MANUAL" style="margin-left:2.75px;"></html:checkbox> 
					...
					<tr id="enteredBy">
						...
						<html:checkbox  name="personSearchForm" property="personSearch.internalUserSelected" styleId="INTERNALUSER" ></html:checkbox> 
						<nobr>Internal User</nobr>&nbsp;
						<html:checkbox  name="personSearchForm" property="personSearch.externalUserSelected" styleId="EXTERNALUSER"></html:checkbox> 
					...
					<tr id="eventState">
						...
						<td>
						<html:checkbox  name="personSearchForm" property="personSearch.newInitialSelected" styleId="newInitial"></html:checkbox> 
						<nobr>New/Initial</nobr> &nbsp;&nbsp;&nbsp;&nbsp;
						<html:checkbox  name="personSearchForm" property="personSearch.updateSelected" styleId="update"></html:checkbox> 
						<nobr>Update</nobr>
	            ...
	            <td>
	                ...
	                <span id="INV185SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.rfSelected" styleId="INV185Text"
                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV185Text','INV185_qec_list')" title="${PamForm.formFieldMap.INV185.tooltip}" 
                                />
  ...
  <td class="fieldName" style="font-weight:normal"> Reporting Facility Selected:</td>            <td style="background: #CEE3F6; margin: 0.05em; padding: 0.05em;">
					<td width="1%"></td>
	            <td>
	            ...
	            <td>
	                ...
	                <span id="INV186SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.ofSelected" styleId="INV186Text"
                                size="10" maxlength="10" onkeydown="genOrganizationAutocomplete('INV186Text','INV186_qec_list')" title="${PamForm.formFieldMap.INV186.tooltip}" 
                                />
                        <input type="Button" class="Button" value="Quick Code Lookup" 
	            ...
	            <td>
	                ...
	                <span id="INV209SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.opSelected" styleId="INV209Text"
                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV209Text','INV209_qec_list')" title="${PamForm.formFieldMap.INV209.tooltip}" 
                                />
                        <input type="Button" class="Button" value="Quick Code Lookup" 
	            ...
	            <td>
	                ...
	                <span id="INV208SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.rpSelected" styleId="INV208Text"
                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV208Text','INV208_qec_list')" title="${PamForm.formFieldMap.INV208.tooltip}" 
                                />
                        <input type="Button" class="Button" value="Quick Code Lookup" 
	            ...
	            <td>
	                ...
	                <span id="INV187SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.rpSelected" styleId="INV187Text"
                                size="10" maxlength="10" onkeydown="genOrganizationAutocomplete('INV187Text','INV187_qec_list')" title="${PamForm.formFieldMap.INV187.tooltip}" 
                                />
                        <input type="Button" class="Button" value="Quick Code Lookup" 
			  ...
			  <!--RESULTED TEST-->
			    ...
			    <tr>
						...
						<td style="width:7%; white-space: nowrap">
									...
									<html:select name="personSearchForm" property='personSearch.resultedTestCodeDropdown' styleId="resultOperatorList">
						...
						<td width="10%">
									...
									size="40" maxlength="50" title="${PamForm.formFieldMap.INV211.tooltip}" 
									/></div>
									<span
			    ...
			    <tr>
						...
						<td>	
									...
									<html:select property='personSearch.codeResultOrganismDropdown' styleId="codedResultOrganismOperatorList" >
										<!--onkeyup="changeElrResultSelection('resultOperatorList');"
										onchange="changeElrResultSelection('resultOperatorList');changeElrSectionDarkBGColor()"
										-->
						...
						<td>
									...
									size="40" maxlength="50" title="${PamForm.formFieldMap.INV212.tooltip}" 
									/></div>
									<span
	       ...
	       <tr id="investigator">
	            ...
	            <td>
	                ...
	                <span id="INV210SearchControls" class="">
	                   <input type="Button" class="Button" value="Search" 
                        ...
                        &nbsp; - OR - &nbsp;
                        <html:text property="personSearch.invSelected" styleId="INV210Text"
                                size="10" maxlength="10" onkeydown="genProviderAutocomplete('INV210Text','INV210_qec_list')" title="${PamForm.formFieldMap.INV210.tooltip}" 
                                />
                        <input type="Button" class="Button" value="Quick Code Lookup" 
			...
			<!-- INVESTIGATION STATUS -->
			  ...
			  <tr id="ESR101TR"  >                                                    
						...
						<td style="background: rgb(206, 227, 246); margin: 0.05em; padding: 0.05em;"></td>
                        <td> <html:select name="personSearchForm" property='personSearch.outbreakNameSelected' styleId="outbreakNameList" >
										<html:optionsCollection property="outbreakNameList" value="key" label="value" />
									</html:select> </td>
              </tr>
					...
					<tr id="caseStatusListValuesSelected">
						...
						<td id="ConditionField">
							<div class="multiSelectBlock">
								<input type="checkbox" name="caseStatusUnassigned" id="caseStatusUnassigned"/> Include Unassigned Status <br />
								<html:select name="personSearchForm"
					 ...
					 <!-- NOTIFICATION STATUS -->
						...
						<td id="ConditionField">
							<div class="multiSelectBlock">
								<input type="checkbox" name="notificationStatusUnassigned" id="notificationStatusUnassigned"/> Include Unassigned Status <br />
								<html:select name="personSearchForm"
				...
				<tr id="currentProcessStateValuesSelected">
						...
						<td id="ConditionField">
							<div class="multiSelectBlock">
								<input type="checkbox" name="currentProcessStateUnassigned" id="currentProcessStateUnassigned"/> Include Unassigned Status <br />
								<html:select name="personSearchForm"
