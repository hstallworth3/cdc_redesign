  ...
  if( col != null )
  {
      ...
      while(iter.hasNext())
      {
         ...
         if( "PST".equalsIgnoreCase(elp.getClassCd()) && NEDSSConstants.STATUS_ACTIVE.equalsIgnoreCase(elp.getStatusCd()))
             out.println( "addrArr.push(" + placeform.getJson( elp , "PST") + ");") ;
         else if( "TELE".equalsIgnoreCase(elp.getClassCd()) && NEDSSConstants.STATUS_ACTIVE.equalsIgnoreCase(elp.getStatusCd()) )
             out.println( "phoneArr.push(" + placeform.getJson( elp , "TELE") + ");") ;
      } 
  } 
  %>
  var refineSearch = <%=BaseForm.toJson(placeform.getPlaceSearch(), new String[] { "nm", "typeCd", "streetAddr1", "city", "state", "zip", "phoneNbrTxt" } )%>;
                   ...
                   <nedss:container id="reasonEdit" name="Reason for Edit" classType="sect" includeBackToTopLink="no"> 
                     <table class="subSect">
                      <tr>
                        ...
                        <td><html:radio property='reasonForEdit' styleId="rfe" value='overwrite' onchange="checkReason();">
                      ...
                      <tr>
                        <td></td>
                        <td><html:radio property='reasonForEdit' value='new'  onchange="checkReason();">
                ...
                <nedss:container id="section1" name="Place Demographics" classType="sect" displayImg="false" includeBackToTopLink="no">
					...
					<logic:notEmpty  name="placeForm" property="place.placeUid">
                        <tr>
                            ...
                            <td><html:text name="placeForm" property="quick.rootExtensionTxt" styleId="quickedit" maxlength="10"  onchange="getQuickEntryCode(this.name, 'trQcError')"/></td>
                        </tr>
						</logic:notEmpty>
						<logic:empty  name="placeForm" property="place.placeUid">
                        <tr>
                            <td class="fieldName" id="qac">Quick Code:</td>
                            <td><html:text name="placeForm" property="quick.rootExtensionTxt" maxlength="10" onchange="getQuickEntryCode(this.name, 'trQcError')"/></td>
                        </tr>
						</logic:empty>
                        ...
                        <tr>
                            ...
                            <td>
                                <html:select name="placeForm" property="place.thePlaceDT.cd" styleId="placeType" onchange="placeTypeOther(this)">
                        ...
                        <tr id="trPlaceTypeOther">
                            ...
                            <td> <html:text name="placeForm" property="place.cdDescTxt" maxlength="50" /> </td>
                        </tr>
                        <tr>
                            <td class="fieldName">General Comments:</td>
                            <td>
                                <html:textarea name="placeForm" property="place.thePlaceDT.description" rows="5" cols="40"/> 
                            </td>
                        </tr>
                    </nedss:container>
                    ...
                    <nedss:container id="subSec1" name="Name" classType="subSect" defaultDisplay="expand">
                        <tr>
                            ...
                            <td><html:text name="placeForm" property="place.thePlaceDT.nm" maxlength="48" /></td>
                        </tr>
                    </nedss:container>
                    ...
                    <nedss:container id="subSec2" name="Address" classType="subSect" defaultDisplay="expand">
                        ...
                        <tr id="trAddr1">
                          ...
                          <td id="addressAsOf">  
                            <html:text  name="placeForm" styleClass="requiredInputField" property="addrAsOf" maxlength="10" size="10"  styleId="AddrAsOf" onkeyup="DateMask(this,null,event)"/>
                            <html:img src="calendar.gif" onclick="getCalDate('AddrAsOf','AddrAsOfIcon');return false;" styleId="AddrAsOfIcon"></html:img>
                          </td>    
                        </tr>
                        <tr id="trAddr2">
                          <td class="fieldName"><span class="boldTenRed">* </span><span class="InputFieldLabel" id="AddrTypeL" title="Address Type">Type:</span></td>
                          <td id="addressType">  
                            <html:select name="placeForm" property="addrType" styleId="addrType">
                        ...
                        <tr id="trAddr3">
                          ...
                          <td id="addressUse">  
                             <html:select name="placeForm" property="addrUse" styleId="addrUse">
                        ...
                        <tr id="trAddr4">
                            ...
                            <td><input type="text" name="streetAddr1" maxlength="100" id="streetAddr1"/></td>
                        </tr>
                        <tr id="trAddr5">
                            <td class="fieldName">Street Address 2:</td>
                            <td><input type="text" name="streetAddr2" maxlength="100" /></td>
                        </tr>
                        <tr id="trAddr6">
                            <td class="fieldName">City:</td>
                            <td><input type="text" name="city" maxlength="100" id="city"/></td>
                        </tr>
                        <tr id="trAddr7">
                            <td class="fieldName">State:</td>
                            <td><html:select name="placeForm" property="state" onchange="getCounties(this, 'county');" styleId="state">
                        ...
                        <tr id="trAddr8">
                            ...
                            <td><input type="text" name="zip" onkeyup="ZipMask(this, event)" id="zip"/></td>
                        </tr>
                        <tr id="trAddr9">
                            <td class="fieldName">County:</td>
                            <td> <html:select name="placeForm" property="county" styleId="county">
                        ...
                        <tr id="trAddr10">
                            ...
                            <td><input type="text" name="censusTract" title="Census tract where the address is located is a unique identifier associated with a small statistical subdivision of a county. A single community may be composed of several census tracts." onblur="checkCensusTract(this)"></input></td>
                        </tr>
                        <tr id="trAddr11">
                            <td class="fieldName">Country:</td>
                            <td>
                                <html:select name="placeForm" property="country" styleId="country">
                        ...
                        <tr id="trAddr12">
                            ...
                            <td>
                              <textarea name="locatorDescTxt" rows="5" cols="40"></textarea>
                            </td>
                        </tr>
                    ...
                    <nedss:container id="subSec3" name="Phone, Email & URL" classType="subSect" defaultDisplay="expand"> 
                        ...
                        <tr id="trTel1">
                          ...
                          <td id="phoneAsOfTd">  
                            <html:text name="placeForm" styleClass="requiredInputField" property="phoneAsOf" maxlength="10" size="10"  styleId="PhoneAsOf" onkeyup="DateMask(this,null,event)"/>
                            <html:img src="calendar.gif" onclick="getCalDate('PhoneAsOf','PhoneAsOfIcon');return false;" styleId="PhoneAsOfIcon"></html:img>
                          </td>    
                        </tr>
                        <tr id="trTel2">
                          <td class="fieldName"><span class="boldTenRed">* </span>Type:</td>
                          <td id="addressType">  
                            <html:select name="placeForm" property="phoneType" styleId="phoneType" onchange='teleTypeOther(this)'>
                        ...
                        <tr id="trTelTypeOther" style="display: none">
                           <td class="fieldName">Description:</td>
                           <td>
                             <input type="text" name="teleOtherDesc" maxlength="50"/>
                           </td>
                        </tr> 
                        <tr id="trTel3">
                          <td class="fieldName"><span class="boldTenRed">* </span> <span class="InputFieldLabel" title="Phone Use">Use:</span></td>
                          <td id="phoneUseTd">  
                             <html:select name="placeForm" property="phoneUse" styleId="phoneUse">
                        ...
                        <tr id="trTel4">
                           <td class="fieldName">Country Code:</td>
                            <td><input type="text" name="cntryCd" maxlength="3" size="5" onkeyup="isNumericCharacterEntered(this)"/></td>
                        </tr>
                        <tr id="trTel4">
                            <td class="fieldName">Telephone:</td>
                            <td><input type="text" name="phone" maxlength="20" onkeyup="TeleMask(this, event)" id="phoneNbrTxt"/></td>
                        </tr>
                        <tr id="trTel5">
                            <td class="fieldName">Ext:</td>
                            <td><html:text name="placeForm" property="phoneExt" maxlength="10" size="10" onkeyup="isNumericCharacterEntered(this)" /></td>
                        </tr>
                        <tr id="trTel6">
                            <td class="fieldName">Email:</td>
                            <td><html:text name="placeForm" property="email" maxlength="48" /></td>
                        </tr>
                        <tr id="trTel7">
                            <td class="fieldName">URL:</td>
                            <td><input type="text" name="urlAddress" maxlength="100" /></td>
                        </tr>
                        <tr id="trTel8">
                            <td class="fieldName">Comments:</td>
                            <td><textarea name="locatorDescTxt_p" rows="5" cols="40"></textarea></td>
                        </tr>
