...
public class SRTTreatmentDAOImpl extends DAOBase {
  ...
  private String treatmentMapORCL =
      ...
      " order by upper(t.TREATMENT_DESC_TXT) ";
  ...
  private String treatmentAllORCL =
