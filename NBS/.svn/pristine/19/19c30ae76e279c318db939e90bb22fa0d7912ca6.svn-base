...
function viewFromPageFields(waUiMetadataUid,questionIdentifier,questionLabel,dataType,codeSetGroup,recordStatusCd, mapped, questionGroupSeqNbr, answerGroupSeqNbr, questionEditFlag){
...
function editQuestion(){
       ...
       mapFromPageFields(null,questionIdentifier,questionLabel,dataType,codeSetGroup,null, mapped, questGrpSeqNbr,null);
       if(mapped!='N'){
...
function populateToFields(toPageQuestionId)
{
       ...
       //JPortPage.getToQuestionFields(fromId,toID, function(data){
             ...
             if(!getElementByIdOrByName("answerMappingReq_textbox").disabled)
                    getElementByIdOrByName("answerMappingReq_textbox").focus();
             else if(!getElementByIdOrByName("repeatingBlockNumber").disabled)
                    getElementByIdOrByName("repeatingBlockNumber").focus();
