...
/*      System.out.println("stateDefinedDataDT LDF UID = " + stateDefinedDataDT.getLdfUid());
        System.out.println("stateDefinedDataDT Bus Name = " + stateDefinedDataDT.getBusinessObjNm());
        System.out.println("stateDefinedDataDT Bus UID  = " + stateDefinedDataDT.getBusinessObjUid());*/
       Iterator<Object>  metaDataItr = stateDefinedFieldMetaDataDTColl.iterator();
        while  (metaDataItr.hasNext())
        {
          StateDefinedFieldMetaDataDT stateDefinedMetaDataDT = (StateDefinedFieldMetaDataDT) metaDataItr.next();
