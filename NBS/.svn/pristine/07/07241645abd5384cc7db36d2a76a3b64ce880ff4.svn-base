...
CREATE TABLE INTERVIEW_CASE_INIT AS SELECT PARTICIPATION.D_INTERVIEW_KEY, PARTICIPATION.IX_INTERVIEWEE_ROLE_CD, PARTICIPATION2.PATIENT_KEY, PARTICIPATION3.IX_INTERVIEWER_KEY, PARTICIPATION.INTERVIEW_UID 
...
SELECT * FROM INTERVIEW_CASE INNER JOIN L_INTERVIEW_N 
