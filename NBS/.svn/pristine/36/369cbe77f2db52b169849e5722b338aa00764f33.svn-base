    ...
    <xsl:text disable-output-escaping="yes"><![CDATA[<script language="JavaScript" src="batch.js"></script>]]></xsl:text> 
        ...
        function OpenProcessingDecisionFromContactRecord() {
	    	...
	    	if(document.getElementById("CON145") != null &&getElementByIdOrByName("CON145").value == 'FF' &&getElementByIdOrByName("coInfectionInv") != null &&getElementByIdOrByName("coInfectionInv").value == 'true'){
				...
				var o = new Object();
				o.opener = self;
				var url = "/nbs/LoadProcessingDecision.do?method=processingDecisionLoad&event="+event+"&CONDITION_CD="+condition+"&context=loadProcessDecisionContactRecord&MprUid="+mprUid;
      ...
      function conStdCheckReferralBasisOptions()
      {
    		...
    		crStdSetupReferralBasisOptions(sourceDispositionCd, sourceInterviewStatusCd);
      }
