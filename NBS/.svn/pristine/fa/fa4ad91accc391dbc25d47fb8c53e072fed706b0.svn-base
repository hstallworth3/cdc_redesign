                        ...
                        <div class="sectBody">
                            <table class ="subSect" >
                                <tr>
                                    ...
                                    <td>
                                        <html:select  styleId="usersList" name="EmailAlertUserForm" property="emailAlertClientVO.nedssEntryId" onchange="return loadEmail();" >
								...
								<tr>
									...
									<td>
										<html:text styleId="emailId1" name="EmailAlertUserForm" property="emailAlertClientVO.emailId1" onkeyup ="deleteCaseButton()" maxlength="100" size="40"/>
									</td>
								</tr>
								<!-- EmailId2-->
								<tr>
									...
									<td >
										<html:text  styleId="emailId2" name="EmailAlertUserForm" property="emailAlertClientVO.emailId2"  onkeyup ="deleteCaseButton()" maxlength="100" size="40"/>
									</td>
								</tr>
								<!-- EmailId3-->
								<tr>
									...
									<td>
										<html:text styleId="emailId3" name="EmailAlertUserForm" property="emailAlertClientVO.emailId3"  onkeyup ="deleteCaseButton()" maxlength="100" size="40"/>
									</td>
								</tr>
								<!-- Update Buttion -->
								<tr>
