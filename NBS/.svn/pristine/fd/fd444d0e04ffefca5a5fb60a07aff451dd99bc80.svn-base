<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            */
            ...
            {
                var subSectionId = '<%=request.getSession().getAttribute("SubsectionId")%>';
                var childEltsCount = '<%=request.getSession().getAttribute("childEltsCount")%>';
    ...
    <body class="popup" onload="updateCheckBoxSelections();startCountdown();showCount()" onunload="handlePageUnload(false, event); return false;">
  ...
  <display:column title="&nbsp;&nbsp;&nbsp;
   ...
   <input type='checkbox' name='selectAll' onclick='selectAllQuestions(this)' />" headerClass="selectAll" style="width:3%;" media="html">
       <input type="checkbox"
