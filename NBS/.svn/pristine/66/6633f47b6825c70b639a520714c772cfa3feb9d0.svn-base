...
<html>
	...
	function showPatientInvestigations(patientUid, identifier) 
	{
		...
		document.forms[0].submit();		
			...
			/*function popupSubmitPatient(patientUid){
				$j("#nedssForm").attr({'target':'_blank','action':'/nbs/LoadPatientSearch.do?method=loadPatientEvents&ContextAction=viewFile&uid='+patientUid}).submit();
			...
			*/
			function viewPatientEvents(url)
			{
		        ...
		        var o = new Object();
		        o.opener = self;
		      //  var modWin = window.showModalDialog(url , o, );
	...
	<body class="popup" onunload="handlePageUnload(false, event); return false;" style="padding-right:15px;">
	                ...
	                <nedss:container id="section1" name="Search Results" classType="sect" 
	                    ...
	                    <div class="infoBox messages" align="left">
	                     ...
	                     <logic:empty name="patientSearchForm" property="attributeMap.contactPatientEle">
	                        ...
	                        <logic:equal value="true" name="addButton" scope="request">   
	                        	or <a href class="cursorHand" onclick="AddNewPatient('<%=caseLocalId%>'); return false;">Add New</a> </n>
	                        </logic:equal>
			      </logic:empty>
			      <logic:notEmpty name="patientSearchForm" property="attributeMap.contactPatientEle">
