    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="41. Sputum Culture Conversion Documented" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB220.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB220)" styleId = "TUB220" onchange="fireRule('TUB220', this)">
           ...
           <!-- Date of First Consistently Negative Culture -->           
            <tr>
                ...
                <td>
                       <html:text maxlength="10"  property="pamClientVO.answer(TUB221)" styleId="TUB221"  onblur="fireRule('TUB221', this)"  onchange="fireRule('TUB221', this)" disabled ="${PamForm.formFieldMap.TUB221.state.disabled}" onkeyup="DateMask(this,null,event)" size="10" title="${PamForm.formFieldMap.TUB221.tooltip}"/>
            <html:img src="calendar.gif" onclick="getCalDate('TUB221','fieldDateofFirstNegativeCultureIcon'); return false;" styleId="fieldDateofFirstNegativeCultureIcon"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB222.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB222)" styleId = "TUB222" onchange="fireRule('TUB222', this)">
            ...
            <tr>
                ...
                <td>
                     <html:text name="PamForm" property="pamClientVO.answer(TUB223)" maxlength="100" 
                            title="${PamForm.formFieldMap.TUB223.tooltip}" styleId="TUB223" onblur="fireRule('TUB223', this)" disabled ="${PamForm.formFieldMap.TUB223.state.disabled}"  />
		...
		<nedss:container id="<%= tabId + (++subSectionIndex) %>" name="42. Moved" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB224.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB224)" styleId = "TUB224" onchange="fireRule('TUB224', this)">
            ...
            <tr>
               ...
               <!-- <td>
                   <html:select disabled ="${PamForm.formFieldMap.TUB225.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB225)" styleId = "TUB225"  onchange="fireRule('TUB225', this);">
                ...
                <td>
		                    <div class="multiSelectBlock">
									...
									<html:select property="pamClientVO.answerArray(TUB225)" 
            ...
            <tr>
                ...
                <td>
                    <html:text name="PamForm" property="pamClientVO.answer(TUB227)" maxlength="100" 
                        title="${PamForm.formFieldMap.TUB227.tooltip}" styleId="TUB227" 
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                            <i> (Use Ctrl to select more than one) </i> <br/>
							<html:select property="pamClientVO.answerArray(TUB228)" 
									styleId="TUB228"
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB229)" 
                                styleId="TUB229" 
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB230)" 
                                styleId="TUB230" 
            ...
            <tr>
                ...
                <td>
                   <html:select disabled ="${PamForm.formFieldMap.TUB226.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB226)" styleId = "TUB226">
	    ...
	    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Therapy" classType="subSect" >
			<!-- 43. Date Therapy Stopped -->
			 <tr>
                ...
                <td>
                    <html:text name="PamForm" property="pamClientVO.answer(TUB232)" maxlength="10" styleId="TUB232" 
                            onkeyup="DateMask(this,null,event)" size="10" disabled ="${PamForm.formFieldMap.TUB232.state.disabled}"/>
                    <html:img src="calendar.gif" onclick="getCalDate('TUB232','TUB232Icon'); return false;" 
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB233.state.disabled}" 
            ...
            <tr>
                ...
                <td>
                   <html:select disabled ="${PamForm.formFieldMap.TUB234.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB234)" styleId = "TUB234" onchange="fireRule('TUB234', this)">
            ...
            <tr>
                ...
                <td>
                   ...
                   <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB235)" 
                                styleId="TUB235" 
            ...
            <tr>
                ...
                <td>
                    <div class="multiSelectBlock">
                        <i> (Use Ctrl to select more than one) </i> <br/>
                        <html:select property="pamClientVO.answerArray(TUB237)" 
                                styleId="TUB237" 
            ...
            <tr>
                ...
                <td>
                   <html:select disabled ="${PamForm.formFieldMap.TUB238.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB238)" styleId = "TUB238" onchange="fireRule('TUB238', this)">
			...
			<!-- Number of weeks of directly observed therapy(DOT):-->
			  <tr>
                ...
                <td>              
				 <html:text name="PamForm" property="pamClientVO.answer(TUB239)" maxlength="3" styleId="TUB239" onblur="fireRule('TUB239', this)" disabled ="${PamForm.formFieldMap.TUB239.state.disabled}"  title="${PamForm.formFieldMap.TUB239.tooltip}" onkeyup="isNumericCharacterEntered(this)"/>
                </td>
            </tr>
            <!-- Therapy LDFs -->
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="48. Final Drug Susceptibility Testing" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB240.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB240)" styleId = "TUB240" onchange="fireRule('TUB240', this); handleFollowUp2_DrugTestBtns('TUB240')">
            ...
            <tr>
                ...
                <td>
                   <html:text maxlength="10"  property="pamClientVO.answer(TUB241)" styleId="TUB241" onblur="fireRule('TUB241', this)" onchange="fireRule('TUB241', this)" disabled ="${PamForm.formFieldMap.TUB241.state.disabled}" onkeyup="DateMask(this,null,event)" size="10" title="${PamForm.formFieldMap.TUB241.tooltip}"/>
                <html:img src="calendar.gif" onclick="getCalDate('TUB241','fieldDateFinaIsolateCollectedIcon'); return false;" styleId="fieldDateFinaIsolateCollectedIcon"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                     <html:select disabled ="${PamForm.formFieldMap.TUB242.state.disabled}"
                            name="PamForm" property="pamClientVO.answer(TUB242)" styleId="TUB242" 	
                            title="${PamForm.formFieldMap.TUB242.tooltip}"  onchange="fireRule('TUB242', this)">
            ...
            <tr>
                ...
                <td>
                     <html:select disabled ="${PamForm.formFieldMap.TUB243.state.disabled}"
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="49. Final Drug Susceptibility Results" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB244.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB244)" styleId = "TUB244" onchange="fireRule('TUB244', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB245.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB245)" styleId = "TUB245" onchange="fireRule('TUB245', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB246.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB246)" styleId = "TUB246" onchange="fireRule('TUB246', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB247.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB247)" styleId = "TUB247" onchange="fireRule('TUB247', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB248.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB248)" styleId = "TUB248" onchange="fireRule('TUB248', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB255.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB255)" styleId = "TUB255" onchange="fireRule('TUB255', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB258.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB258)" styleId = "TUB258" onchange="fireRule('TUB258', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB249.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB249)" styleId = "TUB249" onchange="fireRule('TUB249', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB254.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB254)" styleId = "TUB254" onchange="fireRule('TUB254', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB250.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB250)" styleId = "TUB250" onchange="fireRule('TUB250', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB252.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB252)" styleId = "TUB252" onchange="fireRule('TUB252', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB256.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB256)" styleId = "TUB256" onchange="fireRule('TUB256', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB259.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB259)" styleId = "TUB259" onchange="fireRule('TUB259', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB257.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB257)" styleId = "TUB257" onchange="fireRule('TUB257', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB260.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB260)" styleId = "TUB260" onchange="fireRule('TUB260', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB261.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB261)" styleId = "TUB261" onchange="fireRule('TUB261', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB251.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB251)" styleId = "TUB251" onchange="fireRule('TUB251', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB253.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB253)" styleId = "TUB253" onchange="fireRule('TUB253', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB262.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB262)" styleId = "TUB262"  onchange="fireRule('TUB262', this)">
            ...
            <tr>
                ...
                <td>
                    <html:select disabled ="${PamForm.formFieldMap.TUB264.state.disabled}" name="PamForm" property="pamClientVO.answer(TUB264)" styleId = "TUB264" onchange="fireRule('TUB264', this)">
            ...
            <tr>
                ...
                <td>
                 <html:text name="PamForm" disabled ="${PamForm.formFieldMap.TUB265.state.disabled}" 
                        ...
                        maxlength="100" styleId = "TUB265" onblur="fireRule('TUB265', this)" title="${PamForm.formFieldMap.TUB265.tooltip}"/>
                </td>
            </tr>
			<!--Clear -->
            <tr>
		...
		<nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Follow Up 2 Comments" classType="subSect" >			
            ...
            <tr>
               <td class="fieldName">
                ...
                <td>
                    <html:textarea style="WIDTH: 500px; HEIGHT: 100px;" disabled ="${PamForm.formFieldMap.TUB271.state.disabled}" 
