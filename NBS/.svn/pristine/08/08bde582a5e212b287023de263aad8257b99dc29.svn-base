	        ...
	        HttpServletResponse response)throws Exception 
	{
		...
		try
		{
			...
			if(request.getParameter("rdbTableNmHid") != null) {
				...
				dt.setRdbcolumnNm(subGroupNm+"_"+dt.getUserDefinedColumnNm());
			}
...
public ActionForward activeInactiveQuestionSubmit(ActionMapping mapping, ActionForm form,HttpServletRequest request,HttpServletResponse response)throws Exception {
    ...
    private ArrayList<String> validateQuestionUniqueness(WaQuestionDT questionToValidate)
    {
        ...
        if(waQuestionDT != null && 
            ...
            errorMsgs.add("A question with unique name " + questionToValidate.getQuestionNm() + 
		        ...
		        if(waQuestionDT != null && 
		            ...
		            errorMsgs.add("A question with question identifier " + questionToValidate.getQuestionIdentifier() + 
		                    " already exists in the system");
		        }
        ...
        // question data mart column name
		        String rdbColumnNm = questionToValidate.getRdbTableNm()+"_"+questionToValidate.getUserDefinedColumnNm();
                ...
                (questionToValidate.getWaQuestionUid() == null || 
		            ...
		            errorMsgs.add("A question with rdb column name " + waQuestionDT.getRdbcolumnNm() + 
                " (arrived by combining RDB Table Name and RDB Column Name values) already exists in the system.");
		        }
        }
