<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            */
            ...
            {
                var componentUid = "<bean:write name="pageElementForm" property="pageEltVo.waUiMetadataDT.nbsUiComponentUid" />";
    ...
    <body class="popup" onload="handlePageOnload();startCountdown();" onunload="handlePageUnload(false, event); return false;">
