...
public String getName()
    ...
    protected String renderContainerElement() 
    {
    	...
    	if(classType!=null && classType.equals("sect"))
    	{
	        ...
	        // section header
	        sb.append("<table class=\"sectHeader\"><tr>");
	        ...
	        if(displayImg==null)
	        {
		        sb.append("<a class=\"toggleIconHref\" href=\"#\" tabindex=-1 onclick=\"return toggleSectionDisplay('");
		        sb.append(this.getId()).append("');\">");
		        sb.append("<img border=\"0\" src=\"minus_sign.gif\" alt=\"Minimize\" title=\"Collase Block\">");
		        sb.append("</a>");
	        }
	        ...
	        if (includeBackToTopLink.equalsIgnoreCase("yes")) {
	        	sb.append("<td style=\"text-align:right;\"><a href=\"#pageTop\" tabindex=-1 class=\"backToTopLink\">");
