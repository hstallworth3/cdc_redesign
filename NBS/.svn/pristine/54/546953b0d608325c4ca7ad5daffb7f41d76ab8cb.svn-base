...
public class PortProxyEJB extends BMPBase implements javax.ejb.SessionBean {
	 ...
	 * @throws Exception
	 */
	public Map<String, MappedFromToQuestionFieldsDT> getQuestionsToBeMappedByWaTemplateUid(Long waTemplateUid, NBSSecurityObj nbsSecurityObj) throws NEDSSDAOSysException, Exception{
		try{
			PortPageDAO portPageDAO = new PortPageDAO();
			Map<String, MappedFromToQuestionFieldsDT>  questionIdentifierAndNbsQuestionUidMap  = portPageDAO.getQuestionsToBeMappedByWaTemplateUid(waTemplateUid);
			return questionIdentifierAndNbsQuestionUidMap;
		}catch (Exception ex) {
