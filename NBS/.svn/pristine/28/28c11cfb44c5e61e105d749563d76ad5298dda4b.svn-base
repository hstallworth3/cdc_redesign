...
public class ReportSQLBuilder
{
   ...
   // private static final String FILTER_VALUE_DATA_ERROR = "FilterValue Data Error!";
    ...
    private static SimpleDateFormat infmt1 = new SimpleDateFormat("MM/dd/yyyy");
    private static SimpleDateFormat infmt2 = new SimpleDateFormat("MM/yyyy");
    private static SimpleDateFormat outfmt = new SimpleDateFormat("''ddMMMyyyy'''d'");
    private static SimpleDateFormat dtEndfmt = new SimpleDateFormat("''ddMMMyyyy:23:59:59'''dt'");
    private static SimpleDateFormat dtBeginfmt = new SimpleDateFormat("''ddMMMyyyy:00:00:00'''dt'");
