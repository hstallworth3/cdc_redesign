...
public class NEDSSConstants {
    ...
    public static final String EDX_ACTIVITY_FAIL = "FAIL";
    ...
    public static final String OBS_UNPROCESSED_PREV_DELETED = "UNPROCESSED_PREV_DELETED";

    public static final String OBS_UNPROCESSED_PREV_D = "UNPROCESSED_PREV_D";
...
//    public static final String CDC_INTERVIEW_RECORD_BLANK_FORM ="InterviewRecordBlankForm";
    public static final String CDC_PROVIDER_FORM_PDF ="CDCProviderForm.pdf";
