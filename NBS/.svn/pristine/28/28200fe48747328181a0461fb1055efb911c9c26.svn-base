    ...
    <nedss:container id='<%= "sect_" + tabId + sectionIndex %>' name="<%= sectionNames[sectionIndex++] %>" classType="sect">
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="General Information" classType="subSect" >
            ...
            <tr>
                ...
                <td>
                    <html:text name="PamForm" property="pamClientVO.answer(DEM215)" maxlength="10"
                            styleId="DEM215" onkeyup="DateMask(this,null,event)" size="10"
                            onchange="calculateReportedAge()"/>
                    <html:img src="calendar.gif" onclick="getCalDate('DEM215','DEM215Icon'); return false;" 
        ...
        <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Name Information" classType="subSect">
            ...
            <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td> 
                        <html:text name="PamForm" property="pamClientVO.answer(DEM206)" maxlength="10" 
                                styleId="DEM206" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM206','DEM206Icon'); return false;" 
	    ...
	    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Other Personal Details" classType="subSect" >
	       <!-- Other details As of Date - Edit mode only -->
            <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td>
                        <html:text name="PamForm" property="pamClientVO.answer(DEM207)" maxlength="10" 
                                styleId="DEM207" onkeyup="DateMask(this,null,event)" size="10"  onchange="calculateReportedAge()"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM207','DEM207Icon'); return false;" 
            ...
            <tr>
                ...
                <td> 
                    ...
                    <html:img src="calendar.gif" onclick="getCalDate('DEM115','DEM115Icon'); return false;" 
            ...
            <tr>
                ...
                <td> 
                     ...
                     <html:select name="PamForm" property="pamClientVO.answer(DEM218)" styleId="DEM218">
            ...
            <tr>
                ...
                <td> 
                     <html:select name="PamForm" property="pamClientVO.answer(DEM114)" styleId="DEM114"  onchange="fireRule('DEM114', this)">
            ...
            <tr>
                ...
                <td> 
                     <html:select name="PamForm" property="pamClientVO.answer(DEM113)" styleId="DEM113" onchange="fireRule('DEM113', this)">
            ...
            <!-- Mortality Information As of Date - Edit mode only -->
             <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                         <html:text name="PamForm" property="pamClientVO.answer(DEM208)" maxlength="10" 
                                styleId="DEM208" onkeyup="DateMask(this,null,event)" size="10"/>
                         <html:img src="calendar.gif" onclick="getCalDate('DEM208','DEM208Icon'); return false;" 
            ...
            <tr>
                ...
                <td> 
                    <html:select name="PamForm" property="pamClientVO.answer(DEM127)" styleId="DEM127" 
            ...
            <tr>
                ...
                <td> 
                    ...
                    <html:img src="calendar.gif" onclick="getCalDate('DEM128','DEM128Icon'); return false;" 
             ...
             <logic:notEqual name="PamForm" property="actionMode" value="Create">	
			    <logic:notEqual name="PamForm" property="actionMode" value="CREATE_SUBMIT">	
                 <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM209)" maxlength="10" 
                                styleId="DEM209" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM209','DEM209Icon'); return false;" 
            ...
            <tr>
                ...
                <td>
                    <html:select name="PamForm" property="pamClientVO.answer(DEM140)" styleId="DEM140" 
          ...
          <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM210)" maxlength="10" 
                                styleId="DEM210" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM210','DEM210Icon'); return false;" 
	       ...
	       <!-- Contact Information As of date - Edit mode only -->
            <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM213)" maxlength="10" 
                                styleId="DEM213" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM213','DEM213Icon'); return false;" 
            ...
            <tr>
                ...
                <td> 
                    <html:select name="PamForm" property="pamClientVO.answer(DEM162)" 
            ...
            <tr>
                ...
                <td> 
                    <html:select name="PamForm" property="pamClientVO.answer(DEM165)" 
                            styleId="countyList" >
                        <!-- <html:option value="" /> -->
            ...
            <tr>
                ...
                <td> 
                     <html:select name="PamForm" property="pamClientVO.answer(DEM167)" styleId="DEM167">
                        <html:option value="" />
            ...
            <tr>
                ...
                <td> 
                     <html:select name="PamForm" property="pamClientVO.answer(DEM237)" styleId="DEM237">
                        <html:option value="" />
            ...
            <!-- Telephone Information As of date - Edit mode only -->
             <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM214)" maxlength="10" 
                                styleId="DEM214" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM214','DEM214Icon'); return false;" 
	    ...
	    <nedss:container id="<%= tabId + (++subSectionIndex) %>" name="Ethnicity & Race Information" classType="subSect" >
           ...
           <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM211)" maxlength="10" 
                                styleId="DEM211" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM211','DEM211Icon'); return false;" 
            ...
            <tr>
                ...
                <td> 
                    <html:select name="PamForm" property="pamClientVO.answer(DEM155)" styleId="DEM155">
        ...
        <logic:notEqual name="PamForm" property="actionMode" value="Create">	
                ...
                <tr>
                    ...
                    <td class="topBorder">
                        <html:text name="PamForm" property="pamClientVO.answer(DEM212)" maxlength="10" 
                                styleId="DEM212" onkeyup="DateMask(this,null,event)" size="10"/>
                        <html:img src="calendar.gif" onclick="getCalDate('DEM212','DEM212Icon'); return false;" 
			            ...
			            <div id="asianlist">
			                <div class="CheckboxField">
			                    <div id="asian-multi" style="background:#DFEFFF; margin:0.1em 1em 0.1em 0.25em; padding:0.5em;"> 
			                        ...
			                        <html:select property="pamClientVO.answerArray(DEM243)" 
			                                styleId="DEM243" 
			            ...
			            <div id="hawaiianlist">
			                <div class="CheckboxField">
			                    <div id="hawaiian-multi" style="background:#DFEFFF;  margin:0.25em 1em 0.25em 0.25em; padding:0.5em; "> 
			                        ...
			                        <html:select property="pamClientVO.answerArray(DEM245)" 
			                                styleId="DEM245" 
			                                multiple="true" size="4"
