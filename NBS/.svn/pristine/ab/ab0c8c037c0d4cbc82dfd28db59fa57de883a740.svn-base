    ...
    extends Action
{
  ...
  private Collection<?>  allPermsColl = null;
  public Collection<?>  permSetColl = null;
      ...
      ServletException
  {
    ...
    try
    {
      ...
      allPermsColl = (Collection<?>) arr.get(0);
	...
	if (userProfile != null)
	{
	  convertUserToRequestObj(userProfile, secObj,request);
  ...
  private void setRoleList(Collection<Object> roles, HttpServletRequest request)
  {
