...
<html>
    <head>
        ...
        function makeMSelects() {
        	$j("#lprocessedTime").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
        	$j("#ltype").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
        	$j("#ltemplateName").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
        	$j("#lsource").multiSelect({actionMode: '<%= request.getAttribute("ActionMode") %>'});
