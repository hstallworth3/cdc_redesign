...
<html:form styleId="addNotesForm" action="/InvAddNotes.do?method=saveForm" method="post">
    <table class="formTableNA" style="width:100%; height:100%; margin:0px;">
        ...
        <!-- Notes -->
        <tr>
            <td class="fieldName" id="notesLabel" valign="top"> <span style="color:red; font-weight:bold;">*</span> Notes:</td>
...
<script type="text/javascript">
    <% if (request.getAttribute("confirmation") != null && 
        ...
        var appnd ='<tr class="odd"><%= request.getAttribute("newNote")%></tr>';
