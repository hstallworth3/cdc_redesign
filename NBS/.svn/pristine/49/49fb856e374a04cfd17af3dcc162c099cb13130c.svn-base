...
FROM v_chalk_talk 
where 
DIAGNOSIS_CD is not null and DIAGNOSIS_CD in ('300','350','200','710', '720','730','740','745','750','790','900','950') 
 ;
quit; 
...
. as dispo_dt, . as dispo, . as ct_dispo_dt, . as ct_dispo
from init_add
...
by newadd Type  ;
column newadd blank _200 _300 _710 _720 _730 _740 _745 _750 _790 _900 _950   cohort_count 
...
define  _200    /group '200' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _300    /group '300' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _710    /group '710' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _720    /group '720' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _730    /group '730' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _740    /group '740' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _745   /group '745' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _750   /group '750' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};

define  _790    /group '790' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _900    /group '900' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
define  _950    /group '950' center   style(column)={just=center cellwidth=12mm rules=none }
style(header)={just=center cellwidth=12mm rules=none};
