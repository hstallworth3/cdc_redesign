...
//##!! System.out.println("actRelationshipDT.getTypeCd() = " + actRelationshipDT.getTypeCd());
         if(actRelationshipDT.getTypeCd().equals(NEDSSConstants.PHC_INV_FORM))
         {
            ...
            Iterator<ObservationVO>  iter1 = observationVOCollection.iterator();
             while(iter1.hasNext())
             {
                 ...
                 //** Adding Item to Row Act Relationships**
                       if(observationVO.getTheObservationDT().getCd().equals(NEDSSConstants.ITEM_TO_ROW))
                 {
...
//##!! System.out.println("end of extractActRelationshipsFromObservation");
      ...
      {
        e.printStackTrace();
        throw new NNDException("NNDMarshallerInvestigation.extractActRelationshipsFromObservation" + e.getMessage());
      }
    }
